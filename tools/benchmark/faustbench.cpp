...
extern "C" int bench_all(const char* name, int run, bool trace)
{
    ...
    // Scalar
    measures.push_back(bench(new dsp_scal(), sizeof(dsp_scal), options[ind++], run, trace));
    measures.push_back(bench(new dsp_scal_exp10(), sizeof(dsp_scal_exp10), options[ind++], run, trace));
    
    // Vector -lv 0
    measures.push_back(bench(new dsp_vec1_4(), sizeof(dsp_vec1_4), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_8(), sizeof(dsp_vec0_8), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_16(), sizeof(dsp_vec0_16), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_32(), sizeof(dsp_vec0_32), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_64(), sizeof(dsp_vec0_64), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_128(), sizeof(dsp_vec0_128), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_256(), sizeof(dsp_vec0_256), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0_512(), sizeof(dsp_vec0_512), options[ind++] , run, trace));
    
    measures.push_back(bench(new dsp_vec1_4(), sizeof(dsp_vec1_4), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_8(), sizeof(dsp_vec0g_8), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_16(), sizeof(dsp_vec0g_16), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_32(), sizeof(dsp_vec0g_32), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_64(), sizeof(dsp_vec0g_64), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_128(), sizeof(dsp_vec0g_128), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_256(), sizeof(dsp_vec0g_256), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec0g_512(), sizeof(dsp_vec0g_512), options[ind++] , run, trace));
    
    // Vector -lv 1
    measures.push_back(bench(new dsp_vec1_4(), sizeof(dsp_vec1_4), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_8(), sizeof(dsp_vec1_8), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_16(), sizeof(dsp_vec1_16), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_32(), sizeof(dsp_vec1_32), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_64(), sizeof(dsp_vec1_64), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_128(), sizeof(dsp_vec1_128), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_256(), sizeof(dsp_vec1_256), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1_512(), sizeof(dsp_vec1_512), options[ind++] , run, trace));
    
    measures.push_back(bench(new dsp_vec1g_4(), sizeof(dsp_vec1g_4), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_8(), sizeof(dsp_vec1g_8), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_16(), sizeof(dsp_vec1g_16), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_32(), sizeof(dsp_vec1g_32), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_64(), sizeof(dsp_vec1g_64), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_128(), sizeof(dsp_vec1g_128), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_256(), sizeof(dsp_vec1g_256), options[ind++] , run, trace));
    measures.push_back(bench(new dsp_vec1g_512(), sizeof(dsp_vec1g_512), options[ind++] , run, trace));
