...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "echo -- stereo delay effect");
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("delay", &fslider2, 0.04f, 0.0f, 5.0f, 0.001f);
		interface->addHorizontalSlider("feedback", &fslider1, 0.0f, 0.0f, 1.0f, 0.001f);
		interface->addHorizontalSlider("level", &fslider3, 1.0f, 0.0f, 1.0f, 0.01f);
		interface->addHorizontalSlider("stereo", &fslider0, 1.0f, 0.0f, 1.0f, 0.001f);
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow3 = (iConst0 * float(fslider2));
		int 	iSlow4 = int(fSlow3);
		int 	iSlow5 = (1 + iSlow4);
		int 	iSlow6 = int((int(iSlow5) & 262143));
		float 	fSlow7 = (fSlow3 - iSlow4);
		int 	iSlow8 = int((iSlow4 & 262143));
		float 	fSlow9 = (iSlow5 - fSlow3);
		float 	fSlow10 = float(fslider3);
		float 	fSlow11 = (1.0f / (1 + fSlow10));
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp1 = (fTemp0 + (fSlow2 * ((fSlow1 * fRec0[1]) + (fSlow0 * fRec1[1]))));
			fVec0[IOTA&262143] = fTemp1;
			fRec0[0] = ((fSlow9 * fVec0[(IOTA-iSlow8)&262143]) + (fSlow7 * fVec0[(IOTA-iSlow6)&262143]));
			float fTemp2 = (float)input1[i];
			float fTemp3 = (fTemp2 + (fSlow2 * ((fSlow1 * fRec1[1]) + (fSlow0 * fRec0[1]))));
			fVec1[IOTA&262143] = fTemp3;
			fRec1[0] = ((fSlow9 * fVec1[(IOTA-iSlow8)&262143]) + (fSlow7 * fVec1[(IOTA-iSlow6)&262143]));
			output0[i] = (FAUSTFLOAT)(fSlow11 * (fTemp0 + (fSlow10 * ((fSlow1 * fRec0[0]) + (fSlow0 * fRec1[0])))));
			output1[i] = (FAUSTFLOAT)(fSlow11 * (fTemp2 + (fSlow10 * ((fSlow1 * fRec1[0]) + (fSlow0 * fRec0[0])))));
			// post processing
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			IOTA = IOTA+1;
