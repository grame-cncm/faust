//-----------------------------------------------------
// name: "phasemod -- phase modulation synth"
// author: "Albert Graef"
// version: "1.0"
//
...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "phasemod -- phase modulation synth");
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("pan", &fslider4, 0.5f, 0.0f, 1.0f, 0.01f);
		interface->addHorizontalSlider("vol", &fslider5, 0.3f, 0.0f, 1e+01f, 0.01f);
		interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow7 = (1 - (1.0f / powf((1e+03f * fSlow5),(1.0f / ((fSlow6 == 0.0f) + (iConst0 * fSlow6))))));
		float 	fSlow8 = float(fslider2);
		float 	fSlow9 = (1 - powf(fSlow5,(1.0f / ((fSlow8 == 0.0f) + (iConst0 * fSlow8)))));
		float 	fSlow10 = float(fslider3);
		float 	fSlow11 = (1.0f / ((fSlow10 == 0.0f) + (iConst0 * fSlow10)));
		float 	fSlow12 = (0.0010000000000000009f * float(fentry1));
		float 	fSlow13 = float(fslider4);
		float 	fSlow14 = float(fslider5);
		float 	fSlow15 = (fSlow14 * (1 - fSlow13));
		float 	fSlow16 = (fSlow14 * fSlow13);
		FAUSTFLOAT* output0 = output[0];
		FAUSTFLOAT* output1 = output[1];
		for (int i=0; i<count; i++) {
			float fTemp0 = (fSlow0 + fRec1[1]);
			fRec1[0] = (fTemp0 - floorf(fTemp0));
			float fTemp1 = (65536 * (fRec1[0] - floorf(fRec1[0])));
			float fTemp2 = floorf(fTemp1);
			int iTemp3 = int(fTemp2);
			iRec2[0] = (iSlow2 & (iRec2[1] | (fRec3[1] >= 1)));
			int iTemp4 = (iSlow3 & (fRec3[1] > 0));
			fRec3[0] = (((fSlow11 * (((iRec2[1] == 0) & iSlow2) & (fRec3[1] < 1))) + (fRec3[1] * ((1 - (fSlow9 * (iRec2[1] & (fRec3[1] > fSlow4)))) - (fSlow7 * iTemp4)))) * ((iTemp4 == 0) | (fRec3[1] >= 1e-06f)));
			float fTemp5 = (fRec1[0] + (fRec3[0] * ((((1 + fTemp2) - fTemp1) * ftbl0[(iTemp3 & 65535)]) + ((fTemp1 - fTemp2) * ftbl0[((1 + iTemp3) & 65535)]))));
			float fTemp6 = (65536 * (fTemp5 - floorf(fTemp5)));
			float fTemp7 = floorf(fTemp6);
			int iTemp8 = int(fTemp7);
			fRec4[0] = ((0.999f * fRec4[1]) + fSlow12);
			float fTemp9 = ((fRec3[0] * fRec4[0]) * ((((1 + fTemp7) - fTemp6) * ftbl0[(iTemp8 & 65535)]) + ((fTemp6 - fTemp7) * ftbl0[((1 + iTemp8) & 65535)])));
			output0[i] = (FAUSTFLOAT)(fSlow15 * fTemp9);
			output1[i] = (FAUSTFLOAT)(fSlow16 * fTemp9);
			// post processing
			fRec4[1] = fRec4[0];
			fRec3[1] = fRec3[0];
			iRec2[1] = iRec2[0];
