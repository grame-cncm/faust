//-----------------------------------------------------
// name: "organ -- a simple additive synth"
// author: "Albert Graef"
// version: "1.0"
//
...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "organ -- a simple additive synth");
	...
	virtual void instanceInit(int samplingFreq) {
		...
		fConst2 = (float(3) / fConst1);
		for (int i=0; i<2; i++) fRec1[i] = 0;
		fslider0 = 0.25f;
		fConst3 = (float(2) / fConst1);
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("attack", &fslider6, 0.01f, 0.0f, 1.0f, 0.001f);
		interface->addHorizontalSlider("decay", &fslider5, 0.3f, 0.0f, 1.0f, 0.001f);
		interface->addHorizontalSlider("release", &fslider4, 0.2f, 0.0f, 1.0f, 0.001f);
		interface->addHorizontalSlider("sustain", &fslider3, 0.5f, 0.0f, 1.0f, 0.01f);
		interface->closeBox();
		interface->openVerticalBox("2-master");
		interface->addHorizontalSlider("pan", &fslider7, 0.5f, 0.0f, 1.0f, 0.01f);
		interface->addHorizontalSlider("vol", &fslider8, 0.3f, 0.0f, 1e+01f, 0.01f);
		interface->closeBox();
		interface->addHorizontalSlider("amp1", &fslider2, 1.0f, 0.0f, 3.0f, 0.01f);
		interface->addHorizontalSlider("amp2", &fslider1, 0.5f, 0.0f, 3.0f, 0.01f);
		interface->addHorizontalSlider("amp3", &fslider0, 0.25f, 0.0f, 3.0f, 0.01f);
		interface->addNumEntry("freq", &fentry0, 4.4e+02f, 2e+01f, 2e+04f, 1.0f);
		interface->addNumEntry("gain", &fentry1, 0.3f, 0.0f, 1e+01f, 0.01f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow5 = (fConst4 * fSlow0);
		float 	fSlow6 = float(fslider2);
		float 	fSlow7 = float(fbutton0);
		int 	iSlow8 = (fSlow7 > 0);
		int 	iSlow9 = (fSlow7 <= 0);
		float 	fSlow10 = float(fslider3);
		float 	fSlow11 = (fSlow10 + (0.001f * (fSlow10 == 0.0f)));
		float 	fSlow12 = float(fslider4);
		float 	fSlow13 = (1 - (1.0f / powf((1e+03f * fSlow11),(1.0f / ((fSlow12 == 0.0f) + (iConst0 * fSlow12))))));
		float 	fSlow14 = float(fslider5);
		float 	fSlow15 = (1 - powf(fSlow11,(1.0f / ((fSlow14 == 0.0f) + (iConst0 * fSlow14)))));
		float 	fSlow16 = float(fslider6);
		float 	fSlow17 = (1.0f / ((fSlow16 == 0.0f) + (iConst0 * fSlow16)));
		float 	fSlow18 = float(fslider7);
		float 	fSlow19 = (float(fentry1) * float(fslider8));
		float 	fSlow20 = (fSlow19 * (1 - fSlow18));
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp1 = (fRec2[1] + fSlow3);
			fRec2[0] = (fTemp1 - floorf(fTemp1));
			float fTemp2 = (fRec3[1] + fSlow5);
			fRec3[0] = (fTemp2 - floorf(fTemp2));
			iRec4[0] = (iSlow8 & (iRec4[1] | (fRec5[1] >= 1)));
			int iTemp3 = (iSlow9 & (fRec5[1] > 0));
			fRec5[0] = (((fSlow17 * (((iRec4[1] == 0) & iSlow8) & (fRec5[1] < 1))) + (fRec5[1] * ((1 - (fSlow15 * (iRec4[1] & (fRec5[1] > fSlow10)))) - (fSlow13 * iTemp3)))) * ((iTemp3 == 0) | (fRec5[1] >= 1e-06f)));
			float fTemp4 = (fRec5[0] * (((fSlow6 * ftbl0[int((65536.0f * fRec3[0]))]) + (fSlow4 * ftbl0[int((65536.0f * fRec2[0]))])) + (fSlow2 * ftbl0[int((65536.0f * fRec1[0]))])));
			output0[i] = (FAUSTFLOAT)(fSlow20 * fTemp4);
			output1[i] = (FAUSTFLOAT)(fSlow21 * fTemp4);
			// post processing
			fRec5[1] = fRec5[0];
			iRec4[1] = iRec4[0];
			fRec3[1] = fRec3[0];
