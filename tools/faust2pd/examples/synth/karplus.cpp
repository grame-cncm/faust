//-----------------------------------------------------
// name: "karplus -- Karplus-Strong string synth"
// author: "Yann Orlarey"
// version: "1.0"
//
...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "karplus -- Karplus-Strong string synth");
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("decay time", &fslider2, 4.0f, 0.0f, 1e+01f, 0.01f);
		interface->addNumEntry("freq", &fentry1, 4.4e+02f, 2e+01f, 2e+04f, 1.0f);
		interface->addHorizontalSlider("pitch bend", &fslider1, 0.0f, -2.0f, 2.0f, 0.01f);
		interface->closeBox();
		interface->openVerticalBox("3-master");
		interface->addHorizontalSlider("pan", &fslider3, 0.0f, -1.0f, 1.0f, 0.01f);
		interface->addHorizontalSlider("vol", &fslider4, -1e+01f, -96.0f, 96.0f, 0.1f);
		interface->closeBox();
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow3 = powf(2,(0.08333333333333333f * float(fslider1)));
		float 	fSlow4 = float(fentry1);
		float 	fSlow5 = (0.5f / powf(1e+03f,(1.0f / ((float(fslider2) * fSlow4) * fSlow3))));
		float 	fSlow6 = (float(iConst0) / (fSlow4 * fSlow3));
		int 	iSlow7 = int((fSlow6 - 1.5f));
		int 	iSlow8 = int((int((1 + iSlow7)) & 4095));
		float 	fSlow9 = (fSlow6 - (1.5f + iSlow7));
		int 	iSlow10 = int((iSlow7 & 4095));
		float 	fSlow11 = ((iSlow7 + 2.5f) - fSlow6);
		float 	fSlow12 = (1 + float(fslider3));
		float 	fSlow13 = powf(10,(0.05f * float(fslider4)));
		float 	fSlow14 = (fSlow13 * (1 - (0.5f * fSlow12)));
		float 	fSlow15 = (0.5f * (fSlow13 * fSlow12));
		FAUSTFLOAT* output0 = output[0];
		FAUSTFLOAT* output1 = output[1];
		for (int i=0; i<count; i++) {
			fVec0[0] = fSlow1;
			fRec2[0] = ((fRec2[1] + ((fSlow1 - fVec0[1]) > 0.0f)) - (fSlow0 * (fRec2[1] > 0)));
			iRec3[0] = (12345 + (1103515245 * iRec3[1]));
			float fTemp0 = ((fSlow5 * (fRec1[1] + fRec1[2])) + (fSlow2 * (iRec3[0] * ((fRec2[0] > 0.0f) + 1.52587890625e-05f))));
			fVec1[IOTA&4095] = fTemp0;
			fRec1[0] = ((fSlow11 * fVec1[(IOTA-iSlow10)&4095]) + (fSlow9 * fVec1[(IOTA-iSlow8)&4095]));
			fRec0[0] = ((fRec1[0] + (0.995f * fRec0[1])) - fRec1[1]);
			output0[i] = (FAUSTFLOAT)(fSlow14 * fRec0[0]);
			output1[i] = (FAUSTFLOAT)(fSlow15 * fRec0[0]);
			// post processing
			fRec0[1] = fRec0[0];
