...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow2 = (fConst3 * fSlow0);
		float 	fSlow3 = (fConst4 * fSlow0);
		float 	fSlow4 = float(fbutton0);
		int 	iSlow5 = (fSlow4 > 0);
		int 	iSlow6 = (fSlow4 <= 0);
		float 	fSlow7 = float(fslider0);
		float 	fSlow8 = (fSlow7 + (0.001f * (fSlow7 == 0.0f)));
		float 	fSlow9 = float(fslider1);
		float 	fSlow10 = (1 - (1.0f / powf((1e+03f * fSlow8),(1.0f / ((fSlow9 == 0.0f) + (iConst0 * fSlow9))))));
		float 	fSlow11 = float(fslider2);
		float 	fSlow12 = (1 - powf(fSlow8,(1.0f / ((fSlow11 == 0.0f) + (iConst0 * fSlow11)))));
		float 	fSlow13 = float(fslider3);
		float 	fSlow14 = (1.0f / ((fSlow13 == 0.0f) + (iConst0 * fSlow13)));
		float 	fSlow15 = float(fslider4);
		float 	fSlow16 = (float(fentry1) * float(fslider5));
		float 	fSlow17 = (fSlow16 * (1 - fSlow15));
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp2 = (fRec3[1] + fSlow3);
			fRec3[0] = (fTemp2 - floorf(fTemp2));
			iRec4[0] = (iSlow5 & (iRec4[1] | (fRec5[1] >= 1)));
			int iTemp3 = (iSlow6 & (fRec5[1] > 0));
			fRec5[0] = (((fSlow14 * (((iRec4[1] == 0) & iSlow5) & (fRec5[1] < 1))) + (fRec5[1] * ((1 - (fSlow12 * (iRec4[1] & (fRec5[1] > fSlow7)))) - (fSlow10 * iTemp3)))) * ((iTemp3 == 0) | (fRec5[1] >= 1e-06f)));
			float fTemp4 = (fRec5[0] * ((ftbl0[int((65536.0f * fRec3[0]))] + (0.5f * ftbl0[int((65536.0f * fRec2[0]))])) + (0.25f * ftbl0[int((65536.0f * fRec1[0]))])));
			output0[i] = (FAUSTFLOAT)(fSlow17 * fTemp4);
			output1[i] = (FAUSTFLOAT)(fSlow18 * fTemp4);
			// post processing
			fRec5[1] = fRec5[0];
			iRec4[1] = iRec4[0];
			fRec3[1] = fRec3[0];
