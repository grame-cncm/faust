//-----------------------------------------------------
// name: "karplusplus -- Karplus-Strong + Fuzz"
// author: "Yann Orlarey, Albert Graef"
// version: "1.0"
//
...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "karplusplus -- Karplus-Strong + Fuzz");
		m->declare("author", "Yann Orlarey, Albert Graef");
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->openVerticalBox("1-excitator");
		interface->addNumEntry("gain", &fentry0, 1.0f, 0.0f, 1e+01f, 0.01f);
		interface->addButton("gate", &fbutton0);
		interface->addHorizontalSlider("samples", &fslider0, 512.0f, 1.0f, 1024.0f, 1.0f);
		interface->closeBox();
		interface->openVerticalBox("2-resonator");
		interface->addHorizontalSlider("decay time", &fslider1, 4.0f, 0.0f, 1e+01f, 0.01f);
		interface->addNumEntry("freq", &fentry1, 4.4e+02f, 2e+01f, 2e+04f, 1.0f);
		interface->closeBox();
		interface->openVerticalBox("3-fuzz");
		interface->addHorizontalSlider("drive", &fslider2, 0.0f, 0.0f, 5e+01f, 0.1f);
		interface->addNumEntry("freq", &fentry2, 4.4e+02f, 2e+01f, 2e+04f, 1.0f);
		interface->addHorizontalSlider("level", &fslider7, 1.0f, 0.0f, 1e+01f, 0.01f);
		interface->addHorizontalSlider("res", &fslider4, 0.0f, 0.0f, 2e+01f, 0.1f);
		interface->addHorizontalSlider("tone", &fslider3, 2e+01f, 1.0f, 2e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("4-master");
		interface->addHorizontalSlider("pan", &fslider5, 0.5f, 0.0f, 1.0f, 0.01f);
		interface->addHorizontalSlider("vol", &fslider6, 0.3f, 0.0f, 1e+01f, 0.01f);
		interface->closeBox();
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow2 = (4.656612875245797e-10f * float(fentry0));
		float 	fSlow3 = float(fentry1);
		float 	fSlow4 = (0.5f / powf(1e+03f,(1.0f / (float(fslider1) * fSlow3))));
		float 	fSlow5 = (float(iConst0) / fSlow3);
		int 	iSlow6 = int((fSlow5 - 1.5f));
		int 	iSlow7 = int((int((1 + iSlow6)) & 4095));
		float 	fSlow8 = (fSlow5 - (1.5f + iSlow6));
		int 	iSlow9 = int((iSlow6 & 4095));
		float 	fSlow10 = ((iSlow6 + 2.5f) - fSlow5);
		float 	fSlow11 = float(fslider2);
		float 	fSlow12 = tanf((fConst1 * (float(fentry2) * float(fslider3))));
		float 	fSlow13 = (2.0f * (1.0f - (1.0f / faustpower<2>(fSlow12))));
		float 	fSlow14 = float(fslider4);
		float 	fSlow15 = (1.4142135623730951f / powf(10,(0.1f * fSlow14)));
		float 	fSlow16 = (1.0f / fSlow12);
		float 	fSlow17 = (1.0f + ((fSlow16 - fSlow15) / fSlow12));
		float 	fSlow18 = (1.0f / (1.0f + ((fSlow15 + fSlow16) / fSlow12)));
		float 	fSlow19 = powf(10,(0.025f * fSlow14));
		float 	fSlow20 = float(fslider5);
		float 	fSlow21 = (float(fslider7) * float(fslider6));
		float 	fSlow22 = ((fSlow21 * (1 - fSlow20)) / fSlow19);
		float 	fSlow23 = ((fSlow21 * fSlow20) / fSlow19);
		FAUSTFLOAT* output0 = output[0];
		FAUSTFLOAT* output1 = output[1];
		for (int i=0; i<count; i++) {
			fVec0[0] = fSlow1;
			fRec3[0] = ((fRec3[1] + ((fSlow1 - fVec0[1]) > 0.0f)) - (fSlow0 * (fRec3[1] > 0)));
			iRec4[0] = (12345 + (1103515245 * iRec4[1]));
			float fTemp0 = ((fSlow4 * (fRec2[1] + fRec2[2])) + (fSlow2 * (iRec4[0] * ((fRec3[0] > 0.0f) + 1.52587890625e-05f))));
			fVec1[IOTA&4095] = fTemp0;
			fRec2[0] = ((fSlow10 * fVec1[(IOTA-iSlow9)&4095]) + (fSlow8 * fVec1[(IOTA-iSlow7)&4095]));
			fRec1[0] = ((fRec2[0] + (0.995f * fRec1[1])) - fRec2[1]);
			float fTemp1 = (1 + ((fabsf((fSlow11 * fRec1[0])) <= 1) * (fRec1[0] - 1)));
			fVec2[0] = fTemp1;
			fRec0[0] = (fSlow18 * ((0 - ((fSlow17 * fRec0[2]) + (fSlow13 * fRec0[1]))) + ((fVec2[0] + (2.0f * fVec2[1])) + fVec2[2])));
			output0[i] = (FAUSTFLOAT)(fSlow22 * fRec0[0]);
			output1[i] = (FAUSTFLOAT)(fSlow23 * fRec0[0]);
			// post processing
