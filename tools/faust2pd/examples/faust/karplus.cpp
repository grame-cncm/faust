...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("excitation (samples)", &fslider0, 128.0f, 2.0f, 512.0f, 1.0f);
		...
		interface->addHorizontalSlider("duration (samples)", &fslider3, 128.0f, 2.0f, 512.0f, 1.0f);
		interface->closeBox();
		interface->closeBox();
	}
