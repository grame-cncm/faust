...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addNumEntry("freq (Hz)", &fentry18, 1e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider9, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 1");
		interface->addNumEntry("Q factor", &fentry17, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry16, 2e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider8, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 2");
		interface->addNumEntry("Q factor", &fentry15, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry14, 3e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider7, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 3");
		interface->addNumEntry("Q factor", &fentry13, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry12, 4e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider6, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 4");
		interface->addNumEntry("Q factor", &fentry11, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry10, 5e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider5, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 5");
		interface->addNumEntry("Q factor", &fentry9, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry8, 6e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider4, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 6");
		interface->addNumEntry("Q factor", &fentry7, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry6, 7e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider3, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 7");
		interface->addNumEntry("Q factor", &fentry5, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry4, 8e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider2, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 8");
		interface->addNumEntry("Q factor", &fentry3, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry2, 9e+03f, 2e+01f, 2e+04f, 1.0f);
		interface->addVerticalSlider("gain (dB)", &fslider1, 0.0f, -5e+01f, 5e+01f, 0.1f);
		interface->closeBox();
		interface->openVerticalBox("peak 9");
		interface->addNumEntry("Q factor", &fentry1, 5e+01f, 0.1f, 1e+02f, 0.1f);
		interface->addNumEntry("freq (Hz)", &fentry0, 1e+04f, 2e+01f, 2e+04f, 1.0f);
