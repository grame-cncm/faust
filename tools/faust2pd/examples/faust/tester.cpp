...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("(1) freq", &fslider0, 1e+03f, 0.0f, 2.4e+04f, 0.1f);
		interface->addHorizontalSlider("(2)volume", &fslider1, -96.0f, -96.0f, 0.0f, 0.1f);
		interface->addHorizontalSlider("(3) destination", &fslider2, 0.0f, 0.0f, 8.0f, 1.0f);
