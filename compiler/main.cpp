...
void printhelp()
{
    ...
    cout << "-O <dir> \t--output-dir <dir> specify the relative directory of the generated C++ output, and the output "
...
int main(int argc, char* argv[])
{
    ...
    *****************************************************************/
    ...
    if (!getBoxType(process, &numInputs, &numOutputs)) {
        cerr << "ERROR during the evaluation of  process : " << boxpp(process) << endl;
        exit(1);
    }
