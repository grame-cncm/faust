...
class ClocksyncPrim : public xtended {
   public:
    ClocksyncPrim() : xtended("clocksync") {}
                                    ...
                                    vector<::Type> const& types)
    {
        ...
        return container->pushFunction(subst("clocksync$0", isuffix()), result_type, arg_types, casted_args);
    }
