...
class JAXVectorCodeContainer : public VectorCodeContainer, public JAXCodeContainer {
   protected:
    
   public:
    JAXVectorCodeContainer(const std::string& name, int numInputs, int numOutputs, std::ostream* out);
    virtual ~JAXVectorCodeContainer()
    {}
