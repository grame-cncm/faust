...
class Occurences
{
 ...
 public:
	...
	bool 		hasMultiOccurences();				///< true if multiple occurences or occ. in higher ctxt
	bool 		hasOutDelayOccurences();			///< true if has occurences outside a a delay
	int			getMaxDelay();						///< return the maximal delay collected
};
