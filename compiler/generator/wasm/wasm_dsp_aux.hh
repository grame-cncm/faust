...
/*
 Read the wasm binary module, extract the JSON, define a new end for the module (without the last 'data segment' section).
 */
    ...
    void read()
    {
        ...
        while (more()) {
            ...
            switch (sectionCode) {
                ...
                case BinaryConsts::Section::Global: readGlobals();  break;
                case BinaryConsts::Section::Data: {
                    readDataSegments();
                    // Keep 'data_segment_pos' with is actually the new module end (so remove the last 'data segment' section)
