...
class InstructionsCompiler : public virtual Garbageable {
    ...
    */
    ...
    virtual ValueInst* generateBargraphAux(Tree sig, Tree path, ValueInst* exp,
                                           const std::string& name);
    virtual ValueInst* generateSelect2Aux(Tree sig, Tree s1, Tree s2, ValueInst* cond,
    ...
    {
        return fContainer->pushControlDeclare(inst);
    }
...
class InstructionsFXCompiler : public InstructionsCompiler {
   ...
   public:
    InstructionsFXCompiler(CodeContainer* container) : InstructionsCompiler(container) {}
