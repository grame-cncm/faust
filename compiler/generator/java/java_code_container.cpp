...
void JAVACodeContainer::produceClass()
{
    ...
    */
    ...
    tab(n + 1, *fOut);
    *fOut << "public void classInit(int samplingFreq) {";
    tab(n + 2, *fOut);
    fCodeProducer.Tab(n + 2);
    ...
    *fOut << "}";
    ...
    tab(n + 1, *fOut);
    tab(n + 1, *fOut);
    *fOut << "public void instanceConstants(int samplingFreq) {";
    tab(n + 2, *fOut);
    fCodeProducer.Tab(n + 2);
    generateInit(&fCodeProducer);
    tab(n + 1, *fOut);
    ...
    *fOut << "}";
    ...
    tab(n + 1, *fOut);
    tab(n + 1, *fOut);
    *fOut << "public void init(int samplingFreq) {";
    tab(n + 2, *fOut);
    ...
    *fOut << "}";
    ...
    tab(n + 1, *fOut);
    tab(n + 1, *fOut);
    *fOut << "public void instanceInit(int samplingFreq) {";
    tab(n + 2, *fOut);
