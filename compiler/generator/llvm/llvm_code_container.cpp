 ...
 LLVMCodeContainer::LLVMCodeContainer(const string& name, int numInputs, int numOutputs)
{
    ...
    */
    ...
    /*
     printf("LLVMCodeContainer 1\n");
  
        std::string ErrStr;
        ExecutionEngine *NewEngine = EngineBuilder(fResult->fModule)
                                            .setErrorStr(&ErrStr)
                                            .setUseMCJIT(true)
        ...
        if (!NewEngine) {
         ...
         printf("LLVMCodeContainer 2\n");
        printf("setObjectCache\n");
        NewEngine->setObjectCache(NULL);
        printf("setObjectCache OK\n");
    */
