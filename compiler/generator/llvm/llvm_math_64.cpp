...
Module* llvm_64_module() {
 // Module Construction
 Module* mod = new Module("llvm_math_64.ll", getGlobalContext());
 ...
 // Function: llvm_malloc (func_llvm_malloc)
 {
  ...
  Value* int64_size = args++;
  int64_size->setName("size");
  
  BasicBlock* label_22 = BasicBlock::Create(mod->getContext(), "",func_llvm_malloc,0);
  
  // Block  (label_22)
  AllocaInst* ptr_23 = new AllocaInst(IntegerType::get(mod->getContext(), 64), "", label_22);
  ptr_23->setAlignment(8);
  StoreInst* void_24 = new StoreInst(int64_size, ptr_23, false, label_22);
  void_24->setAlignment(8);
  LoadInst* int64_25 = new LoadInst(ptr_23, "", false, label_22);
  int64_25->setAlignment(8);
  std::vector<Value*> int32_26_params;
  int32_26_params.push_back(const_ptr_20);
  int32_26_params.push_back(int64_25);
  ...
  LoadInst* int64_27 = new LoadInst(ptr_23, "", false, label_22);
  int64_27->setAlignment(8);
  CallInst* ptr_28 = CallInst::Create(func_malloc, int64_27, "", label_22);
