...
inline bool isUIControl(const std::string& name)
{
    return startWith(name, "fButton") || startWith(name, "fCheckbox") ||
           startWith(name, "fVslider") || startWith(name, "fHslider") ||
           startWith(name, "fEntry") || startWith(name, "fVbargraph") ||
...
{
    return isUIControl(name) || name == "iControl" || name == "fControl" || name == "iZone" ||
