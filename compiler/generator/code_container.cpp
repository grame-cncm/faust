...
void CodeContainer::listAllLoopProperties(Tree sig, set<CodeLoop*>& L, set<Tree, treeorder>& visited)
{
                                               ...
                                               bool isvirtual)
{
    ...
    // Hack for Julia
    if (gGlobal->gOutputLang == "julia" || gGlobal->gOutputLang == "mojo" ||
        gGlobal->isPythonBackend()
    ) {
