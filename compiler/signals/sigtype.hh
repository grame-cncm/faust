...
inline Type intCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, kInt, t->variability(), t->computability(), t->vectorability(), t->boolean(),
                          t->getInterval());
}
inline Type floatCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, kReal, t->variability(), t->computability(), t->vectorability(), t->boolean(),
                          t->getInterval());
}
inline Type sampCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, t->nature(), kSamp, t->computability(), t->vectorability(), t->boolean(),
                          t->getInterval());
}
inline Type boolCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, kInt, t->variability(), t->computability(), t->vectorability(), kBool, t->getInterval());
}
inline Type numCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, t->nature(), t->variability(), t->computability(), t->vectorability(), kNum,
                          t->getInterval());
}
inline Type vecCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, t->nature(), t->variability(), t->computability(), kVect, t->boolean(), t->getInterval());
}
inline Type scalCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, t->nature(), t->variability(), t->computability(), kScal, t->boolean(), t->getInterval());
}
inline Type truescalCast(Type t)
{
    vector<int> D;
    t->dimensions(D);
    return makeSimpleType(D, t->nature(), t->variability(), t->computability(), kTrueScal, t->boolean(),
                          t->getInterval());
}
...
class TableType : public AudioType {
   ...
   public:
    TableType(const Type& t)
        : AudioType(t->nature(), t->variability(), t->computability(), t->vectorability(), t->boolean()), fContent(t)
    {
    ...
    TableType(const Type& t, int n, int v, int c, int vec, int b, const interval& i)
        : AudioType(t->nature() | n, t->variability() | v, t->computability() | c, t->vectorability() | vec,
                    t->boolean() | b, i),
          fContent(t)
    {
