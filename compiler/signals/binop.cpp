...
BinOp* gBinOpTable[] = {
	...
	new BinOp(">=","ge_vec","ge_scal", "icmp uge", "fcmp uge", ICmpInst::ICMP_UGE, FCmpInst::FCMP_OGE, geNode, falsePredicate, falsePredicate, 5),
	new BinOp("<=","le_vec","le_scal", "icmp ule", "fcmp ule", ICmpInst::ICMP_ULE, FCmpInst::FCMP_OLE, leNode, falsePredicate, falsePredicate, 5),
...
BinOp* gBinOpLateqTable[] = {
	...
	new BinOp("\\hiderel{\\geq}","ge_vec","ge_scal", "icmp uge", "fcmp uge", 0, 0, geNode, falsePredicate, falsePredicate, 5),
	new BinOp("\\hiderel{\\leq}","le_vec","le_scal", "icmp ule", "fcmp ule", 0, 0, leNode, falsePredicate, falsePredicate, 5),
