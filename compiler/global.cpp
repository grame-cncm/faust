...
#endif
    sstr << "Copyright (C) 2002-2023, GRAME - Centre National de Creation Musicale. All rights reserved. \n";
    return sstr.str();
}
...
string global::printHelp()
{
    ...
    sstr << tab << "-vhdl-type 0|1 --vhdl-type 0|1          sample format 0 = sfixed (default), 1 = float." << endl;
    sstr << tab << "-vhdl-msb <n>  --vhdl-msb <n>           Most Significant Bit (MSB) position." << endl;
    sstr << tab << "-vhdl-lsb <n>  --vhdl-lsb <n>           Less Significant Bit (LSB) position." << endl;
