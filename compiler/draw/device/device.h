...
class device : public virtual Garbageable {
   public:
    virtual ~device() {}
    virtual void rect(double x, double y, double l, double h, const char* color,
                      const char* link)                                       = 0;
    virtual void triangle(double x, double y, double l, double h, const char* color,
                          const char* link, bool leftright)                   = 0;
    ...
    virtual void Error(const char* message, const char* reason, int nb_error, double x, double y,
                       double largeur)                                        = 0;
