...
interval interval_algebra::Xor(const interval& x, const interval& y)
{
    ...
    // if only one of the intervals is a singleton, all of the variation is due to the other interval, which transmits
    // its lsb
    if (x0 == x1) {
        precision = y.lsb();
    }
...
void interval_algebra::testXor()
{
    ...
    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, -800, lx(generator)), interval(127, 127, ly(generator)),
                        myXor, &interval_algebra::Xor);
    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, -800, lx(generator)), interval(127, 127, ly(generator)),
                        myXor, &interval_algebra::Xor);

    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, -800, lx(generator)), interval(123, 123, ly(generator)),
                        myXor, &interval_algebra::Xor);
    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, -800, lx(generator)), interval(123, 123, ly(generator)),
                        myXor, &interval_algebra::Xor);

    analyzeBinaryMethod(10, 20000, "Xor", interval(-128, 128, lx(generator)), interval(127, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);
    analyzeBinaryMethod(10, 20000, "Xor", interval(-128, 128, lx(generator)), interval(127, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);

    analyzeBinaryMethod(10, 20000, "Xor", interval(0, 1000, lx(generator)), interval(63, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);
    analyzeBinaryMethod(10, 20000, "Xor", interval(0, 1000, lx(generator)), interval(63, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);

    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, 1000, lx(generator)), interval(63, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);
    analyzeBinaryMethod(10, 20000, "Xor", interval(-1000, 1000, lx(generator)), interval(63, 127, ly(generator)), myXor,
                        &interval_algebra::Xor);
