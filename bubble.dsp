...
process = hgroup("test", 
	ondemand(vgroup("toto1", button("drop") : bubble(hslider("freq", 600, 150, 2000, 1)) <: dm.freeverb_demo))(checkbox("activate1")),
	ondemand(vgroup("toto2", button("drop") : bubble(hslider("freq", 600, 150, 2000, 1)) <: dm.freeverb_demo))(checkbox("activate2")))
	:> _,_;
