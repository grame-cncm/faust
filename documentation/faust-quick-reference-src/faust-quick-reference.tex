...
In addition of the four inner tags, \lstinline!<mdoc></mdoc>! tags accept text, formatted as \latex text, including standard macros (like \lstinline!\section!, \lstinline!\emph!, etc.), allowing to manage the presentation of resulting tex file.
