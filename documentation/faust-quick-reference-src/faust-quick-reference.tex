...
The \faust compiler provides a mecchanism to produce a self-describing documentation of the mathematical semantic of a \faust program, essentially as a pdf file. The corresponding options are \lstinline!-mdoc! (short) or \lstinline!--mathdoc! (long).
...
\begin{enumerate}
\item to preserve signal processors, independently from any computer langage but only under a mathematical form;
...
\item ''Complete listing of the input code'', listing all needed input files (including librairies).
\end{enumerate}
...
\item \lstinline!<notice>!, to insert the "adaptative'' notice all formulas actually printed,
