...
An \textit{environment} is a kind of dictionnary used to keep track of the definitions of a set of symbols. Some \faust expressions, like \textit{functions}, are bounded to their lexical environment in a structure called a \textit{closure}. Closures allow functions to keep their original meaning independently of where they are used. 

The following constructions allow to explicitely create and access such environments.
...
following :
\begin{enumerate}
\item \lstinline'"...[style:knob]..."' creates a rotative knob instead of a regular 
slider or nentry.
...
\includepdf[pages=-, frame=true, nup=2x2]{images/noisemetadata}
