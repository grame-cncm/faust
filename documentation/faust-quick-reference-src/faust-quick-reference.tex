...
If you'd like to contribute to the localization effort, feel free to translate the mathdoc texts from any of the \lstinline!mathdoctexts-*.txt! files, that are in the \lstinline!architecture! directory (\lstinline!mathdoctexts-fr.txt!, \lstinline!mathdoctexts-it.txt!, etc.).
...
\begin{enumerate}
\item first, simply call \lstinline!faust2mathdoc myfaustfile.dsp! to get the full mathematical documentation stuff done on your faust file,
\item then simply open the pdf file \lstinline!myfaustfile-mdoc/pdf/myfaustfile.pdf!.
\end{enumerate}
