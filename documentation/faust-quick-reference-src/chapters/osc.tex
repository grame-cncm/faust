...
\item \lstinline'-xmit 0|1|2' turn transmission OFF, ALL, or ALIAS (default OFF). When transmission is ALL user's actions are transmitted as OSC messages as well as aliases of output elements (like bargraph). When transmission is ALIAS, aliases of output elements only are transmitted, and input elements can only be controlled using their aliases.
