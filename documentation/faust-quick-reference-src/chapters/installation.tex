...
The \faust source distribution \lstinline'faust-0.9.101.tar.gz' can be downloaded from sourceforge (\myurl{http://sourceforge.net/projects/faudiostream/}).

\section{Organization of the distribution}
The first thing is to decompress the downloaded archive. 
\begin{lstlisting}
	tar xzf faust-0.9.101.tar.gz
\end{lstlisting}

The resulting  \lstinline'faust-0.9.101/' folder should contain the following elements:
...
It should output:
\begin{lstlisting}
	FAUST, DSP to C++ compiler, Version 0.9.101
	Copyright (C) 2002-2017, GRAME - Centre... 
\end{lstlisting}
