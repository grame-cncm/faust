...
The \faust source distribution \lstinline'faust-0.9.104.tar.gz' can be downloaded from sourceforge (\myurl{http://sourceforge.net/projects/faudiostream/}).

\section{Organization of the distribution}
The first thing is to decompress the downloaded archive. 
\begin{lstlisting}
	tar xzf faust-0.9.104.tar.gz
\end{lstlisting}

The resulting  \lstinline'faust-0.9.104/' folder should contain the following elements:
