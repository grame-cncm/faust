...
#ifndef Faust_Interpreter_Wwise_PluginSource_H
#define Faust_Interpreter_Wwise_PluginSource_H

#include "Faust_Interpreter_Wwise_PluginSourceParams.h"
...
class Faust_Interpreter_Wwise_PluginSource
...
private:
    Faust_Interpreter_Wwise_PluginSourceParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkSourcePluginContext* m_pContext;
    AkFXDurationHandler m_durationHandler;

    PluginLoader& pluginLoader = PluginLoader::getInstance();
    AkUInt32 Faust_Interpreter_Wwise_PluginSource::GetSpeakerConfigChannelMask(int predefinedOutputs);
    int speakersAvail;
...
#endif // Faust_Interpreter_Wwise_PluginSource_H
