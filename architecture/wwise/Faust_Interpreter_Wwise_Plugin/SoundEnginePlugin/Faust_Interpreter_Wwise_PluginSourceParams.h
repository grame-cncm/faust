...
#ifndef Faust_Interpreter_Wwise_PluginSourceParams_H
#define Faust_Interpreter_Wwise_PluginSourceParams_H
...
struct Faust_Interpreter_Wwise_PluginRTPCParams
{
    AkReal32 fDuration;
};

struct Faust_Interpreter_Wwise_PluginNonRTPCParams
{
};

struct Faust_Interpreter_Wwise_PluginSourceParams
    : public AK::IAkPluginParam
{
    Faust_Interpreter_Wwise_PluginSourceParams();
    Faust_Interpreter_Wwise_PluginSourceParams(const Faust_Interpreter_Wwise_PluginSourceParams& in_rParams);
    ...
    Faust_Interpreter_Wwise_PluginRTPCParams RTPC;
    Faust_Interpreter_Wwise_PluginNonRTPCParams NonRTPC;
};

#endif // Faust_Interpreter_Wwise_PluginSourceParams_H
