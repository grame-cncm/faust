...
void samFaustDSP::setDSP_ChannelBuffers(FAUSTFLOAT *AudioChannelA_0_Left, FAUSTFLOAT *AudioChannelA_0_Right,
                                        FAUSTFLOAT *AudioChannelA_1_Left, FAUSTFLOAT *AudioChannelA_1_Right,
                                        FAUSTFLOAT *AudioChannelA_2_Left, FAUSTFLOAT *AudioChannelA_2_Right,
                                        FAUSTFLOAT *AudioChannelA_3_Left, FAUSTFLOAT *AudioChannelA_3_Right,
                                        FAUSTFLOAT *AudioChannelB_0_Left, FAUSTFLOAT *AudioChannelB_0_Right,
                                        FAUSTFLOAT *AudioChannelB_1_Left, FAUSTFLOAT *AudioChannelB_1_Right,
                                        FAUSTFLOAT *AudioChannelB_2_Left, FAUSTFLOAT *AudioChannelB_2_Right,
                                        FAUSTFLOAT *AudioChannelB_3_Left, FAUSTFLOAT *AudioChannelB_3_Right)
{
    fAudioDriver->setDSP_ChannelBuffers(
        AudioChannelA_0_Left, AudioChannelA_0_Right, AudioChannelA_1_Left, AudioChannelA_1_Right, AudioChannelA_2_Left,
        AudioChannelA_2_Right, AudioChannelA_3_Left, AudioChannelA_3_Right, AudioChannelB_0_Left, AudioChannelB_0_Right,
        AudioChannelB_1_Left, AudioChannelB_1_Right, AudioChannelB_2_Left, AudioChannelB_2_Right, AudioChannelB_3_Left,
