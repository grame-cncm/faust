...
static bool getNetInfos(string& name, string& ip)
{
    ...
    if (gethostname(szBuffer, sizeof(szBuffer))) return false;
...
//--------------------------------------------------------------------------
float HTTPDControler::version()
{
    return kVersion;
}
const char* HTTPDControler::versionstr()
{
    return kVersionStr;
}
...
template <>
void HTTPDControler::addnode<float>(const char* type, const char* label, float* zone, float init, float min, float max,
                                    float step)
{
...
template <>
void HTTPDControler::addnode<float>(const char* type, const char* label, float* zone, float min, float max)
{
...
template <>
void HTTPDControler::addnode<float>(const char* type, const char* label, float* zone)
{
...
template <>
void HTTPDControler::addnode<double>(const char* type, const char* label, double* zone, double min, double max)
{
    fFactory->addnode(label, zone, min, max, fInit);
...
template <>
void HTTPDControler::addnode<double>(const char* type, const char* label, double* zone, double init, double min,
...
template <>
void HTTPDControler::addnode<double>(const char* type, const char* label, double* zone)
{
