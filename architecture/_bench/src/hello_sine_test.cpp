...
Compilation options: -a bench.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn HelloSine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class HelloSine : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a bench.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn HelloSine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
