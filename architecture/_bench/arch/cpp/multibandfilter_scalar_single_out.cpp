...
Compilation options: -a /Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/arch/cpp/bench.cpp -lang cpp -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/arch/cpp/bench.cpp -lang cpp -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = std::tan(fConst0 * static_cast<float>(fEntry2));
		float fSlow6 = static_cast<float>(fEntry3);
		float fSlow7 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider1))) / fSlow6;
		float fSlow8 = 1.0f / (fSlow5 * (fSlow5 + fSlow7) + 1.0f);
		float fSlow9 = 2.0f * (mydsp_faustpower2_f(fSlow5) + -1.0f);
		float fSlow10 = std::tan(fConst0 * static_cast<float>(fEntry4));
		float fSlow11 = static_cast<float>(fEntry5);
		float fSlow12 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider2))) / fSlow11;
		float fSlow13 = 1.0f / (fSlow10 * (fSlow10 + fSlow12) + 1.0f);
		float fSlow14 = 2.0f * (mydsp_faustpower2_f(fSlow10) + -1.0f);
		float fSlow15 = std::tan(fConst0 * static_cast<float>(fEntry6));
		float fSlow16 = static_cast<float>(fEntry7);
		float fSlow17 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider3))) / fSlow16;
		float fSlow18 = 1.0f / (fSlow15 * (fSlow15 + fSlow17) + 1.0f);
		float fSlow19 = 2.0f * (mydsp_faustpower2_f(fSlow15) + -1.0f);
		float fSlow20 = std::tan(fConst0 * static_cast<float>(fEntry8));
		float fSlow21 = static_cast<float>(fEntry9);
		float fSlow22 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider4))) / fSlow21;
		float fSlow23 = 1.0f / (fSlow20 * (fSlow20 + fSlow22) + 1.0f);
		float fSlow24 = 2.0f * (mydsp_faustpower2_f(fSlow20) + -1.0f);
		float fSlow25 = std::tan(fConst0 * static_cast<float>(fEntry10));
		float fSlow26 = static_cast<float>(fEntry11);
		float fSlow27 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider5))) / fSlow26;
		float fSlow28 = 1.0f / (fSlow25 * (fSlow25 + fSlow27) + 1.0f);
		float fSlow29 = 2.0f * (mydsp_faustpower2_f(fSlow25) + -1.0f);
		float fSlow30 = std::tan(fConst0 * static_cast<float>(fEntry12));
		float fSlow31 = static_cast<float>(fEntry13);
		float fSlow32 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider6))) / fSlow31;
		float fSlow33 = 1.0f / (fSlow30 * (fSlow30 + fSlow32) + 1.0f);
		float fSlow34 = 2.0f * (mydsp_faustpower2_f(fSlow30) + -1.0f);
		float fSlow35 = std::tan(fConst0 * static_cast<float>(fEntry14));
		float fSlow36 = static_cast<float>(fEntry15);
		float fSlow37 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider7))) / fSlow36;
		float fSlow38 = 1.0f / (fSlow35 * (fSlow35 + fSlow37) + 1.0f);
		float fSlow39 = 2.0f * (mydsp_faustpower2_f(fSlow35) + -1.0f);
		float fSlow40 = std::tan(fConst0 * static_cast<float>(fEntry16));
		float fSlow41 = static_cast<float>(fEntry17);
		float fSlow42 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider8))) / fSlow41;
		float fSlow43 = 1.0f / (fSlow40 * (fSlow40 + fSlow42) + 1.0f);
		float fSlow44 = 2.0f * (mydsp_faustpower2_f(fSlow40) + -1.0f);
		float fSlow45 = std::tan(fConst0 * static_cast<float>(fEntry18));
		float fSlow46 = static_cast<float>(fEntry19);
		float fSlow47 = std::pow(1e+01f, -(0.05f * static_cast<float>(fVslider9))) / fSlow46;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec9[0] = static_cast<float>(input0[i0]) - fSlow48 * (fSlow50 * fRec9[2] + fTemp0);
