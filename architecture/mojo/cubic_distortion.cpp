...
Compilation options: -a ../_bench/arch/cpp/inspect.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn CubicDistortion -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 32
------------------------------------------------------------ */
...
class CubicDistortion : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a ../_bench/arch/cpp/inspect.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn CubicDistortion -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 32");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst7 = CubicDistortion_faustpower2_f(fConst3);
		fConst8 = 1.0 / fConst7;
		...
		fConst46 = CubicDistortion_faustpower2_f(fConst42);
		...
		fConst84 = CubicDistortion_faustpower2_f(fConst80);
		...
		fConst122 = CubicDistortion_faustpower2_f(fConst118);
		...
		fConst160 = CubicDistortion_faustpower2_f(fConst156);
		...
		fConst198 = CubicDistortion_faustpower2_f(fConst194);
		...
		fConst236 = CubicDistortion_faustpower2_f(fConst232);
		...
		fConst274 = CubicDistortion_faustpower2_f(fConst270);
		...
		fConst312 = CubicDistortion_faustpower2_f(fConst308);
		...
		fConst350 = CubicDistortion_faustpower2_f(fConst346);
		...
		fConst388 = CubicDistortion_faustpower2_f(fConst384);
		...
		fConst426 = CubicDistortion_faustpower2_f(fConst422);
		...
		fConst464 = CubicDistortion_faustpower2_f(fConst460);
		...
		fConst502 = CubicDistortion_faustpower2_f(fConst498);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (vindex = 0; vindex <= (count - 32); vindex = vindex + 32) {
			...
			for (int i = 0; i < vsize; i = i + 1) {
				fRec5[i] = fRec5[i - 1] * fSlow3 + fSlow4;
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec2[i] = fSlow1 + 0.999 * fRec2[i - 1];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec3[i] = fRec4[i - 1] * fZec1[i] + fRec3[i - 1] * fZec2[i];
				fRec4[i] = static_cast<double>(1 - iVec0[i - 1]) + fRec4[i - 1] * fZec2[i] - fZec1[i] * fRec3[i - 1];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec1[i] = fSlow0 + 0.999 * fRec1[i - 1];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec6[i] = fSlow5 + 0.999 * fRec6[i - 1];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fYec0[i] = fZec4[i] * (1.0 - 0.3333333333333333 * CubicDistortion_faustpower2_f(fZec4[i]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec0[i] = 0.995 * fRec0[i - 1] + fYec0[i] - fYec0[i - 1];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec17[i] = fZec5[i] - fConst26 * (fConst27 * fRec17[i - 2] + fConst28 * fRec17[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec16[i] = fConst26 * (fConst30 * fRec17[i] + fConst31 * fRec17[i - 1] + fConst30 * fRec17[i - 2]) - fConst32 * (fConst33 * fRec16[i - 2] + fConst34 * fRec16[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec15[i] = fConst32 * (fConst35 * fRec16[i] + fConst36 * fRec16[i - 1] + fConst35 * fRec16[i - 2]) - fConst37 * (fConst38 * fRec15[i - 2] + fConst39 * fRec15[i - 1]);
			}
			/* Post code */
			for (int j31 = 0; j31 < 4; j31 = j31 + 1) {
				fRec15_perm[j31] = fRec15_tmp[vsize + j31];
			}
			/* Vectorizable loop 17 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec6[i] = fConst37 * (fConst40 * fRec15[i] + fConst41 * fRec15[i - 1] + fConst40 * fRec15[i - 2]);
			}
			/* Recursive loop 18 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec24[i] = fZec6[i] - fConst64 * (fConst65 * fRec24[i - 2] + fConst66 * fRec24[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec23[i] = fConst64 * (fConst68 * fRec24[i] + fConst69 * fRec24[i - 1] + fConst68 * fRec24[i - 2]) - fConst70 * (fConst71 * fRec23[i - 2] + fConst72 * fRec23[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec22[i] = fConst70 * (fConst73 * fRec23[i] + fConst74 * fRec23[i - 1] + fConst73 * fRec23[i - 2]) - fConst75 * (fConst76 * fRec22[i - 2] + fConst77 * fRec22[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec7[i] = fConst75 * (fConst78 * fRec22[i] + fConst79 * fRec22[i - 1] + fConst78 * fRec22[i - 2]);
			}
			/* Recursive loop 22 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec31[i] = fZec7[i] - fConst102 * (fConst103 * fRec31[i - 2] + fConst104 * fRec31[i - 1]);
			}
			/* Post code */
			for (int j55 = 0; j55 < 4; j55 = j55 + 1) {
				fRec31_perm[j55] = fRec31_tmp[vsize + j55];
			}
			/* Recursive loop 23 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec30[i] = fConst102 * (fConst106 * fRec31[i] + fConst107 * fRec31[i - 1] + fConst106 * fRec31[i - 2]) - fConst108 * (fConst109 * fRec30[i - 2] + fConst110 * fRec30[i - 1]);
			}
			/* Post code */
			for (int j57 = 0; j57 < 4; j57 = j57 + 1) {
				fRec30_perm[j57] = fRec30_tmp[vsize + j57];
			}
			/* Recursive loop 24 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec29[i] = fConst108 * (fConst111 * fRec30[i] + fConst112 * fRec30[i - 1] + fConst111 * fRec30[i - 2]) - fConst113 * (fConst114 * fRec29[i - 2] + fConst115 * fRec29[i - 1]);
			}
			/* Post code */
			for (int j59 = 0; j59 < 4; j59 = j59 + 1) {
				fRec29_perm[j59] = fRec29_tmp[vsize + j59];
			}
			/* Vectorizable loop 25 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec8[i] = fConst113 * (fConst116 * fRec29[i] + fConst117 * fRec29[i - 1] + fConst116 * fRec29[i - 2]);
			}
			/* Recursive loop 26 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec38[i] = fZec8[i] - fConst140 * (fConst141 * fRec38[i - 2] + fConst142 * fRec38[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec37[i] = fConst140 * (fConst144 * fRec38[i] + fConst145 * fRec38[i - 1] + fConst144 * fRec38[i - 2]) - fConst146 * (fConst147 * fRec37[i - 2] + fConst148 * fRec37[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec36[i] = fConst146 * (fConst149 * fRec37[i] + fConst150 * fRec37[i - 1] + fConst149 * fRec37[i - 2]) - fConst151 * (fConst152 * fRec36[i - 2] + fConst153 * fRec36[i - 1]);
			}
			/* Post code */
			for (int j73 = 0; j73 < 4; j73 = j73 + 1) {
				fRec36_perm[j73] = fRec36_tmp[vsize + j73];
			}
			/* Vectorizable loop 29 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec9[i] = fConst151 * (fConst154 * fRec36[i] + fConst155 * fRec36[i - 1] + fConst154 * fRec36[i - 2]);
			}
			/* Recursive loop 30 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec45[i] = fZec9[i] - fConst178 * (fConst179 * fRec45[i - 2] + fConst180 * fRec45[i - 1]);
			}
			/* Post code */
			for (int j83 = 0; j83 < 4; j83 = j83 + 1) {
				fRec45_perm[j83] = fRec45_tmp[vsize + j83];
			}
			/* Recursive loop 31 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec44[i] = fConst178 * (fConst182 * fRec45[i] + fConst183 * fRec45[i - 1] + fConst182 * fRec45[i - 2]) - fConst184 * (fConst185 * fRec44[i - 2] + fConst186 * fRec44[i - 1]);
			}
			/* Post code */
			for (int j85 = 0; j85 < 4; j85 = j85 + 1) {
				fRec44_perm[j85] = fRec44_tmp[vsize + j85];
			}
			/* Recursive loop 32 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec43[i] = fConst184 * (fConst187 * fRec44[i] + fConst188 * fRec44[i - 1] + fConst187 * fRec44[i - 2]) - fConst189 * (fConst190 * fRec43[i - 2] + fConst191 * fRec43[i - 1]);
			}
			/* Post code */
			for (int j87 = 0; j87 < 4; j87 = j87 + 1) {
				fRec43_perm[j87] = fRec43_tmp[vsize + j87];
			}
			/* Vectorizable loop 33 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec10[i] = fConst189 * (fConst192 * fRec43[i] + fConst193 * fRec43[i - 1] + fConst192 * fRec43[i - 2]);
			}
			/* Recursive loop 34 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec52[i] = fZec10[i] - fConst216 * (fConst217 * fRec52[i - 2] + fConst218 * fRec52[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec51[i] = fConst216 * (fConst220 * fRec52[i] + fConst221 * fRec52[i - 1] + fConst220 * fRec52[i - 2]) - fConst222 * (fConst223 * fRec51[i - 2] + fConst224 * fRec51[i - 1]);
			}
			/* Post code */
			for (int j99 = 0; j99 < 4; j99 = j99 + 1) {
				fRec51_perm[j99] = fRec51_tmp[vsize + j99];
			}
			/* Recursive loop 36 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec50[i] = fConst222 * (fConst225 * fRec51[i] + fConst226 * fRec51[i - 1] + fConst225 * fRec51[i - 2]) - fConst227 * (fConst228 * fRec50[i - 2] + fConst229 * fRec50[i - 1]);
			}
			/* Post code */
			for (int j101 = 0; j101 < 4; j101 = j101 + 1) {
				fRec50_perm[j101] = fRec50_tmp[vsize + j101];
			}
			/* Vectorizable loop 37 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec11[i] = fConst227 * (fConst230 * fRec50[i] + fConst231 * fRec50[i - 1] + fConst230 * fRec50[i - 2]);
			}
			/* Recursive loop 38 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec59[i] = fZec11[i] - fConst254 * (fConst255 * fRec59[i - 2] + fConst256 * fRec59[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec58[i] = fConst254 * (fConst258 * fRec59[i] + fConst259 * fRec59[i - 1] + fConst258 * fRec59[i - 2]) - fConst260 * (fConst261 * fRec58[i - 2] + fConst262 * fRec58[i - 1]);
			}
			/* Post code */
			for (int j113 = 0; j113 < 4; j113 = j113 + 1) {
				fRec58_perm[j113] = fRec58_tmp[vsize + j113];
			}
			/* Recursive loop 40 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec57[i] = fConst260 * (fConst263 * fRec58[i] + fConst264 * fRec58[i - 1] + fConst263 * fRec58[i - 2]) - fConst265 * (fConst266 * fRec57[i - 2] + fConst267 * fRec57[i - 1]);
			}
			/* Post code */
			for (int j115 = 0; j115 < 4; j115 = j115 + 1) {
				fRec57_perm[j115] = fRec57_tmp[vsize + j115];
			}
			/* Vectorizable loop 41 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec12[i] = fConst265 * (fConst268 * fRec57[i] + fConst269 * fRec57[i - 1] + fConst268 * fRec57[i - 2]);
			}
			/* Recursive loop 42 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec66[i] = fZec12[i] - fConst292 * (fConst293 * fRec66[i - 2] + fConst294 * fRec66[i - 1]);
			}
			/* Post code */
			for (int j125 = 0; j125 < 4; j125 = j125 + 1) {
				fRec66_perm[j125] = fRec66_tmp[vsize + j125];
			}
			/* Recursive loop 43 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec65[i] = fConst292 * (fConst296 * fRec66[i] + fConst297 * fRec66[i - 1] + fConst296 * fRec66[i - 2]) - fConst298 * (fConst299 * fRec65[i - 2] + fConst300 * fRec65[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec64[i] = fConst298 * (fConst301 * fRec65[i] + fConst302 * fRec65[i - 1] + fConst301 * fRec65[i - 2]) - fConst303 * (fConst304 * fRec64[i - 2] + fConst305 * fRec64[i - 1]);
			}
			/* Post code */
			for (int j129 = 0; j129 < 4; j129 = j129 + 1) {
				fRec64_perm[j129] = fRec64_tmp[vsize + j129];
			}
			/* Vectorizable loop 45 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec13[i] = fConst303 * (fConst306 * fRec64[i] + fConst307 * fRec64[i - 1] + fConst306 * fRec64[i - 2]);
			}
			/* Recursive loop 46 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec73[i] = fZec13[i] - fConst330 * (fConst331 * fRec73[i - 2] + fConst332 * fRec73[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec72[i] = fConst330 * (fConst334 * fRec73[i] + fConst335 * fRec73[i - 1] + fConst334 * fRec73[i - 2]) - fConst336 * (fConst337 * fRec72[i - 2] + fConst338 * fRec72[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec71[i] = fConst336 * (fConst339 * fRec72[i] + fConst340 * fRec72[i - 1] + fConst339 * fRec72[i - 2]) - fConst341 * (fConst342 * fRec71[i - 2] + fConst343 * fRec71[i - 1]);
			}
			/* Post code */
			for (int j143 = 0; j143 < 4; j143 = j143 + 1) {
				fRec71_perm[j143] = fRec71_tmp[vsize + j143];
			}
			/* Vectorizable loop 49 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec14[i] = fConst341 * (fConst344 * fRec71[i] + fConst345 * fRec71[i - 1] + fConst344 * fRec71[i - 2]);
			}
			/* Recursive loop 50 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec80[i] = fZec14[i] - fConst368 * (fConst369 * fRec80[i - 2] + fConst370 * fRec80[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec79[i] = fConst368 * (fConst372 * fRec80[i] + fConst373 * fRec80[i - 1] + fConst372 * fRec80[i - 2]) - fConst374 * (fConst375 * fRec79[i - 2] + fConst376 * fRec79[i - 1]);
			}
			/* Post code */
			for (int j155 = 0; j155 < 4; j155 = j155 + 1) {
				fRec79_perm[j155] = fRec79_tmp[vsize + j155];
			}
			/* Recursive loop 52 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec78[i] = fConst374 * (fConst377 * fRec79[i] + fConst378 * fRec79[i - 1] + fConst377 * fRec79[i - 2]) - fConst379 * (fConst380 * fRec78[i - 2] + fConst381 * fRec78[i - 1]);
			}
			/* Post code */
			for (int j157 = 0; j157 < 4; j157 = j157 + 1) {
				fRec78_perm[j157] = fRec78_tmp[vsize + j157];
			}
			/* Vectorizable loop 53 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec15[i] = fConst379 * (fConst382 * fRec78[i] + fConst383 * fRec78[i - 1] + fConst382 * fRec78[i - 2]);
			}
			/* Recursive loop 54 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec87[i] = fZec15[i] - fConst406 * (fConst407 * fRec87[i - 2] + fConst408 * fRec87[i - 1]);
			}
			/* Post code */
			for (int j167 = 0; j167 < 4; j167 = j167 + 1) {
				fRec87_perm[j167] = fRec87_tmp[vsize + j167];
			}
			/* Recursive loop 55 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec86[i] = fConst406 * (fConst410 * fRec87[i] + fConst411 * fRec87[i - 1] + fConst410 * fRec87[i - 2]) - fConst412 * (fConst413 * fRec86[i - 2] + fConst414 * fRec86[i - 1]);
			}
			/* Post code */
			for (int j169 = 0; j169 < 4; j169 = j169 + 1) {
				fRec86_perm[j169] = fRec86_tmp[vsize + j169];
			}
			/* Recursive loop 56 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec85[i] = fConst412 * (fConst415 * fRec86[i] + fConst416 * fRec86[i - 1] + fConst415 * fRec86[i - 2]) - fConst417 * (fConst418 * fRec85[i - 2] + fConst419 * fRec85[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec16[i] = fConst417 * (fConst420 * fRec85[i] + fConst421 * fRec85[i - 1] + fConst420 * fRec85[i - 2]);
			}
			/* Recursive loop 58 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec94[i] = fZec16[i] - fConst444 * (fConst445 * fRec94[i - 2] + fConst446 * fRec94[i - 1]);
			}
			/* Post code */
			for (int j181 = 0; j181 < 4; j181 = j181 + 1) {
				fRec94_perm[j181] = fRec94_tmp[vsize + j181];
			}
			/* Recursive loop 59 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec93[i] = fConst444 * (fConst448 * fRec94[i] + fConst449 * fRec94[i - 1] + fConst448 * fRec94[i - 2]) - fConst450 * (fConst451 * fRec93[i - 2] + fConst452 * fRec93[i - 1]);
			}
			/* Post code */
			for (int j183 = 0; j183 < 4; j183 = j183 + 1) {
				fRec93_perm[j183] = fRec93_tmp[vsize + j183];
			}
			/* Recursive loop 60 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec92[i] = fConst450 * (fConst453 * fRec93[i] + fConst454 * fRec93[i - 1] + fConst453 * fRec93[i - 2]) - fConst455 * (fConst456 * fRec92[i - 2] + fConst457 * fRec92[i - 1]);
			}
			/* Post code */
			for (int j185 = 0; j185 < 4; j185 = j185 + 1) {
				fRec92_perm[j185] = fRec92_tmp[vsize + j185];
			}
			/* Vectorizable loop 61 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec17[i] = fConst455 * (fConst458 * fRec92[i] + fConst459 * fRec92[i - 1] + fConst458 * fRec92[i - 2]);
			}
			/* Recursive loop 62 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec101[i] = fZec17[i] - fConst482 * (fConst483 * fRec101[i - 2] + fConst484 * fRec101[i - 1]);
			}
			/* Post code */
			for (int j195 = 0; j195 < 4; j195 = j195 + 1) {
				fRec101_perm[j195] = fRec101_tmp[vsize + j195];
			}
			/* Recursive loop 63 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec100[i] = fConst482 * (fConst486 * fRec101[i] + fConst487 * fRec101[i - 1] + fConst486 * fRec101[i - 2]) - fConst488 * (fConst489 * fRec100[i - 2] + fConst490 * fRec100[i - 1]);
			}
			/* Post code */
			for (int j197 = 0; j197 < 4; j197 = j197 + 1) {
				fRec100_perm[j197] = fRec100_tmp[vsize + j197];
			}
			/* Recursive loop 64 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec99[i] = fConst488 * (fConst491 * fRec100[i] + fConst492 * fRec100[i - 1] + fConst491 * fRec100[i - 2]) - fConst493 * (fConst494 * fRec99[i - 2] + fConst495 * fRec99[i - 1]);
			}
			/* Post code */
			for (int j199 = 0; j199 < 4; j199 = j199 + 1) {
				fRec99_perm[j199] = fRec99_tmp[vsize + j199];
			}
			/* Vectorizable loop 65 */
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fZec18[i] = fConst493 * (fConst496 * fRec99[i] + fConst497 * fRec99[i - 1] + fConst496 * fRec99[i - 2]);
			}
			/* Recursive loop 66 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec10[i] = fZec5[i] - fConst5 * (fConst6 * fRec10[i - 2] + fConst9 * fRec10[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec14[i] = fZec6[i] - fConst44 * (fConst45 * fRec14[i - 2] + fConst48 * fRec14[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec21[i] = fZec7[i] - fConst82 * (fConst83 * fRec21[i - 2] + fConst86 * fRec21[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec28[i] = fZec8[i] - fConst120 * (fConst121 * fRec28[i - 2] + fConst124 * fRec28[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec35[i] = fZec9[i] - fConst158 * (fConst159 * fRec35[i - 2] + fConst162 * fRec35[i - 1]);
			}
			/* Post code */
			for (int j75 = 0; j75 < 4; j75 = j75 + 1) {
				fRec35_perm[j75] = fRec35_tmp[vsize + j75];
			}
			/* Recursive loop 71 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec42[i] = fZec10[i] - fConst196 * (fConst197 * fRec42[i - 2] + fConst200 * fRec42[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec49[i] = fZec11[i] - fConst234 * (fConst235 * fRec49[i - 2] + fConst238 * fRec49[i - 1]);
			}
			/* Post code */
			for (int j103 = 0; j103 < 4; j103 = j103 + 1) {
				fRec49_perm[j103] = fRec49_tmp[vsize + j103];
			}
			/* Recursive loop 73 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec56[i] = fZec12[i] - fConst272 * (fConst273 * fRec56[i - 2] + fConst276 * fRec56[i - 1]);
			}
			/* Post code */
			for (int j117 = 0; j117 < 4; j117 = j117 + 1) {
				fRec56_perm[j117] = fRec56_tmp[vsize + j117];
			}
			/* Recursive loop 74 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec63[i] = fZec13[i] - fConst310 * (fConst311 * fRec63[i - 2] + fConst314 * fRec63[i - 1]);
			}
			/* Post code */
			for (int j131 = 0; j131 < 4; j131 = j131 + 1) {
				fRec63_perm[j131] = fRec63_tmp[vsize + j131];
			}
			/* Recursive loop 75 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec70[i] = fZec14[i] - fConst348 * (fConst349 * fRec70[i - 2] + fConst352 * fRec70[i - 1]);
			}
			/* Post code */
			for (int j145 = 0; j145 < 4; j145 = j145 + 1) {
				fRec70_perm[j145] = fRec70_tmp[vsize + j145];
			}
			/* Recursive loop 76 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec77[i] = fZec15[i] - fConst386 * (fConst387 * fRec77[i - 2] + fConst390 * fRec77[i - 1]);
			}
			/* Post code */
			for (int j159 = 0; j159 < 4; j159 = j159 + 1) {
				fRec77_perm[j159] = fRec77_tmp[vsize + j159];
			}
			/* Recursive loop 77 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec84[i] = fZec16[i] - fConst424 * (fConst425 * fRec84[i - 2] + fConst428 * fRec84[i - 1]);
			}
			/* Post code */
			for (int j173 = 0; j173 < 4; j173 = j173 + 1) {
				fRec84_perm[j173] = fRec84_tmp[vsize + j173];
			}
			/* Recursive loop 78 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec91[i] = fZec17[i] - fConst462 * (fConst463 * fRec91[i - 2] + fConst466 * fRec91[i - 1]);
			}
			/* Post code */
			for (int j187 = 0; j187 < 4; j187 = j187 + 1) {
				fRec91_perm[j187] = fRec91_tmp[vsize + j187];
			}
			/* Recursive loop 79 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec98[i] = fZec18[i] - fConst500 * (fConst501 * fRec98[i - 2] + fConst504 * fRec98[i - 1]);
			}
			/* Post code */
			for (int j201 = 0; j201 < 4; j201 = j201 + 1) {
				fRec98_perm[j201] = fRec98_tmp[vsize + j201];
			}
			/* Recursive loop 80 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec105[i] = fZec18[i] - fConst520 * (fConst521 * fRec105[i - 2] + fConst522 * fRec105[i - 1]);
			}
			/* Post code */
			for (int j209 = 0; j209 < 4; j209 = j209 + 1) {
				fRec105_perm[j209] = fRec105_tmp[vsize + j209];
			}
			/* Recursive loop 81 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec9[i] = fConst5 * (fConst11 * fRec10[i] + fConst12 * fRec10[i - 1] + fConst11 * fRec10[i - 2]) - fConst13 * (fConst14 * fRec9[i - 2] + fConst15 * fRec9[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec13[i] = fConst44 * (fConst50 * fRec14[i] + fConst51 * fRec14[i - 1] + fConst50 * fRec14[i - 2]) - fConst52 * (fConst53 * fRec13[i - 2] + fConst54 * fRec13[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec20[i] = fConst82 * (fConst88 * fRec21[i] + fConst89 * fRec21[i - 1] + fConst88 * fRec21[i - 2]) - fConst90 * (fConst91 * fRec20[i - 2] + fConst92 * fRec20[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec27[i] = fConst120 * (fConst126 * fRec28[i] + fConst127 * fRec28[i - 1] + fConst126 * fRec28[i - 2]) - fConst128 * (fConst129 * fRec27[i - 2] + fConst130 * fRec27[i - 1]);
			}
			/* Post code */
			for (int j63 = 0; j63 < 4; j63 = j63 + 1) {
				fRec27_perm[j63] = fRec27_tmp[vsize + j63];
			}
			/* Recursive loop 85 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec34[i] = fConst158 * (fConst164 * fRec35[i] + fConst165 * fRec35[i - 1] + fConst164 * fRec35[i - 2]) - fConst166 * (fConst167 * fRec34[i - 2] + fConst168 * fRec34[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec41[i] = fConst196 * (fConst202 * fRec42[i] + fConst203 * fRec42[i - 1] + fConst202 * fRec42[i - 2]) - fConst204 * (fConst205 * fRec41[i - 2] + fConst206 * fRec41[i - 1]);
			}
			/* Post code */
			for (int j91 = 0; j91 < 4; j91 = j91 + 1) {
				fRec41_perm[j91] = fRec41_tmp[vsize + j91];
			}
			/* Recursive loop 87 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec48[i] = fConst234 * (fConst240 * fRec49[i] + fConst241 * fRec49[i - 1] + fConst240 * fRec49[i - 2]) - fConst242 * (fConst243 * fRec48[i - 2] + fConst244 * fRec48[i - 1]);
			}
			/* Post code */
			for (int j105 = 0; j105 < 4; j105 = j105 + 1) {
				fRec48_perm[j105] = fRec48_tmp[vsize + j105];
			}
			/* Recursive loop 88 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec55[i] = fConst272 * (fConst278 * fRec56[i] + fConst279 * fRec56[i - 1] + fConst278 * fRec56[i - 2]) - fConst280 * (fConst281 * fRec55[i - 2] + fConst282 * fRec55[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec62[i] = fConst310 * (fConst316 * fRec63[i] + fConst317 * fRec63[i - 1] + fConst316 * fRec63[i - 2]) - fConst318 * (fConst319 * fRec62[i - 2] + fConst320 * fRec62[i - 1]);
			}
			/* Post code */
			for (int j133 = 0; j133 < 4; j133 = j133 + 1) {
				fRec62_perm[j133] = fRec62_tmp[vsize + j133];
			}
			/* Recursive loop 90 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec69[i] = fConst348 * (fConst354 * fRec70[i] + fConst355 * fRec70[i - 1] + fConst354 * fRec70[i - 2]) - fConst356 * (fConst357 * fRec69[i - 2] + fConst358 * fRec69[i - 1]);
			}
			/* Post code */
			for (int j147 = 0; j147 < 4; j147 = j147 + 1) {
				fRec69_perm[j147] = fRec69_tmp[vsize + j147];
			}
			/* Recursive loop 91 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec76[i] = fConst386 * (fConst392 * fRec77[i] + fConst393 * fRec77[i - 1] + fConst392 * fRec77[i - 2]) - fConst394 * (fConst395 * fRec76[i - 2] + fConst396 * fRec76[i - 1]);
			}
			/* Post code */
			for (int j161 = 0; j161 < 4; j161 = j161 + 1) {
				fRec76_perm[j161] = fRec76_tmp[vsize + j161];
			}
			/* Recursive loop 92 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec83[i] = fConst424 * (fConst430 * fRec84[i] + fConst431 * fRec84[i - 1] + fConst430 * fRec84[i - 2]) - fConst432 * (fConst433 * fRec83[i - 2] + fConst434 * fRec83[i - 1]);
			}
			/* Post code */
			for (int j175 = 0; j175 < 4; j175 = j175 + 1) {
				fRec83_perm[j175] = fRec83_tmp[vsize + j175];
			}
			/* Recursive loop 93 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec90[i] = fConst462 * (fConst468 * fRec91[i] + fConst469 * fRec91[i - 1] + fConst468 * fRec91[i - 2]) - fConst470 * (fConst471 * fRec90[i - 2] + fConst472 * fRec90[i - 1]);
			}
			/* Post code */
			for (int j189 = 0; j189 < 4; j189 = j189 + 1) {
				fRec90_perm[j189] = fRec90_tmp[vsize + j189];
			}
			/* Recursive loop 94 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec97[i] = fConst500 * (fConst506 * fRec98[i] + fConst507 * fRec98[i - 1] + fConst506 * fRec98[i - 2]) - fConst508 * (fConst509 * fRec97[i - 2] + fConst510 * fRec97[i - 1]);
			}
			/* Post code */
			for (int j203 = 0; j203 < 4; j203 = j203 + 1) {
				fRec97_perm[j203] = fRec97_tmp[vsize + j203];
			}
			/* Recursive loop 95 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec104[i] = fConst520 * (fConst524 * fRec105[i] + fConst525 * fRec105[i - 1] + fConst524 * fRec105[i - 2]) - fConst526 * (fConst527 * fRec104[i - 2] + fConst528 * fRec104[i - 1]);
			}
			/* Post code */
			for (int j211 = 0; j211 < 4; j211 = j211 + 1) {
				fRec104_perm[j211] = fRec104_tmp[vsize + j211];
			}
			/* Recursive loop 96 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec8[i] = fConst13 * (fConst17 * fRec9[i] + fConst18 * fRec9[i - 1] + fConst17 * fRec9[i - 2]) - fConst19 * (fConst20 * fRec8[i - 2] + fConst21 * fRec8[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec12[i] = fConst52 * (fConst56 * fRec13[i] + fConst57 * fRec13[i - 1] + fConst56 * fRec13[i - 2]) - fConst58 * (fConst59 * fRec12[i - 2] + fConst60 * fRec12[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec19[i] = fConst90 * (fConst94 * fRec20[i] + fConst95 * fRec20[i - 1] + fConst94 * fRec20[i - 2]) - fConst96 * (fConst97 * fRec19[i - 2] + fConst98 * fRec19[i - 1]);
			}
			/* Post code */
			for (int j51 = 0; j51 < 4; j51 = j51 + 1) {
				fRec19_perm[j51] = fRec19_tmp[vsize + j51];
			}
			/* Recursive loop 99 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec26[i] = fConst128 * (fConst132 * fRec27[i] + fConst133 * fRec27[i - 1] + fConst132 * fRec27[i - 2]) - fConst134 * (fConst135 * fRec26[i - 2] + fConst136 * fRec26[i - 1]);
			}
			/* Post code */
			for (int j65 = 0; j65 < 4; j65 = j65 + 1) {
				fRec26_perm[j65] = fRec26_tmp[vsize + j65];
			}
			/* Recursive loop 100 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec33[i] = fConst166 * (fConst170 * fRec34[i] + fConst171 * fRec34[i - 1] + fConst170 * fRec34[i - 2]) - fConst172 * (fConst173 * fRec33[i - 2] + fConst174 * fRec33[i - 1]);
			}
			/* Post code */
			for (int j79 = 0; j79 < 4; j79 = j79 + 1) {
				fRec33_perm[j79] = fRec33_tmp[vsize + j79];
			}
			/* Recursive loop 101 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec40[i] = fConst204 * (fConst208 * fRec41[i] + fConst209 * fRec41[i - 1] + fConst208 * fRec41[i - 2]) - fConst210 * (fConst211 * fRec40[i - 2] + fConst212 * fRec40[i - 1]);
			}
			/* Post code */
			for (int j93 = 0; j93 < 4; j93 = j93 + 1) {
				fRec40_perm[j93] = fRec40_tmp[vsize + j93];
			}
			/* Recursive loop 102 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec47[i] = fConst242 * (fConst246 * fRec48[i] + fConst247 * fRec48[i - 1] + fConst246 * fRec48[i - 2]) - fConst248 * (fConst249 * fRec47[i - 2] + fConst250 * fRec47[i - 1]);
			}
			/* Post code */
			for (int j107 = 0; j107 < 4; j107 = j107 + 1) {
				fRec47_perm[j107] = fRec47_tmp[vsize + j107];
			}
			/* Recursive loop 103 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec54[i] = fConst280 * (fConst284 * fRec55[i] + fConst285 * fRec55[i - 1] + fConst284 * fRec55[i - 2]) - fConst286 * (fConst287 * fRec54[i - 2] + fConst288 * fRec54[i - 1]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec61[i] = fConst318 * (fConst322 * fRec62[i] + fConst323 * fRec62[i - 1] + fConst322 * fRec62[i - 2]) - fConst324 * (fConst325 * fRec61[i - 2] + fConst326 * fRec61[i - 1]);
			}
			/* Post code */
			for (int j135 = 0; j135 < 4; j135 = j135 + 1) {
				fRec61_perm[j135] = fRec61_tmp[vsize + j135];
			}
			/* Recursive loop 105 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec68[i] = fConst356 * (fConst360 * fRec69[i] + fConst361 * fRec69[i - 1] + fConst360 * fRec69[i - 2]) - fConst362 * (fConst363 * fRec68[i - 2] + fConst364 * fRec68[i - 1]);
			}
			/* Post code */
			for (int j149 = 0; j149 < 4; j149 = j149 + 1) {
				fRec68_perm[j149] = fRec68_tmp[vsize + j149];
			}
			/* Recursive loop 106 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec75[i] = fConst394 * (fConst398 * fRec76[i] + fConst399 * fRec76[i - 1] + fConst398 * fRec76[i - 2]) - fConst400 * (fConst401 * fRec75[i - 2] + fConst402 * fRec75[i - 1]);
			}
			/* Post code */
			for (int j163 = 0; j163 < 4; j163 = j163 + 1) {
				fRec75_perm[j163] = fRec75_tmp[vsize + j163];
			}
			/* Recursive loop 107 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec82[i] = fConst432 * (fConst436 * fRec83[i] + fConst437 * fRec83[i - 1] + fConst436 * fRec83[i - 2]) - fConst438 * (fConst439 * fRec82[i - 2] + fConst440 * fRec82[i - 1]);
			}
			/* Post code */
			for (int j177 = 0; j177 < 4; j177 = j177 + 1) {
				fRec82_perm[j177] = fRec82_tmp[vsize + j177];
			}
			/* Recursive loop 108 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec89[i] = fConst470 * (fConst474 * fRec90[i] + fConst475 * fRec90[i - 1] + fConst474 * fRec90[i - 2]) - fConst476 * (fConst477 * fRec89[i - 2] + fConst478 * fRec89[i - 1]);
			}
			/* Post code */
			for (int j191 = 0; j191 < 4; j191 = j191 + 1) {
				fRec89_perm[j191] = fRec89_tmp[vsize + j191];
			}
			/* Recursive loop 109 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec96[i] = fConst508 * (fConst512 * fRec97[i] + fConst513 * fRec97[i - 1] + fConst512 * fRec97[i - 2]) - fConst514 * (fConst515 * fRec96[i - 2] + fConst516 * fRec96[i - 1]);
			}
			/* Post code */
			for (int j205 = 0; j205 < 4; j205 = j205 + 1) {
				fRec96_perm[j205] = fRec96_tmp[vsize + j205];
			}
			/* Recursive loop 110 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec103[i] = fConst526 * (fConst529 * fRec104[i] + fConst530 * fRec104[i - 1] + fConst529 * fRec104[i - 2]) - fConst531 * (fConst532 * fRec103[i - 2] + fConst533 * fRec103[i - 1]);
			}
			/* Post code */
			for (int j213 = 0; j213 < 4; j213 = j213 + 1) {
				fRec103_perm[j213] = fRec103_tmp[vsize + j213];
			}
			/* Recursive loop 111 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec7[i] = fRec7[i - 1] * fSlow8 + std::fabs(fConst19 * (fConst24 * fRec8[i] + fConst25 * fRec8[i - 1] + fConst24 * fRec8[i - 2])) * fSlow9;
			}
			/* Post code */
			for (int j25 = 0; j25 < 4; j25 = j25 + 1) {
				fRec7_perm[j25] = fRec7_tmp[vsize + j25];
			}
			/* Recursive loop 112 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec11[i] = fSlow8 * fRec11[i - 1] + fSlow9 * std::fabs(fConst58 * (fConst62 * fRec12[i] + fConst63 * fRec12[i - 1] + fConst62 * fRec12[i - 2]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec18[i] = fSlow8 * fRec18[i - 1] + fSlow9 * std::fabs(fConst96 * (fConst100 * fRec19[i] + fConst101 * fRec19[i - 1] + fConst100 * fRec19[i - 2]));
			}
			/* Post code */
			for (int j53 = 0; j53 < 4; j53 = j53 + 1) {
				fRec18_perm[j53] = fRec18_tmp[vsize + j53];
			}
			/* Recursive loop 114 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec25[i] = fSlow8 * fRec25[i - 1] + fSlow9 * std::fabs(fConst134 * (fConst138 * fRec26[i] + fConst139 * fRec26[i - 1] + fConst138 * fRec26[i - 2]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec32[i] = fSlow8 * fRec32[i - 1] + fSlow9 * std::fabs(fConst172 * (fConst176 * fRec33[i] + fConst177 * fRec33[i - 1] + fConst176 * fRec33[i - 2]));
			}
			/* Post code */
			for (int j81 = 0; j81 < 4; j81 = j81 + 1) {
				fRec32_perm[j81] = fRec32_tmp[vsize + j81];
			}
			/* Recursive loop 116 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec39[i] = fSlow8 * fRec39[i - 1] + fSlow9 * std::fabs(fConst210 * (fConst214 * fRec40[i] + fConst215 * fRec40[i - 1] + fConst214 * fRec40[i - 2]));
			}
			/* Post code */
			for (int j95 = 0; j95 < 4; j95 = j95 + 1) {
				fRec39_perm[j95] = fRec39_tmp[vsize + j95];
			}
			/* Recursive loop 117 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec46[i] = fSlow8 * fRec46[i - 1] + fSlow9 * std::fabs(fConst248 * (fConst252 * fRec47[i] + fConst253 * fRec47[i - 1] + fConst252 * fRec47[i - 2]));
			}
			/* Post code */
			for (int j109 = 0; j109 < 4; j109 = j109 + 1) {
				fRec46_perm[j109] = fRec46_tmp[vsize + j109];
			}
			/* Recursive loop 118 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec53[i] = fSlow8 * fRec53[i - 1] + fSlow9 * std::fabs(fConst286 * (fConst290 * fRec54[i] + fConst291 * fRec54[i - 1] + fConst290 * fRec54[i - 2]));
			}
			/* Post code */
			for (int j123 = 0; j123 < 4; j123 = j123 + 1) {
				fRec53_perm[j123] = fRec53_tmp[vsize + j123];
			}
			/* Recursive loop 119 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec60[i] = fSlow8 * fRec60[i - 1] + fSlow9 * std::fabs(fConst324 * (fConst328 * fRec61[i] + fConst329 * fRec61[i - 1] + fConst328 * fRec61[i - 2]));
			}
			/* Post code */
			for (int j137 = 0; j137 < 4; j137 = j137 + 1) {
				fRec60_perm[j137] = fRec60_tmp[vsize + j137];
			}
			/* Recursive loop 120 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec67[i] = fSlow8 * fRec67[i - 1] + fSlow9 * std::fabs(fConst362 * (fConst366 * fRec68[i] + fConst367 * fRec68[i - 1] + fConst366 * fRec68[i - 2]));
			}
			/* Post code */
			for (int j151 = 0; j151 < 4; j151 = j151 + 1) {
				fRec67_perm[j151] = fRec67_tmp[vsize + j151];
			}
			/* Recursive loop 121 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec74[i] = fSlow8 * fRec74[i - 1] + fSlow9 * std::fabs(fConst400 * (fConst404 * fRec75[i] + fConst405 * fRec75[i - 1] + fConst404 * fRec75[i - 2]));
			}
			/* Post code */
			for (int j165 = 0; j165 < 4; j165 = j165 + 1) {
				fRec74_perm[j165] = fRec74_tmp[vsize + j165];
			}
			/* Recursive loop 122 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec81[i] = fSlow8 * fRec81[i - 1] + fSlow9 * std::fabs(fConst438 * (fConst442 * fRec82[i] + fConst443 * fRec82[i - 1] + fConst442 * fRec82[i - 2]));
			}
			/* Post code */
			for (int j179 = 0; j179 < 4; j179 = j179 + 1) {
				fRec81_perm[j179] = fRec81_tmp[vsize + j179];
			}
			/* Recursive loop 123 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec88[i] = fSlow8 * fRec88[i - 1] + fSlow9 * std::fabs(fConst476 * (fConst480 * fRec89[i] + fConst481 * fRec89[i - 1] + fConst480 * fRec89[i - 2]));
			}
			/* Post code */
			for (int j193 = 0; j193 < 4; j193 = j193 + 1) {
				fRec88_perm[j193] = fRec88_tmp[vsize + j193];
			}
			/* Recursive loop 124 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec95[i] = fSlow8 * fRec95[i - 1] + fSlow9 * std::fabs(fConst514 * (fConst518 * fRec96[i] + fConst519 * fRec96[i - 1] + fConst518 * fRec96[i - 2]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = i + 1) {
				fRec102[i] = fSlow8 * fRec102[i - 1] + fSlow9 * std::fabs(fConst531 * (fConst534 * fRec103[i] + fConst535 * fRec103[i - 1] + fConst534 * fRec103[i - 2]));
			}
			/* Post code */
