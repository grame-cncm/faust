...
struct HelloSine(FaustDsp):
    ...
    def get_json(read dsp) -> String:
        return "{\"name\": \"hello_sine\",\"filename\": \"hello_sine.dsp\",\"version\": \"2.85.5\",\"compile_options\": \"-a bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -cn HelloSine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0\",\"library_list\": [\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/platform.lib\"],\"include_pathnames\": [\"/Users/manuelfarzini/Personal/dev/repo/faust/build/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"src\",\"/Users/manuelfarzini/Personal/dev/repo/faust/architecture/mojo/src\"],\"size\": 20,\"inputs\": 0,\"outputs\": 1,\"meta\": [ { \"compile_options\": \"-a bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -cn HelloSine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0\" },{ \"filename\": \"hello_sine.dsp\" },{ \"maths.lib/author\": \"GRAME\" },{ \"maths.lib/copyright\": \"GRAME\" },{ \"maths.lib/license\": \"LGPL with exception\" },{ \"maths.lib/name\": \"Faust Math Library\" },{ \"maths.lib/version\": \"2.9.0\" },{ \"name\": \"hello_sine\" },{ \"platform.lib/name\": \"Generic Platform Library\" },{ \"platform.lib/version\": \"1.3.0\" }],\"ui\": [ {\"type\": \"vgroup\",\"label\": \"hello_sine\",\"items\": [ {\"type\": \"hslider\",\"label\": \"freq\",\"varname\": \"fHslider0\",\"shortname\": \"freq\",\"address\": \"/hello_sine/freq\",\"init\": 440,\"min\": 20,\"max\": 2000,\"step\": 1}]}]}"

    @always_inline
    def metadata(read dsp, mut meta: Some[FaustMeta]) -> None:
        meta.declare("compile_options", "-a bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -cn HelloSine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0")
