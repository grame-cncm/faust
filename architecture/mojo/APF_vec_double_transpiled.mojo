...
struct mydsp(FaustDsp):
    ...
    def get_json(read dsp) -> String:
        return "{\"name\": \"APF\",\"filename\": \"APF.dsp\",\"version\": \"2.85.5\",\"compile_options\": \"-a /Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/arch/mojo/bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\",\"library_list\": [\"/usr/local/share/faust/maxmsp.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/platform.lib\"],\"include_pathnames\": [\"/Users/manuelfarzini/personal/dev/repo/faust/build/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"/Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/src\",\"/Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/src\"],\"size\": 60,\"inputs\": 1,\"outputs\": 1,\"meta\": [ { \"compile_options\": \"-a /Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/arch/mojo/bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\" },{ \"filename\": \"APF.dsp\" },{ \"maths.lib/author\": \"GRAME\" },{ \"maths.lib/copyright\": \"GRAME\" },{ \"maths.lib/license\": \"LGPL with exception\" },{ \"maths.lib/name\": \"Faust Math Library\" },{ \"maths.lib/version\": \"2.9.0\" },{ \"maxmsp.lib/author\": \"GRAME\" },{ \"maxmsp.lib/copyright\": \"GRAME\" },{ \"maxmsp.lib/license\": \"LGPL with exception\" },{ \"maxmsp.lib/name\": \"MaxMSP compatibility Library\" },{ \"maxmsp.lib/version\": \"1.1.0\" },{ \"name\": \"APF\" },{ \"platform.lib/name\": \"Generic Platform Library\" },{ \"platform.lib/version\": \"1.3.0\" }],\"ui\": [ {\"type\": \"vgroup\",\"label\": \"APF\",\"items\": [ {\"type\": \"hslider\",\"label\": \"Freq\",\"varname\": \"fHslider0\",\"shortname\": \"Freq\",\"address\": \"/APF/Freq\",\"init\": 1000,\"min\": 100,\"max\": 10000,\"step\": 1},{\"type\": \"hslider\",\"label\": \"Q\",\"varname\": \"fHslider1\",\"shortname\": \"Q\",\"address\": \"/APF/Q\",\"init\": 1,\"min\": 0.01,\"max\": 100,\"step\": 0.01}]}]}"

    @always_inline
    def metadata(read dsp, mut meta: Some[FaustMeta]) -> None:
        meta.declare("compile_options", "-a /Users/manuelfarzini/personal/dev/repo/faust/architecture/_bench/arch/mojo/bench.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs")
    ...
    def compute(
        ...
        while (vindex_re0) <= ((count) - (S32(4))): 
            ...
            while i_re1 <= vsize_re0 - width1:
                ...
                var hi = ((simd_load(rec0, i_re1 + S32(dreal_width) - S32(2))) + ((slow2) * (((slow3) * (simd_load(rec0, i_re1 + S32(dreal_width)))) - (simd_load(zec0, i_re1 + S32(dreal_width)))))).cast[dfaust]()
        ...
        if ((vindex_re0) < (count) != 0):
            ...
            while i_re3 <= vsize_re1 - width3:
                var lo = ((simd_load(rec0, i_re3 - S32(2))) + ((slow2) * (((slow3) * (simd_load(rec0, i_re3))) - (simd_load(zec0, i_re3))))).cast[dfaust]()
                var hi = ((simd_load(rec0, i_re3 + S32(dreal_width) - S32(2))) + ((slow2) * (((slow3) * (simd_load(rec0, i_re3 + S32(dreal_width)))) - (simd_load(zec0, i_re3 + S32(dreal_width)))))).cast[dfaust]()
                var values = lo.join(hi)
