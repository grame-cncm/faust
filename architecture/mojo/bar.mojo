...
struct mydsp(FaustDsp):
    ...
    def compute(mut dsp, var count: S32, var inputs: ImmStreams, var outputs: MutStreams) -> None:
        ...
        var output2_ptr = outputs[unsafe_offset = S32(2)]
        var output3_ptr = outputs[unsafe_offset = S32(3)]
        var output4_ptr = outputs[unsafe_offset = S32(4)]
        var output5_ptr = outputs[unsafe_offset = S32(5)]
        var output6_ptr = outputs[unsafe_offset = S32(6)]
        var output7_ptr = outputs[unsafe_offset = S32(7)]
        ...
        while vindex <= end:
            ...
            var output2 = Ptr(to=output2_ptr[unsafe_offset = vindex])
            var output3 = Ptr(to=output3_ptr[unsafe_offset = vindex])
            var output4 = Ptr(to=output4_ptr[unsafe_offset = vindex])
            var output5 = Ptr(to=output5_ptr[unsafe_offset = vindex])
            var output6 = Ptr(to=output6_ptr[unsafe_offset = vindex])
            var output7 = Ptr(to=output7_ptr[unsafe_offset = vindex])
            vstore(output0, ((slow0) + ((slow1) * ((vload(input0)).cast[f64]()))).cast[dfaust]())
            dsp.hbargraph0 = output0[unsafe_offset = vsize - S32(1)]
            vstore(output1, (((slow2) * ((vload(input0)).cast[f64]())) - (slow0)).cast[dfaust]())
            dsp.vbargraph0 = output1[unsafe_offset = vsize - S32(1)]
            vstore(output2, ((slow3) * ((vload(input0)).cast[f64]())).cast[dfaust]())
            dsp.hbargraph1 = output2[unsafe_offset = vsize - S32(1)]
            vstore(output3, ((slow6) * ((vload(input0)).cast[f64]())).cast[dfaust]())
            dsp.vbargraph1 = output3[unsafe_offset = vsize - S32(1)]
            vstore(output4, (((F64Vec(slow7)) * ((F64Vec(slow0)) + ((vload[H](input0)).cast[f64]()))).cast[dfaust]()).join(((F64Vec(slow7)) * ((F64Vec(slow0)) + ((vload[H](input0, hsize)).cast[f64]()))).cast[dfaust]()))
            vstore(output5, (((F64Vec(slow8)) * (((vload[H](input0)).cast[f64]()) - (F64Vec(slow0)))).cast[dfaust]()).join(((F64Vec(slow8)) * (((vload[H](input0, hsize)).cast[f64]()) - (F64Vec(slow0)))).cast[dfaust]()))
            vstore(output6, (((F64Vec(slow9)) * ((vload[H](input0)).cast[f64]())).cast[dfaust]()).join(((F64Vec(slow9)) * ((vload[H](input0, hsize)).cast[f64]())).cast[dfaust]()))
            vstore(output7, (((F64Vec(slow10)) * ((vload[H](input0)).cast[f64]())).cast[dfaust]()).join(((F64Vec(slow10)) * ((vload[H](input0, hsize)).cast[f64]())).cast[dfaust]()))
            vindex += vsize
