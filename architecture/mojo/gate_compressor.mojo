...
struct mydsp(FaustDsp):
    ...
    def compute(mut dsp, var count: S32, var inputs: ImmStreams, var outputs: MutStreams) -> None:
        ...
        while vindex <= end:
            ...
            vstore(rec4_tmp, vload(dsp.rec4_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec4[unsafe_offset = i] = (slow0) + ((0.999) * (rec4[unsafe_offset = (i) - (S32(1))]))
            ...
            vstore(rec6_tmp, vload(dsp.rec6_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec6[unsafe_offset = i] = ((rec6[unsafe_offset = (i) - (S32(1))]) * (slow2)) + (slow3)
            ...
            vstore(zec0, max(F64Vec(2e+01), abs(vload(rec6, hsize))), hsize)
            vstore(rec5_tmp, vload(dsp.rec5_perm))
            vstore(rec5_tmp, vload(dsp.rec5_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec1[i] = (rec5[unsafe_offset = (i) - (S32(1))]) + ((dsp.const1) * (zec0[i]))
                rec5[unsafe_offset = i] = (zec1[i]) - (floor(zec1[i]))
            vstore(dsp.rec5_perm, vload(rec5_tmp, vsize))
            vstore(dsp.rec5_perm, vload[H](rec5_tmp, vsize + hsize), hsize)
            vstore(zec2, max(F64Vec(2e+01), abs((F64Vec(slow4)) * (vload(rec6)))))
            vstore(zec2, max(F64Vec(2e+01), abs((F64Vec(slow4)) * (vload(rec6, hsize)))), hsize)
            vstore(rec7_tmp, vload(dsp.rec7_perm))
            vstore(rec7_tmp, vload(dsp.rec7_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec3[i] = (rec7[unsafe_offset = (i) - (S32(1))]) + ((dsp.const1) * (zec2[i]))
                rec7[unsafe_offset = i] = (zec3[i]) - (floor(zec3[i]))
            vstore(dsp.rec7_perm, vload(rec7_tmp, vsize))
            vstore(dsp.rec7_perm, vload[H](rec7_tmp, vsize + hsize), hsize)
            vstore(zec4, max(F64Vec(2e+01), abs((F64Vec(slow5)) * (vload(rec6)))))
            vstore(zec4, max(F64Vec(2e+01), abs((F64Vec(slow5)) * (vload(rec6, hsize)))), hsize)
            vstore(rec8_tmp, vload(dsp.rec8_perm))
            vstore(rec8_tmp, vload(dsp.rec8_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec5[i] = (rec8[unsafe_offset = (i) - (S32(1))]) + ((dsp.const1) * (zec4[i]))
                rec8[unsafe_offset = i] = (zec5[i]) - (floor(zec5[i]))
            ...
            comptime for i in range(vsize):
                i_rec9[unsafe_offset = i] = ((S32(1103515245)) * (i_rec9[unsafe_offset = (i) - (S32(1))])) + (S32(12345))
            vstore(dsp.i_rec9_perm, vload(i_rec9_tmp, vsize))
            vstore(zec6, (F64Vec(4.656612875245797e-10)) * ((vload[H](i_rec9)).cast[f64]()))
            vstore(zec6, (F64Vec(4.656612875245797e-10)) * ((vload[H](i_rec9, hsize)).cast[f64]()), hsize)
            vstore(rec10_tmp, vload(dsp.rec10_perm))
            vstore(rec10_tmp, vload(dsp.rec10_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec10[unsafe_offset = i] = (((0.5221894) * (rec10[unsafe_offset = (i) - (S32(3))])) + ((zec6[i]) + ((2.494956002) * (rec10[unsafe_offset = (i) - (S32(1))])))) - ((2.017265875) * (rec10[unsafe_offset = (i) - (S32(2))]))
            ...
            vstore(zec7, (F64Vec(2.0)) * (vload(rec5, hsize)), hsize)
            vstore(zec8, (vload(zec7)) + (F64Vec(-1.0)))
            vstore(zec8, (vload(zec7, hsize)) + (F64Vec(-1.0)), hsize)
            vstore(zec9, (vload[H](i_vec0, - S32(1))).cast[f64]())
            vstore(zec9, (vload[H](i_vec0, - S32(1) + hsize)).cast[f64](), hsize)
            vstore(yec0_tmp, vload(dsp.yec0_perm))
            vstore(yec0_tmp, vload(dsp.yec0_perm, hsize), hsize)
            vstore(yec0, pow_unrolled[2](vload(zec8)))
            vstore(yec0, pow_unrolled[2](vload(zec8, hsize)), hsize)
            vstore(dsp.yec0_perm, vload(yec0_tmp, vsize))
            vstore(dsp.yec0_perm, vload[H](yec0_tmp, vsize + hsize), hsize)
            vstore(zec10, (vload[H](i_vec0, - S32(2))).cast[f64]())
            vstore(zec10, (vload[H](i_vec0, - S32(2) + hsize)).cast[f64](), hsize)
            vstore(zec11, pow_unrolled[3](vload(zec8)))
            vstore(zec11, pow_unrolled[3](vload(zec8, hsize)), hsize)
            vstore(yec1_tmp, vload(dsp.yec1_perm))
            vstore(yec1_tmp, vload(dsp.yec1_perm, hsize), hsize)
            vstore(yec1, (vload(zec11)) + ((F64Vec(1.0)) - (vload(zec7))))
            vstore(yec1, (vload(zec11, hsize)) + ((F64Vec(1.0)) - (vload(zec7, hsize))), hsize)
            ...
            vstore(yec2_tmp, vload(dsp.yec2_perm, hsize), hsize)
            vstore(yec2, ((vload(zec11)) + ((F64Vec(1.0)) - ((vload(zec7)) + (vload(yec1, - S32(1)))))) / (vload(zec0)))
            vstore(yec2, ((vload(zec11, hsize)) + ((F64Vec(1.0)) - ((vload(zec7, hsize)) + (vload(yec1, - S32(1) + hsize))))) / (vload(zec0, hsize)), hsize)
            vstore(dsp.yec2_perm, vload(yec2_tmp, vsize))
            vstore(dsp.yec2_perm, vload[H](yec2_tmp, vsize + hsize), hsize)
            vstore(zec12, (vload[H](i_vec0, - S32(3))).cast[f64]())
            vstore(zec12, (vload[H](i_vec0, - S32(3) + hsize)).cast[f64](), hsize)
            vstore(yec3_tmp, vload(dsp.yec3_perm))
            vstore(yec3_tmp, vload(dsp.yec3_perm, hsize), hsize)
            vstore(yec3, (vload(yec0)) * ((vload(yec0)) + (F64Vec(-2.0))))
            vstore(yec3, (vload(yec0, hsize)) * ((vload(yec0, hsize)) + (F64Vec(-2.0))), hsize)
            ...
            vstore(yec4_tmp, vload(dsp.yec4_perm, hsize), hsize)
            vstore(yec4, ((vload(yec3)) - (vload(yec3, - S32(1)))) / (vload(zec0)))
            vstore(yec4, ((vload(yec3, hsize)) - (vload(yec3, - S32(1) + hsize))) / (vload(zec0, hsize)), hsize)
            ...
            vstore(yec5_tmp, vload(dsp.yec5_perm, hsize), hsize)
            vstore(yec5, ((vload(yec4)) - (vload(yec4, - S32(1)))) / (vload(zec0)))
            vstore(yec5, ((vload(yec4, hsize)) - (vload(yec4, - S32(1) + hsize))) / (vload(zec0, hsize)), hsize)
            ...
            vstore(zec13, (F64Vec(2.0)) * (vload(rec7, hsize)), hsize)
            vstore(zec14, (vload(zec13)) + (F64Vec(-1.0)))
            vstore(zec14, (vload(zec13, hsize)) + (F64Vec(-1.0)), hsize)
            vstore(yec6_tmp, vload(dsp.yec6_perm))
            vstore(yec6_tmp, vload(dsp.yec6_perm, hsize), hsize)
            vstore(yec6, pow_unrolled[2](vload(zec14)))
            vstore(yec6, pow_unrolled[2](vload(zec14, hsize)), hsize)
            ...
            vstore(zec15, pow_unrolled[3](vload(zec14, hsize)), hsize)
            vstore(yec7_tmp, vload(dsp.yec7_perm))
            vstore(yec7_tmp, vload(dsp.yec7_perm, hsize), hsize)
            vstore(yec7, (vload(zec15)) + ((F64Vec(1.0)) - (vload(zec13))))
            vstore(yec7, (vload(zec15, hsize)) + ((F64Vec(1.0)) - (vload(zec13, hsize))), hsize)
            ...
            vstore(yec8_tmp, vload(dsp.yec8_perm, hsize), hsize)
            vstore(yec8, ((vload(zec15)) + ((F64Vec(1.0)) - ((vload(zec13)) + (vload(yec7, - S32(1)))))) / (vload(zec2)))
            vstore(yec8, ((vload(zec15, hsize)) + ((F64Vec(1.0)) - ((vload(zec13, hsize)) + (vload(yec7, - S32(1) + hsize))))) / (vload(zec2, hsize)), hsize)
            ...
            vstore(yec9_tmp, vload(dsp.yec9_perm, hsize), hsize)
            vstore(yec9, (vload(yec6)) * ((vload(yec6)) + (F64Vec(-2.0))))
            vstore(yec9, (vload(yec6, hsize)) * ((vload(yec6, hsize)) + (F64Vec(-2.0))), hsize)
            ...
            vstore(yec10_tmp, vload(dsp.yec10_perm, hsize), hsize)
            vstore(yec10, ((vload(yec9)) - (vload(yec9, - S32(1)))) / (vload(zec2)))
            vstore(yec10, ((vload(yec9, hsize)) - (vload(yec9, - S32(1) + hsize))) / (vload(zec2, hsize)), hsize)
            ...
            vstore(yec11_tmp, vload(dsp.yec11_perm, hsize), hsize)
            vstore(yec11, ((vload(yec10)) - (vload(yec10, - S32(1)))) / (vload(zec2)))
            vstore(yec11, ((vload(yec10, hsize)) - (vload(yec10, - S32(1) + hsize))) / (vload(zec2, hsize)), hsize)
            ...
            vstore(zec16, (F64Vec(2.0)) * (vload(rec8, hsize)), hsize)
            vstore(zec17, (vload(zec16)) + (F64Vec(-1.0)))
            vstore(zec17, (vload(zec16, hsize)) + (F64Vec(-1.0)), hsize)
            vstore(yec12_tmp, vload(dsp.yec12_perm))
            vstore(yec12_tmp, vload(dsp.yec12_perm, hsize), hsize)
            vstore(yec12, pow_unrolled[2](vload(zec17)))
            vstore(yec12, pow_unrolled[2](vload(zec17, hsize)), hsize)
            ...
            vstore(zec18, pow_unrolled[3](vload(zec17, hsize)), hsize)
            vstore(yec13_tmp, vload(dsp.yec13_perm))
            vstore(yec13_tmp, vload(dsp.yec13_perm, hsize), hsize)
            vstore(yec13, (vload(zec18)) + ((F64Vec(1.0)) - (vload(zec16))))
            vstore(yec13, (vload(zec18, hsize)) + ((F64Vec(1.0)) - (vload(zec16, hsize))), hsize)
            ...
            vstore(yec14_tmp, vload(dsp.yec14_perm, hsize), hsize)
            vstore(yec14, ((vload(zec18)) + ((F64Vec(1.0)) - ((vload(zec16)) + (vload(yec13, - S32(1)))))) / (vload(zec4)))
            vstore(yec14, ((vload(zec18, hsize)) + ((F64Vec(1.0)) - ((vload(zec16, hsize)) + (vload(yec13, - S32(1) + hsize))))) / (vload(zec4, hsize)), hsize)
            ...
            vstore(yec15_tmp, vload(dsp.yec15_perm, hsize), hsize)
            vstore(yec15, (vload(yec12)) * ((vload(yec12)) + (F64Vec(-2.0))))
            vstore(yec15, (vload(yec12, hsize)) * ((vload(yec12, hsize)) + (F64Vec(-2.0))), hsize)
            ...
            vstore(yec16_tmp, vload(dsp.yec16_perm, hsize), hsize)
            vstore(yec16, ((vload(yec15)) - (vload(yec15, - S32(1)))) / (vload(zec4)))
            vstore(yec16, ((vload(yec15, hsize)) - (vload(yec15, - S32(1) + hsize))) / (vload(zec4, hsize)), hsize)
            ...
            vstore(yec17_tmp, vload(dsp.yec17_perm, hsize), hsize)
            vstore(yec17, ((vload(yec16)) - (vload(yec16, - S32(1)))) / (vload(zec4)))
            vstore(yec17, ((vload(yec16, hsize)) - (vload(yec16, - S32(1) + hsize))) / (vload(zec4, hsize)), hsize)
            vstore(dsp.yec17_perm, vload(yec17_tmp, vsize))
            vstore(dsp.yec17_perm, vload[H](yec17_tmp, vsize + hsize), hsize)
            vstore(zec19, (vload(rec4)) * ((vload[H](input0)).cast[f64]() if i_slow11 else (((F64Vec(0.049922035)) * (vload[H](rec10))) + ((F64Vec(0.050612699)) * (vload[H](rec10, - S32(2))))) - (((F64Vec(0.095993537)) * (vload[H](rec10, - S32(1)))) + ((F64Vec(0.004408786)) * (vload[H](rec10, - S32(3))))) if i_slow17 else vload[H](zec6) if i_slow12 else (F64Vec(0.3333333333333333)) * ((vload[H](rec4)) * ((((F64Vec(dsp.const4)) * (((vload[H](zec12)) * ((vload[H](yec5)) - (vload[H](yec5, - S32(1))))) / (vload[H](zec0))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10)) * ((vload[H](yec2)) - (vload[H](yec2, - S32(1))))) / (vload[H](zec0))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9)) * ((vload[H](yec0)) - (vload[H](yec0, - S32(1))))) / (vload[H](zec0))) if i_slow15 else vload[H](zec8)) + ((F64Vec(dsp.const4)) * (((vload[H](zec12)) * ((vload[H](yec11)) - (vload[H](yec11, - S32(1))))) / (vload[H](zec2))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10)) * ((vload[H](yec8)) - (vload[H](yec8, - S32(1))))) / (vload[H](zec2))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9)) * ((vload[H](yec6)) - (vload[H](yec6, - S32(1))))) / (vload[H](zec2))) if i_slow15 else vload[H](zec14))) + ((F64Vec(dsp.const4)) * (((vload[H](zec12)) * ((vload[H](yec17)) - (vload[H](yec17, - S32(1))))) / (vload[H](zec4))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10)) * ((vload[H](yec14)) - (vload[H](yec14, - S32(1))))) / (vload[H](zec4))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9)) * ((vload[H](yec12)) - (vload[H](yec12, - S32(1))))) / (vload[H](zec4))) if i_slow15 else vload[H](zec17))))))
            vstore(zec19, (vload[H](rec4, hsize)) * ((vload[H](input0, hsize)).cast[f64]() if i_slow11 else (((F64Vec(0.049922035)) * (vload[H](rec10, hsize))) + ((F64Vec(0.050612699)) * (vload[H](rec10, - S32(2) + hsize)))) - (((F64Vec(0.095993537)) * (vload[H](rec10, - S32(1) + hsize))) + ((F64Vec(0.004408786)) * (vload[H](rec10, - S32(3) + hsize)))) if i_slow17 else vload[H](zec6, hsize) if i_slow12 else (F64Vec(0.3333333333333333)) * ((vload[H](rec4, hsize)) * ((((F64Vec(dsp.const4)) * (((vload[H](zec12, hsize)) * ((vload[H](yec5, hsize)) - (vload[H](yec5, - S32(1) + hsize)))) / (vload[H](zec0, hsize))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10, hsize)) * ((vload[H](yec2, hsize)) - (vload[H](yec2, - S32(1) + hsize)))) / (vload[H](zec0, hsize))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9, hsize)) * ((vload[H](yec0, hsize)) - (vload[H](yec0, - S32(1) + hsize)))) / (vload[H](zec0, hsize))) if i_slow15 else vload[H](zec8, hsize)) + ((F64Vec(dsp.const4)) * (((vload[H](zec12, hsize)) * ((vload[H](yec11, hsize)) - (vload[H](yec11, - S32(1) + hsize)))) / (vload[H](zec2, hsize))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10, hsize)) * ((vload[H](yec8, hsize)) - (vload[H](yec8, - S32(1) + hsize)))) / (vload[H](zec2, hsize))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9, hsize)) * ((vload[H](yec6, hsize)) - (vload[H](yec6, - S32(1) + hsize)))) / (vload[H](zec2, hsize))) if i_slow15 else vload[H](zec14, hsize))) + ((F64Vec(dsp.const4)) * (((vload[H](zec12, hsize)) * ((vload[H](yec17, hsize)) - (vload[H](yec17, - S32(1) + hsize)))) / (vload[H](zec4, hsize))) if i_slow16 else (F64Vec(dsp.const3)) * (((vload[H](zec10, hsize)) * ((vload[H](yec14, hsize)) - (vload[H](yec14, - S32(1) + hsize)))) / (vload[H](zec4, hsize))) if i_slow14 else (F64Vec(dsp.const2)) * (((vload[H](zec9, hsize)) * ((vload[H](yec12, hsize)) - (vload[H](yec12, - S32(1) + hsize)))) / (vload[H](zec4, hsize))) if i_slow15 else vload[H](zec17, hsize))))), hsize)
            vstore(zec20, F64Vec(0.0) if i_slow10 else vload[H](zec19))
            vstore(zec20, F64Vec(0.0) if i_slow10 else vload[H](zec19, hsize), hsize)
            vstore(zec21, abs(vload(zec20)))
            vstore(zec21, abs(vload(zec20, hsize)), hsize)
            vstore(rec14_tmp, vload(dsp.rec14_perm))
            vstore(rec14_tmp, vload(dsp.rec14_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec14[unsafe_offset = i] = ((rec14[unsafe_offset = (i) - (S32(1))]) * (slow9)) + ((abs((2.0) * (zec21[i]))) * (slow18))
            vstore(dsp.rec14_perm, vload(rec14_tmp, vsize))
            vstore(dsp.rec14_perm, vload[H](rec14_tmp, vsize + hsize), hsize)
            comptime for i in range(vsize):
                rec13[i] = rec14[unsafe_offset = i]
            vstore(i_yec18_tmp, vload(dsp.i_yec18_perm))
            vstore(i_yec18, (vload(rec13).gt(F64Vec(slow20)).cast[s32]()))
            vstore(dsp.i_yec18_perm, vload(i_yec18_tmp, vsize))
            vstore(i_rec15_tmp, vload(dsp.i_rec15_perm))
            comptime for i in range(vsize):
                i_rec15[unsafe_offset = i] = max((i_slow19) * (S32((i_yec18[unsafe_offset = i]) < (i_yec18[unsafe_offset = (i) - (S32(1))]))), (i_rec15[unsafe_offset = (i) - (S32(1))]) + (S32(-1)))
            vstore(dsp.i_rec15_perm, vload(i_rec15_tmp, vsize))
            vstore(zec22, abs(max((vload[H](i_yec18)).cast[f64](), ((vload[H](i_rec15).gt(S32Hec(0)).cast[f64]())).cast[f64]())))
            vstore(zec22, abs(max((vload[H](i_yec18, hsize)).cast[f64](), ((vload[H](i_rec15, hsize).gt(S32Hec(0)).cast[f64]())).cast[f64]())), hsize)
            vstore(rec12_tmp, vload(dsp.rec12_perm))
            vstore(rec12_tmp, vload(dsp.rec12_perm, hsize), hsize)
            vstore(rec11_tmp, vload(dsp.rec11_perm))
            vstore(rec11_tmp, vload(dsp.rec11_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec23[i] = slow22 if S32((rec11[unsafe_offset = (i) - (S32(1))]) > (zec22[i])) else slow21
                rec12[unsafe_offset = i] = ((rec12[unsafe_offset = (i) - (S32(1))]) * (zec23[i])) + ((zec22[i]) * ((1.0) - (zec23[i])))
                rec11[unsafe_offset = i] = rec12[unsafe_offset = i]
            ...
            vstore(zec24, (F64Vec(2e+01)) * (log10(vload(rec11, hsize))), hsize)
            dsp.hbargraph0 = FaustFloat(zec24[vsize - S32(1)])
            vstore(rec3_tmp, vload(dsp.rec3_perm))
            vstore(rec3_tmp, vload(dsp.rec3_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec3[unsafe_offset = i] = ((rec3[unsafe_offset = (i) - (S32(1))]) * (slow9)) + ((slow18) * (abs((zec21[i]) + (abs(zec24[i])))))
            vstore(dsp.rec3_perm, vload(rec3_tmp, vsize))
            vstore(dsp.rec3_perm, vload[H](rec3_tmp, vsize + hsize), hsize)
            comptime for i in range(vsize):
                rec2[i] = rec3[unsafe_offset = i]
            vstore(i_yec19_tmp, vload(dsp.i_yec19_perm))
            vstore(i_yec19, (vload(rec2).gt(F64Vec(slow20)).cast[s32]()))
            vstore(dsp.i_yec19_perm, vload(i_yec19_tmp, vsize))
            vstore(i_rec16_tmp, vload(dsp.i_rec16_perm))
            comptime for i in range(vsize):
                i_rec16[unsafe_offset = i] = max((i_slow19) * (S32((i_yec19[unsafe_offset = i]) < (i_yec19[unsafe_offset = (i) - (S32(1))]))), (i_rec16[unsafe_offset = (i) - (S32(1))]) + (S32(-1)))
            vstore(dsp.i_rec16_perm, vload(i_rec16_tmp, vsize))
            vstore(zec25, abs(max((vload[H](i_yec19)).cast[f64](), ((vload[H](i_rec16).gt(S32Hec(0)).cast[f64]())).cast[f64]())))
            vstore(zec25, abs(max((vload[H](i_yec19, hsize)).cast[f64](), ((vload[H](i_rec16, hsize).gt(S32Hec(0)).cast[f64]())).cast[f64]())), hsize)
            vstore(rec1_tmp, vload(dsp.rec1_perm))
            vstore(rec1_tmp, vload(dsp.rec1_perm, hsize), hsize)
            vstore(rec0_tmp, vload(dsp.rec0_perm))
            vstore(rec0_tmp, vload(dsp.rec0_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec26[i] = slow22 if S32((rec0[unsafe_offset = (i) - (S32(1))]) > (zec25[i])) else slow21
                rec1[unsafe_offset = i] = ((rec1[unsafe_offset = (i) - (S32(1))]) * (zec26[i])) + ((zec25[i]) * ((1.0) - (zec26[i])))
                rec0[unsafe_offset = i] = rec1[unsafe_offset = i]
            ...
            vstore(zec27, vload(zec19) if i_slow10 else (vload[H](rec0)) * (vload[H](zec24)))
            vstore(zec27, vload[H](zec19, hsize) if i_slow10 else (vload[H](rec0, hsize)) * (vload[H](zec24, hsize)), hsize)
            vstore(zec28, F64Vec(0.0) if i_slow23 else vload[H](zec27))
            vstore(zec28, F64Vec(0.0) if i_slow23 else vload[H](zec27, hsize), hsize)
            vstore(zec29, vload(zec19) if i_slow10 else (vload[H](rec0)) * (vload[H](zec20)))
            vstore(zec29, vload[H](zec19, hsize) if i_slow10 else (vload[H](rec0, hsize)) * (vload[H](zec20, hsize)), hsize)
            vstore(zec30, F64Vec(0.0) if i_slow23 else vload[H](zec29))
            vstore(zec30, F64Vec(0.0) if i_slow23 else vload[H](zec29, hsize), hsize)
            vstore(zec31, abs((abs(vload(zec28))) + (abs(vload(zec30)))))
            vstore(zec31, abs((abs(vload(zec28, hsize))) + (abs(vload(zec30, hsize)))), hsize)
            vstore(rec19_tmp, vload(dsp.rec19_perm))
            vstore(rec19_tmp, vload(dsp.rec19_perm, hsize), hsize)
            vstore(rec18_tmp, vload(dsp.rec18_perm))
            vstore(rec18_tmp, vload(dsp.rec18_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec32[i] = slow27 if S32((rec18[unsafe_offset = (i) - (S32(1))]) > (zec31[i])) else slow25
                rec19[unsafe_offset = i] = ((rec19[unsafe_offset = (i) - (S32(1))]) * (zec32[i])) + ((zec31[i]) * ((1.0) - (zec32[i])))
                rec18[unsafe_offset = i] = rec19[unsafe_offset = i]
            ...
            vstore(rec17_tmp, vload(dsp.rec17_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec17[unsafe_offset = i] = ((rec17[unsafe_offset = (i) - (S32(1))]) * (slow28)) + ((slow29) * ((max(((2e+01) * (log10(rec18[unsafe_offset = i]))) - (slow30), 0.0)) * (slow31)))
            ...
            vstore(zec33, pow(F64Vec(1e+01), (F64Vec(0.05)) * (vload(rec17, hsize))), hsize)
            vstore(zec34, (vload(zec28)) * (vload(zec33)))
            vstore(zec34, (vload(zec28, hsize)) * (vload(zec33, hsize)), hsize)
            vstore(zec35, (vload(zec30)) * (vload(zec33)))
            vstore(zec35, (vload(zec30, hsize)) * (vload(zec33, hsize)), hsize)
            vstore(zec36, abs((abs(vload(zec34))) + (abs(vload(zec35)))))
            vstore(zec36, abs((abs(vload(zec34, hsize))) + (abs(vload(zec35, hsize)))), hsize)
            vstore(rec22_tmp, vload(dsp.rec22_perm))
            vstore(rec22_tmp, vload(dsp.rec22_perm, hsize), hsize)
            vstore(rec21_tmp, vload(dsp.rec21_perm))
            vstore(rec21_tmp, vload(dsp.rec21_perm, hsize), hsize)
            comptime for i in range(vsize):
                zec37[i] = slow27 if S32((rec21[unsafe_offset = (i) - (S32(1))]) > (zec36[i])) else slow25
                rec22[unsafe_offset = i] = ((rec22[unsafe_offset = (i) - (S32(1))]) * (zec37[i])) + ((zec36[i]) * ((1.0) - (zec37[i])))
                rec21[unsafe_offset = i] = rec22[unsafe_offset = i]
            ...
            vstore(rec20_tmp, vload(dsp.rec20_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec20[unsafe_offset = i] = ((slow28) * (rec20[unsafe_offset = (i) - (S32(1))])) + ((slow29) * ((max(((2e+01) * (log10(rec21[unsafe_offset = i]))) - (slow30), 0.0)) * (slow31)))
            ...
            vstore(zec38, (F64Vec(2e+01)) * (log10(pow(F64Vec(1e+01), (F64Vec(0.05)) * (vload(rec20, hsize))))), hsize)
            dsp.hbargraph1 = FaustFloat(zec38[vsize - S32(1)])
            vstore(rec26_tmp, vload(dsp.rec26_perm))
            vstore(rec26_tmp, vload(dsp.rec26_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec26[unsafe_offset = i] = (zec38[i]) - ((dsp.const8) * (((dsp.const9) * (rec26[unsafe_offset = (i) - (S32(2))])) + ((dsp.const12) * (rec26[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec25_tmp, vload(dsp.rec25_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec25[unsafe_offset = i] = ((dsp.const8) * ((((dsp.const14) * (rec26[unsafe_offset = i])) + ((dsp.const15) * (rec26[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const14) * (rec26[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const16) * (((dsp.const17) * (rec25[unsafe_offset = (i) - (S32(2))])) + ((dsp.const18) * (rec25[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec24_tmp, vload(dsp.rec24_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec24[unsafe_offset = i] = ((dsp.const16) * ((((dsp.const20) * (rec25[unsafe_offset = i])) + ((dsp.const21) * (rec25[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const20) * (rec25[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const22) * (((dsp.const23) * (rec24[unsafe_offset = (i) - (S32(2))])) + ((dsp.const24) * (rec24[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec23_tmp, vload(dsp.rec23_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec23[unsafe_offset = i] = ((rec23[unsafe_offset = (i) - (S32(1))]) * (slow34)) + ((abs((dsp.const22) * ((((dsp.const27) * (rec24[unsafe_offset = i])) + ((dsp.const28) * (rec24[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const27) * (rec24[unsafe_offset = (i) - (S32(2))]))))) * (slow35))
            ...
            vstore(rec33_tmp, vload(dsp.rec33_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec33[unsafe_offset = i] = (zec38[i]) - ((dsp.const29) * (((dsp.const30) * (rec33[unsafe_offset = (i) - (S32(2))])) + ((dsp.const31) * (rec33[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec32_tmp, vload(dsp.rec32_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec32[unsafe_offset = i] = ((dsp.const29) * ((((dsp.const33) * (rec33[unsafe_offset = i])) + ((dsp.const34) * (rec33[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const33) * (rec33[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const35) * (((dsp.const36) * (rec32[unsafe_offset = (i) - (S32(2))])) + ((dsp.const37) * (rec32[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec31_tmp, vload(dsp.rec31_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec31[unsafe_offset = i] = ((dsp.const35) * ((((dsp.const38) * (rec32[unsafe_offset = i])) + ((dsp.const39) * (rec32[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const38) * (rec32[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const40) * (((dsp.const41) * (rec31[unsafe_offset = (i) - (S32(2))])) + ((dsp.const42) * (rec31[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec31_perm, vload(rec31_tmp, vsize))
            vstore(dsp.rec31_perm, vload[H](rec31_tmp, vsize + hsize), hsize)
            vstore(zec39, (F64Vec(dsp.const40)) * ((((F64Vec(dsp.const43)) * (vload(rec31))) + ((F64Vec(dsp.const44)) * (vload(rec31, - S32(1))))) + ((F64Vec(dsp.const43)) * (vload(rec31, - S32(2))))))
            vstore(zec39, (F64Vec(dsp.const40)) * ((((F64Vec(dsp.const43)) * (vload(rec31, hsize))) + ((F64Vec(dsp.const44)) * (vload(rec31, - S32(1) + hsize)))) + ((F64Vec(dsp.const43)) * (vload(rec31, - S32(2) + hsize)))), hsize)
            vstore(rec30_tmp, vload(dsp.rec30_perm))
            vstore(rec30_tmp, vload(dsp.rec30_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec30[unsafe_offset = i] = (zec39[i]) - ((dsp.const47) * (((dsp.const48) * (rec30[unsafe_offset = (i) - (S32(2))])) + ((dsp.const51) * (rec30[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec29_tmp, vload(dsp.rec29_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec29[unsafe_offset = i] = ((dsp.const47) * ((((dsp.const53) * (rec30[unsafe_offset = i])) + ((dsp.const54) * (rec30[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const53) * (rec30[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const55) * (((dsp.const56) * (rec29[unsafe_offset = (i) - (S32(2))])) + ((dsp.const57) * (rec29[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec28_tmp, vload(dsp.rec28_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec28[unsafe_offset = i] = ((dsp.const55) * ((((dsp.const59) * (rec29[unsafe_offset = i])) + ((dsp.const60) * (rec29[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const59) * (rec29[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const61) * (((dsp.const62) * (rec28[unsafe_offset = (i) - (S32(2))])) + ((dsp.const63) * (rec28[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec27_tmp, vload(dsp.rec27_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec27[unsafe_offset = i] = ((slow34) * (rec27[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const61) * ((((dsp.const65) * (rec28[unsafe_offset = i])) + ((dsp.const66) * (rec28[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const65) * (rec28[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec40_tmp, vload(dsp.rec40_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec40[unsafe_offset = i] = (zec39[i]) - ((dsp.const67) * (((dsp.const68) * (rec40[unsafe_offset = (i) - (S32(2))])) + ((dsp.const69) * (rec40[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec39_tmp, vload(dsp.rec39_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec39[unsafe_offset = i] = ((dsp.const67) * ((((dsp.const71) * (rec40[unsafe_offset = i])) + ((dsp.const72) * (rec40[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const71) * (rec40[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const73) * (((dsp.const74) * (rec39[unsafe_offset = (i) - (S32(2))])) + ((dsp.const75) * (rec39[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec38_tmp, vload(dsp.rec38_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec38[unsafe_offset = i] = ((dsp.const73) * ((((dsp.const76) * (rec39[unsafe_offset = i])) + ((dsp.const77) * (rec39[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const76) * (rec39[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const78) * (((dsp.const79) * (rec38[unsafe_offset = (i) - (S32(2))])) + ((dsp.const80) * (rec38[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec38_perm, vload(rec38_tmp, vsize))
            vstore(dsp.rec38_perm, vload[H](rec38_tmp, vsize + hsize), hsize)
            vstore(zec40, (F64Vec(dsp.const78)) * ((((F64Vec(dsp.const81)) * (vload(rec38))) + ((F64Vec(dsp.const82)) * (vload(rec38, - S32(1))))) + ((F64Vec(dsp.const81)) * (vload(rec38, - S32(2))))))
            vstore(zec40, (F64Vec(dsp.const78)) * ((((F64Vec(dsp.const81)) * (vload(rec38, hsize))) + ((F64Vec(dsp.const82)) * (vload(rec38, - S32(1) + hsize)))) + ((F64Vec(dsp.const81)) * (vload(rec38, - S32(2) + hsize)))), hsize)
            vstore(rec37_tmp, vload(dsp.rec37_perm))
            vstore(rec37_tmp, vload(dsp.rec37_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec37[unsafe_offset = i] = (zec40[i]) - ((dsp.const85) * (((dsp.const86) * (rec37[unsafe_offset = (i) - (S32(2))])) + ((dsp.const89) * (rec37[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec36_tmp, vload(dsp.rec36_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec36[unsafe_offset = i] = ((dsp.const85) * ((((dsp.const91) * (rec37[unsafe_offset = i])) + ((dsp.const92) * (rec37[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const91) * (rec37[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const93) * (((dsp.const94) * (rec36[unsafe_offset = (i) - (S32(2))])) + ((dsp.const95) * (rec36[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec35_tmp, vload(dsp.rec35_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec35[unsafe_offset = i] = ((dsp.const93) * ((((dsp.const97) * (rec36[unsafe_offset = i])) + ((dsp.const98) * (rec36[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const97) * (rec36[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const99) * (((dsp.const100) * (rec35[unsafe_offset = (i) - (S32(2))])) + ((dsp.const101) * (rec35[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec34_tmp, vload(dsp.rec34_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec34[unsafe_offset = i] = ((slow34) * (rec34[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const99) * ((((dsp.const103) * (rec35[unsafe_offset = i])) + ((dsp.const104) * (rec35[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const103) * (rec35[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec47_tmp, vload(dsp.rec47_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec47[unsafe_offset = i] = (zec40[i]) - ((dsp.const105) * (((dsp.const106) * (rec47[unsafe_offset = (i) - (S32(2))])) + ((dsp.const107) * (rec47[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec46_tmp, vload(dsp.rec46_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec46[unsafe_offset = i] = ((dsp.const105) * ((((dsp.const109) * (rec47[unsafe_offset = i])) + ((dsp.const110) * (rec47[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const109) * (rec47[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const111) * (((dsp.const112) * (rec46[unsafe_offset = (i) - (S32(2))])) + ((dsp.const113) * (rec46[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec45_tmp, vload(dsp.rec45_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec45[unsafe_offset = i] = ((dsp.const111) * ((((dsp.const114) * (rec46[unsafe_offset = i])) + ((dsp.const115) * (rec46[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const114) * (rec46[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const116) * (((dsp.const117) * (rec45[unsafe_offset = (i) - (S32(2))])) + ((dsp.const118) * (rec45[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec45_perm, vload(rec45_tmp, vsize))
            vstore(dsp.rec45_perm, vload[H](rec45_tmp, vsize + hsize), hsize)
            vstore(zec41, (F64Vec(dsp.const116)) * ((((F64Vec(dsp.const119)) * (vload(rec45))) + ((F64Vec(dsp.const120)) * (vload(rec45, - S32(1))))) + ((F64Vec(dsp.const119)) * (vload(rec45, - S32(2))))))
            vstore(zec41, (F64Vec(dsp.const116)) * ((((F64Vec(dsp.const119)) * (vload(rec45, hsize))) + ((F64Vec(dsp.const120)) * (vload(rec45, - S32(1) + hsize)))) + ((F64Vec(dsp.const119)) * (vload(rec45, - S32(2) + hsize)))), hsize)
            vstore(rec44_tmp, vload(dsp.rec44_perm))
            vstore(rec44_tmp, vload(dsp.rec44_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec44[unsafe_offset = i] = (zec41[i]) - ((dsp.const123) * (((dsp.const124) * (rec44[unsafe_offset = (i) - (S32(2))])) + ((dsp.const127) * (rec44[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec43_tmp, vload(dsp.rec43_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec43[unsafe_offset = i] = ((dsp.const123) * ((((dsp.const129) * (rec44[unsafe_offset = i])) + ((dsp.const130) * (rec44[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const129) * (rec44[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const131) * (((dsp.const132) * (rec43[unsafe_offset = (i) - (S32(2))])) + ((dsp.const133) * (rec43[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec42_tmp, vload(dsp.rec42_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec42[unsafe_offset = i] = ((dsp.const131) * ((((dsp.const135) * (rec43[unsafe_offset = i])) + ((dsp.const136) * (rec43[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const135) * (rec43[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const137) * (((dsp.const138) * (rec42[unsafe_offset = (i) - (S32(2))])) + ((dsp.const139) * (rec42[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec41_tmp, vload(dsp.rec41_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec41[unsafe_offset = i] = ((slow34) * (rec41[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const137) * ((((dsp.const141) * (rec42[unsafe_offset = i])) + ((dsp.const142) * (rec42[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const141) * (rec42[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec54_tmp, vload(dsp.rec54_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec54[unsafe_offset = i] = (zec41[i]) - ((dsp.const143) * (((dsp.const144) * (rec54[unsafe_offset = (i) - (S32(2))])) + ((dsp.const145) * (rec54[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec53_tmp, vload(dsp.rec53_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec53[unsafe_offset = i] = ((dsp.const143) * ((((dsp.const147) * (rec54[unsafe_offset = i])) + ((dsp.const148) * (rec54[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const147) * (rec54[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const149) * (((dsp.const150) * (rec53[unsafe_offset = (i) - (S32(2))])) + ((dsp.const151) * (rec53[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec52_tmp, vload(dsp.rec52_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec52[unsafe_offset = i] = ((dsp.const149) * ((((dsp.const152) * (rec53[unsafe_offset = i])) + ((dsp.const153) * (rec53[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const152) * (rec53[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const154) * (((dsp.const155) * (rec52[unsafe_offset = (i) - (S32(2))])) + ((dsp.const156) * (rec52[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec52_perm, vload(rec52_tmp, vsize))
            vstore(dsp.rec52_perm, vload[H](rec52_tmp, vsize + hsize), hsize)
            vstore(zec42, (F64Vec(dsp.const154)) * ((((F64Vec(dsp.const157)) * (vload(rec52))) + ((F64Vec(dsp.const158)) * (vload(rec52, - S32(1))))) + ((F64Vec(dsp.const157)) * (vload(rec52, - S32(2))))))
            vstore(zec42, (F64Vec(dsp.const154)) * ((((F64Vec(dsp.const157)) * (vload(rec52, hsize))) + ((F64Vec(dsp.const158)) * (vload(rec52, - S32(1) + hsize)))) + ((F64Vec(dsp.const157)) * (vload(rec52, - S32(2) + hsize)))), hsize)
            vstore(rec51_tmp, vload(dsp.rec51_perm))
            vstore(rec51_tmp, vload(dsp.rec51_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec51[unsafe_offset = i] = (zec42[i]) - ((dsp.const161) * (((dsp.const162) * (rec51[unsafe_offset = (i) - (S32(2))])) + ((dsp.const165) * (rec51[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec50_tmp, vload(dsp.rec50_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec50[unsafe_offset = i] = ((dsp.const161) * ((((dsp.const167) * (rec51[unsafe_offset = i])) + ((dsp.const168) * (rec51[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const167) * (rec51[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const169) * (((dsp.const170) * (rec50[unsafe_offset = (i) - (S32(2))])) + ((dsp.const171) * (rec50[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec49_tmp, vload(dsp.rec49_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec49[unsafe_offset = i] = ((dsp.const169) * ((((dsp.const173) * (rec50[unsafe_offset = i])) + ((dsp.const174) * (rec50[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const173) * (rec50[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const175) * (((dsp.const176) * (rec49[unsafe_offset = (i) - (S32(2))])) + ((dsp.const177) * (rec49[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec48_tmp, vload(dsp.rec48_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec48[unsafe_offset = i] = ((slow34) * (rec48[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const175) * ((((dsp.const179) * (rec49[unsafe_offset = i])) + ((dsp.const180) * (rec49[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const179) * (rec49[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec61_tmp, vload(dsp.rec61_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec61[unsafe_offset = i] = (zec42[i]) - ((dsp.const181) * (((dsp.const182) * (rec61[unsafe_offset = (i) - (S32(2))])) + ((dsp.const183) * (rec61[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec60_tmp, vload(dsp.rec60_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec60[unsafe_offset = i] = ((dsp.const181) * ((((dsp.const185) * (rec61[unsafe_offset = i])) + ((dsp.const186) * (rec61[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const185) * (rec61[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const187) * (((dsp.const188) * (rec60[unsafe_offset = (i) - (S32(2))])) + ((dsp.const189) * (rec60[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec59_tmp, vload(dsp.rec59_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec59[unsafe_offset = i] = ((dsp.const187) * ((((dsp.const190) * (rec60[unsafe_offset = i])) + ((dsp.const191) * (rec60[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const190) * (rec60[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const192) * (((dsp.const193) * (rec59[unsafe_offset = (i) - (S32(2))])) + ((dsp.const194) * (rec59[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec59_perm, vload(rec59_tmp, vsize))
            vstore(dsp.rec59_perm, vload[H](rec59_tmp, vsize + hsize), hsize)
            vstore(zec43, (F64Vec(dsp.const192)) * ((((F64Vec(dsp.const195)) * (vload(rec59))) + ((F64Vec(dsp.const196)) * (vload(rec59, - S32(1))))) + ((F64Vec(dsp.const195)) * (vload(rec59, - S32(2))))))
            vstore(zec43, (F64Vec(dsp.const192)) * ((((F64Vec(dsp.const195)) * (vload(rec59, hsize))) + ((F64Vec(dsp.const196)) * (vload(rec59, - S32(1) + hsize)))) + ((F64Vec(dsp.const195)) * (vload(rec59, - S32(2) + hsize)))), hsize)
            vstore(rec58_tmp, vload(dsp.rec58_perm))
            vstore(rec58_tmp, vload(dsp.rec58_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec58[unsafe_offset = i] = (zec43[i]) - ((dsp.const199) * (((dsp.const200) * (rec58[unsafe_offset = (i) - (S32(2))])) + ((dsp.const203) * (rec58[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec57_tmp, vload(dsp.rec57_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec57[unsafe_offset = i] = ((dsp.const199) * ((((dsp.const205) * (rec58[unsafe_offset = i])) + ((dsp.const206) * (rec58[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const205) * (rec58[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const207) * (((dsp.const208) * (rec57[unsafe_offset = (i) - (S32(2))])) + ((dsp.const209) * (rec57[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec56_tmp, vload(dsp.rec56_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec56[unsafe_offset = i] = ((dsp.const207) * ((((dsp.const211) * (rec57[unsafe_offset = i])) + ((dsp.const212) * (rec57[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const211) * (rec57[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const213) * (((dsp.const214) * (rec56[unsafe_offset = (i) - (S32(2))])) + ((dsp.const215) * (rec56[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec55_tmp, vload(dsp.rec55_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec55[unsafe_offset = i] = ((slow34) * (rec55[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const213) * ((((dsp.const217) * (rec56[unsafe_offset = i])) + ((dsp.const218) * (rec56[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const217) * (rec56[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec68_tmp, vload(dsp.rec68_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec68[unsafe_offset = i] = (zec43[i]) - ((dsp.const219) * (((dsp.const220) * (rec68[unsafe_offset = (i) - (S32(2))])) + ((dsp.const221) * (rec68[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec67_tmp, vload(dsp.rec67_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec67[unsafe_offset = i] = ((dsp.const219) * ((((dsp.const223) * (rec68[unsafe_offset = i])) + ((dsp.const224) * (rec68[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const223) * (rec68[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const225) * (((dsp.const226) * (rec67[unsafe_offset = (i) - (S32(2))])) + ((dsp.const227) * (rec67[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec66_tmp, vload(dsp.rec66_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec66[unsafe_offset = i] = ((dsp.const225) * ((((dsp.const228) * (rec67[unsafe_offset = i])) + ((dsp.const229) * (rec67[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const228) * (rec67[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const230) * (((dsp.const231) * (rec66[unsafe_offset = (i) - (S32(2))])) + ((dsp.const232) * (rec66[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec66_perm, vload(rec66_tmp, vsize))
            vstore(dsp.rec66_perm, vload[H](rec66_tmp, vsize + hsize), hsize)
            vstore(zec44, (F64Vec(dsp.const230)) * ((((F64Vec(dsp.const233)) * (vload(rec66))) + ((F64Vec(dsp.const234)) * (vload(rec66, - S32(1))))) + ((F64Vec(dsp.const233)) * (vload(rec66, - S32(2))))))
            vstore(zec44, (F64Vec(dsp.const230)) * ((((F64Vec(dsp.const233)) * (vload(rec66, hsize))) + ((F64Vec(dsp.const234)) * (vload(rec66, - S32(1) + hsize)))) + ((F64Vec(dsp.const233)) * (vload(rec66, - S32(2) + hsize)))), hsize)
            vstore(rec65_tmp, vload(dsp.rec65_perm))
            vstore(rec65_tmp, vload(dsp.rec65_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec65[unsafe_offset = i] = (zec44[i]) - ((dsp.const237) * (((dsp.const238) * (rec65[unsafe_offset = (i) - (S32(2))])) + ((dsp.const241) * (rec65[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec64_tmp, vload(dsp.rec64_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec64[unsafe_offset = i] = ((dsp.const237) * ((((dsp.const243) * (rec65[unsafe_offset = i])) + ((dsp.const244) * (rec65[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const243) * (rec65[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const245) * (((dsp.const246) * (rec64[unsafe_offset = (i) - (S32(2))])) + ((dsp.const247) * (rec64[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec63_tmp, vload(dsp.rec63_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec63[unsafe_offset = i] = ((dsp.const245) * ((((dsp.const249) * (rec64[unsafe_offset = i])) + ((dsp.const250) * (rec64[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const249) * (rec64[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const251) * (((dsp.const252) * (rec63[unsafe_offset = (i) - (S32(2))])) + ((dsp.const253) * (rec63[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec62_tmp, vload(dsp.rec62_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec62[unsafe_offset = i] = ((slow34) * (rec62[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const251) * ((((dsp.const255) * (rec63[unsafe_offset = i])) + ((dsp.const256) * (rec63[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const255) * (rec63[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec75_tmp, vload(dsp.rec75_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec75[unsafe_offset = i] = (zec44[i]) - ((dsp.const257) * (((dsp.const258) * (rec75[unsafe_offset = (i) - (S32(2))])) + ((dsp.const259) * (rec75[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec74_tmp, vload(dsp.rec74_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec74[unsafe_offset = i] = ((dsp.const257) * ((((dsp.const261) * (rec75[unsafe_offset = i])) + ((dsp.const262) * (rec75[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const261) * (rec75[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const263) * (((dsp.const264) * (rec74[unsafe_offset = (i) - (S32(2))])) + ((dsp.const265) * (rec74[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec73_tmp, vload(dsp.rec73_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec73[unsafe_offset = i] = ((dsp.const263) * ((((dsp.const266) * (rec74[unsafe_offset = i])) + ((dsp.const267) * (rec74[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const266) * (rec74[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const268) * (((dsp.const269) * (rec73[unsafe_offset = (i) - (S32(2))])) + ((dsp.const270) * (rec73[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec73_perm, vload(rec73_tmp, vsize))
            vstore(dsp.rec73_perm, vload[H](rec73_tmp, vsize + hsize), hsize)
            vstore(zec45, (F64Vec(dsp.const268)) * ((((F64Vec(dsp.const271)) * (vload(rec73))) + ((F64Vec(dsp.const272)) * (vload(rec73, - S32(1))))) + ((F64Vec(dsp.const271)) * (vload(rec73, - S32(2))))))
            vstore(zec45, (F64Vec(dsp.const268)) * ((((F64Vec(dsp.const271)) * (vload(rec73, hsize))) + ((F64Vec(dsp.const272)) * (vload(rec73, - S32(1) + hsize)))) + ((F64Vec(dsp.const271)) * (vload(rec73, - S32(2) + hsize)))), hsize)
            vstore(rec72_tmp, vload(dsp.rec72_perm))
            vstore(rec72_tmp, vload(dsp.rec72_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec72[unsafe_offset = i] = (zec45[i]) - ((dsp.const275) * (((dsp.const276) * (rec72[unsafe_offset = (i) - (S32(2))])) + ((dsp.const279) * (rec72[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec71_tmp, vload(dsp.rec71_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec71[unsafe_offset = i] = ((dsp.const275) * ((((dsp.const281) * (rec72[unsafe_offset = i])) + ((dsp.const282) * (rec72[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const281) * (rec72[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const283) * (((dsp.const284) * (rec71[unsafe_offset = (i) - (S32(2))])) + ((dsp.const285) * (rec71[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec70_tmp, vload(dsp.rec70_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec70[unsafe_offset = i] = ((dsp.const283) * ((((dsp.const287) * (rec71[unsafe_offset = i])) + ((dsp.const288) * (rec71[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const287) * (rec71[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const289) * (((dsp.const290) * (rec70[unsafe_offset = (i) - (S32(2))])) + ((dsp.const291) * (rec70[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec69_tmp, vload(dsp.rec69_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec69[unsafe_offset = i] = ((slow34) * (rec69[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const289) * ((((dsp.const293) * (rec70[unsafe_offset = i])) + ((dsp.const294) * (rec70[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const293) * (rec70[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec82_tmp, vload(dsp.rec82_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec82[unsafe_offset = i] = (zec45[i]) - ((dsp.const295) * (((dsp.const296) * (rec82[unsafe_offset = (i) - (S32(2))])) + ((dsp.const297) * (rec82[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec81_tmp, vload(dsp.rec81_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec81[unsafe_offset = i] = ((dsp.const295) * ((((dsp.const299) * (rec82[unsafe_offset = i])) + ((dsp.const300) * (rec82[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const299) * (rec82[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const301) * (((dsp.const302) * (rec81[unsafe_offset = (i) - (S32(2))])) + ((dsp.const303) * (rec81[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec80_tmp, vload(dsp.rec80_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec80[unsafe_offset = i] = ((dsp.const301) * ((((dsp.const304) * (rec81[unsafe_offset = i])) + ((dsp.const305) * (rec81[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const304) * (rec81[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const306) * (((dsp.const307) * (rec80[unsafe_offset = (i) - (S32(2))])) + ((dsp.const308) * (rec80[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec80_perm, vload(rec80_tmp, vsize))
            vstore(dsp.rec80_perm, vload[H](rec80_tmp, vsize + hsize), hsize)
            vstore(zec46, (F64Vec(dsp.const306)) * ((((F64Vec(dsp.const309)) * (vload(rec80))) + ((F64Vec(dsp.const310)) * (vload(rec80, - S32(1))))) + ((F64Vec(dsp.const309)) * (vload(rec80, - S32(2))))))
            vstore(zec46, (F64Vec(dsp.const306)) * ((((F64Vec(dsp.const309)) * (vload(rec80, hsize))) + ((F64Vec(dsp.const310)) * (vload(rec80, - S32(1) + hsize)))) + ((F64Vec(dsp.const309)) * (vload(rec80, - S32(2) + hsize)))), hsize)
            vstore(rec79_tmp, vload(dsp.rec79_perm))
            vstore(rec79_tmp, vload(dsp.rec79_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec79[unsafe_offset = i] = (zec46[i]) - ((dsp.const313) * (((dsp.const314) * (rec79[unsafe_offset = (i) - (S32(2))])) + ((dsp.const317) * (rec79[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec78_tmp, vload(dsp.rec78_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec78[unsafe_offset = i] = ((dsp.const313) * ((((dsp.const319) * (rec79[unsafe_offset = i])) + ((dsp.const320) * (rec79[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const319) * (rec79[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const321) * (((dsp.const322) * (rec78[unsafe_offset = (i) - (S32(2))])) + ((dsp.const323) * (rec78[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec77_tmp, vload(dsp.rec77_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec77[unsafe_offset = i] = ((dsp.const321) * ((((dsp.const325) * (rec78[unsafe_offset = i])) + ((dsp.const326) * (rec78[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const325) * (rec78[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const327) * (((dsp.const328) * (rec77[unsafe_offset = (i) - (S32(2))])) + ((dsp.const329) * (rec77[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec76_tmp, vload(dsp.rec76_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec76[unsafe_offset = i] = ((slow34) * (rec76[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const327) * ((((dsp.const331) * (rec77[unsafe_offset = i])) + ((dsp.const332) * (rec77[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const331) * (rec77[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec89_tmp, vload(dsp.rec89_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec89[unsafe_offset = i] = (zec46[i]) - ((dsp.const333) * (((dsp.const334) * (rec89[unsafe_offset = (i) - (S32(2))])) + ((dsp.const335) * (rec89[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec88_tmp, vload(dsp.rec88_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec88[unsafe_offset = i] = ((dsp.const333) * ((((dsp.const337) * (rec89[unsafe_offset = i])) + ((dsp.const338) * (rec89[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const337) * (rec89[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const339) * (((dsp.const340) * (rec88[unsafe_offset = (i) - (S32(2))])) + ((dsp.const341) * (rec88[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec87_tmp, vload(dsp.rec87_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec87[unsafe_offset = i] = ((dsp.const339) * ((((dsp.const342) * (rec88[unsafe_offset = i])) + ((dsp.const343) * (rec88[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const342) * (rec88[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const344) * (((dsp.const345) * (rec87[unsafe_offset = (i) - (S32(2))])) + ((dsp.const346) * (rec87[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec87_perm, vload(rec87_tmp, vsize))
            vstore(dsp.rec87_perm, vload[H](rec87_tmp, vsize + hsize), hsize)
            vstore(zec47, (F64Vec(dsp.const344)) * ((((F64Vec(dsp.const347)) * (vload(rec87))) + ((F64Vec(dsp.const348)) * (vload(rec87, - S32(1))))) + ((F64Vec(dsp.const347)) * (vload(rec87, - S32(2))))))
            vstore(zec47, (F64Vec(dsp.const344)) * ((((F64Vec(dsp.const347)) * (vload(rec87, hsize))) + ((F64Vec(dsp.const348)) * (vload(rec87, - S32(1) + hsize)))) + ((F64Vec(dsp.const347)) * (vload(rec87, - S32(2) + hsize)))), hsize)
            vstore(rec86_tmp, vload(dsp.rec86_perm))
            vstore(rec86_tmp, vload(dsp.rec86_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec86[unsafe_offset = i] = (zec47[i]) - ((dsp.const351) * (((dsp.const352) * (rec86[unsafe_offset = (i) - (S32(2))])) + ((dsp.const355) * (rec86[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec85_tmp, vload(dsp.rec85_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec85[unsafe_offset = i] = ((dsp.const351) * ((((dsp.const357) * (rec86[unsafe_offset = i])) + ((dsp.const358) * (rec86[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const357) * (rec86[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const359) * (((dsp.const360) * (rec85[unsafe_offset = (i) - (S32(2))])) + ((dsp.const361) * (rec85[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec84_tmp, vload(dsp.rec84_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec84[unsafe_offset = i] = ((dsp.const359) * ((((dsp.const363) * (rec85[unsafe_offset = i])) + ((dsp.const364) * (rec85[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const363) * (rec85[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const365) * (((dsp.const366) * (rec84[unsafe_offset = (i) - (S32(2))])) + ((dsp.const367) * (rec84[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec83_tmp, vload(dsp.rec83_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec83[unsafe_offset = i] = ((slow34) * (rec83[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const365) * ((((dsp.const369) * (rec84[unsafe_offset = i])) + ((dsp.const370) * (rec84[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const369) * (rec84[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec96_tmp, vload(dsp.rec96_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec96[unsafe_offset = i] = (zec47[i]) - ((dsp.const371) * (((dsp.const372) * (rec96[unsafe_offset = (i) - (S32(2))])) + ((dsp.const373) * (rec96[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec95_tmp, vload(dsp.rec95_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec95[unsafe_offset = i] = ((dsp.const371) * ((((dsp.const375) * (rec96[unsafe_offset = i])) + ((dsp.const376) * (rec96[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const375) * (rec96[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const377) * (((dsp.const378) * (rec95[unsafe_offset = (i) - (S32(2))])) + ((dsp.const379) * (rec95[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec94_tmp, vload(dsp.rec94_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec94[unsafe_offset = i] = ((dsp.const377) * ((((dsp.const380) * (rec95[unsafe_offset = i])) + ((dsp.const381) * (rec95[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const380) * (rec95[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const382) * (((dsp.const383) * (rec94[unsafe_offset = (i) - (S32(2))])) + ((dsp.const384) * (rec94[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec94_perm, vload(rec94_tmp, vsize))
            vstore(dsp.rec94_perm, vload[H](rec94_tmp, vsize + hsize), hsize)
            vstore(zec48, (F64Vec(dsp.const382)) * ((((F64Vec(dsp.const385)) * (vload(rec94))) + ((F64Vec(dsp.const386)) * (vload(rec94, - S32(1))))) + ((F64Vec(dsp.const385)) * (vload(rec94, - S32(2))))))
            vstore(zec48, (F64Vec(dsp.const382)) * ((((F64Vec(dsp.const385)) * (vload(rec94, hsize))) + ((F64Vec(dsp.const386)) * (vload(rec94, - S32(1) + hsize)))) + ((F64Vec(dsp.const385)) * (vload(rec94, - S32(2) + hsize)))), hsize)
            vstore(rec93_tmp, vload(dsp.rec93_perm))
            vstore(rec93_tmp, vload(dsp.rec93_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec93[unsafe_offset = i] = (zec48[i]) - ((dsp.const389) * (((dsp.const390) * (rec93[unsafe_offset = (i) - (S32(2))])) + ((dsp.const393) * (rec93[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec92_tmp, vload(dsp.rec92_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec92[unsafe_offset = i] = ((dsp.const389) * ((((dsp.const395) * (rec93[unsafe_offset = i])) + ((dsp.const396) * (rec93[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const395) * (rec93[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const397) * (((dsp.const398) * (rec92[unsafe_offset = (i) - (S32(2))])) + ((dsp.const399) * (rec92[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec91_tmp, vload(dsp.rec91_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec91[unsafe_offset = i] = ((dsp.const397) * ((((dsp.const401) * (rec92[unsafe_offset = i])) + ((dsp.const402) * (rec92[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const401) * (rec92[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const403) * (((dsp.const404) * (rec91[unsafe_offset = (i) - (S32(2))])) + ((dsp.const405) * (rec91[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec90_tmp, vload(dsp.rec90_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec90[unsafe_offset = i] = ((slow34) * (rec90[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const403) * ((((dsp.const407) * (rec91[unsafe_offset = i])) + ((dsp.const408) * (rec91[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const407) * (rec91[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec103_tmp, vload(dsp.rec103_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec103[unsafe_offset = i] = (zec48[i]) - ((dsp.const409) * (((dsp.const410) * (rec103[unsafe_offset = (i) - (S32(2))])) + ((dsp.const411) * (rec103[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec102_tmp, vload(dsp.rec102_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec102[unsafe_offset = i] = ((dsp.const409) * ((((dsp.const413) * (rec103[unsafe_offset = i])) + ((dsp.const414) * (rec103[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const413) * (rec103[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const415) * (((dsp.const416) * (rec102[unsafe_offset = (i) - (S32(2))])) + ((dsp.const417) * (rec102[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec101_tmp, vload(dsp.rec101_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec101[unsafe_offset = i] = ((dsp.const415) * ((((dsp.const418) * (rec102[unsafe_offset = i])) + ((dsp.const419) * (rec102[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const418) * (rec102[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const420) * (((dsp.const421) * (rec101[unsafe_offset = (i) - (S32(2))])) + ((dsp.const422) * (rec101[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec101_perm, vload(rec101_tmp, vsize))
            vstore(dsp.rec101_perm, vload[H](rec101_tmp, vsize + hsize), hsize)
            vstore(zec49, (F64Vec(dsp.const420)) * ((((F64Vec(dsp.const423)) * (vload(rec101))) + ((F64Vec(dsp.const424)) * (vload(rec101, - S32(1))))) + ((F64Vec(dsp.const423)) * (vload(rec101, - S32(2))))))
            vstore(zec49, (F64Vec(dsp.const420)) * ((((F64Vec(dsp.const423)) * (vload(rec101, hsize))) + ((F64Vec(dsp.const424)) * (vload(rec101, - S32(1) + hsize)))) + ((F64Vec(dsp.const423)) * (vload(rec101, - S32(2) + hsize)))), hsize)
            vstore(rec100_tmp, vload(dsp.rec100_perm))
            vstore(rec100_tmp, vload(dsp.rec100_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec100[unsafe_offset = i] = (zec49[i]) - ((dsp.const427) * (((dsp.const428) * (rec100[unsafe_offset = (i) - (S32(2))])) + ((dsp.const431) * (rec100[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec99_tmp, vload(dsp.rec99_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec99[unsafe_offset = i] = ((dsp.const427) * ((((dsp.const433) * (rec100[unsafe_offset = i])) + ((dsp.const434) * (rec100[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const433) * (rec100[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const435) * (((dsp.const436) * (rec99[unsafe_offset = (i) - (S32(2))])) + ((dsp.const437) * (rec99[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec98_tmp, vload(dsp.rec98_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec98[unsafe_offset = i] = ((dsp.const435) * ((((dsp.const439) * (rec99[unsafe_offset = i])) + ((dsp.const440) * (rec99[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const439) * (rec99[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const441) * (((dsp.const442) * (rec98[unsafe_offset = (i) - (S32(2))])) + ((dsp.const443) * (rec98[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec97_tmp, vload(dsp.rec97_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec97[unsafe_offset = i] = ((slow34) * (rec97[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const441) * ((((dsp.const445) * (rec98[unsafe_offset = i])) + ((dsp.const446) * (rec98[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const445) * (rec98[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec110_tmp, vload(dsp.rec110_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec110[unsafe_offset = i] = (zec49[i]) - ((dsp.const447) * (((dsp.const448) * (rec110[unsafe_offset = (i) - (S32(2))])) + ((dsp.const449) * (rec110[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec109_tmp, vload(dsp.rec109_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec109[unsafe_offset = i] = ((dsp.const447) * ((((dsp.const451) * (rec110[unsafe_offset = i])) + ((dsp.const452) * (rec110[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const451) * (rec110[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const453) * (((dsp.const454) * (rec109[unsafe_offset = (i) - (S32(2))])) + ((dsp.const455) * (rec109[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec108_tmp, vload(dsp.rec108_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec108[unsafe_offset = i] = ((dsp.const453) * ((((dsp.const456) * (rec109[unsafe_offset = i])) + ((dsp.const457) * (rec109[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const456) * (rec109[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const458) * (((dsp.const459) * (rec108[unsafe_offset = (i) - (S32(2))])) + ((dsp.const460) * (rec108[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec108_perm, vload(rec108_tmp, vsize))
            vstore(dsp.rec108_perm, vload[H](rec108_tmp, vsize + hsize), hsize)
            vstore(zec50, (F64Vec(dsp.const458)) * ((((F64Vec(dsp.const461)) * (vload(rec108))) + ((F64Vec(dsp.const462)) * (vload(rec108, - S32(1))))) + ((F64Vec(dsp.const461)) * (vload(rec108, - S32(2))))))
            vstore(zec50, (F64Vec(dsp.const458)) * ((((F64Vec(dsp.const461)) * (vload(rec108, hsize))) + ((F64Vec(dsp.const462)) * (vload(rec108, - S32(1) + hsize)))) + ((F64Vec(dsp.const461)) * (vload(rec108, - S32(2) + hsize)))), hsize)
            vstore(rec107_tmp, vload(dsp.rec107_perm))
            vstore(rec107_tmp, vload(dsp.rec107_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec107[unsafe_offset = i] = (zec50[i]) - ((dsp.const465) * (((dsp.const466) * (rec107[unsafe_offset = (i) - (S32(2))])) + ((dsp.const469) * (rec107[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec106_tmp, vload(dsp.rec106_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec106[unsafe_offset = i] = ((dsp.const465) * ((((dsp.const471) * (rec107[unsafe_offset = i])) + ((dsp.const472) * (rec107[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const471) * (rec107[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const473) * (((dsp.const474) * (rec106[unsafe_offset = (i) - (S32(2))])) + ((dsp.const475) * (rec106[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec105_tmp, vload(dsp.rec105_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec105[unsafe_offset = i] = ((dsp.const473) * ((((dsp.const477) * (rec106[unsafe_offset = i])) + ((dsp.const478) * (rec106[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const477) * (rec106[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const479) * (((dsp.const480) * (rec105[unsafe_offset = (i) - (S32(2))])) + ((dsp.const481) * (rec105[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec104_tmp, vload(dsp.rec104_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec104[unsafe_offset = i] = ((slow34) * (rec104[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const479) * ((((dsp.const483) * (rec105[unsafe_offset = i])) + ((dsp.const484) * (rec105[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const483) * (rec105[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec117_tmp, vload(dsp.rec117_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec117[unsafe_offset = i] = (zec50[i]) - ((dsp.const485) * (((dsp.const486) * (rec117[unsafe_offset = (i) - (S32(2))])) + ((dsp.const487) * (rec117[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec116_tmp, vload(dsp.rec116_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec116[unsafe_offset = i] = ((dsp.const485) * ((((dsp.const489) * (rec117[unsafe_offset = i])) + ((dsp.const490) * (rec117[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const489) * (rec117[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const491) * (((dsp.const492) * (rec116[unsafe_offset = (i) - (S32(2))])) + ((dsp.const493) * (rec116[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec115_tmp, vload(dsp.rec115_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec115[unsafe_offset = i] = ((dsp.const491) * ((((dsp.const494) * (rec116[unsafe_offset = i])) + ((dsp.const495) * (rec116[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const494) * (rec116[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const496) * (((dsp.const497) * (rec115[unsafe_offset = (i) - (S32(2))])) + ((dsp.const498) * (rec115[unsafe_offset = (i) - (S32(1))]))))
            vstore(dsp.rec115_perm, vload(rec115_tmp, vsize))
            vstore(dsp.rec115_perm, vload[H](rec115_tmp, vsize + hsize), hsize)
            vstore(zec51, (F64Vec(dsp.const496)) * ((((F64Vec(dsp.const499)) * (vload(rec115))) + ((F64Vec(dsp.const500)) * (vload(rec115, - S32(1))))) + ((F64Vec(dsp.const499)) * (vload(rec115, - S32(2))))))
            vstore(zec51, (F64Vec(dsp.const496)) * ((((F64Vec(dsp.const499)) * (vload(rec115, hsize))) + ((F64Vec(dsp.const500)) * (vload(rec115, - S32(1) + hsize)))) + ((F64Vec(dsp.const499)) * (vload(rec115, - S32(2) + hsize)))), hsize)
            vstore(rec114_tmp, vload(dsp.rec114_perm))
            vstore(rec114_tmp, vload(dsp.rec114_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec114[unsafe_offset = i] = (zec51[i]) - ((dsp.const503) * (((dsp.const504) * (rec114[unsafe_offset = (i) - (S32(2))])) + ((dsp.const507) * (rec114[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec113_tmp, vload(dsp.rec113_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec113[unsafe_offset = i] = ((dsp.const503) * ((((dsp.const509) * (rec114[unsafe_offset = i])) + ((dsp.const510) * (rec114[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const509) * (rec114[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const511) * (((dsp.const512) * (rec113[unsafe_offset = (i) - (S32(2))])) + ((dsp.const513) * (rec113[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec112_tmp, vload(dsp.rec112_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec112[unsafe_offset = i] = ((dsp.const511) * ((((dsp.const515) * (rec113[unsafe_offset = i])) + ((dsp.const516) * (rec113[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const515) * (rec113[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const517) * (((dsp.const518) * (rec112[unsafe_offset = (i) - (S32(2))])) + ((dsp.const519) * (rec112[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec111_tmp, vload(dsp.rec111_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec111[unsafe_offset = i] = ((slow34) * (rec111[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const517) * ((((dsp.const521) * (rec112[unsafe_offset = i])) + ((dsp.const522) * (rec112[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const521) * (rec112[unsafe_offset = (i) - (S32(2))]))))))
            ...
            vstore(rec121_tmp, vload(dsp.rec121_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec121[unsafe_offset = i] = (zec51[i]) - ((dsp.const523) * (((dsp.const524) * (rec121[unsafe_offset = (i) - (S32(2))])) + ((dsp.const525) * (rec121[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec120_tmp, vload(dsp.rec120_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec120[unsafe_offset = i] = ((dsp.const523) * ((((dsp.const527) * (rec121[unsafe_offset = i])) + ((dsp.const528) * (rec121[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const527) * (rec121[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const529) * (((dsp.const530) * (rec120[unsafe_offset = (i) - (S32(2))])) + ((dsp.const531) * (rec120[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec119_tmp, vload(dsp.rec119_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec119[unsafe_offset = i] = ((dsp.const529) * ((((dsp.const532) * (rec120[unsafe_offset = i])) + ((dsp.const533) * (rec120[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const532) * (rec120[unsafe_offset = (i) - (S32(2))])))) - ((dsp.const534) * (((dsp.const535) * (rec119[unsafe_offset = (i) - (S32(2))])) + ((dsp.const536) * (rec119[unsafe_offset = (i) - (S32(1))]))))
            ...
            vstore(rec118_tmp, vload(dsp.rec118_perm, hsize), hsize)
            comptime for i in range(vsize):
                rec118[unsafe_offset = i] = ((slow34) * (rec118[unsafe_offset = (i) - (S32(1))])) + ((slow35) * (abs((dsp.const534) * ((((dsp.const537) * (rec119[unsafe_offset = i])) + ((dsp.const538) * (rec119[unsafe_offset = (i) - (S32(1))]))) + ((dsp.const537) * (rec119[unsafe_offset = (i) - (S32(2))]))))))
            ...
            comptime for i in range(S32(0), vsize):
                dsp.vbargraph0 = FaustFloat((slow36) + ((2e+01) * (log10(rec23[unsafe_offset = i]))))
                dsp.vbargraph1 = FaustFloat((slow36) + ((2e+01) * (log10(rec27[unsafe_offset = i]))))
                dsp.vbargraph2 = FaustFloat((slow36) + ((2e+01) * (log10(rec34[unsafe_offset = i]))))
                dsp.vbargraph3 = FaustFloat((slow36) + ((2e+01) * (log10(rec41[unsafe_offset = i]))))
                dsp.vbargraph4 = FaustFloat((slow36) + ((2e+01) * (log10(rec48[unsafe_offset = i]))))
                dsp.vbargraph5 = FaustFloat((slow36) + ((2e+01) * (log10(rec55[unsafe_offset = i]))))
                dsp.vbargraph6 = FaustFloat((slow36) + ((2e+01) * (log10(rec62[unsafe_offset = i]))))
                dsp.vbargraph7 = FaustFloat((slow36) + ((2e+01) * (log10(rec69[unsafe_offset = i]))))
                dsp.vbargraph8 = FaustFloat((slow36) + ((2e+01) * (log10(rec76[unsafe_offset = i]))))
                dsp.vbargraph9 = FaustFloat((slow36) + ((2e+01) * (log10(rec83[unsafe_offset = i]))))
                dsp.vbargraph10 = FaustFloat((slow36) + ((2e+01) * (log10(rec90[unsafe_offset = i]))))
                dsp.vbargraph11 = FaustFloat((slow36) + ((2e+01) * (log10(rec97[unsafe_offset = i]))))
                dsp.vbargraph12 = FaustFloat((slow36) + ((2e+01) * (log10(rec104[unsafe_offset = i]))))
                dsp.vbargraph13 = FaustFloat((slow36) + ((2e+01) * (log10(rec111[unsafe_offset = i]))))
                dsp.vbargraph14 = FaustFloat((slow36) + ((2e+01) * (log10(rec118[unsafe_offset = i]))))
            vstore(zec52, vload(zec38))
            vstore(zec52, vload(zec38, hsize), hsize)
            vstore(output0, ((vload[H](zec52)).cast[dfaust]()).join((vload[H](zec52, hsize)).cast[dfaust]()))
            vstore(output1, ((vload[H](zec52)).cast[dfaust]()).join((vload[H](zec52, hsize)).cast[dfaust]()))
            vindex += vsize
