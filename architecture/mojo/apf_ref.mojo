...
struct mydsp(FaustDsp):
    ...
    def get_json(read dsp) -> String:
        return "{\"name\": \"apf\",\"filename\": \"apf.dsp\",\"version\": \"2.85.5\",\"compile_options\": \"-a /Users/manuelfarzini/Personal/dev/repo/faust/architecture/mojo/impulse.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\",\"library_list\": [\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp/maxmsp.lib\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp/music.lib\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp/math.lib\"],\"include_pathnames\": [\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp\",\"/Users/manuelfarzini/Personal/dev/repo/faust/build/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp\"],\"size\": 60,\"inputs\": 1,\"outputs\": 1,\"meta\": [ { \"compile_options\": \"-a /Users/manuelfarzini/Personal/dev/repo/faust/architecture/mojo/impulse.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\" },{ \"filename\": \"apf.dsp\" },{ \"math.lib/author\": \"GRAME\" },{ \"math.lib/copyright\": \"GRAME\" },{ \"math.lib/deprecated\": \"This library is deprecated and is not maintained anymore. It will be removed in August 2017.\" },{ \"math.lib/license\": \"LGPL with exception\" },{ \"math.lib/name\": \"Math Library\" },{ \"math.lib/version\": \"1.0\" },{ \"maxmsp.lib/author\": \"GRAME\" },{ \"maxmsp.lib/copyright\": \"GRAME\" },{ \"maxmsp.lib/license\": \"LGPL\" },{ \"maxmsp.lib/name\": \"MaxMSP compatibility Library\" },{ \"maxmsp.lib/version\": \"1.1\" },{ \"music.lib/author\": \"GRAME\" },{ \"music.lib/copyright\": \"GRAME\" },{ \"music.lib/license\": \"LGPL with exception\" },{ \"music.lib/name\": \"Music Library\" },{ \"music.lib/version\": \"1.0\" },{ \"name\": \"apf\" }],\"ui\": [ {\"type\": \"vgroup\",\"label\": \"apf\",\"items\": [ {\"type\": \"hslider\",\"label\": \"Freq\",\"varname\": \"fHslider0\",\"shortname\": \"Freq\",\"address\": \"/apf/Freq\",\"init\": 1000,\"min\": 100,\"max\": 10000,\"step\": 1},{\"type\": \"hslider\",\"label\": \"Q\",\"varname\": \"fHslider1\",\"shortname\": \"Q\",\"address\": \"/apf/Q\",\"init\": 1,\"min\": 0.01,\"max\": 100,\"step\": 0.01}]}]}"
    ...
    def compute(
        ...
        while (vindex_re0) <= ((count) - (S32(4))): 
            ...
            while j0_re0 <= S32(4) - w64:
                ...
                simd_store[w64](rec0_tmp, j0_re0, values0)
                j0_re0 = j0_re0 + w64
            var i_re0 = S32(0)
            ...
            while j1_re0 <= S32(4) - w64:
                var values1 = simd_load(rec0_tmp, vsize_re0 + )
                simd_store[w64](dsp.rec0_perm, j1_re0, values1)
                j1_re0 = j1_re0 + w64
            var i_re1 = S32(0)
            while i_re1 <= vsize_re0 - w64:
                var lo = ((simd_load(rec0, i_re1 - )) + ((slow2) * (((slow3) * (simd_load(rec0, i_re1))) - (simd_load(zec0, i_re1))))).cast[dfaust]()
                var hi = ((simd_load(rec0, i_re1 + S32(wreal) - )) + ((slow2) * (((slow3) * (simd_load(rec0, i_re1 + S32(wreal)))) - (simd_load(zec0, i_re1 + S32(wreal)))))).cast[dfaust]()
                var values2  = lo.join(hi)
                simd_store[w64](output0, i_re1, values2)
                i_re1 = i_re1 + w64
