...
struct mydsp(FaustDsp):
    ...
    def get_json(read dsp) -> String:
        return "{\"name\": \"bargraph\",\"filename\": \"bargraph.dsp\",\"version\": \"2.85.5\",\"compile_options\": \"-a impulse.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\",\"include_pathnames\": [\"/Users/manuelfarzini/Personal/dev/repo/faust/build/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp\",\"/Users/manuelfarzini/Personal/dev/repo/faust/tests/impulse-tests/dsp\"],\"size\": 84,\"inputs\": 0,\"outputs\": 10,\"meta\": [ { \"compile_options\": \"-a impulse.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0 -vec -lv 0 -vs 4 -dfs\" },{ \"filename\": \"bargraph.dsp\" },{ \"name\": \"bargraph\" }],\"ui\": [ {\"type\": \"vgroup\",\"label\": \"bargraph\",\"items\": [ {\"type\": \"vbargraph\",\"label\": \"bar0\",\"varname\": \"fVbargraph5\",\"shortname\": \"bar0\",\"address\": \"/bargraph/bar0\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"bar1\",\"varname\": \"fVbargraph6\",\"shortname\": \"bar1\",\"address\": \"/bargraph/bar1\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"bar2\",\"varname\": \"fVbargraph7\",\"shortname\": \"bar2\",\"address\": \"/bargraph/bar2\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"bar3\",\"varname\": \"fVbargraph8\",\"shortname\": \"bar3\",\"address\": \"/bargraph/bar3\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"bar4\",\"varname\": \"fVbargraph9\",\"shortname\": \"bar4\",\"address\": \"/bargraph/bar4\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"foo0\",\"varname\": \"fVbargraph0\",\"shortname\": \"foo0\",\"address\": \"/bargraph/foo0\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"foo1\",\"varname\": \"fVbargraph1\",\"shortname\": \"foo1\",\"address\": \"/bargraph/foo1\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"foo2\",\"varname\": \"fVbargraph2\",\"shortname\": \"foo2\",\"address\": \"/bargraph/foo2\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"foo3\",\"varname\": \"fVbargraph3\",\"shortname\": \"foo3\",\"address\": \"/bargraph/foo3\",\"min\": 0,\"max\": 10},{\"type\": \"vbargraph\",\"label\": \"foo4\",\"varname\": \"fVbargraph4\",\"shortname\": \"foo4\",\"address\": \"/bargraph/foo4\",\"min\": 0,\"max\": 10}]}]}"
    ...
    def compute(
        ...
        while (vindex_re0) <= ((count) - (S32(4))): 
            ...
            simd_store[wfaust](output0, i_re0, values0)
            # Vectorizable loop 1 
            # Compute code 
            var i_re1 = S32(0)
            var values1 = (slow1).cast[dfaust]()
            simd_store[wfaust](output1, i_re1, values1)
            # Vectorizable loop 2 
            # Compute code 
            var i_re2 = S32(0)
            ...
            simd_store[wfaust](output3, i_re3, values3)
            # Vectorizable loop 4 
            # Compute code 
            var i_re4 = S32(0)
            var values4 = (slow4).cast[dfaust]()
            simd_store[wfaust](output4, i_re4, values4)
            # Vectorizable loop 5 
            # Compute code 
            var i_re5 = S32(0)
            var values5 = (slow5).cast[dfaust]()
            simd_store[wfaust](output5, i_re5, values5)
            # Vectorizable loop 6 
            # Compute code 
            var i_re6 = S32(0)
            var values6 = (slow6).cast[dfaust]()
            simd_store[wfaust](output6, i_re6, values6)
            # Vectorizable loop 7 
            # Compute code 
            var i_re7 = S32(0)
            var values7 = (slow7).cast[dfaust]()
            simd_store[wfaust](output7, i_re7, values7)
            # Vectorizable loop 8 
            # Compute code 
            var i_re8 = S32(0)
            var values8 = (slow8).cast[dfaust]()
            simd_store[wfaust](output8, i_re8, values8)
            # Vectorizable loop 9 
            # Compute code 
            var i_re9 = S32(0)
            var values9 = (slow9).cast[dfaust]()
            simd_store[wfaust](output9, i_re9, values9)
