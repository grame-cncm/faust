...
struct mydsp(FaustDsp):
    ...
    def get_json(imm dsp) -> String:
        return "{\"name\": \"cubic_mini_01\",\"filename\": \"cubic_mini_01.dsp\",\"version\": \"2.85.5\",\"compile_options\": \"-a inspect.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0\",\"include_pathnames\": [\"/Users/manuelfarzini/Personal/dev/repo/faust/build/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"../_bench/src\",\"/Users/manuelfarzini/Personal/dev/repo/faust/architecture/mojo/../_bench/src\"],\"size\": 12,\"inputs\": 1,\"outputs\": 2,\"meta\": [ { \"compile_options\": \"-a inspect.mojo -lang mojo -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0\" },{ \"filename\": \"cubic_mini_01.dsp\" },{ \"name\": \"cubic_mini_01\" }],\"ui\": [ {\"type\": \"vgroup\",\"label\": \"cubic_mini_01\",\"items\": [ {\"type\": \"hslider\",\"label\": \"drive\",\"varname\": \"fHslider0\",\"shortname\": \"drive\",\"address\": \"/cubic_mini_01/drive\",\"init\": 0.5,\"min\": 0,\"max\": 2,\"step\": 0.01}]}]}"
