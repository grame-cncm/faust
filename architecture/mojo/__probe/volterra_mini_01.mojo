...
struct mydsp(FaustDsp):
    ...
    def metadata(read dsp, mut meta: Some[FaustMeta]) -> None:
        ...
        meta.declare("name", "volterra_mini_01")
    ...
    def build_user_interface(mut dsp, mut ui: Some[FaustGui]) -> None:
        ui.open_vertical_box("volterra_mini_01")
    ...
    def compute(
        ...
        var slow29 = pow_unrolled[3](slow3)
        for var i0 in range(S32(0), count):
            ...
            dsp.rec7[S32(0)] = (slow2) * ((dsp.rec7[S32(1)]) + ((slow1) * (((slow29) * (pow_unrolled[3](temp7))) - (temp8))))
            ...
            output0[i0] = FaustFloat((dsp.rec0[S32(0)]) - ((slow28) * (dsp.rec5[S32(0)])))
