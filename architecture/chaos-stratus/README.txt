...
* Bring up a terminal/console whose working directory
...
the c++ file has the effect's UUID declared as the "stratusId" metadata item.
...
If you just want to BUILD your effect for the pedal, but not install it, then comment out
...
else - it's far more powerful. Discover its options by running 'faust2stratus -h'.