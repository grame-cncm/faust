 ...
 *
 * @return the expanded DSP or a NULL string in case of failure (to be deleted by the caller using
 * freeCMemory).
 */
 ...
 * @param error_msg - the error string to be filled, has to be 4096 characters long
 *
 * @return the result as a string or a NULL string in case of failure (to be deleted by the caller
 * using freeCMemory).
 */
