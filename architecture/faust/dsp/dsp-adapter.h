...
template <int fVslider0, typename REAL>
struct LowPass4 : public Filter<fVslider0> {
...
template <int fVslider0, typename REAL>
struct LowPass3e : public Filter<fVslider0> {
...
template <int fVslider0, typename REAL>
struct LowPass6e : public Filter<fVslider0> {
