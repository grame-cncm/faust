...
class dsp_sample_adapter : public decorator_dsp {
   ...
   public:
    ...
    virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs)
    {
        ...
        // DSP base class uses FAUSTFLOAT** type, so reinterpret_cast has to be used even if the real DSP uses
        // SAMPLE_TYPE
        fDSP->compute(count, reinterpret_cast<FAUSTFLOAT**>(fAdaptedInputs),
                      reinterpret_cast<FAUSTFLOAT**>(fAdaptedOutputs));
    ...
    virtual void compute(double date_usec, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs)
    {
        ...
        // DSP base class uses FAUSTFLOAT** type, so reinterpret_cast has to be used even if the real DSP uses
        // SAMPLE_TYPE
        fDSP->compute(date_usec, count, reinterpret_cast<FAUSTFLOAT**>(fAdaptedInputs),
                      reinterpret_cast<FAUSTFLOAT**>(fAdaptedOutputs));
        adaptOutputsBuffers(count, outputs);
    }
};
