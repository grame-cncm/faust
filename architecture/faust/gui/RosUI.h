...
class RosUI : public UI {
   public:
    RosUI(ros::NodeHandle nh, std::string nspace)
        : nh_(nh), queue_(10), count_(0), meta_(false), box_names_(0), zones_(0)
    {
    ...
    void buttonCallback(const std_msgs::BoolConstPtr& msg, FAUSTFLOAT* zone) { *zone = msg->data; }

    void cButtonCallback(const std_msgs::BoolConstPtr& msg, FAUSTFLOAT* zone) { *zone = msg->data; }

    void sliderCallback(const std_msgs::Float32ConstPtr& msg, FAUSTFLOAT* zone) { *zone = msg->data; }

    void numEntryCallback(const std_msgs::Float32ConstPtr& msg, FAUSTFLOAT* zone) { *zone = msg->data; }
    ...
    void closeBox() { box_names_.pop_back(); }
    ...
    void addButton(const char* label, FAUSTFLOAT* zone)
    {
        ...
        *button_sub =
            nh_.subscribe<std_msgs::Bool>(my_string, queue_, boost::bind(&RosUI::buttonCallback, this, _1, zone));
    ...
    void addCheckButton(const char* label, FAUSTFLOAT* zone)
    {
        ...
        *c_button_sub =
            nh_.subscribe<std_msgs::Bool>(my_string, queue_, boost::bind(&RosUI::cButtonCallback, this, _1, zone));
                           ...
                           FAUSTFLOAT step)
    {
        ...
        *v_slider =
            nh_.subscribe<std_msgs::Float32>(my_string, queue_, boost::bind(&RosUI::sliderCallback, this, _1, zone));
                     ...
                     FAUSTFLOAT step)
    {
        ...
        *num_entry =
            nh_.subscribe<std_msgs::Float32>(my_string, queue_, boost::bind(&RosUI::numEntryCallback, this, _1, zone));
    ...
    int getParamsCount() { return count_; }
    ...
    std::vector<FAUSTFLOAT*> getZones() { return zones_; }
