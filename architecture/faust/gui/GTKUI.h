...
bool GTKUI::run()
{
    ...
    if (fWindow->allocation.width > gdk_screen_width() || fWindow->allocation.height > gdk_screen_height()) {
        ...
        gtk_widget_set_size_request(fScrolledWindow, gdk_screen_width()/2, gdk_screen_height()/2);
