...
static int audioCallback(const void* ibuf, void* obuf, unsigned long frames, const PaStreamCallbackTimeInfo*,
...
class MyApp : public wxApp {
    ...
    virtual bool OnInit()
    {
        ...
        */
        ...
        PaError err;
        if ((err = Pa_IsFormatSupported(((gDevNumInChans > 0) ? &inputParameters : 0),
