...
#include "faust/dsp/poly-dsp.h"
   ...
   public:
    ...
    void allNotesOff(bool hard = false) { static_cast<mydsp_poly*>(fDSP)->allNotesOff(hard); }
};
...
DllExport void Faust_contextInit(unitypolydsp* ctx, int sampleRate)
{
    ctx->init(sampleRate);
}
...
DllExport void Faust_delete(unitypolydsp* ctx)
{
    delete ctx;
}

DllExport int Faust_getSampleRate(unitypolydsp* ctx)
{
    return ctx->getSampleRate();
}

DllExport int Faust_getNumInputChannels(unitypolydsp* ctx)
{
    return ctx->getNumInputs();
}

DllExport int Faust_getNumOutputChannels(unitypolydsp* ctx)
{
    return ctx->getNumOutputs();
}

DllExport void Faust_setParameterValue(unitypolydsp* ctx, int param, float value)
{
    ctx->setParamValue(param, value);
}

DllExport float Faust_getParameterValue(unitypolydsp* ctx, int param)
{
    return ctx->getParamValue(param);
}

DllExport float Faust_getParamMin(unitypolydsp* ctx, int param)
{
    return ctx->getParamMin(param);
}

DllExport float Faust_getParamMax(unitypolydsp* ctx, int param)
{
...
DllExport void Faust_contextInit(unitydsp* ctx, int sampleRate)
{
    ctx->init(sampleRate);
}
...
DllExport void Faust_delete(unitydsp* ctx)
{
    delete ctx;
}

DllExport int Faust_getSampleRate(unitydsp* ctx)
{
    return ctx->getSampleRate();
}

DllExport int Faust_getNumInputChannels(unitydsp* ctx)
{
    return ctx->getNumInputs();
}

DllExport int Faust_getNumOutputChannels(unitydsp* ctx)
{
    return ctx->getNumOutputs();
}

DllExport void Faust_setParameterValue(unitydsp* ctx, int param, float value)
{
    ctx->setParamValue(param, value);
}

DllExport float Faust_getParameterValue(unitydsp* ctx, int param)
{
    return ctx->getParamValue(param);
}

DllExport float Faust_getParamMin(unitydsp* ctx, int param)
{
    return ctx->getParamMin(param);
}

DllExport float Faust_getParamMax(unitydsp* ctx, int param)
{
    return ctx->getParamMax(param);
}
}
