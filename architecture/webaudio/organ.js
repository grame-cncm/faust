...
class organPoly {
    ...
    async load()
    {
    	return new Promise((resolve, reject) => {   
            ...
            this.node = new organPolyNode(this.context, this.baseURL, {});
