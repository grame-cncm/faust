...
void metadatamydsp(MetaGlue* m) { 
	m->declare(m->metaInterface, "name", "path3");
}
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "slid1", &dsp->fHslider1, 0.0f, 0.0f, 1.0f, 0.100000001f);
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "slid1", &dsp->fHslider3, 0.0f, 0.0f, 1.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "slid2", &dsp->fHslider0, 0.0f, 0.0f, 1.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow1 = (fSlow0 * (float)dsp->fHslider1);
