...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "name", "elecGuitarEffect");
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = max(-1.0f, min(1.0f, (39.8107185f * (float)input0[i])));
			...
			dsp->fVec0[(dsp->IOTA & 32767)] = ((0.353553385f * dsp->fRec14[0]) + 9.99999968e-21f);
			float fTemp4 = max(-1.0f, min(1.0f, (39.8107185f * (float)input1[i])));
			float fTemp5 = (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp4)));
			dsp->fVec1[(dsp->IOTA & 16383)] = (fTemp4 * fTemp5);
			float fTemp6 = (0.300000012f * dsp->fVec1[((dsp->IOTA - iSlow26) & 16383)]);
			float fTemp7 = (((0.600000024f * dsp->fRec12[1]) + dsp->fVec0[((dsp->IOTA - dsp->iConst7) & 32767)]) - fTemp6);
			dsp->fVec2[(dsp->IOTA & 2047)] = fTemp7;
			dsp->fRec12[0] = dsp->fVec2[((dsp->IOTA - dsp->iConst9) & 2047)];
			...
			dsp->fVec3[(dsp->IOTA & 32767)] = ((0.353553385f * dsp->fRec18[0]) + 9.99999968e-21f);
			float fTemp8 = (((0.600000024f * dsp->fRec16[1]) + dsp->fVec3[((dsp->IOTA - dsp->iConst13) & 32767)]) - fTemp6);
			dsp->fVec4[(dsp->IOTA & 4095)] = fTemp8;
			dsp->fRec16[0] = dsp->fVec4[((dsp->IOTA - dsp->iConst14) & 4095)];
			...
			dsp->fVec5[(dsp->IOTA & 16383)] = ((0.353553385f * dsp->fRec22[0]) + 9.99999968e-21f);
			float fTemp9 = (dsp->fVec5[((dsp->IOTA - dsp->iConst18) & 16383)] + (fTemp6 + (0.600000024f * dsp->fRec20[1])));
			dsp->fVec6[(dsp->IOTA & 4095)] = fTemp9;
			dsp->fRec20[0] = dsp->fVec6[((dsp->IOTA - dsp->iConst19) & 4095)];
			...
			dsp->fVec7[(dsp->IOTA & 32767)] = ((0.353553385f * dsp->fRec26[0]) + 9.99999968e-21f);
			float fTemp10 = (fTemp6 + ((0.600000024f * dsp->fRec24[1]) + dsp->fVec7[((dsp->IOTA - dsp->iConst23) & 32767)]));
			dsp->fVec8[(dsp->IOTA & 4095)] = fTemp10;
			dsp->fRec24[0] = dsp->fVec8[((dsp->IOTA - dsp->iConst24) & 4095)];
			...
			dsp->fVec9[(dsp->IOTA & 16383)] = ((0.353553385f * dsp->fRec30[0]) + 9.99999968e-21f);
			dsp->fVec10[(dsp->IOTA & 16383)] = (fTemp1 * fTemp2);
			float fTemp11 = (0.300000012f * dsp->fVec10[((dsp->IOTA - iSlow26) & 16383)]);
			float fTemp12 = (dsp->fVec9[((dsp->IOTA - dsp->iConst28) & 16383)] - (fTemp11 + (0.600000024f * dsp->fRec28[1])));
			dsp->fVec11[(dsp->IOTA & 2047)] = fTemp12;
			...
			float fTemp13 = (dsp->fVec12[((dsp->IOTA - dsp->iConst33) & 16383)] - (fTemp11 + (0.600000024f * dsp->fRec32[1])));
			dsp->fVec13[(dsp->IOTA & 4095)] = fTemp13;
			...
			float fTemp14 = ((fTemp11 + dsp->fVec14[((dsp->IOTA - dsp->iConst38) & 16383)]) - (0.600000024f * dsp->fRec36[1]));
			dsp->fVec15[(dsp->IOTA & 4095)] = fTemp14;
			...
			float fTemp15 = ((dsp->fVec16[((dsp->IOTA - dsp->iConst43) & 16383)] + fTemp11) - (0.600000024f * dsp->fRec40[1]));
			dsp->fVec17[(dsp->IOTA & 2047)] = fTemp15;
			...
			dsp->fRec4[0] = (dsp->fRec12[1] + (dsp->fRec16[1] + (dsp->fRec20[1] + (dsp->fRec24[1] + (dsp->fRec28[1] + (dsp->fRec32[1] + (dsp->fRec36[1] + (dsp->fRec40[1] + (fRec13 + (fRec17 + (fRec21 + (fRec25 + fTemp17))))))))))));
			dsp->fRec5[0] = ((dsp->fRec28[1] + (dsp->fRec32[1] + (dsp->fRec36[1] + (dsp->fRec40[1] + fTemp17)))) - (dsp->fRec12[1] + (dsp->fRec16[1] + (dsp->fRec20[1] + (dsp->fRec24[1] + (fRec13 + (fRec17 + (fRec25 + fRec21))))))));
			float fTemp18 = (fRec33 + fRec29);
			dsp->fRec6[0] = ((dsp->fRec20[1] + (dsp->fRec24[1] + (dsp->fRec36[1] + (dsp->fRec40[1] + (fRec21 + (fRec25 + fTemp16)))))) - (dsp->fRec12[1] + (dsp->fRec16[1] + (dsp->fRec28[1] + (dsp->fRec32[1] + (fRec13 + (fRec17 + fTemp18)))))));
			dsp->fRec7[0] = ((dsp->fRec12[1] + (dsp->fRec16[1] + (dsp->fRec36[1] + (dsp->fRec40[1] + (fRec13 + (fRec17 + fTemp16)))))) - (dsp->fRec20[1] + (dsp->fRec24[1] + (dsp->fRec28[1] + (dsp->fRec32[1] + (fRec21 + (fRec25 + fTemp18)))))));
			float fTemp19 = (fRec41 + fRec33);
			float fTemp20 = (fRec37 + fRec29);
			dsp->fRec8[0] = ((dsp->fRec16[1] + (dsp->fRec24[1] + (dsp->fRec32[1] + (dsp->fRec40[1] + (fRec17 + (fRec25 + fTemp19)))))) - (dsp->fRec12[1] + (dsp->fRec20[1] + (dsp->fRec28[1] + (dsp->fRec36[1] + (fRec13 + (fRec21 + fTemp20)))))));
			dsp->fRec9[0] = ((dsp->fRec12[1] + (dsp->fRec20[1] + (dsp->fRec32[1] + (dsp->fRec40[1] + (fRec13 + (fRec21 + fTemp19)))))) - (dsp->fRec16[1] + (dsp->fRec24[1] + (dsp->fRec28[1] + (dsp->fRec36[1] + (fRec17 + (fRec25 + fTemp20)))))));
			float fTemp21 = (fRec41 + fRec29);
			float fTemp22 = (fRec37 + fRec33);
			dsp->fRec10[0] = ((dsp->fRec12[1] + (dsp->fRec24[1] + (dsp->fRec28[1] + (dsp->fRec40[1] + (fRec13 + (fRec25 + fTemp21)))))) - (dsp->fRec16[1] + (dsp->fRec20[1] + (dsp->fRec32[1] + (dsp->fRec36[1] + (fRec17 + (fRec21 + fTemp22)))))));
			dsp->fRec11[0] = ((dsp->fRec16[1] + (dsp->fRec20[1] + (dsp->fRec28[1] + (dsp->fRec40[1] + (fRec17 + (fRec21 + fTemp21)))))) - (dsp->fRec12[1] + (dsp->fRec24[1] + (dsp->fRec32[1] + (dsp->fRec36[1] + (fRec13 + (fRec25 + fTemp22)))))));
			float fTemp23 = (0.370000005f * (dsp->fRec5[0] + dsp->fRec6[0]));
			float fTemp24 = (fSlow90 * dsp->fRec3[1]);
			dsp->fRec3[0] = (fTemp23 - (fTemp24 + (fSlow9 * dsp->fRec3[2])));
			float fTemp25 = (fSlow9 * dsp->fRec3[0]);
			float fTemp26 = (0.5f * ((fTemp25 + (dsp->fRec3[2] + (fTemp23 + fTemp24))) + (fSlow7 * ((fTemp25 + (fTemp24 + dsp->fRec3[2])) - fTemp23))));
			float fTemp27 = (fSlow91 * dsp->fRec2[1]);
			dsp->fRec2[0] = (fTemp26 - (fTemp27 + (fSlow5 * dsp->fRec2[2])));
			float fTemp28 = (fSlow5 * dsp->fRec2[0]);
			output0[i] = (FAUSTFLOAT)(0.5f * (dsp->fRec0[0] * (((fTemp0 * fTemp1) * fTemp2) + (fTemp3 * ((fTemp28 + (dsp->fRec2[2] + (fTemp26 + fTemp27))) + (fSlow3 * ((fTemp28 + (fTemp27 + dsp->fRec2[2])) - fTemp26)))))));
			float fTemp29 = (0.370000005f * (dsp->fRec5[0] - dsp->fRec6[0]));
			float fTemp30 = (fSlow90 * dsp->fRec45[1]);
			dsp->fRec45[0] = (fTemp29 - (fTemp30 + (fSlow9 * dsp->fRec45[2])));
			float fTemp31 = (fSlow9 * dsp->fRec45[0]);
			float fTemp32 = (0.5f * ((fTemp31 + (dsp->fRec45[2] + (fTemp29 + fTemp30))) + (fSlow7 * ((fTemp31 + (fTemp30 + dsp->fRec45[2])) - fTemp29))));
			float fTemp33 = (fSlow91 * dsp->fRec44[1]);
			dsp->fRec44[0] = (fTemp32 - (fTemp33 + (fSlow5 * dsp->fRec44[2])));
			float fTemp34 = (fSlow5 * dsp->fRec44[0]);
			output1[i] = (FAUSTFLOAT)(0.5f * (dsp->fRec0[0] * (((fTemp0 * fTemp4) * fTemp5) + (fTemp3 * ((fTemp34 + (dsp->fRec44[2] + (fTemp32 + fTemp33))) + (fSlow3 * ((fTemp34 + (fTemp33 + dsp->fRec44[2])) - fTemp32)))))));
