...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "contributor", "Yghe");
	m->declare(m->metaInterface, "copyright", "(c)GRAME 2009");
	m->declare(m->metaInterface, "license", "BSD");
	m->declare(m->metaInterface, "name", "noiseMetadata");
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "noiseMetadata");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider0, "style", "knob");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "Volume", &dsp->fVslider0, 0.0f, 0.0f, 1.0f, 0.100000001f);
