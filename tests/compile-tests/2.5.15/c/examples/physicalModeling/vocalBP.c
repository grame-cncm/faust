...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "description", "Simple source-filter vocal synthesizer.");
	...
	m->declare(m->metaInterface, "name", "Vocal BandPass");
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "vowel", &dsp->fHslider6, 0.0f, 0.0f, 4.0f, 0.00999999978f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider1, "4", "");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "fricative", &dsp->fHslider1, 0.0f, 0.0f, 1.0f, 0.00999999978f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "5", "");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "vibratoFreq", &dsp->fHslider4, 6.0f, 1.0f, 10.0f, 0.00999999978f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "6", "");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "vibratoGain", &dsp->fHslider3, 0.5f, 0.0f, 1.0f, 0.00999999978f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow3 = (0.100000001f * (float)dsp->fHslider3);
	...
	float fSlow10 = (0.00100000005f * (float)dsp->fHslider6);
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			...
			dsp->fRec4[0] = ((fSlow5 * dsp->fRec5[1]) + (fSlow6 * dsp->fRec4[1]));
			int iTemp0 = (1 - dsp->iVec0[1]);
			dsp->fRec5[0] = (((fSlow6 * dsp->fRec5[1]) + (fSlow7 * dsp->fRec4[1])) + (float)iTemp0);
			float fTemp1 = max(1.00000001e-07f, fabsf((fSlow2 * ((fSlow3 * dsp->fRec4[0]) + 1.0f))));
			float fTemp2 = (dsp->fRec2[1] + (dsp->fConst1 * fTemp1));
			float fTemp3 = (fTemp2 + -1.0f);
			int iTemp4 = (fTemp3 < 0.0f);
			dsp->fRec2[0] = (iTemp4?fTemp2:fTemp3);
			float fRec3 = (iTemp4?fTemp2:(fTemp2 + (fTemp3 * (1.0f - (dsp->fConst0 / fTemp1)))));
			dsp->iRec6[0] = ((1103515245 * dsp->iRec6[1]) + 12345);
			float fTemp5 = (fSlow0 * (((1.0f - dsp->fRec1[0]) * ((2.0f * fRec3) + -1.0f)) + (4.65661287e-10f * (dsp->fRec1[0] * (float)dsp->iRec6[0]))));
			dsp->fRec7[0] = (fSlow10 + (0.999000013f * dsp->fRec7[1]));
			float fTemp6 = (fSlow9 + dsp->fRec7[0]);
			int iTemp7 = (fTemp6 < 23.0f);
			int iTemp8 = (fTemp6 < 24.0f);
			float fTemp9 = (fSlow9 + (dsp->fRec7[0] + -23.0f));
			int iTemp10 = (fTemp6 < 22.0f);
			float fTemp11 = (fSlow9 + (dsp->fRec7[0] + -22.0f));
			int iTemp12 = (fTemp6 < 21.0f);
			float fTemp13 = (fSlow9 + (dsp->fRec7[0] + -21.0f));
			int iTemp14 = (fTemp6 < 20.0f);
			float fTemp15 = (fSlow9 + (dsp->fRec7[0] + -20.0f));
			int iTemp16 = (fTemp6 < 19.0f);
			float fTemp17 = (fSlow9 + (dsp->fRec7[0] + -19.0f));
			int iTemp18 = (fTemp6 < 18.0f);
			float fTemp19 = (fSlow9 + (dsp->fRec7[0] + -18.0f));
			int iTemp20 = (fTemp6 < 17.0f);
			float fTemp21 = (fSlow9 + (dsp->fRec7[0] + -17.0f));
			int iTemp22 = (fTemp6 < 16.0f);
			float fTemp23 = (fSlow9 + (dsp->fRec7[0] + -16.0f));
			float fTemp24 = (80.0f * fTemp23);
			int iTemp25 = (fTemp6 < 15.0f);
			float fTemp26 = (fSlow9 + (dsp->fRec7[0] + -15.0f));
			int iTemp27 = (fTemp6 < 14.0f);
			float fTemp28 = (fSlow9 + (dsp->fRec7[0] + -14.0f));
			int iTemp29 = (fTemp6 < 13.0f);
			float fTemp30 = (fSlow9 + (dsp->fRec7[0] + -13.0f));
			int iTemp31 = (fTemp6 < 12.0f);
			float fTemp32 = (fSlow9 + (dsp->fRec7[0] + -12.0f));
			int iTemp33 = (fTemp6 < 11.0f);
			float fTemp34 = (fSlow9 + (dsp->fRec7[0] + -11.0f));
			int iTemp35 = (fTemp6 < 10.0f);
			float fTemp36 = (fSlow9 + (dsp->fRec7[0] + -10.0f));
			int iTemp37 = (fTemp6 < 9.0f);
			float fTemp38 = (fSlow9 + (dsp->fRec7[0] + -9.0f));
			int iTemp39 = (fTemp6 < 8.0f);
			float fTemp40 = (fSlow9 + (dsp->fRec7[0] + -8.0f));
			float fTemp41 = (50.0f * fTemp40);
			int iTemp42 = (fTemp6 < 7.0f);
			float fTemp43 = (fSlow9 + (dsp->fRec7[0] + -7.0f));
			int iTemp44 = (fTemp6 < 6.0f);
			float fTemp45 = (fSlow9 + (dsp->fRec7[0] + -6.0f));
			int iTemp46 = (fTemp6 < 5.0f);
			float fTemp47 = (dsp->fRec7[0] - fSlow11);
			int iTemp48 = (fTemp6 < 4.0f);
			float fTemp49 = (fSlow9 + (dsp->fRec7[0] + -4.0f));
			int iTemp50 = (fTemp6 < 3.0f);
			float fTemp51 = (fSlow9 + (dsp->fRec7[0] + -3.0f));
			int iTemp52 = (fTemp6 < 2.0f);
			float fTemp53 = (fSlow9 + (dsp->fRec7[0] + -2.0f));
			int iTemp54 = (fTemp6 < 1.0f);
			float fTemp55 = (fSlow9 + (dsp->fRec7[0] + -1.0f));
			...
			dsp->fRec8[0] = ((fSlow5 * dsp->fRec9[1]) + (fSlow6 * dsp->fRec8[1]));
			dsp->fRec9[0] = (((fSlow6 * dsp->fRec9[1]) + (fSlow7 * dsp->fRec8[1])) + (float)iTemp0);
			float fTemp58 = ((fSlow3 * dsp->fRec8[0]) + 1.0f);
			float fTemp59 = (fSlow2 * fTemp58);
			float fTemp60 = ((fTemp57 <= fTemp59)?fTemp59:fTemp57);
			float fTemp61 = tanf((dsp->fConst3 * fTemp60));
			...
			dsp->fRec0[0] = (fTemp5 - (((dsp->fRec0[2] * (((fTemp62 - fTemp70) / fTemp61) + 1.0f)) + (2.0f * (dsp->fRec0[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp61)))))) / fTemp71));
			...
			float fTemp78 = tanf((dsp->fConst3 * fTemp77));
			...
			dsp->fRec10[0] = (fTemp5 - (((dsp->fRec10[2] * (((fTemp79 - fTemp84) / fTemp78) + 1.0f)) + (2.0f * (dsp->fRec10[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp78)))))) / fTemp85));
			...
			float fTemp92 = tanf((dsp->fConst3 * fTemp91));
			...
			dsp->fRec11[0] = (fTemp5 - (((dsp->fRec11[2] * (((fTemp93 - fTemp98) / fTemp92) + 1.0f)) + (2.0f * (dsp->fRec11[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp92)))))) / fTemp99));
			...
			float fTemp105 = tanf((dsp->fConst3 * fTemp104));
			...
			dsp->fRec12[0] = (fTemp5 - (((dsp->fRec12[2] * (((fTemp106 - fTemp107) / fTemp105) + 1.0f)) + (2.0f * (dsp->fRec12[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp105)))))) / fTemp108));
			...
			float fTemp113 = tanf((dsp->fConst3 * fTemp112));
			...
			dsp->fRec13[0] = (fTemp5 - (((dsp->fRec13[2] * (((fTemp114 - fTemp115) / fTemp113) + 1.0f)) + (2.0f * (dsp->fRec13[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp113)))))) / fTemp116));
			...
			float fTemp119 = (((((((dsp->fRec0[2] * (0.0f - (fTemp74 / fTemp61))) + ((dsp->fRec0[0] * fTemp74) / fTemp61)) / fTemp71) + (((dsp->fRec10[2] * (0.0f - (fTemp87 / fTemp78))) + ((dsp->fRec10[0] * fTemp87) / fTemp78)) / fTemp85)) + (((dsp->fRec11[2] * (0.0f - (fTemp102 / fTemp92))) + ((dsp->fRec11[0] * fTemp102) / fTemp92)) / fTemp99)) + (((dsp->fRec12[2] * (0.0f - (fTemp111 / fTemp105))) + ((dsp->fRec12[0] * fTemp111) / fTemp105)) / fTemp108)) + (((dsp->fRec13[2] * (0.0f - (fTemp118 / fTemp113))) + ((dsp->fRec13[0] * fTemp118) / fTemp113)) / fTemp116));
