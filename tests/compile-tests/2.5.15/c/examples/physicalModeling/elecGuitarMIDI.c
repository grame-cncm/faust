...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "description", "Simple electric guitar model without effect chain.");
	...
	m->declare(m->metaInterface, "name", "ElecGuitarMidi");
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = ((fSlow3 / dsp->fRec30[0]) + -0.109999999f);
			...
			float fTemp62 = (dsp->fVec1[1] + fTemp61);
			dsp->fVec3[0] = fTemp62;
			dsp->fRec32[(dsp->IOTA & 2047)] = ((0.0500000007f * dsp->fRec32[((dsp->IOTA - 1) & 2047)]) + (0.949999988f * dsp->fVec3[2]));
			...
			float fRec28 = (dsp->fRec21[1] + ((float)iRec35 + dsp->fVec3[1]));
			dsp->fRec21[0] = fRec26;
			float fRec22 = dsp->fRec21[1];
			float fRec23 = fRec27;
			float fRec24 = fRec28;
			dsp->fRec17[0] = fRec22;
			float fRec18 = (fTemp61 + dsp->fRec17[1]);
			float fRec19 = fRec23;
			float fRec20 = fRec24;
			dsp->fRec13[(dsp->IOTA & 2047)] = fRec18;
			float fRec14 = (((((fTemp34 * fTemp36) * fTemp38) * fTemp40) * dsp->fRec13[((dsp->IOTA - (iTemp31 + 1)) & 2047)]) + (fTemp41 * (((0.166666672f * ((fTemp49 * fTemp51) * dsp->fRec13[((dsp->IOTA - (iTemp50 + 1)) & 2047)])) + ((((fTemp46 * fTemp47) * fTemp48) * dsp->fRec13[((dsp->IOTA - (iTemp45 + 1)) & 2047)]) + (0.5f * (((fTemp33 * fTemp43) * fTemp44) * dsp->fRec13[((dsp->IOTA - (iTemp42 + 1)) & 2047)])))) + (0.0416666679f * (fTemp52 * dsp->fRec13[((dsp->IOTA - (iTemp53 + 1)) & 2047)])))));
			dsp->fRec15[0] = fRec19;
			float fRec16 = fRec20;
			dsp->fRec11[0] = dsp->fRec15[1];
			float fRec12 = fRec16;
			dsp->fRec6[0] = fRec10;
			float fRec7 = dsp->fRec6[1];
