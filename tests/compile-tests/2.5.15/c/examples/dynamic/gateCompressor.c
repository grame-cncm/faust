...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "name", "gateCompressor");
...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fHslider2 = (FAUSTFLOAT)40.0f;
	dsp->fCheckbox1 = (FAUSTFLOAT)0.0f;
	dsp->fHslider3 = (FAUSTFLOAT)10.0f;
	dsp->fHslider4 = (FAUSTFLOAT)100.0f;
	...
	dsp->fHslider5 = (FAUSTFLOAT)-30.0f;
	dsp->fHslider6 = (FAUSTFLOAT)200.0f;
	dsp->fHslider7 = (FAUSTFLOAT)50.0f;
	dsp->fHslider8 = (FAUSTFLOAT)5.0f;
	dsp->fHslider9 = (FAUSTFLOAT)500.0f;
	dsp->fHslider10 = (FAUSTFLOAT)-30.0f;
...
void instanceConstantsmydsp(mydsp* dsp, int samplingFreq) {
	...
	dsp->fConst13 = (dsp->fConst12 + 0.000407678192f);
	...
	dsp->fConst23 = (2.0f * (0.000407678192f - dsp->fConst12));
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "gateCompressor");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fCheckbox1, "tooltip", "When this is checked,   the gate has no effect");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider5, "tooltip", "When   the signal level falls below the Threshold (expressed in dB), the signal is   muted");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider5, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Threshold", &dsp->fHslider5, -30.0f, -120.0f, 0.0f, 0.100000001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "tooltip", "Time constant in MICROseconds (1/e smoothing time) for the gate  gain to go (exponentially) from 0 (muted) to 1 (unmuted)");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "unit", "us");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Attack", &dsp->fHslider3, 10.0f, 10.0f, 10000.0f, 1.0f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider6, "tooltip", "Time in ms to keep the gate open (no muting) after the signal  level falls below the Threshold");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider6, "unit", "ms");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Hold", &dsp->fHslider6, 200.0f, 1.0f, 1000.0f, 1.0f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "tooltip", "Time constant in ms (1/e smoothing time) for the gain to go  (exponentially) from 1 (unmuted) to 0 (muted)");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "unit", "ms");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Release", &dsp->fHslider4, 100.0f, 1.0f, 1000.0f, 1.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHbargraph1, "1", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHbargraph1, "tooltip", "Current gain of  the compressor in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHbargraph1, "unit", "dB");
	ui_interface->addHorizontalBargraph(ui_interface->uiInterface, "Compressor Gain", &dsp->fHbargraph1, -50.0f, 10.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "1", "");
	ui_interface->openHorizontalBox(ui_interface->uiInterface, "0x00");
	ui_interface->declare(ui_interface->uiInterface, 0, "3", "");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider8, "tooltip", "A compression Ratio of N means that for each N dB increase in input  signal level above Threshold, the output level goes up 1 dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Ratio", &dsp->fHslider8, 5.0f, 1.0f, 20.0f, 0.100000001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider10, "tooltip", "When the signal level exceeds the Threshold (in dB), its level  is compressed according to the Ratio");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider10, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Threshold", &dsp->fHslider10, -30.0f, -100.0f, 10.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Attack     tooltip: Time constant in ms (1/e smoothing time) for the compression gain  to approach (exponentially) a new lower target level (the compression  `kicking in')]", &dsp->fHslider7, 50.0f, 1.0f, 1000.0f, 0.100000001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "2", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "scale", "log");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "style", "knob");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "tooltip", "Time constant in ms (1/e smoothing time) for the compression gain  to approach (exponentially) a new higher target level (the compression  'releasing')");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "unit", "ms");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Release", &dsp->fHslider9, 500.0f, 1.0f, 1000.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "5", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "tooltip", "The compressed-signal output level is increased by this amount  (in dB) to make up for the level lost due to compression");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Makeup Gain", &dsp->fHslider2, 40.0f, -96.0f, 96.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "4", "");
	ui_interface->openVerticalBox(ui_interface->uiInterface, "0x00");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93c79630", &dsp->fVbargraph14, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93c67c20", &dsp->fVbargraph13, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93c45a20", &dsp->fVbargraph12, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93c23820", &dsp->fVbargraph11, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93c01620", &dsp->fVbargraph10, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93bdb4a0", &dsp->fVbargraph9, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93bb92a0", &dsp->fVbargraph8, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93b970a0", &dsp->fVbargraph7, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93b74ea0", &dsp->fVbargraph6, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93b52ca0", &dsp->fVbargraph5, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93b30aa0", &dsp->fVbargraph4, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93b0e8a0", &dsp->fVbargraph3, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93ae8720", &dsp->fVbargraph2, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93ac6520", &dsp->fVbargraph1, -50.0f, 10.0f);
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f8a93aa3290", &dsp->fVbargraph0, -50.0f, 10.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "1", "");
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow6 = max(dsp->fConst15, (9.99999997e-07f * (float)dsp->fHslider3));
	float fSlow7 = max(dsp->fConst15, (0.00100000005f * (float)dsp->fHslider4));
	float fSlow8 = expf((0.0f - (dsp->fConst14 / min(fSlow6, fSlow7))));
	float fSlow9 = (1.0f - fSlow8);
	float fSlow10 = (0.00100000005f * powf(10.0f, (0.0500000007f * (float)dsp->fVslider0)));
	int iSlow11 = (int)(float)dsp->fCheckbox2;
	int iSlow12 = (int)(float)dsp->fCheckbox3;
	int iSlow13 = (int)((float)dsp->fEntry0 + -1.0f);
	int iSlow14 = (iSlow13 >= 2);
	int iSlow15 = (iSlow13 >= 1);
	float fSlow16 = expf((0.0f - (dsp->fConst14 / (float)dsp->fVslider2)));
	float fSlow17 = (440.0f * (powf(2.0f, (0.0833333358f * ((float)dsp->fVslider1 + -49.0f))) * (1.0f - fSlow16)));
	int iSlow18 = (iSlow13 >= 3);
	float fSlow19 = ((0.00999999978f * (float)dsp->fVslider3) + 1.0f);
	float fSlow20 = ((0.00999999978f * (float)dsp->fVslider4) + 1.0f);
	int iSlow21 = (int)(float)dsp->fCheckbox4;
	float fSlow22 = powf(10.0f, (0.0500000007f * (float)dsp->fHslider5));
	int iSlow23 = (int)(dsp->fConst0 * max(dsp->fConst15, (0.00100000005f * (float)dsp->fHslider6)));
	float fSlow24 = expf((0.0f - (dsp->fConst14 / fSlow6)));
	float fSlow25 = expf((0.0f - (dsp->fConst14 / fSlow7)));
	float fSlow26 = max(dsp->fConst14, (0.00100000005f * (float)dsp->fHslider7));
	float fSlow27 = expf((0.0f - (dsp->fConst19 / fSlow26)));
	float fSlow28 = (((1.0f / (float)dsp->fHslider8) + -1.0f) * (1.0f - fSlow27));
	float fSlow29 = expf((0.0f - (dsp->fConst14 / fSlow26)));
	float fSlow30 = expf((0.0f - (dsp->fConst14 / max(dsp->fConst14, (0.00100000005f * (float)dsp->fHslider9)))));
	float fSlow31 = (float)dsp->fHslider10;
	/* C99 loop */
	{
		int i;
		for (i = 0; (i < count); i = (i + 1)) {
			dsp->iVec0[0] = 1;
			dsp->fRec8[0] = (fSlow10 + (0.999000013f * dsp->fRec8[1]));
			dsp->fRec10[0] = (fSlow17 + (fSlow16 * dsp->fRec10[1]));
			float fTemp0 = max(20.0f, fabsf(dsp->fRec10[0]));
			dsp->fVec1[0] = fTemp0;
			float fTemp1 = (dsp->fRec9[1] + (dsp->fConst14 * dsp->fVec1[1]));
			dsp->fRec9[0] = (fTemp1 - floorf(fTemp1));
			float fTemp2 = (2.0f * dsp->fRec9[0]);
			...
			dsp->fVec7[0] = fTemp9;
			float fTemp10 = max(20.0f, fabsf((fSlow19 * dsp->fRec10[0])));
			dsp->fVec8[0] = fTemp10;
			float fTemp11 = (dsp->fRec11[1] + (dsp->fConst14 * dsp->fVec8[1]));
			dsp->fRec11[0] = (fTemp11 - floorf(fTemp11));
			float fTemp12 = (2.0f * dsp->fRec11[0]);
			...
			float fTemp20 = max(20.0f, fabsf((fSlow20 * dsp->fRec10[0])));
			dsp->fVec15[0] = fTemp20;
			float fTemp21 = (dsp->fRec12[1] + (dsp->fConst14 * dsp->fVec15[1]));
			dsp->fRec12[0] = (fTemp21 - floorf(fTemp21));
			float fTemp22 = (2.0f * dsp->fRec12[0]);
			...
			float fTemp30 = (4.65661287e-10f * (float)dsp->iRec13[0]);
			dsp->fRec14[0] = (((0.522189379f * dsp->fRec14[3]) + (fTemp30 + (2.49495602f * dsp->fRec14[1]))) - (2.0172658f * dsp->fRec14[2]));
			float fTemp31 = (dsp->fRec8[0] * (iSlow11?(float)input0[i]:(iSlow12?(iSlow21?(((0.0499220341f * dsp->fRec14[0]) + (0.0506126992f * dsp->fRec14[2])) - ((0.0959935337f * dsp->fRec14[1]) + (0.00440878607f * dsp->fRec14[3]))):fTemp30):(0.333333343f * (dsp->fRec8[0] * (((iSlow14?(iSlow18?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp9 - dsp->fVec7[1])) / fTemp0)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp6 - dsp->fVec4[1])) / fTemp0))):(iSlow15?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp4 - dsp->fVec2[1])) / fTemp0)):fTemp3)) + (iSlow14?(iSlow18?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp19 - dsp->fVec14[1])) / fTemp10)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp16 - dsp->fVec11[1])) / fTemp10))):(iSlow15?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp14 - dsp->fVec9[1])) / fTemp10)):fTemp13))) + (iSlow14?(iSlow18?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp29 - dsp->fVec21[1])) / fTemp20)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp26 - dsp->fVec18[1])) / fTemp20))):(iSlow15?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp24 - dsp->fVec16[1])) / fTemp20)):fTemp23))))))));
			float fTemp32 = (iSlow5?0.0f:fTemp31);
			float fTemp33 = fabsf(fTemp32);
			dsp->fRec18[0] = ((fSlow8 * dsp->fRec18[1]) + (fSlow9 * fabsf((2.0f * fTemp33))));
			float fRec17 = dsp->fRec18[0];
			int iTemp34 = (fRec17 > fSlow22);
			dsp->iVec22[0] = iTemp34;
			dsp->iRec19[0] = max((int)(iSlow23 * (iTemp34 < dsp->iVec22[1])), (int)(dsp->iRec19[1] + -1));
			float fTemp35 = fabsf(max((float)iTemp34, (float)(dsp->iRec19[0] > 0)));
			float fTemp36 = ((dsp->fRec15[1] > fTemp35)?fSlow25:fSlow24);
			dsp->fRec16[0] = ((dsp->fRec16[1] * fTemp36) + (fTemp35 * (1.0f - fTemp36)));
			dsp->fRec15[0] = dsp->fRec16[0];
			dsp->fHbargraph0 = (FAUSTFLOAT)(20.0f * log10f(dsp->fRec15[0]));
			dsp->fRec7[0] = ((fSlow8 * dsp->fRec7[1]) + (fSlow9 * fabsf((fTemp33 + fabsf(fTemp32)))));
			float fRec6 = dsp->fRec7[0];
			int iTemp37 = (fRec6 > fSlow22);
			dsp->iVec23[0] = iTemp37;
			dsp->iRec20[0] = max((int)(iSlow23 * (iTemp37 < dsp->iVec23[1])), (int)(dsp->iRec20[1] + -1));
			float fTemp38 = fabsf(max((float)iTemp37, (float)(dsp->iRec20[0] > 0)));
			float fTemp39 = ((dsp->fRec4[1] > fTemp38)?fSlow25:fSlow24);
			dsp->fRec5[0] = ((dsp->fRec5[1] * fTemp39) + (fTemp38 * (1.0f - fTemp39)));
			dsp->fRec4[0] = dsp->fRec5[0];
			float fTemp40 = (iSlow5?fTemp31:(dsp->fRec4[0] * fTemp32));
			float fTemp41 = (iSlow3?0.0f:fTemp40);
			float fTemp42 = (iSlow5?fTemp31:(dsp->fRec4[0] * fTemp32));
			float fTemp43 = (iSlow3?0.0f:fTemp42);
			float fTemp44 = fabsf((fabsf(fTemp41) + fabsf(fTemp43)));
			float fTemp45 = ((dsp->fRec22[1] > fTemp44)?fSlow30:fSlow29);
			dsp->fRec23[0] = ((dsp->fRec23[1] * fTemp45) + (fTemp44 * (1.0f - fTemp45)));
			dsp->fRec22[0] = dsp->fRec23[0];
			dsp->fRec21[0] = ((fSlow27 * dsp->fRec21[1]) + (fSlow28 * max(((20.0f * log10f(dsp->fRec22[0])) - fSlow31), 0.0f)));
			float fTemp46 = powf(10.0f, (0.0500000007f * dsp->fRec21[0]));
			float fTemp47 = (fTemp41 * fTemp46);
			float fTemp48 = (fTemp43 * fTemp46);
			float fTemp49 = fabsf((fabsf(fTemp47) + fabsf(fTemp48)));
			float fTemp50 = ((dsp->fRec25[1] > fTemp49)?fSlow30:fSlow29);
			dsp->fRec26[0] = ((dsp->fRec26[1] * fTemp50) + (fTemp49 * (1.0f - fTemp50)));
			dsp->fRec25[0] = dsp->fRec26[0];
			dsp->fRec24[0] = ((fSlow27 * dsp->fRec24[1]) + (fSlow28 * max(((20.0f * log10f(dsp->fRec25[0])) - fSlow31), 0.0f)));
			dsp->fHbargraph1 = (FAUSTFLOAT)(20.0f * log10f(powf(10.0f, (0.0500000007f * dsp->fRec24[0]))));
			float fTemp51 = ((iSlow3?fTemp40:(fSlow4 * fTemp47)) + (iSlow3?fTemp42:(fSlow4 * fTemp48)));
			dsp->fRec3[0] = (fTemp51 - (dsp->fConst11 * ((dsp->fConst20 * dsp->fRec3[2]) + (dsp->fConst22 * dsp->fRec3[1]))));
			dsp->fRec2[0] = ((dsp->fConst11 * (((dsp->fConst13 * dsp->fRec3[0]) + (dsp->fConst23 * dsp->fRec3[1])) + (dsp->fConst13 * dsp->fRec3[2]))) - (dsp->fConst8 * ((dsp->fConst24 * dsp->fRec2[2]) + (dsp->fConst25 * dsp->fRec2[1]))));
			...
			dsp->fRec33[0] = (fTemp51 - (dsp->fConst46 * ((dsp->fConst49 * dsp->fRec33[2]) + (dsp->fConst50 * dsp->fRec33[1]))));
			dsp->fRec32[0] = ((dsp->fConst46 * (((dsp->fConst48 * dsp->fRec33[1]) + (dsp->fConst51 * dsp->fRec33[0])) + (dsp->fConst51 * dsp->fRec33[2]))) - (dsp->fConst44 * ((dsp->fConst52 * dsp->fRec32[2]) + (dsp->fConst53 * dsp->fRec32[1]))));
			dsp->fRec31[0] = ((dsp->fConst44 * (((dsp->fConst45 * dsp->fRec32[1]) + (dsp->fConst54 * dsp->fRec32[0])) + (dsp->fConst54 * dsp->fRec32[2]))) - (dsp->fConst42 * ((dsp->fConst55 * dsp->fRec31[2]) + (dsp->fConst56 * dsp->fRec31[1]))));
			float fTemp52 = (dsp->fConst42 * (((dsp->fConst43 * dsp->fRec31[1]) + (dsp->fConst57 * dsp->fRec31[0])) + (dsp->fConst57 * dsp->fRec31[2])));
			dsp->fRec30[0] = (fTemp52 - (dsp->fConst39 * ((dsp->fConst58 * dsp->fRec30[2]) + (dsp->fConst60 * dsp->fRec30[1]))));
			dsp->fRec29[0] = ((dsp->fConst39 * (((dsp->fConst41 * dsp->fRec30[1]) + (dsp->fConst61 * dsp->fRec30[0])) + (dsp->fConst61 * dsp->fRec30[2]))) - (dsp->fConst36 * ((dsp->fConst62 * dsp->fRec29[2]) + (dsp->fConst63 * dsp->fRec29[1]))));
			dsp->fRec28[0] = ((dsp->fConst36 * (((dsp->fConst38 * dsp->fRec29[1]) + (dsp->fConst64 * dsp->fRec29[0])) + (dsp->fConst64 * dsp->fRec29[2]))) - (dsp->fConst32 * ((dsp->fConst65 * dsp->fRec28[2]) + (dsp->fConst66 * dsp->fRec28[1]))));
			dsp->fRec27[0] = ((fSlow1 * dsp->fRec27[1]) + (fSlow2 * fabsf((dsp->fConst32 * (((dsp->fConst35 * dsp->fRec28[1]) + (dsp->fConst67 * dsp->fRec28[0])) + (dsp->fConst67 * dsp->fRec28[2]))))));
			dsp->fVbargraph1 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec27[0]))));
			dsp->fRec40[0] = (fTemp52 - (dsp->fConst84 * ((dsp->fConst87 * dsp->fRec40[2]) + (dsp->fConst88 * dsp->fRec40[1]))));
			dsp->fRec39[0] = ((dsp->fConst84 * (((dsp->fConst86 * dsp->fRec40[1]) + (dsp->fConst89 * dsp->fRec40[0])) + (dsp->fConst89 * dsp->fRec40[2]))) - (dsp->fConst82 * ((dsp->fConst90 * dsp->fRec39[2]) + (dsp->fConst91 * dsp->fRec39[1]))));
			dsp->fRec38[0] = ((dsp->fConst82 * (((dsp->fConst83 * dsp->fRec39[1]) + (dsp->fConst92 * dsp->fRec39[0])) + (dsp->fConst92 * dsp->fRec39[2]))) - (dsp->fConst80 * ((dsp->fConst93 * dsp->fRec38[2]) + (dsp->fConst94 * dsp->fRec38[1]))));
			float fTemp53 = (dsp->fConst80 * (((dsp->fConst81 * dsp->fRec38[1]) + (dsp->fConst95 * dsp->fRec38[0])) + (dsp->fConst95 * dsp->fRec38[2])));
			dsp->fRec37[0] = (fTemp53 - (dsp->fConst77 * ((dsp->fConst96 * dsp->fRec37[2]) + (dsp->fConst98 * dsp->fRec37[1]))));
			dsp->fRec36[0] = ((dsp->fConst77 * (((dsp->fConst79 * dsp->fRec37[1]) + (dsp->fConst99 * dsp->fRec37[0])) + (dsp->fConst99 * dsp->fRec37[2]))) - (dsp->fConst74 * ((dsp->fConst100 * dsp->fRec36[2]) + (dsp->fConst101 * dsp->fRec36[1]))));
			dsp->fRec35[0] = ((dsp->fConst74 * (((dsp->fConst76 * dsp->fRec36[1]) + (dsp->fConst102 * dsp->fRec36[0])) + (dsp->fConst102 * dsp->fRec36[2]))) - (dsp->fConst70 * ((dsp->fConst103 * dsp->fRec35[2]) + (dsp->fConst104 * dsp->fRec35[1]))));
			dsp->fRec34[0] = ((fSlow1 * dsp->fRec34[1]) + (fSlow2 * fabsf((dsp->fConst70 * (((dsp->fConst73 * dsp->fRec35[1]) + (dsp->fConst105 * dsp->fRec35[0])) + (dsp->fConst105 * dsp->fRec35[2]))))));
			dsp->fVbargraph2 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec34[0]))));
			dsp->fRec47[0] = (fTemp53 - (dsp->fConst122 * ((dsp->fConst125 * dsp->fRec47[2]) + (dsp->fConst126 * dsp->fRec47[1]))));
			dsp->fRec46[0] = ((dsp->fConst122 * (((dsp->fConst124 * dsp->fRec47[1]) + (dsp->fConst127 * dsp->fRec47[0])) + (dsp->fConst127 * dsp->fRec47[2]))) - (dsp->fConst120 * ((dsp->fConst128 * dsp->fRec46[2]) + (dsp->fConst129 * dsp->fRec46[1]))));
			dsp->fRec45[0] = ((dsp->fConst120 * (((dsp->fConst121 * dsp->fRec46[1]) + (dsp->fConst130 * dsp->fRec46[0])) + (dsp->fConst130 * dsp->fRec46[2]))) - (dsp->fConst118 * ((dsp->fConst131 * dsp->fRec45[2]) + (dsp->fConst132 * dsp->fRec45[1]))));
			float fTemp54 = (dsp->fConst118 * (((dsp->fConst119 * dsp->fRec45[1]) + (dsp->fConst133 * dsp->fRec45[0])) + (dsp->fConst133 * dsp->fRec45[2])));
			dsp->fRec44[0] = (fTemp54 - (dsp->fConst115 * ((dsp->fConst134 * dsp->fRec44[2]) + (dsp->fConst136 * dsp->fRec44[1]))));
			dsp->fRec43[0] = ((dsp->fConst115 * (((dsp->fConst117 * dsp->fRec44[1]) + (dsp->fConst137 * dsp->fRec44[0])) + (dsp->fConst137 * dsp->fRec44[2]))) - (dsp->fConst112 * ((dsp->fConst138 * dsp->fRec43[2]) + (dsp->fConst139 * dsp->fRec43[1]))));
			dsp->fRec42[0] = ((dsp->fConst112 * (((dsp->fConst114 * dsp->fRec43[1]) + (dsp->fConst140 * dsp->fRec43[0])) + (dsp->fConst140 * dsp->fRec43[2]))) - (dsp->fConst108 * ((dsp->fConst141 * dsp->fRec42[2]) + (dsp->fConst142 * dsp->fRec42[1]))));
			dsp->fRec41[0] = ((fSlow1 * dsp->fRec41[1]) + (fSlow2 * fabsf((dsp->fConst108 * (((dsp->fConst111 * dsp->fRec42[1]) + (dsp->fConst143 * dsp->fRec42[0])) + (dsp->fConst143 * dsp->fRec42[2]))))));
			dsp->fVbargraph3 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec41[0]))));
			dsp->fRec54[0] = (fTemp54 - (dsp->fConst160 * ((dsp->fConst163 * dsp->fRec54[2]) + (dsp->fConst164 * dsp->fRec54[1]))));
			dsp->fRec53[0] = ((dsp->fConst160 * (((dsp->fConst162 * dsp->fRec54[1]) + (dsp->fConst165 * dsp->fRec54[0])) + (dsp->fConst165 * dsp->fRec54[2]))) - (dsp->fConst158 * ((dsp->fConst166 * dsp->fRec53[2]) + (dsp->fConst167 * dsp->fRec53[1]))));
			dsp->fRec52[0] = ((dsp->fConst158 * (((dsp->fConst159 * dsp->fRec53[1]) + (dsp->fConst168 * dsp->fRec53[0])) + (dsp->fConst168 * dsp->fRec53[2]))) - (dsp->fConst156 * ((dsp->fConst169 * dsp->fRec52[2]) + (dsp->fConst170 * dsp->fRec52[1]))));
			float fTemp55 = (dsp->fConst156 * (((dsp->fConst157 * dsp->fRec52[1]) + (dsp->fConst171 * dsp->fRec52[0])) + (dsp->fConst171 * dsp->fRec52[2])));
			dsp->fRec51[0] = (fTemp55 - (dsp->fConst153 * ((dsp->fConst172 * dsp->fRec51[2]) + (dsp->fConst174 * dsp->fRec51[1]))));
			dsp->fRec50[0] = ((dsp->fConst153 * (((dsp->fConst155 * dsp->fRec51[1]) + (dsp->fConst175 * dsp->fRec51[0])) + (dsp->fConst175 * dsp->fRec51[2]))) - (dsp->fConst150 * ((dsp->fConst176 * dsp->fRec50[2]) + (dsp->fConst177 * dsp->fRec50[1]))));
			dsp->fRec49[0] = ((dsp->fConst150 * (((dsp->fConst152 * dsp->fRec50[1]) + (dsp->fConst178 * dsp->fRec50[0])) + (dsp->fConst178 * dsp->fRec50[2]))) - (dsp->fConst146 * ((dsp->fConst179 * dsp->fRec49[2]) + (dsp->fConst180 * dsp->fRec49[1]))));
			dsp->fRec48[0] = ((fSlow1 * dsp->fRec48[1]) + (fSlow2 * fabsf((dsp->fConst146 * (((dsp->fConst149 * dsp->fRec49[1]) + (dsp->fConst181 * dsp->fRec49[0])) + (dsp->fConst181 * dsp->fRec49[2]))))));
			dsp->fVbargraph4 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec48[0]))));
			dsp->fRec61[0] = (fTemp55 - (dsp->fConst198 * ((dsp->fConst201 * dsp->fRec61[2]) + (dsp->fConst202 * dsp->fRec61[1]))));
			dsp->fRec60[0] = ((dsp->fConst198 * (((dsp->fConst200 * dsp->fRec61[1]) + (dsp->fConst203 * dsp->fRec61[0])) + (dsp->fConst203 * dsp->fRec61[2]))) - (dsp->fConst196 * ((dsp->fConst204 * dsp->fRec60[2]) + (dsp->fConst205 * dsp->fRec60[1]))));
			dsp->fRec59[0] = ((dsp->fConst196 * (((dsp->fConst197 * dsp->fRec60[1]) + (dsp->fConst206 * dsp->fRec60[0])) + (dsp->fConst206 * dsp->fRec60[2]))) - (dsp->fConst194 * ((dsp->fConst207 * dsp->fRec59[2]) + (dsp->fConst208 * dsp->fRec59[1]))));
			float fTemp56 = (dsp->fConst194 * (((dsp->fConst195 * dsp->fRec59[1]) + (dsp->fConst209 * dsp->fRec59[0])) + (dsp->fConst209 * dsp->fRec59[2])));
			dsp->fRec58[0] = (fTemp56 - (dsp->fConst191 * ((dsp->fConst210 * dsp->fRec58[2]) + (dsp->fConst212 * dsp->fRec58[1]))));
			dsp->fRec57[0] = ((dsp->fConst191 * (((dsp->fConst193 * dsp->fRec58[1]) + (dsp->fConst213 * dsp->fRec58[0])) + (dsp->fConst213 * dsp->fRec58[2]))) - (dsp->fConst188 * ((dsp->fConst214 * dsp->fRec57[2]) + (dsp->fConst215 * dsp->fRec57[1]))));
			dsp->fRec56[0] = ((dsp->fConst188 * (((dsp->fConst190 * dsp->fRec57[1]) + (dsp->fConst216 * dsp->fRec57[0])) + (dsp->fConst216 * dsp->fRec57[2]))) - (dsp->fConst184 * ((dsp->fConst217 * dsp->fRec56[2]) + (dsp->fConst218 * dsp->fRec56[1]))));
			dsp->fRec55[0] = ((fSlow1 * dsp->fRec55[1]) + (fSlow2 * fabsf((dsp->fConst184 * (((dsp->fConst187 * dsp->fRec56[1]) + (dsp->fConst219 * dsp->fRec56[0])) + (dsp->fConst219 * dsp->fRec56[2]))))));
			dsp->fVbargraph5 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec55[0]))));
			dsp->fRec68[0] = (fTemp56 - (dsp->fConst236 * ((dsp->fConst239 * dsp->fRec68[2]) + (dsp->fConst240 * dsp->fRec68[1]))));
			dsp->fRec67[0] = ((dsp->fConst236 * (((dsp->fConst238 * dsp->fRec68[1]) + (dsp->fConst241 * dsp->fRec68[0])) + (dsp->fConst241 * dsp->fRec68[2]))) - (dsp->fConst234 * ((dsp->fConst242 * dsp->fRec67[2]) + (dsp->fConst243 * dsp->fRec67[1]))));
			dsp->fRec66[0] = ((dsp->fConst234 * (((dsp->fConst235 * dsp->fRec67[1]) + (dsp->fConst244 * dsp->fRec67[0])) + (dsp->fConst244 * dsp->fRec67[2]))) - (dsp->fConst232 * ((dsp->fConst245 * dsp->fRec66[2]) + (dsp->fConst246 * dsp->fRec66[1]))));
			float fTemp57 = (dsp->fConst232 * (((dsp->fConst233 * dsp->fRec66[1]) + (dsp->fConst247 * dsp->fRec66[0])) + (dsp->fConst247 * dsp->fRec66[2])));
			dsp->fRec65[0] = (fTemp57 - (dsp->fConst229 * ((dsp->fConst248 * dsp->fRec65[2]) + (dsp->fConst250 * dsp->fRec65[1]))));
			dsp->fRec64[0] = ((dsp->fConst229 * (((dsp->fConst231 * dsp->fRec65[1]) + (dsp->fConst251 * dsp->fRec65[0])) + (dsp->fConst251 * dsp->fRec65[2]))) - (dsp->fConst226 * ((dsp->fConst252 * dsp->fRec64[2]) + (dsp->fConst253 * dsp->fRec64[1]))));
			dsp->fRec63[0] = ((dsp->fConst226 * (((dsp->fConst228 * dsp->fRec64[1]) + (dsp->fConst254 * dsp->fRec64[0])) + (dsp->fConst254 * dsp->fRec64[2]))) - (dsp->fConst222 * ((dsp->fConst255 * dsp->fRec63[2]) + (dsp->fConst256 * dsp->fRec63[1]))));
			dsp->fRec62[0] = ((fSlow1 * dsp->fRec62[1]) + (fSlow2 * fabsf((dsp->fConst222 * (((dsp->fConst225 * dsp->fRec63[1]) + (dsp->fConst257 * dsp->fRec63[0])) + (dsp->fConst257 * dsp->fRec63[2]))))));
			dsp->fVbargraph6 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec62[0]))));
			dsp->fRec75[0] = (fTemp57 - (dsp->fConst274 * ((dsp->fConst277 * dsp->fRec75[2]) + (dsp->fConst278 * dsp->fRec75[1]))));
			dsp->fRec74[0] = ((dsp->fConst274 * (((dsp->fConst276 * dsp->fRec75[1]) + (dsp->fConst279 * dsp->fRec75[0])) + (dsp->fConst279 * dsp->fRec75[2]))) - (dsp->fConst272 * ((dsp->fConst280 * dsp->fRec74[2]) + (dsp->fConst281 * dsp->fRec74[1]))));
			dsp->fRec73[0] = ((dsp->fConst272 * (((dsp->fConst273 * dsp->fRec74[1]) + (dsp->fConst282 * dsp->fRec74[0])) + (dsp->fConst282 * dsp->fRec74[2]))) - (dsp->fConst270 * ((dsp->fConst283 * dsp->fRec73[2]) + (dsp->fConst284 * dsp->fRec73[1]))));
			float fTemp58 = (dsp->fConst270 * (((dsp->fConst271 * dsp->fRec73[1]) + (dsp->fConst285 * dsp->fRec73[0])) + (dsp->fConst285 * dsp->fRec73[2])));
			dsp->fRec72[0] = (fTemp58 - (dsp->fConst267 * ((dsp->fConst286 * dsp->fRec72[2]) + (dsp->fConst288 * dsp->fRec72[1]))));
			dsp->fRec71[0] = ((dsp->fConst267 * (((dsp->fConst269 * dsp->fRec72[1]) + (dsp->fConst289 * dsp->fRec72[0])) + (dsp->fConst289 * dsp->fRec72[2]))) - (dsp->fConst264 * ((dsp->fConst290 * dsp->fRec71[2]) + (dsp->fConst291 * dsp->fRec71[1]))));
			dsp->fRec70[0] = ((dsp->fConst264 * (((dsp->fConst266 * dsp->fRec71[1]) + (dsp->fConst292 * dsp->fRec71[0])) + (dsp->fConst292 * dsp->fRec71[2]))) - (dsp->fConst260 * ((dsp->fConst293 * dsp->fRec70[2]) + (dsp->fConst294 * dsp->fRec70[1]))));
			dsp->fRec69[0] = ((fSlow1 * dsp->fRec69[1]) + (fSlow2 * fabsf((dsp->fConst260 * (((dsp->fConst263 * dsp->fRec70[1]) + (dsp->fConst295 * dsp->fRec70[0])) + (dsp->fConst295 * dsp->fRec70[2]))))));
			dsp->fVbargraph7 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec69[0]))));
			dsp->fRec82[0] = (fTemp58 - (dsp->fConst312 * ((dsp->fConst315 * dsp->fRec82[2]) + (dsp->fConst316 * dsp->fRec82[1]))));
			dsp->fRec81[0] = ((dsp->fConst312 * (((dsp->fConst314 * dsp->fRec82[1]) + (dsp->fConst317 * dsp->fRec82[0])) + (dsp->fConst317 * dsp->fRec82[2]))) - (dsp->fConst310 * ((dsp->fConst318 * dsp->fRec81[2]) + (dsp->fConst319 * dsp->fRec81[1]))));
			dsp->fRec80[0] = ((dsp->fConst310 * (((dsp->fConst311 * dsp->fRec81[1]) + (dsp->fConst320 * dsp->fRec81[0])) + (dsp->fConst320 * dsp->fRec81[2]))) - (dsp->fConst308 * ((dsp->fConst321 * dsp->fRec80[2]) + (dsp->fConst322 * dsp->fRec80[1]))));
			float fTemp59 = (dsp->fConst308 * (((dsp->fConst309 * dsp->fRec80[1]) + (dsp->fConst323 * dsp->fRec80[0])) + (dsp->fConst323 * dsp->fRec80[2])));
			dsp->fRec79[0] = (fTemp59 - (dsp->fConst305 * ((dsp->fConst324 * dsp->fRec79[2]) + (dsp->fConst326 * dsp->fRec79[1]))));
			dsp->fRec78[0] = ((dsp->fConst305 * (((dsp->fConst307 * dsp->fRec79[1]) + (dsp->fConst327 * dsp->fRec79[0])) + (dsp->fConst327 * dsp->fRec79[2]))) - (dsp->fConst302 * ((dsp->fConst328 * dsp->fRec78[2]) + (dsp->fConst329 * dsp->fRec78[1]))));
			dsp->fRec77[0] = ((dsp->fConst302 * (((dsp->fConst304 * dsp->fRec78[1]) + (dsp->fConst330 * dsp->fRec78[0])) + (dsp->fConst330 * dsp->fRec78[2]))) - (dsp->fConst298 * ((dsp->fConst331 * dsp->fRec77[2]) + (dsp->fConst332 * dsp->fRec77[1]))));
			dsp->fRec76[0] = ((fSlow1 * dsp->fRec76[1]) + (fSlow2 * fabsf((dsp->fConst298 * (((dsp->fConst301 * dsp->fRec77[1]) + (dsp->fConst333 * dsp->fRec77[0])) + (dsp->fConst333 * dsp->fRec77[2]))))));
			dsp->fVbargraph8 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec76[0]))));
			dsp->fRec89[0] = (fTemp59 - (dsp->fConst350 * ((dsp->fConst353 * dsp->fRec89[2]) + (dsp->fConst354 * dsp->fRec89[1]))));
			dsp->fRec88[0] = ((dsp->fConst350 * (((dsp->fConst352 * dsp->fRec89[1]) + (dsp->fConst355 * dsp->fRec89[0])) + (dsp->fConst355 * dsp->fRec89[2]))) - (dsp->fConst348 * ((dsp->fConst356 * dsp->fRec88[2]) + (dsp->fConst357 * dsp->fRec88[1]))));
			dsp->fRec87[0] = ((dsp->fConst348 * (((dsp->fConst349 * dsp->fRec88[1]) + (dsp->fConst358 * dsp->fRec88[0])) + (dsp->fConst358 * dsp->fRec88[2]))) - (dsp->fConst346 * ((dsp->fConst359 * dsp->fRec87[2]) + (dsp->fConst360 * dsp->fRec87[1]))));
			float fTemp60 = (dsp->fConst346 * (((dsp->fConst347 * dsp->fRec87[1]) + (dsp->fConst361 * dsp->fRec87[0])) + (dsp->fConst361 * dsp->fRec87[2])));
			dsp->fRec86[0] = (fTemp60 - (dsp->fConst343 * ((dsp->fConst362 * dsp->fRec86[2]) + (dsp->fConst364 * dsp->fRec86[1]))));
			dsp->fRec85[0] = ((dsp->fConst343 * (((dsp->fConst345 * dsp->fRec86[1]) + (dsp->fConst365 * dsp->fRec86[0])) + (dsp->fConst365 * dsp->fRec86[2]))) - (dsp->fConst340 * ((dsp->fConst366 * dsp->fRec85[2]) + (dsp->fConst367 * dsp->fRec85[1]))));
			dsp->fRec84[0] = ((dsp->fConst340 * (((dsp->fConst342 * dsp->fRec85[1]) + (dsp->fConst368 * dsp->fRec85[0])) + (dsp->fConst368 * dsp->fRec85[2]))) - (dsp->fConst336 * ((dsp->fConst369 * dsp->fRec84[2]) + (dsp->fConst370 * dsp->fRec84[1]))));
			dsp->fRec83[0] = ((fSlow1 * dsp->fRec83[1]) + (fSlow2 * fabsf((dsp->fConst336 * (((dsp->fConst339 * dsp->fRec84[1]) + (dsp->fConst371 * dsp->fRec84[0])) + (dsp->fConst371 * dsp->fRec84[2]))))));
			dsp->fVbargraph9 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec83[0]))));
			dsp->fRec96[0] = (fTemp60 - (dsp->fConst388 * ((dsp->fConst391 * dsp->fRec96[2]) + (dsp->fConst392 * dsp->fRec96[1]))));
			dsp->fRec95[0] = ((dsp->fConst388 * (((dsp->fConst390 * dsp->fRec96[1]) + (dsp->fConst393 * dsp->fRec96[0])) + (dsp->fConst393 * dsp->fRec96[2]))) - (dsp->fConst386 * ((dsp->fConst394 * dsp->fRec95[2]) + (dsp->fConst395 * dsp->fRec95[1]))));
			dsp->fRec94[0] = ((dsp->fConst386 * (((dsp->fConst387 * dsp->fRec95[1]) + (dsp->fConst396 * dsp->fRec95[0])) + (dsp->fConst396 * dsp->fRec95[2]))) - (dsp->fConst384 * ((dsp->fConst397 * dsp->fRec94[2]) + (dsp->fConst398 * dsp->fRec94[1]))));
			float fTemp61 = (dsp->fConst384 * (((dsp->fConst385 * dsp->fRec94[1]) + (dsp->fConst399 * dsp->fRec94[0])) + (dsp->fConst399 * dsp->fRec94[2])));
			dsp->fRec93[0] = (fTemp61 - (dsp->fConst381 * ((dsp->fConst400 * dsp->fRec93[2]) + (dsp->fConst402 * dsp->fRec93[1]))));
			dsp->fRec92[0] = ((dsp->fConst381 * (((dsp->fConst383 * dsp->fRec93[1]) + (dsp->fConst403 * dsp->fRec93[0])) + (dsp->fConst403 * dsp->fRec93[2]))) - (dsp->fConst378 * ((dsp->fConst404 * dsp->fRec92[2]) + (dsp->fConst405 * dsp->fRec92[1]))));
			dsp->fRec91[0] = ((dsp->fConst378 * (((dsp->fConst380 * dsp->fRec92[1]) + (dsp->fConst406 * dsp->fRec92[0])) + (dsp->fConst406 * dsp->fRec92[2]))) - (dsp->fConst374 * ((dsp->fConst407 * dsp->fRec91[2]) + (dsp->fConst408 * dsp->fRec91[1]))));
			dsp->fRec90[0] = ((fSlow1 * dsp->fRec90[1]) + (fSlow2 * fabsf((dsp->fConst374 * (((dsp->fConst377 * dsp->fRec91[1]) + (dsp->fConst409 * dsp->fRec91[0])) + (dsp->fConst409 * dsp->fRec91[2]))))));
			dsp->fVbargraph10 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec90[0]))));
			dsp->fRec103[0] = (fTemp61 - (dsp->fConst426 * ((dsp->fConst429 * dsp->fRec103[2]) + (dsp->fConst430 * dsp->fRec103[1]))));
			dsp->fRec102[0] = ((dsp->fConst426 * (((dsp->fConst428 * dsp->fRec103[1]) + (dsp->fConst431 * dsp->fRec103[0])) + (dsp->fConst431 * dsp->fRec103[2]))) - (dsp->fConst424 * ((dsp->fConst432 * dsp->fRec102[2]) + (dsp->fConst433 * dsp->fRec102[1]))));
			dsp->fRec101[0] = ((dsp->fConst424 * (((dsp->fConst425 * dsp->fRec102[1]) + (dsp->fConst434 * dsp->fRec102[0])) + (dsp->fConst434 * dsp->fRec102[2]))) - (dsp->fConst422 * ((dsp->fConst435 * dsp->fRec101[2]) + (dsp->fConst436 * dsp->fRec101[1]))));
			float fTemp62 = (dsp->fConst422 * (((dsp->fConst423 * dsp->fRec101[1]) + (dsp->fConst437 * dsp->fRec101[0])) + (dsp->fConst437 * dsp->fRec101[2])));
			dsp->fRec100[0] = (fTemp62 - (dsp->fConst419 * ((dsp->fConst438 * dsp->fRec100[2]) + (dsp->fConst440 * dsp->fRec100[1]))));
			dsp->fRec99[0] = ((dsp->fConst419 * (((dsp->fConst421 * dsp->fRec100[1]) + (dsp->fConst441 * dsp->fRec100[0])) + (dsp->fConst441 * dsp->fRec100[2]))) - (dsp->fConst416 * ((dsp->fConst442 * dsp->fRec99[2]) + (dsp->fConst443 * dsp->fRec99[1]))));
			dsp->fRec98[0] = ((dsp->fConst416 * (((dsp->fConst418 * dsp->fRec99[1]) + (dsp->fConst444 * dsp->fRec99[0])) + (dsp->fConst444 * dsp->fRec99[2]))) - (dsp->fConst412 * ((dsp->fConst445 * dsp->fRec98[2]) + (dsp->fConst446 * dsp->fRec98[1]))));
			dsp->fRec97[0] = ((fSlow1 * dsp->fRec97[1]) + (fSlow2 * fabsf((dsp->fConst412 * (((dsp->fConst415 * dsp->fRec98[1]) + (dsp->fConst447 * dsp->fRec98[0])) + (dsp->fConst447 * dsp->fRec98[2]))))));
			dsp->fVbargraph11 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec97[0]))));
			dsp->fRec110[0] = (fTemp62 - (dsp->fConst464 * ((dsp->fConst467 * dsp->fRec110[2]) + (dsp->fConst468 * dsp->fRec110[1]))));
			dsp->fRec109[0] = ((dsp->fConst464 * (((dsp->fConst466 * dsp->fRec110[1]) + (dsp->fConst469 * dsp->fRec110[0])) + (dsp->fConst469 * dsp->fRec110[2]))) - (dsp->fConst462 * ((dsp->fConst470 * dsp->fRec109[2]) + (dsp->fConst471 * dsp->fRec109[1]))));
			dsp->fRec108[0] = ((dsp->fConst462 * (((dsp->fConst463 * dsp->fRec109[1]) + (dsp->fConst472 * dsp->fRec109[0])) + (dsp->fConst472 * dsp->fRec109[2]))) - (dsp->fConst460 * ((dsp->fConst473 * dsp->fRec108[2]) + (dsp->fConst474 * dsp->fRec108[1]))));
			float fTemp63 = (dsp->fConst460 * (((dsp->fConst461 * dsp->fRec108[1]) + (dsp->fConst475 * dsp->fRec108[0])) + (dsp->fConst475 * dsp->fRec108[2])));
			dsp->fRec107[0] = (fTemp63 - (dsp->fConst457 * ((dsp->fConst476 * dsp->fRec107[2]) + (dsp->fConst478 * dsp->fRec107[1]))));
			dsp->fRec106[0] = ((dsp->fConst457 * (((dsp->fConst459 * dsp->fRec107[1]) + (dsp->fConst479 * dsp->fRec107[0])) + (dsp->fConst479 * dsp->fRec107[2]))) - (dsp->fConst454 * ((dsp->fConst480 * dsp->fRec106[2]) + (dsp->fConst481 * dsp->fRec106[1]))));
			dsp->fRec105[0] = ((dsp->fConst454 * (((dsp->fConst456 * dsp->fRec106[1]) + (dsp->fConst482 * dsp->fRec106[0])) + (dsp->fConst482 * dsp->fRec106[2]))) - (dsp->fConst450 * ((dsp->fConst483 * dsp->fRec105[2]) + (dsp->fConst484 * dsp->fRec105[1]))));
			dsp->fRec104[0] = ((fSlow1 * dsp->fRec104[1]) + (fSlow2 * fabsf((dsp->fConst450 * (((dsp->fConst453 * dsp->fRec105[1]) + (dsp->fConst485 * dsp->fRec105[0])) + (dsp->fConst485 * dsp->fRec105[2]))))));
			dsp->fVbargraph12 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec104[0]))));
			dsp->fRec117[0] = (fTemp63 - (dsp->fConst502 * ((dsp->fConst505 * dsp->fRec117[2]) + (dsp->fConst506 * dsp->fRec117[1]))));
			dsp->fRec116[0] = ((dsp->fConst502 * (((dsp->fConst504 * dsp->fRec117[1]) + (dsp->fConst507 * dsp->fRec117[0])) + (dsp->fConst507 * dsp->fRec117[2]))) - (dsp->fConst500 * ((dsp->fConst508 * dsp->fRec116[2]) + (dsp->fConst509 * dsp->fRec116[1]))));
			dsp->fRec115[0] = ((dsp->fConst500 * (((dsp->fConst501 * dsp->fRec116[1]) + (dsp->fConst510 * dsp->fRec116[0])) + (dsp->fConst510 * dsp->fRec116[2]))) - (dsp->fConst498 * ((dsp->fConst511 * dsp->fRec115[2]) + (dsp->fConst512 * dsp->fRec115[1]))));
			float fTemp64 = (dsp->fConst498 * (((dsp->fConst499 * dsp->fRec115[1]) + (dsp->fConst513 * dsp->fRec115[0])) + (dsp->fConst513 * dsp->fRec115[2])));
			dsp->fRec114[0] = (fTemp64 - (dsp->fConst495 * ((dsp->fConst514 * dsp->fRec114[2]) + (dsp->fConst516 * dsp->fRec114[1]))));
			dsp->fRec113[0] = ((dsp->fConst495 * (((dsp->fConst497 * dsp->fRec114[1]) + (dsp->fConst517 * dsp->fRec114[0])) + (dsp->fConst517 * dsp->fRec114[2]))) - (dsp->fConst492 * ((dsp->fConst518 * dsp->fRec113[2]) + (dsp->fConst519 * dsp->fRec113[1]))));
			dsp->fRec112[0] = ((dsp->fConst492 * (((dsp->fConst494 * dsp->fRec113[1]) + (dsp->fConst520 * dsp->fRec113[0])) + (dsp->fConst520 * dsp->fRec113[2]))) - (dsp->fConst488 * ((dsp->fConst521 * dsp->fRec112[2]) + (dsp->fConst522 * dsp->fRec112[1]))));
			dsp->fRec111[0] = ((fSlow1 * dsp->fRec111[1]) + (fSlow2 * fabsf((dsp->fConst488 * (((dsp->fConst491 * dsp->fRec112[1]) + (dsp->fConst523 * dsp->fRec112[0])) + (dsp->fConst523 * dsp->fRec112[2]))))));
			dsp->fVbargraph13 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec111[0]))));
			dsp->fRec121[0] = (fTemp64 - (dsp->fConst528 * ((dsp->fConst531 * dsp->fRec121[2]) + (dsp->fConst532 * dsp->fRec121[1]))));
			dsp->fRec120[0] = ((dsp->fConst528 * (((dsp->fConst530 * dsp->fRec121[1]) + (dsp->fConst533 * dsp->fRec121[0])) + (dsp->fConst533 * dsp->fRec121[2]))) - (dsp->fConst526 * ((dsp->fConst534 * dsp->fRec120[2]) + (dsp->fConst535 * dsp->fRec120[1]))));
			dsp->fRec119[0] = ((dsp->fConst526 * (((dsp->fConst527 * dsp->fRec120[1]) + (dsp->fConst536 * dsp->fRec120[0])) + (dsp->fConst536 * dsp->fRec120[2]))) - (dsp->fConst524 * ((dsp->fConst537 * dsp->fRec119[2]) + (dsp->fConst538 * dsp->fRec119[1]))));
			dsp->fRec118[0] = ((fSlow1 * dsp->fRec118[1]) + (fSlow2 * fabsf((dsp->fConst524 * (((dsp->fConst525 * dsp->fRec119[1]) + (dsp->fConst539 * dsp->fRec119[0])) + (dsp->fConst539 * dsp->fRec119[2]))))));
			dsp->fVbargraph14 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec118[0]))));
			output0[i] = (FAUSTFLOAT)fTemp51;
			output1[i] = (FAUSTFLOAT)fTemp51;
			/* C99 loop */
			{
				int j0;
