...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "name", "lowboost");
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "low-freq shelving boost");
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "freq", &dsp->fHslider0, 1000.0f, 20.0f, 20000.0f, 0.100000001f);
	...
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "gain", &dsp->fHslider1, 0.0f, -20.0f, 20.0f, 0.100000001f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow2 = powf(10.0f, (0.0500000007f * (float)dsp->fHslider1));
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			dsp->fRec0[0] = ((float)input0[i] - (fSlow1 * ((fSlow5 * dsp->fRec0[2]) + (fSlow6 * dsp->fRec0[1]))));
			output0[i] = (FAUSTFLOAT)(fSlow1 * (((fSlow4 * dsp->fRec0[1]) + (fSlow9 * dsp->fRec0[0])) + (fSlow10 * dsp->fRec0[2])));
