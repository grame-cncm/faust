...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "description", "Demonstrate the Fourth-Order Wah pedal (similar to the Moog VCF)");
	...
	m->declare(m->metaInterface, "name", "wahPedal");
...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fHslider0 = (FAUSTFLOAT)200.0f;
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider0, "tooltip", "wah resonance   frequency in Hz");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Resonance Frequency", &dsp->fHslider0, 200.0f, 100.0f, 2000.0f, 1.0f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			...
			dsp->fRec5[0] = (fSlow1 + (0.999000013f * dsp->fRec5[1]));
			float fTemp1 = (dsp->fConst0 * dsp->fRec5[0]);
			float fTemp2 = (1.0f - fTemp1);
			dsp->fRec4[0] = (((iSlow0?0.0f:fTemp0) + (fTemp2 * dsp->fRec4[1])) - (3.20000005f * dsp->fRec0[1]));
			dsp->fRec3[0] = (dsp->fRec4[0] + (fTemp2 * dsp->fRec3[1]));
			dsp->fRec2[0] = (dsp->fRec3[0] + (fTemp2 * dsp->fRec2[1]));
			dsp->fRec1[0] = (dsp->fRec2[0] + (dsp->fRec1[1] * fTemp2));
			dsp->fRec0[0] = (dsp->fRec1[0] * powf(fTemp1, 4.0f));
			output0[i] = (FAUSTFLOAT)(iSlow0?fTemp0:(4.0f * dsp->fRec0[0]));
