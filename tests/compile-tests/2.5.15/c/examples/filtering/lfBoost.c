...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "name", "lfboost");
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "lowboost");
	...
	ui_interface->addNumEntry(ui_interface->uiInterface, "freq", &dsp->fEntry0, 100.0f, 20.0f, 150.0f, 1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider0, "unit", "dB");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "gain", &dsp->fVslider0, 0.0f, -20.0f, 20.0f, 0.100000001f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow2 = powf(10.0f, (0.0500000007f * (float)dsp->fVslider0));
