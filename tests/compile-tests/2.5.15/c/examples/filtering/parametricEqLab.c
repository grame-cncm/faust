...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "description", "Demonstrate the Parametric Equalizer sections on test signals with spectrum analysis display");
	...
	m->declare(m->metaInterface, "name", "parametricEqLab");
...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fHslider2 = (FAUSTFLOAT)8000.0f;
	...
	dsp->fHslider5 = (FAUSTFLOAT)49.0f;
	dsp->fHslider6 = (FAUSTFLOAT)0.0f;
	dsp->fHslider7 = (FAUSTFLOAT)40.0f;
...
void instanceConstantsmydsp(mydsp* dsp, int samplingFreq) {
	...
	dsp->fConst19 = (1382.30078f / dsp->fConst0);
	dsp->fConst20 = (1382.30078f * dsp->fConst15);
	dsp->fConst21 = (2764.60156f * dsp->fConst15);
	...
	dsp->fConst32 = tanf((35543.0625f / dsp->fConst0));
	...
	dsp->fConst70 = tanf((25132.7422f / dsp->fConst0));
	...
	dsp->fConst108 = tanf((17771.5312f / dsp->fConst0));
	...
	dsp->fConst146 = tanf((12566.3711f / dsp->fConst0));
	...
	dsp->fConst184 = tanf((8885.76562f / dsp->fConst0));
	...
	dsp->fConst222 = tanf((6283.18555f / dsp->fConst0));
	...
	dsp->fConst260 = tanf((4442.88281f / dsp->fConst0));
	...
	dsp->fConst298 = tanf((3141.59277f / dsp->fConst0));
	...
	dsp->fConst336 = tanf((2221.44141f / dsp->fConst0));
	...
	dsp->fConst374 = tanf((1570.79639f / dsp->fConst0));
	...
	dsp->fConst412 = tanf((1110.7207f / dsp->fConst0));
	...
	dsp->fConst450 = tanf((785.398193f / dsp->fConst0));
	...
	dsp->fConst488 = tanf((555.360352f / dsp->fConst0));
	...
	dsp->fConst526 = tanf((392.699097f / dsp->fConst0));
	dsp->fConst527 = (1.0f / dsp->fConst526);
	dsp->fConst528 = (1.0f / (((dsp->fConst527 + 0.157482162f) / dsp->fConst526) + 0.935140193f));
	dsp->fConst529 = mydsp_faustpower2_f(dsp->fConst526);
	dsp->fConst530 = (50.0638084f / dsp->fConst529);
	dsp->fConst531 = (2.0f * (0.935140193f - dsp->fConst530));
	dsp->fConst532 = (1.0f / (((dsp->fConst527 + 0.743130445f) / dsp->fConst526) + 1.4500711f));
	dsp->fConst533 = (11.0520525f / dsp->fConst529);
	dsp->fConst534 = (2.0f * (1.4500711f - dsp->fConst533));
	dsp->fConst535 = (1.0f / (((dsp->fConst527 + 3.18972731f) / dsp->fConst526) + 4.07678175f));
	dsp->fConst536 = (0.00176617282f / dsp->fConst529);
	dsp->fConst537 = (2.0f * (0.000407678192f - dsp->fConst536));
	dsp->fConst538 = (1.0f / (((dsp->fConst489 + 0.168404877f) / dsp->fConst488) + 1.06935835f));
	dsp->fConst539 = (2.0f * (53.5361519f - dsp->fConst517));
	dsp->fConst540 = (1.0f / (((dsp->fConst489 + 0.51247865f) / dsp->fConst488) + 0.689621389f));
	dsp->fConst541 = (2.0f * (7.62173128f - dsp->fConst517));
	dsp->fConst542 = (1.0f / (((dsp->fConst489 + 0.782413065f) / dsp->fConst488) + 0.245291501f));
	dsp->fConst543 = (9.99999975e-05f / dsp->fConst491);
	dsp->fConst544 = (2.0f * (0.000433227193f - dsp->fConst543));
	dsp->fConst545 = (((dsp->fConst489 + -0.782413065f) / dsp->fConst488) + 0.245291501f);
	dsp->fConst546 = (2.0f * (0.245291501f - dsp->fConst517));
	dsp->fConst547 = (dsp->fConst543 + 0.000433227193f);
	dsp->fConst548 = (((dsp->fConst489 + -0.51247865f) / dsp->fConst488) + 0.689621389f);
	dsp->fConst549 = (2.0f * (0.689621389f - dsp->fConst517));
	dsp->fConst550 = (dsp->fConst517 + 7.62173128f);
	dsp->fConst551 = (((dsp->fConst489 + -0.168404877f) / dsp->fConst488) + 1.06935835f);
	dsp->fConst552 = (2.0f * (1.06935835f - dsp->fConst517));
	dsp->fConst553 = (dsp->fConst517 + 53.5361519f);
	dsp->fConst554 = (((dsp->fConst527 + -3.18972731f) / dsp->fConst526) + 4.07678175f);
	dsp->fConst555 = (1.0f / dsp->fConst529);
	dsp->fConst556 = (2.0f * (4.07678175f - dsp->fConst555));
	dsp->fConst557 = (dsp->fConst536 + 0.000407678192f);
	dsp->fConst558 = (((dsp->fConst527 + -0.743130445f) / dsp->fConst526) + 1.4500711f);
	dsp->fConst559 = (2.0f * (1.4500711f - dsp->fConst555));
	dsp->fConst560 = (dsp->fConst533 + 1.4500711f);
	dsp->fConst561 = (((dsp->fConst527 + -0.157482162f) / dsp->fConst526) + 0.935140193f);
	dsp->fConst562 = (2.0f * (0.935140193f - dsp->fConst555));
	dsp->fConst563 = (dsp->fConst530 + 0.935140193f);
	dsp->fConst564 = tanf((277.680176f / dsp->fConst0));
	dsp->fConst565 = (1.0f / dsp->fConst564);
	dsp->fConst566 = (1.0f / (((dsp->fConst565 + 0.157482162f) / dsp->fConst564) + 0.935140193f));
	dsp->fConst567 = mydsp_faustpower2_f(dsp->fConst564);
	dsp->fConst568 = (50.0638084f / dsp->fConst567);
	dsp->fConst569 = (2.0f * (0.935140193f - dsp->fConst568));
	dsp->fConst570 = (1.0f / (((dsp->fConst565 + 0.743130445f) / dsp->fConst564) + 1.4500711f));
	dsp->fConst571 = (11.0520525f / dsp->fConst567);
	dsp->fConst572 = (2.0f * (1.4500711f - dsp->fConst571));
	dsp->fConst573 = (1.0f / (((dsp->fConst565 + 3.18972731f) / dsp->fConst564) + 4.07678175f));
	dsp->fConst574 = (0.00176617282f / dsp->fConst567);
	dsp->fConst575 = (2.0f * (0.000407678192f - dsp->fConst574));
	dsp->fConst576 = (1.0f / (((dsp->fConst527 + 0.168404877f) / dsp->fConst526) + 1.06935835f));
	dsp->fConst577 = (2.0f * (53.5361519f - dsp->fConst555));
	dsp->fConst578 = (1.0f / (((dsp->fConst527 + 0.51247865f) / dsp->fConst526) + 0.689621389f));
	dsp->fConst579 = (2.0f * (7.62173128f - dsp->fConst555));
	dsp->fConst580 = (1.0f / (((dsp->fConst527 + 0.782413065f) / dsp->fConst526) + 0.245291501f));
	dsp->fConst581 = (9.99999975e-05f / dsp->fConst529);
	dsp->fConst582 = (2.0f * (0.000433227193f - dsp->fConst581));
	dsp->fConst583 = (((dsp->fConst527 + -0.782413065f) / dsp->fConst526) + 0.245291501f);
	dsp->fConst584 = (2.0f * (0.245291501f - dsp->fConst555));
	dsp->fConst585 = (dsp->fConst581 + 0.000433227193f);
	dsp->fConst586 = (((dsp->fConst527 + -0.51247865f) / dsp->fConst526) + 0.689621389f);
	dsp->fConst587 = (2.0f * (0.689621389f - dsp->fConst555));
	dsp->fConst588 = (dsp->fConst555 + 7.62173128f);
	dsp->fConst589 = (((dsp->fConst527 + -0.168404877f) / dsp->fConst526) + 1.06935835f);
	dsp->fConst590 = (2.0f * (1.06935835f - dsp->fConst555));
	dsp->fConst591 = (dsp->fConst555 + 53.5361519f);
	dsp->fConst592 = (((dsp->fConst565 + -3.18972731f) / dsp->fConst564) + 4.07678175f);
	dsp->fConst593 = (1.0f / dsp->fConst567);
	dsp->fConst594 = (2.0f * (4.07678175f - dsp->fConst593));
	dsp->fConst595 = (dsp->fConst574 + 0.000407678192f);
	dsp->fConst596 = (((dsp->fConst565 + -0.743130445f) / dsp->fConst564) + 1.4500711f);
	dsp->fConst597 = (2.0f * (1.4500711f - dsp->fConst593));
	dsp->fConst598 = (dsp->fConst571 + 1.4500711f);
	dsp->fConst599 = (((dsp->fConst565 + -0.157482162f) / dsp->fConst564) + 0.935140193f);
	dsp->fConst600 = (2.0f * (0.935140193f - dsp->fConst593));
	dsp->fConst601 = (dsp->fConst568 + 0.935140193f);
	dsp->fConst602 = tanf((196.349548f / dsp->fConst0));
	dsp->fConst603 = (1.0f / dsp->fConst602);
	dsp->fConst604 = (1.0f / (((dsp->fConst603 + 0.157482162f) / dsp->fConst602) + 0.935140193f));
	dsp->fConst605 = mydsp_faustpower2_f(dsp->fConst602);
	dsp->fConst606 = (50.0638084f / dsp->fConst605);
	dsp->fConst607 = (2.0f * (0.935140193f - dsp->fConst606));
	dsp->fConst608 = (1.0f / (((dsp->fConst603 + 0.743130445f) / dsp->fConst602) + 1.4500711f));
	dsp->fConst609 = (11.0520525f / dsp->fConst605);
	dsp->fConst610 = (2.0f * (1.4500711f - dsp->fConst609));
	dsp->fConst611 = (1.0f / (((dsp->fConst603 + 3.18972731f) / dsp->fConst602) + 4.07678175f));
	dsp->fConst612 = (0.00176617282f / dsp->fConst605);
	dsp->fConst613 = (2.0f * (0.000407678192f - dsp->fConst612));
	dsp->fConst614 = (1.0f / (((dsp->fConst565 + 0.168404877f) / dsp->fConst564) + 1.06935835f));
	dsp->fConst615 = (2.0f * (53.5361519f - dsp->fConst593));
	dsp->fConst616 = (1.0f / (((dsp->fConst565 + 0.51247865f) / dsp->fConst564) + 0.689621389f));
	dsp->fConst617 = (2.0f * (7.62173128f - dsp->fConst593));
	dsp->fConst618 = (1.0f / (((dsp->fConst565 + 0.782413065f) / dsp->fConst564) + 0.245291501f));
	dsp->fConst619 = (9.99999975e-05f / dsp->fConst567);
	dsp->fConst620 = (2.0f * (0.000433227193f - dsp->fConst619));
	dsp->fConst621 = (((dsp->fConst565 + -0.782413065f) / dsp->fConst564) + 0.245291501f);
	dsp->fConst622 = (2.0f * (0.245291501f - dsp->fConst593));
	dsp->fConst623 = (dsp->fConst619 + 0.000433227193f);
	dsp->fConst624 = (((dsp->fConst565 + -0.51247865f) / dsp->fConst564) + 0.689621389f);
	dsp->fConst625 = (2.0f * (0.689621389f - dsp->fConst593));
	dsp->fConst626 = (dsp->fConst593 + 7.62173128f);
	dsp->fConst627 = (((dsp->fConst565 + -0.168404877f) / dsp->fConst564) + 1.06935835f);
	dsp->fConst628 = (2.0f * (1.06935835f - dsp->fConst593));
	dsp->fConst629 = (dsp->fConst593 + 53.5361519f);
	dsp->fConst630 = (((dsp->fConst603 + -3.18972731f) / dsp->fConst602) + 4.07678175f);
	dsp->fConst631 = (1.0f / dsp->fConst605);
	dsp->fConst632 = (2.0f * (4.07678175f - dsp->fConst631));
	dsp->fConst633 = (dsp->fConst612 + 0.000407678192f);
	dsp->fConst634 = (((dsp->fConst603 + -0.743130445f) / dsp->fConst602) + 1.4500711f);
	dsp->fConst635 = (2.0f * (1.4500711f - dsp->fConst631));
	dsp->fConst636 = (dsp->fConst609 + 1.4500711f);
	dsp->fConst637 = (((dsp->fConst603 + -0.157482162f) / dsp->fConst602) + 0.935140193f);
	dsp->fConst638 = (2.0f * (0.935140193f - dsp->fConst631));
	dsp->fConst639 = (dsp->fConst606 + 0.935140193f);
	dsp->fConst640 = tanf((138.840088f / dsp->fConst0));
	dsp->fConst641 = (1.0f / dsp->fConst640);
	dsp->fConst642 = (1.0f / (((dsp->fConst641 + 0.157482162f) / dsp->fConst640) + 0.935140193f));
	dsp->fConst643 = mydsp_faustpower2_f(dsp->fConst640);
	dsp->fConst644 = (50.0638084f / dsp->fConst643);
	dsp->fConst645 = (2.0f * (0.935140193f - dsp->fConst644));
	dsp->fConst646 = (1.0f / (((dsp->fConst641 + 0.743130445f) / dsp->fConst640) + 1.4500711f));
	dsp->fConst647 = (11.0520525f / dsp->fConst643);
	dsp->fConst648 = (2.0f * (1.4500711f - dsp->fConst647));
	dsp->fConst649 = (1.0f / (((dsp->fConst641 + 3.18972731f) / dsp->fConst640) + 4.07678175f));
	dsp->fConst650 = (0.00176617282f / dsp->fConst643);
	dsp->fConst651 = (2.0f * (0.000407678192f - dsp->fConst650));
	dsp->fConst652 = (1.0f / (((dsp->fConst603 + 0.168404877f) / dsp->fConst602) + 1.06935835f));
	dsp->fConst653 = (2.0f * (53.5361519f - dsp->fConst631));
	dsp->fConst654 = (1.0f / (((dsp->fConst603 + 0.51247865f) / dsp->fConst602) + 0.689621389f));
	dsp->fConst655 = (2.0f * (7.62173128f - dsp->fConst631));
	dsp->fConst656 = (1.0f / (((dsp->fConst603 + 0.782413065f) / dsp->fConst602) + 0.245291501f));
	dsp->fConst657 = (9.99999975e-05f / dsp->fConst605);
	dsp->fConst658 = (2.0f * (0.000433227193f - dsp->fConst657));
	dsp->fConst659 = (((dsp->fConst603 + -0.782413065f) / dsp->fConst602) + 0.245291501f);
	dsp->fConst660 = (2.0f * (0.245291501f - dsp->fConst631));
	dsp->fConst661 = (dsp->fConst657 + 0.000433227193f);
	dsp->fConst662 = (((dsp->fConst603 + -0.51247865f) / dsp->fConst602) + 0.689621389f);
	dsp->fConst663 = (2.0f * (0.689621389f - dsp->fConst631));
	dsp->fConst664 = (dsp->fConst631 + 7.62173128f);
	dsp->fConst665 = (((dsp->fConst603 + -0.168404877f) / dsp->fConst602) + 1.06935835f);
	dsp->fConst666 = (2.0f * (1.06935835f - dsp->fConst631));
	dsp->fConst667 = (dsp->fConst631 + 53.5361519f);
	dsp->fConst668 = (((dsp->fConst641 + -3.18972731f) / dsp->fConst640) + 4.07678175f);
	dsp->fConst669 = (1.0f / dsp->fConst643);
	dsp->fConst670 = (2.0f * (4.07678175f - dsp->fConst669));
	dsp->fConst671 = (dsp->fConst650 + 0.000407678192f);
	dsp->fConst672 = (((dsp->fConst641 + -0.743130445f) / dsp->fConst640) + 1.4500711f);
	dsp->fConst673 = (2.0f * (1.4500711f - dsp->fConst669));
	dsp->fConst674 = (dsp->fConst647 + 1.4500711f);
	dsp->fConst675 = (((dsp->fConst641 + -0.157482162f) / dsp->fConst640) + 0.935140193f);
	dsp->fConst676 = (2.0f * (0.935140193f - dsp->fConst669));
	dsp->fConst677 = (dsp->fConst644 + 0.935140193f);
	dsp->fConst678 = tanf((98.1747742f / dsp->fConst0));
	dsp->fConst679 = (1.0f / dsp->fConst678);
	dsp->fConst680 = (1.0f / (((dsp->fConst679 + 0.157482162f) / dsp->fConst678) + 0.935140193f));
	dsp->fConst681 = mydsp_faustpower2_f(dsp->fConst678);
	dsp->fConst682 = (50.0638084f / dsp->fConst681);
	dsp->fConst683 = (2.0f * (0.935140193f - dsp->fConst682));
	dsp->fConst684 = (1.0f / (((dsp->fConst679 + 0.743130445f) / dsp->fConst678) + 1.4500711f));
	dsp->fConst685 = (11.0520525f / dsp->fConst681);
	dsp->fConst686 = (2.0f * (1.4500711f - dsp->fConst685));
	dsp->fConst687 = (1.0f / (((dsp->fConst679 + 3.18972731f) / dsp->fConst678) + 4.07678175f));
	dsp->fConst688 = (0.00176617282f / dsp->fConst681);
	dsp->fConst689 = (2.0f * (0.000407678192f - dsp->fConst688));
	dsp->fConst690 = (1.0f / (((dsp->fConst641 + 0.168404877f) / dsp->fConst640) + 1.06935835f));
	dsp->fConst691 = (2.0f * (53.5361519f - dsp->fConst669));
	dsp->fConst692 = (1.0f / (((dsp->fConst641 + 0.51247865f) / dsp->fConst640) + 0.689621389f));
	dsp->fConst693 = (2.0f * (7.62173128f - dsp->fConst669));
	dsp->fConst694 = (1.0f / (((dsp->fConst641 + 0.782413065f) / dsp->fConst640) + 0.245291501f));
	dsp->fConst695 = (9.99999975e-05f / dsp->fConst643);
	dsp->fConst696 = (2.0f * (0.000433227193f - dsp->fConst695));
	dsp->fConst697 = (((dsp->fConst641 + -0.782413065f) / dsp->fConst640) + 0.245291501f);
	dsp->fConst698 = (2.0f * (0.245291501f - dsp->fConst669));
	dsp->fConst699 = (dsp->fConst695 + 0.000433227193f);
	dsp->fConst700 = (((dsp->fConst641 + -0.51247865f) / dsp->fConst640) + 0.689621389f);
	dsp->fConst701 = (2.0f * (0.689621389f - dsp->fConst669));
	dsp->fConst702 = (dsp->fConst669 + 7.62173128f);
	dsp->fConst703 = (((dsp->fConst641 + -0.168404877f) / dsp->fConst640) + 1.06935835f);
	dsp->fConst704 = (2.0f * (1.06935835f - dsp->fConst669));
	dsp->fConst705 = (dsp->fConst669 + 53.5361519f);
	dsp->fConst706 = (((dsp->fConst679 + -3.18972731f) / dsp->fConst678) + 4.07678175f);
	dsp->fConst707 = (1.0f / dsp->fConst681);
	dsp->fConst708 = (2.0f * (4.07678175f - dsp->fConst707));
	dsp->fConst709 = (dsp->fConst688 + 0.000407678192f);
	dsp->fConst710 = (((dsp->fConst679 + -0.743130445f) / dsp->fConst678) + 1.4500711f);
	dsp->fConst711 = (2.0f * (1.4500711f - dsp->fConst707));
	dsp->fConst712 = (dsp->fConst685 + 1.4500711f);
	dsp->fConst713 = (((dsp->fConst679 + -0.157482162f) / dsp->fConst678) + 0.935140193f);
	dsp->fConst714 = (2.0f * (0.935140193f - dsp->fConst707));
	dsp->fConst715 = (dsp->fConst682 + 0.935140193f);
	dsp->fConst716 = (1.0f / (((dsp->fConst679 + 0.168404877f) / dsp->fConst678) + 1.06935835f));
	dsp->fConst717 = (2.0f * (53.5361519f - dsp->fConst707));
	dsp->fConst718 = (1.0f / (((dsp->fConst679 + 0.51247865f) / dsp->fConst678) + 0.689621389f));
	dsp->fConst719 = (2.0f * (7.62173128f - dsp->fConst707));
	dsp->fConst720 = (1.0f / (((dsp->fConst679 + 0.782413065f) / dsp->fConst678) + 0.245291501f));
	dsp->fConst721 = (9.99999975e-05f / dsp->fConst681);
	dsp->fConst722 = (2.0f * (0.000433227193f - dsp->fConst721));
	dsp->fConst723 = (((dsp->fConst679 + -0.782413065f) / dsp->fConst678) + 0.245291501f);
	dsp->fConst724 = (2.0f * (0.245291501f - dsp->fConst707));
	dsp->fConst725 = (dsp->fConst721 + 0.000433227193f);
	dsp->fConst726 = (((dsp->fConst679 + -0.51247865f) / dsp->fConst678) + 0.689621389f);
	dsp->fConst727 = (2.0f * (0.689621389f - dsp->fConst707));
	dsp->fConst728 = (dsp->fConst707 + 7.62173128f);
	dsp->fConst729 = (((dsp->fConst679 + -0.168404877f) / dsp->fConst678) + 1.06935835f);
	dsp->fConst730 = (2.0f * (1.06935835f - dsp->fConst707));
	dsp->fConst731 = (dsp->fConst707 + 53.5361519f);
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "parametricEqLab");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "tooltip", "Amount of low-frequency boost or cut in decibels");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Low Boost|Cut", &dsp->fHslider4, 0.0f, -40.0f, 40.0f, 0.100000001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "tooltip", "Transition-frequency from boost (cut) to unity gain");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "unit", "Hz");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Transition Frequency", &dsp->fHslider3, 200.0f, 1.0f, 5000.0f, 1.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "2", "");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider6, "tooltip", "Amount of   local boost or cut in decibels");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider6, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Peak Boost|Cut", &dsp->fHslider6, 0.0f, -40.0f, 40.0f, 0.100000001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider5, "tooltip", "Peak   Frequency in Piano Key (PK) units (A440 = 49PK)");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider5, "unit", "PK");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Peak Frequency", &dsp->fHslider5, 49.0f, 1.0f, 100.0f, 1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider7, "2", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider7, "scale", "log");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider7, "style", "knob");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider7, "tooltip", "Quality factor   (Q) of the peak = center-frequency/bandwidth");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Peak Q", &dsp->fHslider7, 40.0f, 1.0f, 1000.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider8, "tooltip", "Amount of   high-frequency boost or cut in decibels");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider8, "unit", "dB");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "High Boost|Cut", &dsp->fHslider8, 0.0f, -40.0f, 40.0f, 0.100000001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "tooltip", "Transition-frequency from boost (cut) to unity gain");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider2, "unit", "Hz");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "Transition Frequency", &dsp->fHslider2, 8000.0f, 20.0f, 10000.0f, 1.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "3", "");
	...
	ui_interface->openHorizontalBox(ui_interface->uiInterface, "CONSTANT-Q SPECTRUM ANALYZER (6E), 20 bands spanning    LP, 9 octaves below 16000 Hz, HP");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph19, "0", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph19, "tooltip", "Spectral Band Level in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph19, "unit", "dB");
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1f76dd0", &dsp->fVbargraph19, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph18, "1", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph18, "tooltip", "Spectral Band Level in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph18, "unit", "dB");
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1f65470", &dsp->fVbargraph18, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph17, "2", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph17, "tooltip", "Spectral Band Level in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph17, "unit", "dB");
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1f43320", &dsp->fVbargraph17, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph16, "3", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph16, "tooltip", "Spectral Band Level in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph16, "unit", "dB");
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1f211d0", &dsp->fVbargraph16, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph15, "4", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph15, "tooltip", "Spectral Band Level in dB");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph15, "unit", "dB");
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1efb100", &dsp->fVbargraph15, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph14, "5", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1ed8fb0", &dsp->fVbargraph14, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph13, "6", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1eb6e60", &dsp->fVbargraph13, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph12, "7", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1e94d10", &dsp->fVbargraph12, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph11, "8", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1e72bc0", &dsp->fVbargraph11, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph10, "9", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1e50a70", &dsp->fVbargraph10, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph9, "10", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1e2e920", &dsp->fVbargraph9, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph8, "11", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1e0c7d0", &dsp->fVbargraph8, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph7, "12", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1de6700", &dsp->fVbargraph7, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph6, "13", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1dc45b0", &dsp->fVbargraph6, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph5, "14", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1da2460", &dsp->fVbargraph5, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph4, "15", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1d80310", &dsp->fVbargraph4, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph3, "16", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1d5e1c0", &dsp->fVbargraph3, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph2, "17", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1d3c070", &dsp->fVbargraph2, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph1, "18", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1d19f20", &dsp->fVbargraph1, -50.0f, 10.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVbargraph0, "19", "");
	...
	ui_interface->addVerticalBargraph(ui_interface->uiInterface, "0x7f9cb1cf2dc0", &dsp->fVbargraph0, -50.0f, 10.0f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->declare(ui_interface->uiInterface, 0, "1", "");
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow3 = tanf((dsp->fConst14 * (float)dsp->fHslider2));
	...
	float fSlow9 = tanf((dsp->fConst14 * (float)dsp->fHslider3));
	...
	float fSlow18 = (0.00100000005f * powf(10.0f, (0.0500000007f * (float)dsp->fVslider0)));
	int iSlow19 = (int)(float)dsp->fCheckbox0;
	int iSlow20 = (int)(float)dsp->fCheckbox1;
	int iSlow21 = (int)((float)dsp->fEntry0 + -1.0f);
	int iSlow22 = (iSlow21 >= 2);
	int iSlow23 = (iSlow21 >= 1);
	float fSlow24 = expf((0.0f - (dsp->fConst15 / (float)dsp->fVslider2)));
	float fSlow25 = (440.0f * (powf(2.0f, (0.0833333358f * ((float)dsp->fVslider1 + -49.0f))) * (1.0f - fSlow24)));
	int iSlow26 = (iSlow21 >= 3);
	float fSlow27 = ((0.00999999978f * (float)dsp->fVslider3) + 1.0f);
	float fSlow28 = ((0.00999999978f * (float)dsp->fVslider4) + 1.0f);
	int iSlow29 = (int)(float)dsp->fCheckbox2;
	float fSlow30 = (((fSlow10 + -1.0f) / fSlow9) + 1.0f);
	float fSlow31 = (2.0f * (1.0f - fSlow12));
	float fSlow32 = powf(10.0f, (0.0500000007f * (float)dsp->fHslider4));
	float fSlow33 = (0.00100000005f * (float)dsp->fHslider5);
	float fSlow34 = (float)dsp->fHslider6;
	int iSlow35 = (fSlow34 > 0.0f);
	float fSlow36 = (float)dsp->fHslider7;
	float fSlow37 = (dsp->fConst20 * (powf(10.0f, (0.0500000007f * fabsf(fSlow34))) / fSlow36));
	float fSlow38 = (dsp->fConst20 / fSlow36);
	float fSlow39 = (1.0f / mydsp_faustpower2_f(fSlow3));
	float fSlow40 = (2.0f * (1.0f - fSlow39));
	float fSlow41 = (((fSlow4 + -1.0f) / fSlow3) + 1.0f);
	float fSlow42 = powf(10.0f, (0.0500000007f * (float)dsp->fHslider8));
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			dsp->iVec0[0] = 1;
			dsp->fRec9[0] = (fSlow18 + (0.999000013f * dsp->fRec9[1]));
			dsp->fRec11[0] = (fSlow25 + (fSlow24 * dsp->fRec11[1]));
			float fTemp0 = max(20.0f, fabsf(dsp->fRec11[0]));
			dsp->fVec1[0] = fTemp0;
			float fTemp1 = (dsp->fRec10[1] + (dsp->fConst15 * dsp->fVec1[1]));
			dsp->fRec10[0] = (fTemp1 - floorf(fTemp1));
			float fTemp2 = (2.0f * dsp->fRec10[0]);
			...
			dsp->fVec7[0] = fTemp9;
			float fTemp10 = max(20.0f, fabsf((fSlow27 * dsp->fRec11[0])));
			dsp->fVec8[0] = fTemp10;
			float fTemp11 = (dsp->fRec12[1] + (dsp->fConst15 * dsp->fVec8[1]));
			dsp->fRec12[0] = (fTemp11 - floorf(fTemp11));
			float fTemp12 = (2.0f * dsp->fRec12[0]);
			...
			float fTemp20 = max(20.0f, fabsf((fSlow28 * dsp->fRec11[0])));
			dsp->fVec15[0] = fTemp20;
			float fTemp21 = (dsp->fRec13[1] + (dsp->fConst15 * dsp->fVec15[1]));
			dsp->fRec13[0] = (fTemp21 - floorf(fTemp21));
			float fTemp22 = (2.0f * dsp->fRec13[0]);
			...
			float fTemp30 = (4.65661287e-10f * (float)dsp->iRec14[0]);
			dsp->fRec15[0] = (((0.522189379f * dsp->fRec15[3]) + (fTemp30 + (2.49495602f * dsp->fRec15[1]))) - (2.0172658f * dsp->fRec15[2]));
			float fTemp31 = (dsp->fRec9[0] * (iSlow19?(float)input0[i]:(iSlow20?(iSlow29?(((0.0499220341f * dsp->fRec15[0]) + (0.0506126992f * dsp->fRec15[2])) - ((0.0959935337f * dsp->fRec15[1]) + (0.00440878607f * dsp->fRec15[3]))):fTemp30):(0.333333343f * (dsp->fRec9[0] * (((iSlow22?(iSlow26?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp9 - dsp->fVec7[1])) / fTemp0)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp6 - dsp->fVec4[1])) / fTemp0))):(iSlow23?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp4 - dsp->fVec2[1])) / fTemp0)):fTemp3)) + (iSlow22?(iSlow26?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp19 - dsp->fVec14[1])) / fTemp10)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp16 - dsp->fVec11[1])) / fTemp10))):(iSlow23?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp14 - dsp->fVec9[1])) / fTemp10)):fTemp13))) + (iSlow22?(iSlow26?(dsp->fConst18 * (((float)dsp->iVec0[3] * (fTemp29 - dsp->fVec21[1])) / fTemp20)):(dsp->fConst17 * (((float)dsp->iVec0[2] * (fTemp26 - dsp->fVec18[1])) / fTemp20))):(iSlow23?(dsp->fConst16 * (((float)dsp->iVec0[1] * (fTemp24 - dsp->fVec16[1])) / fTemp20)):fTemp23))))))));
			dsp->fVec22[0] = fTemp31;
			dsp->fRec8[0] = ((fSlow15 * dsp->fRec8[1]) + (fSlow16 * ((fSlow17 * dsp->fVec22[1]) + (fSlow10 * fTemp31))));
			dsp->fRec7[0] = (dsp->fRec8[0] - (fSlow11 * ((fSlow30 * dsp->fRec7[2]) + (fSlow31 * dsp->fRec7[1]))));
			dsp->fRec17[0] = ((fSlow15 * dsp->fRec17[1]) + (fSlow16 * (fTemp31 + dsp->fVec22[1])));
			dsp->fRec16[0] = (dsp->fRec17[0] - (fSlow11 * ((fSlow31 * dsp->fRec16[1]) + (fSlow30 * dsp->fRec16[2]))));
			dsp->fRec18[0] = (fSlow33 + (0.999000013f * dsp->fRec18[1]));
			float fTemp32 = powf(2.0f, (0.0833333358f * (dsp->fRec18[0] + -49.0f)));
			float fTemp33 = tanf((dsp->fConst19 * fTemp32));
			float fTemp34 = (1.0f / fTemp33);
			float fTemp35 = (fTemp32 / sinf((dsp->fConst21 * fTemp32)));
			float fTemp36 = (fSlow37 * fTemp35);
			float fTemp37 = (fSlow38 * fTemp35);
			float fTemp38 = (iSlow35?fTemp37:fTemp36);
			float fTemp39 = (2.0f * (dsp->fRec6[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp33)))));
			float fTemp40 = (((fTemp34 + fTemp38) / fTemp33) + 1.0f);
			dsp->fRec6[0] = ((fSlow11 * ((((fSlow13 * dsp->fRec7[1]) + (fSlow12 * dsp->fRec7[0])) + (fSlow12 * dsp->fRec7[2])) + (fSlow32 * (dsp->fRec16[2] + (dsp->fRec16[0] + (2.0f * dsp->fRec16[1])))))) - (((dsp->fRec6[2] * (((fTemp34 - fTemp38) / fTemp33) + 1.0f)) + fTemp39) / fTemp40));
			float fTemp41 = (iSlow35?fTemp36:fTemp37);
			float fTemp42 = (((fTemp39 + (dsp->fRec6[0] * (((fTemp34 + fTemp41) / fTemp33) + 1.0f))) + (dsp->fRec6[2] * (((fTemp34 - fTemp41) / fTemp33) + 1.0f))) / fTemp40);
			dsp->fVec23[0] = fTemp42;
			dsp->fRec5[0] = ((fSlow7 * dsp->fRec5[1]) + (fSlow8 * (fTemp42 + dsp->fVec23[1])));
			dsp->fRec4[0] = (dsp->fRec5[0] - (fSlow5 * ((fSlow40 * dsp->fRec4[1]) + (fSlow41 * dsp->fRec4[2]))));
			dsp->fRec20[0] = ((fSlow7 * dsp->fRec20[1]) + (fSlow8 * ((fSlow44 * dsp->fVec23[1]) + (fSlow4 * fTemp42))));
			dsp->fRec19[0] = (dsp->fRec20[0] - (fSlow5 * ((fSlow41 * dsp->fRec19[2]) + (fSlow40 * dsp->fRec19[1]))));
			float fTemp43 = (fSlow5 * ((dsp->fRec4[2] + (dsp->fRec4[0] + (2.0f * dsp->fRec4[1]))) + (fSlow42 * (((fSlow43 * dsp->fRec19[1]) + (fSlow39 * dsp->fRec19[0])) + (fSlow39 * dsp->fRec19[2])))));
			dsp->fRec3[0] = (fTemp43 - (dsp->fConst11 * ((dsp->fConst22 * dsp->fRec3[2]) + (dsp->fConst24 * dsp->fRec3[1]))));
			...
			dsp->fRec27[0] = (fTemp43 - (dsp->fConst48 * ((dsp->fConst51 * dsp->fRec27[2]) + (dsp->fConst52 * dsp->fRec27[1]))));
			dsp->fRec26[0] = ((dsp->fConst48 * (((dsp->fConst50 * dsp->fRec27[1]) + (dsp->fConst53 * dsp->fRec27[0])) + (dsp->fConst53 * dsp->fRec27[2]))) - (dsp->fConst46 * ((dsp->fConst54 * dsp->fRec26[2]) + (dsp->fConst55 * dsp->fRec26[1]))));
			dsp->fRec25[0] = ((dsp->fConst46 * (((dsp->fConst47 * dsp->fRec26[1]) + (dsp->fConst56 * dsp->fRec26[0])) + (dsp->fConst56 * dsp->fRec26[2]))) - (dsp->fConst44 * ((dsp->fConst57 * dsp->fRec25[2]) + (dsp->fConst58 * dsp->fRec25[1]))));
			float fTemp44 = (dsp->fConst44 * (((dsp->fConst45 * dsp->fRec25[1]) + (dsp->fConst59 * dsp->fRec25[0])) + (dsp->fConst59 * dsp->fRec25[2])));
			dsp->fRec24[0] = (fTemp44 - (dsp->fConst41 * ((dsp->fConst60 * dsp->fRec24[2]) + (dsp->fConst62 * dsp->fRec24[1]))));
			dsp->fRec23[0] = ((dsp->fConst41 * (((dsp->fConst43 * dsp->fRec24[1]) + (dsp->fConst63 * dsp->fRec24[0])) + (dsp->fConst63 * dsp->fRec24[2]))) - (dsp->fConst38 * ((dsp->fConst64 * dsp->fRec23[2]) + (dsp->fConst65 * dsp->fRec23[1]))));
			dsp->fRec22[0] = ((dsp->fConst38 * (((dsp->fConst40 * dsp->fRec23[1]) + (dsp->fConst66 * dsp->fRec23[0])) + (dsp->fConst66 * dsp->fRec23[2]))) - (dsp->fConst34 * ((dsp->fConst67 * dsp->fRec22[2]) + (dsp->fConst68 * dsp->fRec22[1]))));
			dsp->fRec21[0] = ((fSlow1 * dsp->fRec21[1]) + (fSlow2 * fabsf((dsp->fConst34 * (((dsp->fConst37 * dsp->fRec22[1]) + (dsp->fConst69 * dsp->fRec22[0])) + (dsp->fConst69 * dsp->fRec22[2]))))));
			dsp->fVbargraph1 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec21[0]))));
			dsp->fRec34[0] = (fTemp44 - (dsp->fConst86 * ((dsp->fConst89 * dsp->fRec34[2]) + (dsp->fConst90 * dsp->fRec34[1]))));
			dsp->fRec33[0] = ((dsp->fConst86 * (((dsp->fConst88 * dsp->fRec34[1]) + (dsp->fConst91 * dsp->fRec34[0])) + (dsp->fConst91 * dsp->fRec34[2]))) - (dsp->fConst84 * ((dsp->fConst92 * dsp->fRec33[2]) + (dsp->fConst93 * dsp->fRec33[1]))));
			dsp->fRec32[0] = ((dsp->fConst84 * (((dsp->fConst85 * dsp->fRec33[1]) + (dsp->fConst94 * dsp->fRec33[0])) + (dsp->fConst94 * dsp->fRec33[2]))) - (dsp->fConst82 * ((dsp->fConst95 * dsp->fRec32[2]) + (dsp->fConst96 * dsp->fRec32[1]))));
			float fTemp45 = (dsp->fConst82 * (((dsp->fConst83 * dsp->fRec32[1]) + (dsp->fConst97 * dsp->fRec32[0])) + (dsp->fConst97 * dsp->fRec32[2])));
			dsp->fRec31[0] = (fTemp45 - (dsp->fConst79 * ((dsp->fConst98 * dsp->fRec31[2]) + (dsp->fConst100 * dsp->fRec31[1]))));
			dsp->fRec30[0] = ((dsp->fConst79 * (((dsp->fConst81 * dsp->fRec31[1]) + (dsp->fConst101 * dsp->fRec31[0])) + (dsp->fConst101 * dsp->fRec31[2]))) - (dsp->fConst76 * ((dsp->fConst102 * dsp->fRec30[2]) + (dsp->fConst103 * dsp->fRec30[1]))));
			dsp->fRec29[0] = ((dsp->fConst76 * (((dsp->fConst78 * dsp->fRec30[1]) + (dsp->fConst104 * dsp->fRec30[0])) + (dsp->fConst104 * dsp->fRec30[2]))) - (dsp->fConst72 * ((dsp->fConst105 * dsp->fRec29[2]) + (dsp->fConst106 * dsp->fRec29[1]))));
			dsp->fRec28[0] = ((fSlow1 * dsp->fRec28[1]) + (fSlow2 * fabsf((dsp->fConst72 * (((dsp->fConst75 * dsp->fRec29[1]) + (dsp->fConst107 * dsp->fRec29[0])) + (dsp->fConst107 * dsp->fRec29[2]))))));
			dsp->fVbargraph2 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec28[0]))));
			dsp->fRec41[0] = (fTemp45 - (dsp->fConst124 * ((dsp->fConst127 * dsp->fRec41[2]) + (dsp->fConst128 * dsp->fRec41[1]))));
			dsp->fRec40[0] = ((dsp->fConst124 * (((dsp->fConst126 * dsp->fRec41[1]) + (dsp->fConst129 * dsp->fRec41[0])) + (dsp->fConst129 * dsp->fRec41[2]))) - (dsp->fConst122 * ((dsp->fConst130 * dsp->fRec40[2]) + (dsp->fConst131 * dsp->fRec40[1]))));
			dsp->fRec39[0] = ((dsp->fConst122 * (((dsp->fConst123 * dsp->fRec40[1]) + (dsp->fConst132 * dsp->fRec40[0])) + (dsp->fConst132 * dsp->fRec40[2]))) - (dsp->fConst120 * ((dsp->fConst133 * dsp->fRec39[2]) + (dsp->fConst134 * dsp->fRec39[1]))));
			float fTemp46 = (dsp->fConst120 * (((dsp->fConst121 * dsp->fRec39[1]) + (dsp->fConst135 * dsp->fRec39[0])) + (dsp->fConst135 * dsp->fRec39[2])));
			dsp->fRec38[0] = (fTemp46 - (dsp->fConst117 * ((dsp->fConst136 * dsp->fRec38[2]) + (dsp->fConst138 * dsp->fRec38[1]))));
			dsp->fRec37[0] = ((dsp->fConst117 * (((dsp->fConst119 * dsp->fRec38[1]) + (dsp->fConst139 * dsp->fRec38[0])) + (dsp->fConst139 * dsp->fRec38[2]))) - (dsp->fConst114 * ((dsp->fConst140 * dsp->fRec37[2]) + (dsp->fConst141 * dsp->fRec37[1]))));
			dsp->fRec36[0] = ((dsp->fConst114 * (((dsp->fConst116 * dsp->fRec37[1]) + (dsp->fConst142 * dsp->fRec37[0])) + (dsp->fConst142 * dsp->fRec37[2]))) - (dsp->fConst110 * ((dsp->fConst143 * dsp->fRec36[2]) + (dsp->fConst144 * dsp->fRec36[1]))));
			dsp->fRec35[0] = ((fSlow1 * dsp->fRec35[1]) + (fSlow2 * fabsf((dsp->fConst110 * (((dsp->fConst113 * dsp->fRec36[1]) + (dsp->fConst145 * dsp->fRec36[0])) + (dsp->fConst145 * dsp->fRec36[2]))))));
			dsp->fVbargraph3 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec35[0]))));
			dsp->fRec48[0] = (fTemp46 - (dsp->fConst162 * ((dsp->fConst165 * dsp->fRec48[2]) + (dsp->fConst166 * dsp->fRec48[1]))));
			dsp->fRec47[0] = ((dsp->fConst162 * (((dsp->fConst164 * dsp->fRec48[1]) + (dsp->fConst167 * dsp->fRec48[0])) + (dsp->fConst167 * dsp->fRec48[2]))) - (dsp->fConst160 * ((dsp->fConst168 * dsp->fRec47[2]) + (dsp->fConst169 * dsp->fRec47[1]))));
			dsp->fRec46[0] = ((dsp->fConst160 * (((dsp->fConst161 * dsp->fRec47[1]) + (dsp->fConst170 * dsp->fRec47[0])) + (dsp->fConst170 * dsp->fRec47[2]))) - (dsp->fConst158 * ((dsp->fConst171 * dsp->fRec46[2]) + (dsp->fConst172 * dsp->fRec46[1]))));
			float fTemp47 = (dsp->fConst158 * (((dsp->fConst159 * dsp->fRec46[1]) + (dsp->fConst173 * dsp->fRec46[0])) + (dsp->fConst173 * dsp->fRec46[2])));
			dsp->fRec45[0] = (fTemp47 - (dsp->fConst155 * ((dsp->fConst174 * dsp->fRec45[2]) + (dsp->fConst176 * dsp->fRec45[1]))));
			dsp->fRec44[0] = ((dsp->fConst155 * (((dsp->fConst157 * dsp->fRec45[1]) + (dsp->fConst177 * dsp->fRec45[0])) + (dsp->fConst177 * dsp->fRec45[2]))) - (dsp->fConst152 * ((dsp->fConst178 * dsp->fRec44[2]) + (dsp->fConst179 * dsp->fRec44[1]))));
			dsp->fRec43[0] = ((dsp->fConst152 * (((dsp->fConst154 * dsp->fRec44[1]) + (dsp->fConst180 * dsp->fRec44[0])) + (dsp->fConst180 * dsp->fRec44[2]))) - (dsp->fConst148 * ((dsp->fConst181 * dsp->fRec43[2]) + (dsp->fConst182 * dsp->fRec43[1]))));
			dsp->fRec42[0] = ((fSlow1 * dsp->fRec42[1]) + (fSlow2 * fabsf((dsp->fConst148 * (((dsp->fConst151 * dsp->fRec43[1]) + (dsp->fConst183 * dsp->fRec43[0])) + (dsp->fConst183 * dsp->fRec43[2]))))));
			dsp->fVbargraph4 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec42[0]))));
			dsp->fRec55[0] = (fTemp47 - (dsp->fConst200 * ((dsp->fConst203 * dsp->fRec55[2]) + (dsp->fConst204 * dsp->fRec55[1]))));
			dsp->fRec54[0] = ((dsp->fConst200 * (((dsp->fConst202 * dsp->fRec55[1]) + (dsp->fConst205 * dsp->fRec55[0])) + (dsp->fConst205 * dsp->fRec55[2]))) - (dsp->fConst198 * ((dsp->fConst206 * dsp->fRec54[2]) + (dsp->fConst207 * dsp->fRec54[1]))));
			dsp->fRec53[0] = ((dsp->fConst198 * (((dsp->fConst199 * dsp->fRec54[1]) + (dsp->fConst208 * dsp->fRec54[0])) + (dsp->fConst208 * dsp->fRec54[2]))) - (dsp->fConst196 * ((dsp->fConst209 * dsp->fRec53[2]) + (dsp->fConst210 * dsp->fRec53[1]))));
			float fTemp48 = (dsp->fConst196 * (((dsp->fConst197 * dsp->fRec53[1]) + (dsp->fConst211 * dsp->fRec53[0])) + (dsp->fConst211 * dsp->fRec53[2])));
			dsp->fRec52[0] = (fTemp48 - (dsp->fConst193 * ((dsp->fConst212 * dsp->fRec52[2]) + (dsp->fConst214 * dsp->fRec52[1]))));
			dsp->fRec51[0] = ((dsp->fConst193 * (((dsp->fConst195 * dsp->fRec52[1]) + (dsp->fConst215 * dsp->fRec52[0])) + (dsp->fConst215 * dsp->fRec52[2]))) - (dsp->fConst190 * ((dsp->fConst216 * dsp->fRec51[2]) + (dsp->fConst217 * dsp->fRec51[1]))));
			dsp->fRec50[0] = ((dsp->fConst190 * (((dsp->fConst192 * dsp->fRec51[1]) + (dsp->fConst218 * dsp->fRec51[0])) + (dsp->fConst218 * dsp->fRec51[2]))) - (dsp->fConst186 * ((dsp->fConst219 * dsp->fRec50[2]) + (dsp->fConst220 * dsp->fRec50[1]))));
			dsp->fRec49[0] = ((fSlow1 * dsp->fRec49[1]) + (fSlow2 * fabsf((dsp->fConst186 * (((dsp->fConst189 * dsp->fRec50[1]) + (dsp->fConst221 * dsp->fRec50[0])) + (dsp->fConst221 * dsp->fRec50[2]))))));
			dsp->fVbargraph5 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec49[0]))));
			dsp->fRec62[0] = (fTemp48 - (dsp->fConst238 * ((dsp->fConst241 * dsp->fRec62[2]) + (dsp->fConst242 * dsp->fRec62[1]))));
			dsp->fRec61[0] = ((dsp->fConst238 * (((dsp->fConst240 * dsp->fRec62[1]) + (dsp->fConst243 * dsp->fRec62[0])) + (dsp->fConst243 * dsp->fRec62[2]))) - (dsp->fConst236 * ((dsp->fConst244 * dsp->fRec61[2]) + (dsp->fConst245 * dsp->fRec61[1]))));
			dsp->fRec60[0] = ((dsp->fConst236 * (((dsp->fConst237 * dsp->fRec61[1]) + (dsp->fConst246 * dsp->fRec61[0])) + (dsp->fConst246 * dsp->fRec61[2]))) - (dsp->fConst234 * ((dsp->fConst247 * dsp->fRec60[2]) + (dsp->fConst248 * dsp->fRec60[1]))));
			float fTemp49 = (dsp->fConst234 * (((dsp->fConst235 * dsp->fRec60[1]) + (dsp->fConst249 * dsp->fRec60[0])) + (dsp->fConst249 * dsp->fRec60[2])));
			dsp->fRec59[0] = (fTemp49 - (dsp->fConst231 * ((dsp->fConst250 * dsp->fRec59[2]) + (dsp->fConst252 * dsp->fRec59[1]))));
			dsp->fRec58[0] = ((dsp->fConst231 * (((dsp->fConst233 * dsp->fRec59[1]) + (dsp->fConst253 * dsp->fRec59[0])) + (dsp->fConst253 * dsp->fRec59[2]))) - (dsp->fConst228 * ((dsp->fConst254 * dsp->fRec58[2]) + (dsp->fConst255 * dsp->fRec58[1]))));
			dsp->fRec57[0] = ((dsp->fConst228 * (((dsp->fConst230 * dsp->fRec58[1]) + (dsp->fConst256 * dsp->fRec58[0])) + (dsp->fConst256 * dsp->fRec58[2]))) - (dsp->fConst224 * ((dsp->fConst257 * dsp->fRec57[2]) + (dsp->fConst258 * dsp->fRec57[1]))));
			dsp->fRec56[0] = ((fSlow1 * dsp->fRec56[1]) + (fSlow2 * fabsf((dsp->fConst224 * (((dsp->fConst227 * dsp->fRec57[1]) + (dsp->fConst259 * dsp->fRec57[0])) + (dsp->fConst259 * dsp->fRec57[2]))))));
			dsp->fVbargraph6 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec56[0]))));
			dsp->fRec69[0] = (fTemp49 - (dsp->fConst276 * ((dsp->fConst279 * dsp->fRec69[2]) + (dsp->fConst280 * dsp->fRec69[1]))));
			dsp->fRec68[0] = ((dsp->fConst276 * (((dsp->fConst278 * dsp->fRec69[1]) + (dsp->fConst281 * dsp->fRec69[0])) + (dsp->fConst281 * dsp->fRec69[2]))) - (dsp->fConst274 * ((dsp->fConst282 * dsp->fRec68[2]) + (dsp->fConst283 * dsp->fRec68[1]))));
			dsp->fRec67[0] = ((dsp->fConst274 * (((dsp->fConst275 * dsp->fRec68[1]) + (dsp->fConst284 * dsp->fRec68[0])) + (dsp->fConst284 * dsp->fRec68[2]))) - (dsp->fConst272 * ((dsp->fConst285 * dsp->fRec67[2]) + (dsp->fConst286 * dsp->fRec67[1]))));
			float fTemp50 = (dsp->fConst272 * (((dsp->fConst273 * dsp->fRec67[1]) + (dsp->fConst287 * dsp->fRec67[0])) + (dsp->fConst287 * dsp->fRec67[2])));
			dsp->fRec66[0] = (fTemp50 - (dsp->fConst269 * ((dsp->fConst288 * dsp->fRec66[2]) + (dsp->fConst290 * dsp->fRec66[1]))));
			dsp->fRec65[0] = ((dsp->fConst269 * (((dsp->fConst271 * dsp->fRec66[1]) + (dsp->fConst291 * dsp->fRec66[0])) + (dsp->fConst291 * dsp->fRec66[2]))) - (dsp->fConst266 * ((dsp->fConst292 * dsp->fRec65[2]) + (dsp->fConst293 * dsp->fRec65[1]))));
			dsp->fRec64[0] = ((dsp->fConst266 * (((dsp->fConst268 * dsp->fRec65[1]) + (dsp->fConst294 * dsp->fRec65[0])) + (dsp->fConst294 * dsp->fRec65[2]))) - (dsp->fConst262 * ((dsp->fConst295 * dsp->fRec64[2]) + (dsp->fConst296 * dsp->fRec64[1]))));
			dsp->fRec63[0] = ((fSlow1 * dsp->fRec63[1]) + (fSlow2 * fabsf((dsp->fConst262 * (((dsp->fConst265 * dsp->fRec64[1]) + (dsp->fConst297 * dsp->fRec64[0])) + (dsp->fConst297 * dsp->fRec64[2]))))));
			dsp->fVbargraph7 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec63[0]))));
			dsp->fRec76[0] = (fTemp50 - (dsp->fConst314 * ((dsp->fConst317 * dsp->fRec76[2]) + (dsp->fConst318 * dsp->fRec76[1]))));
			dsp->fRec75[0] = ((dsp->fConst314 * (((dsp->fConst316 * dsp->fRec76[1]) + (dsp->fConst319 * dsp->fRec76[0])) + (dsp->fConst319 * dsp->fRec76[2]))) - (dsp->fConst312 * ((dsp->fConst320 * dsp->fRec75[2]) + (dsp->fConst321 * dsp->fRec75[1]))));
			dsp->fRec74[0] = ((dsp->fConst312 * (((dsp->fConst313 * dsp->fRec75[1]) + (dsp->fConst322 * dsp->fRec75[0])) + (dsp->fConst322 * dsp->fRec75[2]))) - (dsp->fConst310 * ((dsp->fConst323 * dsp->fRec74[2]) + (dsp->fConst324 * dsp->fRec74[1]))));
			float fTemp51 = (dsp->fConst310 * (((dsp->fConst311 * dsp->fRec74[1]) + (dsp->fConst325 * dsp->fRec74[0])) + (dsp->fConst325 * dsp->fRec74[2])));
			dsp->fRec73[0] = (fTemp51 - (dsp->fConst307 * ((dsp->fConst326 * dsp->fRec73[2]) + (dsp->fConst328 * dsp->fRec73[1]))));
			dsp->fRec72[0] = ((dsp->fConst307 * (((dsp->fConst309 * dsp->fRec73[1]) + (dsp->fConst329 * dsp->fRec73[0])) + (dsp->fConst329 * dsp->fRec73[2]))) - (dsp->fConst304 * ((dsp->fConst330 * dsp->fRec72[2]) + (dsp->fConst331 * dsp->fRec72[1]))));
			dsp->fRec71[0] = ((dsp->fConst304 * (((dsp->fConst306 * dsp->fRec72[1]) + (dsp->fConst332 * dsp->fRec72[0])) + (dsp->fConst332 * dsp->fRec72[2]))) - (dsp->fConst300 * ((dsp->fConst333 * dsp->fRec71[2]) + (dsp->fConst334 * dsp->fRec71[1]))));
			dsp->fRec70[0] = ((fSlow1 * dsp->fRec70[1]) + (fSlow2 * fabsf((dsp->fConst300 * (((dsp->fConst303 * dsp->fRec71[1]) + (dsp->fConst335 * dsp->fRec71[0])) + (dsp->fConst335 * dsp->fRec71[2]))))));
			dsp->fVbargraph8 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec70[0]))));
			dsp->fRec83[0] = (fTemp51 - (dsp->fConst352 * ((dsp->fConst355 * dsp->fRec83[2]) + (dsp->fConst356 * dsp->fRec83[1]))));
			dsp->fRec82[0] = ((dsp->fConst352 * (((dsp->fConst354 * dsp->fRec83[1]) + (dsp->fConst357 * dsp->fRec83[0])) + (dsp->fConst357 * dsp->fRec83[2]))) - (dsp->fConst350 * ((dsp->fConst358 * dsp->fRec82[2]) + (dsp->fConst359 * dsp->fRec82[1]))));
			dsp->fRec81[0] = ((dsp->fConst350 * (((dsp->fConst351 * dsp->fRec82[1]) + (dsp->fConst360 * dsp->fRec82[0])) + (dsp->fConst360 * dsp->fRec82[2]))) - (dsp->fConst348 * ((dsp->fConst361 * dsp->fRec81[2]) + (dsp->fConst362 * dsp->fRec81[1]))));
			float fTemp52 = (dsp->fConst348 * (((dsp->fConst349 * dsp->fRec81[1]) + (dsp->fConst363 * dsp->fRec81[0])) + (dsp->fConst363 * dsp->fRec81[2])));
			dsp->fRec80[0] = (fTemp52 - (dsp->fConst345 * ((dsp->fConst364 * dsp->fRec80[2]) + (dsp->fConst366 * dsp->fRec80[1]))));
			dsp->fRec79[0] = ((dsp->fConst345 * (((dsp->fConst347 * dsp->fRec80[1]) + (dsp->fConst367 * dsp->fRec80[0])) + (dsp->fConst367 * dsp->fRec80[2]))) - (dsp->fConst342 * ((dsp->fConst368 * dsp->fRec79[2]) + (dsp->fConst369 * dsp->fRec79[1]))));
			dsp->fRec78[0] = ((dsp->fConst342 * (((dsp->fConst344 * dsp->fRec79[1]) + (dsp->fConst370 * dsp->fRec79[0])) + (dsp->fConst370 * dsp->fRec79[2]))) - (dsp->fConst338 * ((dsp->fConst371 * dsp->fRec78[2]) + (dsp->fConst372 * dsp->fRec78[1]))));
			dsp->fRec77[0] = ((fSlow1 * dsp->fRec77[1]) + (fSlow2 * fabsf((dsp->fConst338 * (((dsp->fConst341 * dsp->fRec78[1]) + (dsp->fConst373 * dsp->fRec78[0])) + (dsp->fConst373 * dsp->fRec78[2]))))));
			dsp->fVbargraph9 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec77[0]))));
			dsp->fRec90[0] = (fTemp52 - (dsp->fConst390 * ((dsp->fConst393 * dsp->fRec90[2]) + (dsp->fConst394 * dsp->fRec90[1]))));
			dsp->fRec89[0] = ((dsp->fConst390 * (((dsp->fConst392 * dsp->fRec90[1]) + (dsp->fConst395 * dsp->fRec90[0])) + (dsp->fConst395 * dsp->fRec90[2]))) - (dsp->fConst388 * ((dsp->fConst396 * dsp->fRec89[2]) + (dsp->fConst397 * dsp->fRec89[1]))));
			dsp->fRec88[0] = ((dsp->fConst388 * (((dsp->fConst389 * dsp->fRec89[1]) + (dsp->fConst398 * dsp->fRec89[0])) + (dsp->fConst398 * dsp->fRec89[2]))) - (dsp->fConst386 * ((dsp->fConst399 * dsp->fRec88[2]) + (dsp->fConst400 * dsp->fRec88[1]))));
			float fTemp53 = (dsp->fConst386 * (((dsp->fConst387 * dsp->fRec88[1]) + (dsp->fConst401 * dsp->fRec88[0])) + (dsp->fConst401 * dsp->fRec88[2])));
			dsp->fRec87[0] = (fTemp53 - (dsp->fConst383 * ((dsp->fConst402 * dsp->fRec87[2]) + (dsp->fConst404 * dsp->fRec87[1]))));
			dsp->fRec86[0] = ((dsp->fConst383 * (((dsp->fConst385 * dsp->fRec87[1]) + (dsp->fConst405 * dsp->fRec87[0])) + (dsp->fConst405 * dsp->fRec87[2]))) - (dsp->fConst380 * ((dsp->fConst406 * dsp->fRec86[2]) + (dsp->fConst407 * dsp->fRec86[1]))));
			dsp->fRec85[0] = ((dsp->fConst380 * (((dsp->fConst382 * dsp->fRec86[1]) + (dsp->fConst408 * dsp->fRec86[0])) + (dsp->fConst408 * dsp->fRec86[2]))) - (dsp->fConst376 * ((dsp->fConst409 * dsp->fRec85[2]) + (dsp->fConst410 * dsp->fRec85[1]))));
			dsp->fRec84[0] = ((fSlow1 * dsp->fRec84[1]) + (fSlow2 * fabsf((dsp->fConst376 * (((dsp->fConst379 * dsp->fRec85[1]) + (dsp->fConst411 * dsp->fRec85[0])) + (dsp->fConst411 * dsp->fRec85[2]))))));
			dsp->fVbargraph10 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec84[0]))));
			dsp->fRec97[0] = (fTemp53 - (dsp->fConst428 * ((dsp->fConst431 * dsp->fRec97[2]) + (dsp->fConst432 * dsp->fRec97[1]))));
			dsp->fRec96[0] = ((dsp->fConst428 * (((dsp->fConst430 * dsp->fRec97[1]) + (dsp->fConst433 * dsp->fRec97[0])) + (dsp->fConst433 * dsp->fRec97[2]))) - (dsp->fConst426 * ((dsp->fConst434 * dsp->fRec96[2]) + (dsp->fConst435 * dsp->fRec96[1]))));
			dsp->fRec95[0] = ((dsp->fConst426 * (((dsp->fConst427 * dsp->fRec96[1]) + (dsp->fConst436 * dsp->fRec96[0])) + (dsp->fConst436 * dsp->fRec96[2]))) - (dsp->fConst424 * ((dsp->fConst437 * dsp->fRec95[2]) + (dsp->fConst438 * dsp->fRec95[1]))));
			float fTemp54 = (dsp->fConst424 * (((dsp->fConst425 * dsp->fRec95[1]) + (dsp->fConst439 * dsp->fRec95[0])) + (dsp->fConst439 * dsp->fRec95[2])));
			dsp->fRec94[0] = (fTemp54 - (dsp->fConst421 * ((dsp->fConst440 * dsp->fRec94[2]) + (dsp->fConst442 * dsp->fRec94[1]))));
			dsp->fRec93[0] = ((dsp->fConst421 * (((dsp->fConst423 * dsp->fRec94[1]) + (dsp->fConst443 * dsp->fRec94[0])) + (dsp->fConst443 * dsp->fRec94[2]))) - (dsp->fConst418 * ((dsp->fConst444 * dsp->fRec93[2]) + (dsp->fConst445 * dsp->fRec93[1]))));
			dsp->fRec92[0] = ((dsp->fConst418 * (((dsp->fConst420 * dsp->fRec93[1]) + (dsp->fConst446 * dsp->fRec93[0])) + (dsp->fConst446 * dsp->fRec93[2]))) - (dsp->fConst414 * ((dsp->fConst447 * dsp->fRec92[2]) + (dsp->fConst448 * dsp->fRec92[1]))));
			dsp->fRec91[0] = ((fSlow1 * dsp->fRec91[1]) + (fSlow2 * fabsf((dsp->fConst414 * (((dsp->fConst417 * dsp->fRec92[1]) + (dsp->fConst449 * dsp->fRec92[0])) + (dsp->fConst449 * dsp->fRec92[2]))))));
			dsp->fVbargraph11 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec91[0]))));
			dsp->fRec104[0] = (fTemp54 - (dsp->fConst466 * ((dsp->fConst469 * dsp->fRec104[2]) + (dsp->fConst470 * dsp->fRec104[1]))));
			dsp->fRec103[0] = ((dsp->fConst466 * (((dsp->fConst468 * dsp->fRec104[1]) + (dsp->fConst471 * dsp->fRec104[0])) + (dsp->fConst471 * dsp->fRec104[2]))) - (dsp->fConst464 * ((dsp->fConst472 * dsp->fRec103[2]) + (dsp->fConst473 * dsp->fRec103[1]))));
			dsp->fRec102[0] = ((dsp->fConst464 * (((dsp->fConst465 * dsp->fRec103[1]) + (dsp->fConst474 * dsp->fRec103[0])) + (dsp->fConst474 * dsp->fRec103[2]))) - (dsp->fConst462 * ((dsp->fConst475 * dsp->fRec102[2]) + (dsp->fConst476 * dsp->fRec102[1]))));
			float fTemp55 = (dsp->fConst462 * (((dsp->fConst463 * dsp->fRec102[1]) + (dsp->fConst477 * dsp->fRec102[0])) + (dsp->fConst477 * dsp->fRec102[2])));
			dsp->fRec101[0] = (fTemp55 - (dsp->fConst459 * ((dsp->fConst478 * dsp->fRec101[2]) + (dsp->fConst480 * dsp->fRec101[1]))));
			dsp->fRec100[0] = ((dsp->fConst459 * (((dsp->fConst461 * dsp->fRec101[1]) + (dsp->fConst481 * dsp->fRec101[0])) + (dsp->fConst481 * dsp->fRec101[2]))) - (dsp->fConst456 * ((dsp->fConst482 * dsp->fRec100[2]) + (dsp->fConst483 * dsp->fRec100[1]))));
			dsp->fRec99[0] = ((dsp->fConst456 * (((dsp->fConst458 * dsp->fRec100[1]) + (dsp->fConst484 * dsp->fRec100[0])) + (dsp->fConst484 * dsp->fRec100[2]))) - (dsp->fConst452 * ((dsp->fConst485 * dsp->fRec99[2]) + (dsp->fConst486 * dsp->fRec99[1]))));
			dsp->fRec98[0] = ((fSlow1 * dsp->fRec98[1]) + (fSlow2 * fabsf((dsp->fConst452 * (((dsp->fConst455 * dsp->fRec99[1]) + (dsp->fConst487 * dsp->fRec99[0])) + (dsp->fConst487 * dsp->fRec99[2]))))));
			dsp->fVbargraph12 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec98[0]))));
			dsp->fRec111[0] = (fTemp55 - (dsp->fConst504 * ((dsp->fConst507 * dsp->fRec111[2]) + (dsp->fConst508 * dsp->fRec111[1]))));
			dsp->fRec110[0] = ((dsp->fConst504 * (((dsp->fConst506 * dsp->fRec111[1]) + (dsp->fConst509 * dsp->fRec111[0])) + (dsp->fConst509 * dsp->fRec111[2]))) - (dsp->fConst502 * ((dsp->fConst510 * dsp->fRec110[2]) + (dsp->fConst511 * dsp->fRec110[1]))));
			dsp->fRec109[0] = ((dsp->fConst502 * (((dsp->fConst503 * dsp->fRec110[1]) + (dsp->fConst512 * dsp->fRec110[0])) + (dsp->fConst512 * dsp->fRec110[2]))) - (dsp->fConst500 * ((dsp->fConst513 * dsp->fRec109[2]) + (dsp->fConst514 * dsp->fRec109[1]))));
			float fTemp56 = (dsp->fConst500 * (((dsp->fConst501 * dsp->fRec109[1]) + (dsp->fConst515 * dsp->fRec109[0])) + (dsp->fConst515 * dsp->fRec109[2])));
			dsp->fRec108[0] = (fTemp56 - (dsp->fConst497 * ((dsp->fConst516 * dsp->fRec108[2]) + (dsp->fConst518 * dsp->fRec108[1]))));
			dsp->fRec107[0] = ((dsp->fConst497 * (((dsp->fConst499 * dsp->fRec108[1]) + (dsp->fConst519 * dsp->fRec108[0])) + (dsp->fConst519 * dsp->fRec108[2]))) - (dsp->fConst494 * ((dsp->fConst520 * dsp->fRec107[2]) + (dsp->fConst521 * dsp->fRec107[1]))));
			dsp->fRec106[0] = ((dsp->fConst494 * (((dsp->fConst496 * dsp->fRec107[1]) + (dsp->fConst522 * dsp->fRec107[0])) + (dsp->fConst522 * dsp->fRec107[2]))) - (dsp->fConst490 * ((dsp->fConst523 * dsp->fRec106[2]) + (dsp->fConst524 * dsp->fRec106[1]))));
			dsp->fRec105[0] = ((fSlow1 * dsp->fRec105[1]) + (fSlow2 * fabsf((dsp->fConst490 * (((dsp->fConst493 * dsp->fRec106[1]) + (dsp->fConst525 * dsp->fRec106[0])) + (dsp->fConst525 * dsp->fRec106[2]))))));
			dsp->fVbargraph13 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec105[0]))));
			dsp->fRec118[0] = (fTemp56 - (dsp->fConst542 * ((dsp->fConst545 * dsp->fRec118[2]) + (dsp->fConst546 * dsp->fRec118[1]))));
			dsp->fRec117[0] = ((dsp->fConst542 * (((dsp->fConst544 * dsp->fRec118[1]) + (dsp->fConst547 * dsp->fRec118[0])) + (dsp->fConst547 * dsp->fRec118[2]))) - (dsp->fConst540 * ((dsp->fConst548 * dsp->fRec117[2]) + (dsp->fConst549 * dsp->fRec117[1]))));
			dsp->fRec116[0] = ((dsp->fConst540 * (((dsp->fConst541 * dsp->fRec117[1]) + (dsp->fConst550 * dsp->fRec117[0])) + (dsp->fConst550 * dsp->fRec117[2]))) - (dsp->fConst538 * ((dsp->fConst551 * dsp->fRec116[2]) + (dsp->fConst552 * dsp->fRec116[1]))));
			float fTemp57 = (dsp->fConst538 * (((dsp->fConst539 * dsp->fRec116[1]) + (dsp->fConst553 * dsp->fRec116[0])) + (dsp->fConst553 * dsp->fRec116[2])));
			dsp->fRec115[0] = (fTemp57 - (dsp->fConst535 * ((dsp->fConst554 * dsp->fRec115[2]) + (dsp->fConst556 * dsp->fRec115[1]))));
			dsp->fRec114[0] = ((dsp->fConst535 * (((dsp->fConst537 * dsp->fRec115[1]) + (dsp->fConst557 * dsp->fRec115[0])) + (dsp->fConst557 * dsp->fRec115[2]))) - (dsp->fConst532 * ((dsp->fConst558 * dsp->fRec114[2]) + (dsp->fConst559 * dsp->fRec114[1]))));
			dsp->fRec113[0] = ((dsp->fConst532 * (((dsp->fConst534 * dsp->fRec114[1]) + (dsp->fConst560 * dsp->fRec114[0])) + (dsp->fConst560 * dsp->fRec114[2]))) - (dsp->fConst528 * ((dsp->fConst561 * dsp->fRec113[2]) + (dsp->fConst562 * dsp->fRec113[1]))));
			dsp->fRec112[0] = ((fSlow1 * dsp->fRec112[1]) + (fSlow2 * fabsf((dsp->fConst528 * (((dsp->fConst531 * dsp->fRec113[1]) + (dsp->fConst563 * dsp->fRec113[0])) + (dsp->fConst563 * dsp->fRec113[2]))))));
			dsp->fVbargraph14 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec112[0]))));
			dsp->fRec125[0] = (fTemp57 - (dsp->fConst580 * ((dsp->fConst583 * dsp->fRec125[2]) + (dsp->fConst584 * dsp->fRec125[1]))));
			dsp->fRec124[0] = ((dsp->fConst580 * (((dsp->fConst582 * dsp->fRec125[1]) + (dsp->fConst585 * dsp->fRec125[0])) + (dsp->fConst585 * dsp->fRec125[2]))) - (dsp->fConst578 * ((dsp->fConst586 * dsp->fRec124[2]) + (dsp->fConst587 * dsp->fRec124[1]))));
			dsp->fRec123[0] = ((dsp->fConst578 * (((dsp->fConst579 * dsp->fRec124[1]) + (dsp->fConst588 * dsp->fRec124[0])) + (dsp->fConst588 * dsp->fRec124[2]))) - (dsp->fConst576 * ((dsp->fConst589 * dsp->fRec123[2]) + (dsp->fConst590 * dsp->fRec123[1]))));
			float fTemp58 = (dsp->fConst576 * (((dsp->fConst577 * dsp->fRec123[1]) + (dsp->fConst591 * dsp->fRec123[0])) + (dsp->fConst591 * dsp->fRec123[2])));
			dsp->fRec122[0] = (fTemp58 - (dsp->fConst573 * ((dsp->fConst592 * dsp->fRec122[2]) + (dsp->fConst594 * dsp->fRec122[1]))));
			dsp->fRec121[0] = ((dsp->fConst573 * (((dsp->fConst575 * dsp->fRec122[1]) + (dsp->fConst595 * dsp->fRec122[0])) + (dsp->fConst595 * dsp->fRec122[2]))) - (dsp->fConst570 * ((dsp->fConst596 * dsp->fRec121[2]) + (dsp->fConst597 * dsp->fRec121[1]))));
			dsp->fRec120[0] = ((dsp->fConst570 * (((dsp->fConst572 * dsp->fRec121[1]) + (dsp->fConst598 * dsp->fRec121[0])) + (dsp->fConst598 * dsp->fRec121[2]))) - (dsp->fConst566 * ((dsp->fConst599 * dsp->fRec120[2]) + (dsp->fConst600 * dsp->fRec120[1]))));
			dsp->fRec119[0] = ((fSlow1 * dsp->fRec119[1]) + (fSlow2 * fabsf((dsp->fConst566 * (((dsp->fConst569 * dsp->fRec120[1]) + (dsp->fConst601 * dsp->fRec120[0])) + (dsp->fConst601 * dsp->fRec120[2]))))));
			dsp->fVbargraph15 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec119[0]))));
			dsp->fRec132[0] = (fTemp58 - (dsp->fConst618 * ((dsp->fConst621 * dsp->fRec132[2]) + (dsp->fConst622 * dsp->fRec132[1]))));
			dsp->fRec131[0] = ((dsp->fConst618 * (((dsp->fConst620 * dsp->fRec132[1]) + (dsp->fConst623 * dsp->fRec132[0])) + (dsp->fConst623 * dsp->fRec132[2]))) - (dsp->fConst616 * ((dsp->fConst624 * dsp->fRec131[2]) + (dsp->fConst625 * dsp->fRec131[1]))));
			dsp->fRec130[0] = ((dsp->fConst616 * (((dsp->fConst617 * dsp->fRec131[1]) + (dsp->fConst626 * dsp->fRec131[0])) + (dsp->fConst626 * dsp->fRec131[2]))) - (dsp->fConst614 * ((dsp->fConst627 * dsp->fRec130[2]) + (dsp->fConst628 * dsp->fRec130[1]))));
			float fTemp59 = (dsp->fConst614 * (((dsp->fConst615 * dsp->fRec130[1]) + (dsp->fConst629 * dsp->fRec130[0])) + (dsp->fConst629 * dsp->fRec130[2])));
			dsp->fRec129[0] = (fTemp59 - (dsp->fConst611 * ((dsp->fConst630 * dsp->fRec129[2]) + (dsp->fConst632 * dsp->fRec129[1]))));
			dsp->fRec128[0] = ((dsp->fConst611 * (((dsp->fConst613 * dsp->fRec129[1]) + (dsp->fConst633 * dsp->fRec129[0])) + (dsp->fConst633 * dsp->fRec129[2]))) - (dsp->fConst608 * ((dsp->fConst634 * dsp->fRec128[2]) + (dsp->fConst635 * dsp->fRec128[1]))));
			dsp->fRec127[0] = ((dsp->fConst608 * (((dsp->fConst610 * dsp->fRec128[1]) + (dsp->fConst636 * dsp->fRec128[0])) + (dsp->fConst636 * dsp->fRec128[2]))) - (dsp->fConst604 * ((dsp->fConst637 * dsp->fRec127[2]) + (dsp->fConst638 * dsp->fRec127[1]))));
			dsp->fRec126[0] = ((fSlow1 * dsp->fRec126[1]) + (fSlow2 * fabsf((dsp->fConst604 * (((dsp->fConst607 * dsp->fRec127[1]) + (dsp->fConst639 * dsp->fRec127[0])) + (dsp->fConst639 * dsp->fRec127[2]))))));
			dsp->fVbargraph16 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec126[0]))));
			dsp->fRec139[0] = (fTemp59 - (dsp->fConst656 * ((dsp->fConst659 * dsp->fRec139[2]) + (dsp->fConst660 * dsp->fRec139[1]))));
			dsp->fRec138[0] = ((dsp->fConst656 * (((dsp->fConst658 * dsp->fRec139[1]) + (dsp->fConst661 * dsp->fRec139[0])) + (dsp->fConst661 * dsp->fRec139[2]))) - (dsp->fConst654 * ((dsp->fConst662 * dsp->fRec138[2]) + (dsp->fConst663 * dsp->fRec138[1]))));
			dsp->fRec137[0] = ((dsp->fConst654 * (((dsp->fConst655 * dsp->fRec138[1]) + (dsp->fConst664 * dsp->fRec138[0])) + (dsp->fConst664 * dsp->fRec138[2]))) - (dsp->fConst652 * ((dsp->fConst665 * dsp->fRec137[2]) + (dsp->fConst666 * dsp->fRec137[1]))));
			float fTemp60 = (dsp->fConst652 * (((dsp->fConst653 * dsp->fRec137[1]) + (dsp->fConst667 * dsp->fRec137[0])) + (dsp->fConst667 * dsp->fRec137[2])));
			dsp->fRec136[0] = (fTemp60 - (dsp->fConst649 * ((dsp->fConst668 * dsp->fRec136[2]) + (dsp->fConst670 * dsp->fRec136[1]))));
			dsp->fRec135[0] = ((dsp->fConst649 * (((dsp->fConst651 * dsp->fRec136[1]) + (dsp->fConst671 * dsp->fRec136[0])) + (dsp->fConst671 * dsp->fRec136[2]))) - (dsp->fConst646 * ((dsp->fConst672 * dsp->fRec135[2]) + (dsp->fConst673 * dsp->fRec135[1]))));
			dsp->fRec134[0] = ((dsp->fConst646 * (((dsp->fConst648 * dsp->fRec135[1]) + (dsp->fConst674 * dsp->fRec135[0])) + (dsp->fConst674 * dsp->fRec135[2]))) - (dsp->fConst642 * ((dsp->fConst675 * dsp->fRec134[2]) + (dsp->fConst676 * dsp->fRec134[1]))));
			dsp->fRec133[0] = ((fSlow1 * dsp->fRec133[1]) + (fSlow2 * fabsf((dsp->fConst642 * (((dsp->fConst645 * dsp->fRec134[1]) + (dsp->fConst677 * dsp->fRec134[0])) + (dsp->fConst677 * dsp->fRec134[2]))))));
			dsp->fVbargraph17 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec133[0]))));
			dsp->fRec146[0] = (fTemp60 - (dsp->fConst694 * ((dsp->fConst697 * dsp->fRec146[2]) + (dsp->fConst698 * dsp->fRec146[1]))));
			dsp->fRec145[0] = ((dsp->fConst694 * (((dsp->fConst696 * dsp->fRec146[1]) + (dsp->fConst699 * dsp->fRec146[0])) + (dsp->fConst699 * dsp->fRec146[2]))) - (dsp->fConst692 * ((dsp->fConst700 * dsp->fRec145[2]) + (dsp->fConst701 * dsp->fRec145[1]))));
			dsp->fRec144[0] = ((dsp->fConst692 * (((dsp->fConst693 * dsp->fRec145[1]) + (dsp->fConst702 * dsp->fRec145[0])) + (dsp->fConst702 * dsp->fRec145[2]))) - (dsp->fConst690 * ((dsp->fConst703 * dsp->fRec144[2]) + (dsp->fConst704 * dsp->fRec144[1]))));
			float fTemp61 = (dsp->fConst690 * (((dsp->fConst691 * dsp->fRec144[1]) + (dsp->fConst705 * dsp->fRec144[0])) + (dsp->fConst705 * dsp->fRec144[2])));
			dsp->fRec143[0] = (fTemp61 - (dsp->fConst687 * ((dsp->fConst706 * dsp->fRec143[2]) + (dsp->fConst708 * dsp->fRec143[1]))));
			dsp->fRec142[0] = ((dsp->fConst687 * (((dsp->fConst689 * dsp->fRec143[1]) + (dsp->fConst709 * dsp->fRec143[0])) + (dsp->fConst709 * dsp->fRec143[2]))) - (dsp->fConst684 * ((dsp->fConst710 * dsp->fRec142[2]) + (dsp->fConst711 * dsp->fRec142[1]))));
			dsp->fRec141[0] = ((dsp->fConst684 * (((dsp->fConst686 * dsp->fRec142[1]) + (dsp->fConst712 * dsp->fRec142[0])) + (dsp->fConst712 * dsp->fRec142[2]))) - (dsp->fConst680 * ((dsp->fConst713 * dsp->fRec141[2]) + (dsp->fConst714 * dsp->fRec141[1]))));
			dsp->fRec140[0] = ((fSlow1 * dsp->fRec140[1]) + (fSlow2 * fabsf((dsp->fConst680 * (((dsp->fConst683 * dsp->fRec141[1]) + (dsp->fConst715 * dsp->fRec141[0])) + (dsp->fConst715 * dsp->fRec141[2]))))));
			dsp->fVbargraph18 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec140[0]))));
			dsp->fRec150[0] = (fTemp61 - (dsp->fConst720 * ((dsp->fConst723 * dsp->fRec150[2]) + (dsp->fConst724 * dsp->fRec150[1]))));
			dsp->fRec149[0] = ((dsp->fConst720 * (((dsp->fConst722 * dsp->fRec150[1]) + (dsp->fConst725 * dsp->fRec150[0])) + (dsp->fConst725 * dsp->fRec150[2]))) - (dsp->fConst718 * ((dsp->fConst726 * dsp->fRec149[2]) + (dsp->fConst727 * dsp->fRec149[1]))));
			dsp->fRec148[0] = ((dsp->fConst718 * (((dsp->fConst719 * dsp->fRec149[1]) + (dsp->fConst728 * dsp->fRec149[0])) + (dsp->fConst728 * dsp->fRec149[2]))) - (dsp->fConst716 * ((dsp->fConst729 * dsp->fRec148[2]) + (dsp->fConst730 * dsp->fRec148[1]))));
			dsp->fRec147[0] = ((fSlow1 * dsp->fRec147[1]) + (fSlow2 * fabsf((dsp->fConst716 * (((dsp->fConst717 * dsp->fRec148[1]) + (dsp->fConst731 * dsp->fRec148[0])) + (dsp->fConst731 * dsp->fRec148[2]))))));
			dsp->fVbargraph19 = (FAUSTFLOAT)(fSlow0 + (20.0f * log10f(max(1.00000001e-07f, dsp->fRec147[0]))));
