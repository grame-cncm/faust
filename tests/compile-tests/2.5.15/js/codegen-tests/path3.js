...
function mydsp() {
	...
	this.buildUserInterface = function(ui_interface) {
		...
		ui_interface.addHorizontalSlider("slid1", function handler(obj) { function setval(val) { obj.fHslider1 = val; } return setval; }(this), 0, 0, 1, 0.1);
		...
		ui_interface.addHorizontalSlider("slid1", function handler(obj) { function setval(val) { obj.fHslider3 = val; } return setval; }(this), 0, 0, 1, 0.1);
		ui_interface.closeBox();
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow1 = (fSlow0 * this.fHslider1);
