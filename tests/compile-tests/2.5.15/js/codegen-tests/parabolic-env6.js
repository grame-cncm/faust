...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		for (var i = 0; (i < count); i = (i + 1)) {
			...
			var iTemp0 = ((this.iRec0[1] % 7) == 3);
			this.iVec0[0] = iTemp0;
			output1[i] = iTemp0;
			var iTemp1 = (((this.fRec1[1] > 0) | iTemp0) | this.iVec0[1]);
			this.fRec3[0] = ((this.fRec3[1] + -0.08) * iTemp1);
			this.fRec2[0] = (iTemp1 * ((this.fRec2[1] + this.fRec3[1]) + 0.36));
			this.fRec1[0] = max_f(0, this.fRec2[1]);
			output2[i] = (this.fRec1[0] * this.iRec0[3]);
			for (var j0 = 3; (j0 > 0); j0 = (j0 - 1)) {
				this.iRec0[j0] = this.iRec0[(j0 - 1)];
