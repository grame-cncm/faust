...
function mydsp() {
	...
	this.fRec2 = new Float32Array(131072);
	this.fRec3 = new Float32Array(131072);
	...
	this.instanceClear = function() {
		...
		for (var l2 = 0; (l2 < 131072); l2 = (l2 + 1)) {
			this.fRec2[l2] = 0;
			
		}
		for (var l3 = 0; (l3 < 131072); l3 = (l3 + 1)) {
			this.fRec3[l3] = 0;
	...
	this.compute = function(count, inputs, outputs) {
		...
		for (var i = 0; (i < count); i = (i + 1)) {
			...
			this.fRec2[(this.IOTA & 131071)] = (input2[i] + (fSlow0 * this.fRec2[((this.IOTA - iSlow1) & 131071)]));
			output2[i] = this.fRec2[((this.IOTA - 0) & 131071)];
			this.fRec3[(this.IOTA & 131071)] = (input3[i] + (fSlow0 * this.fRec3[((this.IOTA - iSlow1) & 131071)]));
			output3[i] = this.fRec3[((this.IOTA - 0) & 131071)];
