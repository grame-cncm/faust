...
function mydsp() {
	...
	this.fConst6;
	this.iConst7;
	this.fVec1 = new Float32Array(16384);
	this.fConst8;
	this.fVslider10;
	...
	this.fVec3 = new Float32Array(32768);
	this.fConst12;
	this.iConst13;
	...
	this.fVec5 = new Float32Array(16384);
	this.fConst17;
	this.iConst18;
	...
	this.fVec7 = new Float32Array(32768);
	this.fConst22;
	this.iConst23;
	...
	this.fVec9 = new Float32Array(16384);
	this.fConst27;
	this.iConst28;
	...
	this.instanceClear = function() {
		...
		this.IOTA = 0;
		for (var l4 = 0; (l4 < 32768); l4 = (l4 + 1)) {
			this.fVec0[l4] = 0;
			
		}
		for (var l5 = 0; (l5 < 16384); l5 = (l5 + 1)) {
			this.fVec1[l5] = 0;
		...
		for (var l10 = 0; (l10 < 32768); l10 = (l10 + 1)) {
			this.fVec3[l10] = 0;
			
		}
		for (var l11 = 0; (l11 < 4096); l11 = (l11 + 1)) {
			this.fVec4[l11] = 0;
		...
		for (var l15 = 0; (l15 < 16384); l15 = (l15 + 1)) {
			this.fVec5[l15] = 0;
			
		}
		for (var l16 = 0; (l16 < 4096); l16 = (l16 + 1)) {
			this.fVec6[l16] = 0;
		...
		for (var l20 = 0; (l20 < 32768); l20 = (l20 + 1)) {
			this.fVec7[l20] = 0;
			
		}
		for (var l21 = 0; (l21 < 4096); l21 = (l21 + 1)) {
			this.fVec8[l21] = 0;
		...
		for (var l25 = 0; (l25 < 16384); l25 = (l25 + 1)) {
			this.fVec9[l25] = 0;
	...
	this.compute = function(count, inputs, outputs) {
		...
		for (var i = 0; (i < count); i = (i + 1)) {
			...
			var fTemp0 = (this.fRec1[0] + 1);
			var fTemp1 = max_f(-1, min_f(1, (39.8107 * input0[i])));
			var fTemp2 = (1 - (0.333333 * mydsp_faustpower2_f(fTemp1)));
			var fTemp3 = (1 - (0.5 * fTemp0));
			...
			this.fVec0[(this.IOTA & 32767)] = ((0.353553 * this.fRec14[0]) + 1e-20);
			var fTemp4 = max_f(-1, min_f(1, (39.8107 * input1[i])));
			var fTemp5 = (1 - (0.333333 * mydsp_faustpower2_f(fTemp4)));
			this.fVec1[(this.IOTA & 16383)] = (fTemp4 * fTemp5);
			var fTemp6 = (0.3 * this.fVec1[((this.IOTA - iSlow26) & 16383)]);
			var fTemp7 = (((0.6 * this.fRec12[1]) + this.fVec0[((this.IOTA - this.iConst7) & 32767)]) - fTemp6);
			this.fVec2[(this.IOTA & 2047)] = fTemp7;
			this.fRec12[0] = this.fVec2[((this.IOTA - this.iConst9) & 2047)];
			var fRec13 = (0 - (0.6 * fTemp7));
			...
			this.fVec3[(this.IOTA & 32767)] = ((0.353553 * this.fRec18[0]) + 1e-20);
			var fTemp8 = (((0.6 * this.fRec16[1]) + this.fVec3[((this.IOTA - this.iConst13) & 32767)]) - fTemp6);
			this.fVec4[(this.IOTA & 4095)] = fTemp8;
			this.fRec16[0] = this.fVec4[((this.IOTA - this.iConst14) & 4095)];
			var fRec17 = (0 - (0.6 * fTemp8));
			...
			this.fVec5[(this.IOTA & 16383)] = ((0.353553 * this.fRec22[0]) + 1e-20);
			var fTemp9 = (this.fVec5[((this.IOTA - this.iConst18) & 16383)] + (fTemp6 + (0.6 * this.fRec20[1])));
			this.fVec6[(this.IOTA & 4095)] = fTemp9;
			this.fRec20[0] = this.fVec6[((this.IOTA - this.iConst19) & 4095)];
			var fRec21 = (0 - (0.6 * fTemp9));
			...
			this.fVec7[(this.IOTA & 32767)] = ((0.353553 * this.fRec26[0]) + 1e-20);
			var fTemp10 = (fTemp6 + ((0.6 * this.fRec24[1]) + this.fVec7[((this.IOTA - this.iConst23) & 32767)]));
			this.fVec8[(this.IOTA & 4095)] = fTemp10;
			this.fRec24[0] = this.fVec8[((this.IOTA - this.iConst24) & 4095)];
			var fRec25 = (0 - (0.6 * fTemp10));
			...
			this.fVec9[(this.IOTA & 16383)] = ((0.353553 * this.fRec30[0]) + 1e-20);
			this.fVec10[(this.IOTA & 16383)] = (fTemp1 * fTemp2);
			var fTemp11 = (0.3 * this.fVec10[((this.IOTA - iSlow26) & 16383)]);
			var fTemp12 = (this.fVec9[((this.IOTA - this.iConst28) & 16383)] - (fTemp11 + (0.6 * this.fRec28[1])));
			this.fVec11[(this.IOTA & 2047)] = fTemp12;
			this.fRec28[0] = this.fVec11[((this.IOTA - this.iConst29) & 2047)];
			var fRec29 = (0.6 * fTemp12);
			...
			var fTemp13 = (this.fVec12[((this.IOTA - this.iConst33) & 16383)] - (fTemp11 + (0.6 * this.fRec32[1])));
			this.fVec13[(this.IOTA & 4095)] = fTemp13;
			this.fRec32[0] = this.fVec13[((this.IOTA - this.iConst34) & 4095)];
			var fRec33 = (0.6 * fTemp13);
			...
			var fTemp14 = ((fTemp11 + this.fVec14[((this.IOTA - this.iConst38) & 16383)]) - (0.6 * this.fRec36[1]));
			this.fVec15[(this.IOTA & 4095)] = fTemp14;
			this.fRec36[0] = this.fVec15[((this.IOTA - this.iConst39) & 4095)];
			var fRec37 = (0.6 * fTemp14);
			...
			var fTemp15 = ((this.fVec16[((this.IOTA - this.iConst43) & 16383)] + fTemp11) - (0.6 * this.fRec40[1]));
			this.fVec17[(this.IOTA & 2047)] = fTemp15;
			this.fRec40[0] = this.fVec17[((this.IOTA - this.iConst44) & 2047)];
			var fRec41 = (0.6 * fTemp15);
			var fTemp16 = (fRec41 + fRec37);
			var fTemp17 = (fRec29 + (fRec33 + fTemp16));
			this.fRec4[0] = (this.fRec12[1] + (this.fRec16[1] + (this.fRec20[1] + (this.fRec24[1] + (this.fRec28[1] + (this.fRec32[1] + (this.fRec36[1] + (this.fRec40[1] + (fRec13 + (fRec17 + (fRec21 + (fRec25 + fTemp17))))))))))));
			this.fRec5[0] = ((this.fRec28[1] + (this.fRec32[1] + (this.fRec36[1] + (this.fRec40[1] + fTemp17)))) - (this.fRec12[1] + (this.fRec16[1] + (this.fRec20[1] + (this.fRec24[1] + (fRec13 + (fRec17 + (fRec25 + fRec21))))))));
			var fTemp18 = (fRec33 + fRec29);
			this.fRec6[0] = ((this.fRec20[1] + (this.fRec24[1] + (this.fRec36[1] + (this.fRec40[1] + (fRec21 + (fRec25 + fTemp16)))))) - (this.fRec12[1] + (this.fRec16[1] + (this.fRec28[1] + (this.fRec32[1] + (fRec13 + (fRec17 + fTemp18)))))));
			this.fRec7[0] = ((this.fRec12[1] + (this.fRec16[1] + (this.fRec36[1] + (this.fRec40[1] + (fRec13 + (fRec17 + fTemp16)))))) - (this.fRec20[1] + (this.fRec24[1] + (this.fRec28[1] + (this.fRec32[1] + (fRec21 + (fRec25 + fTemp18)))))));
			var fTemp19 = (fRec41 + fRec33);
			var fTemp20 = (fRec37 + fRec29);
			this.fRec8[0] = ((this.fRec16[1] + (this.fRec24[1] + (this.fRec32[1] + (this.fRec40[1] + (fRec17 + (fRec25 + fTemp19)))))) - (this.fRec12[1] + (this.fRec20[1] + (this.fRec28[1] + (this.fRec36[1] + (fRec13 + (fRec21 + fTemp20)))))));
			this.fRec9[0] = ((this.fRec12[1] + (this.fRec20[1] + (this.fRec32[1] + (this.fRec40[1] + (fRec13 + (fRec21 + fTemp19)))))) - (this.fRec16[1] + (this.fRec24[1] + (this.fRec28[1] + (this.fRec36[1] + (fRec17 + (fRec25 + fTemp20)))))));
			var fTemp21 = (fRec41 + fRec29);
			var fTemp22 = (fRec37 + fRec33);
			this.fRec10[0] = ((this.fRec12[1] + (this.fRec24[1] + (this.fRec28[1] + (this.fRec40[1] + (fRec13 + (fRec25 + fTemp21)))))) - (this.fRec16[1] + (this.fRec20[1] + (this.fRec32[1] + (this.fRec36[1] + (fRec17 + (fRec21 + fTemp22)))))));
			this.fRec11[0] = ((this.fRec16[1] + (this.fRec20[1] + (this.fRec28[1] + (this.fRec40[1] + (fRec17 + (fRec21 + fTemp21)))))) - (this.fRec12[1] + (this.fRec24[1] + (this.fRec32[1] + (this.fRec36[1] + (fRec13 + (fRec25 + fTemp22)))))));
			var fTemp23 = (0.37 * (this.fRec5[0] + this.fRec6[0]));
			var fTemp24 = (fSlow90 * this.fRec3[1]);
			this.fRec3[0] = (fTemp23 - (fTemp24 + (fSlow9 * this.fRec3[2])));
			var fTemp25 = (fSlow9 * this.fRec3[0]);
			var fTemp26 = (0.5 * ((fTemp25 + (this.fRec3[2] + (fTemp23 + fTemp24))) + (fSlow7 * ((fTemp25 + (fTemp24 + this.fRec3[2])) - fTemp23))));
			var fTemp27 = (fSlow91 * this.fRec2[1]);
			this.fRec2[0] = (fTemp26 - (fTemp27 + (fSlow5 * this.fRec2[2])));
			var fTemp28 = (fSlow5 * this.fRec2[0]);
			output0[i] = (0.5 * (this.fRec0[0] * (((fTemp0 * fTemp1) * fTemp2) + (fTemp3 * ((fTemp28 + (this.fRec2[2] + (fTemp26 + fTemp27))) + (fSlow3 * ((fTemp28 + (fTemp27 + this.fRec2[2])) - fTemp26)))))));
			var fTemp29 = (0.37 * (this.fRec5[0] - this.fRec6[0]));
			var fTemp30 = (fSlow90 * this.fRec45[1]);
			this.fRec45[0] = (fTemp29 - (fTemp30 + (fSlow9 * this.fRec45[2])));
			var fTemp31 = (fSlow9 * this.fRec45[0]);
			var fTemp32 = (0.5 * ((fTemp31 + (this.fRec45[2] + (fTemp29 + fTemp30))) + (fSlow7 * ((fTemp31 + (fTemp30 + this.fRec45[2])) - fTemp29))));
			var fTemp33 = (fSlow91 * this.fRec44[1]);
			this.fRec44[0] = (fTemp32 - (fTemp33 + (fSlow5 * this.fRec44[2])));
			var fTemp34 = (fSlow5 * this.fRec44[0]);
			output1[i] = (0.5 * (this.fRec0[0] * (((fTemp0 * fTemp4) * fTemp5) + (fTemp3 * ((fTemp34 + (this.fRec44[2] + (fTemp32 + fTemp33))) + (fSlow3 * ((fTemp34 + (fTemp33 + this.fRec44[2])) - fTemp32)))))));
