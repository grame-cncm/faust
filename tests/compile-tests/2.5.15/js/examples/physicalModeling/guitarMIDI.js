...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		for (var i = 0; (i < count); i = (i + 1)) {
			...
			var fTemp1 = ((fSlow3 / this.fRec30[0]) + -0.1);
			...
			this.fVec3[0] = (this.fVec1[1] + fTemp61);
			this.fRec32[(this.IOTA & 2047)] = ((0.05 * this.fRec32[((this.IOTA - 1) & 2047)]) + (0.95 * this.fVec3[1]));
			...
			var fRec22 = (fTemp61 + this.fRec21[1]);
			var fRec23 = fRec27;
			var iRec24 = iRec28;
