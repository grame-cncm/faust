...
function mydsp() {
	...
	this.fVec20 = new Float32Array(8192);
	this.fRec48 = new Float32Array(2);
	this.fRec51 = new Float32Array(2);
	this.fVec21 = new Float32Array(8192);
	...
	this.fVec24 = new Float32Array(2048);
	this.fRec30 = new Float32Array(2);
	this.fVec25 = new Float32Array(2048);
	...
	this.instanceConstants = function(samplingFreq) {
		...
		this.fConst4 = (0.075 / this.fConst0);
		this.fConst5 = (1 / this.fConst0);
		this.iConst6 = (0.0253061 * this.fConst0);
		this.iConst7 = (0.0269388 * this.fConst0);
		this.iConst8 = (0.0289569 * this.fConst0);
		this.iConst9 = (0.0307483 * this.fConst0);
		this.iConst10 = (0.0322449 * this.fConst0);
		this.iConst11 = (0.0338095 * this.fConst0);
		this.iConst12 = (0.0353061 * this.fConst0);
		this.iConst13 = (0.0366667 * this.fConst0);
		this.iConst14 = (0.0126077 * this.fConst0);
		this.iConst15 = min_i(1024, max_i(0, (this.iConst14 + -1)));
		this.iConst16 = (0.01 * this.fConst0);
		this.iConst17 = min_i(1024, max_i(0, (this.iConst16 + -1)));
		this.iConst18 = (0.00773243 * this.fConst0);
		this.iConst19 = min_i(1024, max_i(0, (this.iConst18 + -1)));
		this.iConst20 = (0.00510204 * this.fConst0);
		this.iConst21 = min_i(1024, max_i(0, (this.iConst20 + -1)));
		this.fConst22 = (0.00104308 * this.fConst0);
		this.instanceClear();
	}
	...
	this.instanceClear = function() {
		...
		for (var l25 = 0; (l25 < 8192); l25 = (l25 + 1)) {
			this.fVec8[l25] = 0;
		...
		for (var l28 = 0; (l28 < 8192); l28 = (l28 + 1)) {
			this.fVec9[l28] = 0;
		...
		for (var l30 = 0; (l30 < 2048); l30 = (l30 + 1)) {
			this.fVec10[l30] = 0;
		...
		for (var l32 = 0; (l32 < 2048); l32 = (l32 + 1)) {
			this.fVec11[l32] = 0;
		...
		for (var l36 = 0; (l36 < 1024); l36 = (l36 + 1)) {
			this.fVec13[l36] = 0;
		...
		for (var l57 = 0; (l57 < 8192); l57 = (l57 + 1)) {
			this.fVec20[l57] = 0;
		...
		for (var l60 = 0; (l60 < 8192); l60 = (l60 + 1)) {
			this.fVec21[l60] = 0;
		...
		for (var l64 = 0; (l64 < 2048); l64 = (l64 + 1)) {
			this.fVec23[l64] = 0;
		...
		for (var l66 = 0; (l66 < 2048); l66 = (l66 + 1)) {
			this.fVec24[l66] = 0;
		...
		for (var l68 = 0; (l68 < 2048); l68 = (l68 + 1)) {
			this.fVec25[l68] = 0;
	...
	this.buildUserInterface = function(ui_interface) {
		...
		ui_interface.closeBox();
		ui_interface.openVerticalBox("bubble");
		ui_interface.addHorizontalSlider("freq", function handler(obj) { function setval(val) { obj.fHslider0 = val; } return setval; }(this), 600, 150, 2000, 1);
		ui_interface.closeBox();
		ui_interface.addButton("drop", function handler(obj) { function setval(val) { obj.fButton0 = val; } return setval; }(this));
		ui_interface.closeBox();
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow4 = (0.2 * fSlow3);
		var fSlow5 = this.fHslider0;
		var fSlow6 = (this.fConst3 * fSlow5);
		var fSlow7 = ((0.043 * fSlow5) + (0.0014 * Math.pow(fSlow5, 1.5)));
		var fSlow8 = (this.fConst4 * fSlow7);
		var fSlow9 = this.fButton0;
		var fSlow10 = (this.fConst5 * (0 - fSlow7));
		var fSlow11 = (1 - fSlow3);
		var iSlow12 = (this.fConst22 * this.fVslider3);
		var iSlow13 = (this.iConst6 + iSlow12);
		var iSlow14 = (this.iConst7 + iSlow12);
		var iSlow15 = (this.iConst8 + iSlow12);
		var iSlow16 = (this.iConst9 + iSlow12);
		var iSlow17 = (this.iConst10 + iSlow12);
		var iSlow18 = (this.iConst11 + iSlow12);
		var iSlow19 = (this.iConst12 + iSlow12);
		var iSlow20 = (this.iConst13 + iSlow12);
		var iSlow21 = (iSlow12 + -1);
		var iSlow22 = min_i(1024, max_i(0, (this.iConst14 + iSlow21)));
		var iSlow23 = min_i(1024, max_i(0, (this.iConst16 + iSlow21)));
		var iSlow24 = min_i(1024, max_i(0, (this.iConst18 + iSlow21)));
		var iSlow25 = min_i(1024, max_i(0, (this.iConst20 + iSlow21)));
		for (var i = 0; (i < count); i = (i + 1)) {
			this.iVec0[0] = 1;
			this.fRec9[0] = ((fSlow1 * this.fRec9[1]) + (fSlow2 * this.fRec8[1]));
			this.fVec1[0] = fSlow9;
			this.iRec12[0] = (((fSlow9 > this.fVec1[1])?0:this.iRec12[1]) + 1);
			var fTemp0 = (fSlow6 * ((fSlow8 * this.iRec12[0]) + 1));
			var fTemp1 = Math.sin(fTemp0);
			var fTemp2 = Math.cos(fTemp0);
			this.fRec10[0] = ((this.fRec11[1] * fTemp1) + (this.fRec10[1] * fTemp2));
			this.fRec11[0] = (((this.fRec11[1] * fTemp2) + (this.fRec10[1] * (0 - fTemp1))) + (1 - this.iVec0[1]));
			this.fRec13[0] = ((0.99 * this.fRec13[1]) + (0.01 * Math.exp((fSlow10 * this.iRec12[0]))));
			var fTemp3 = (this.fRec10[0] * this.fRec13[0]);
			var fTemp4 = (fSlow4 * fTemp3);
			this.fVec2[(this.IOTA & 8191)] = ((fSlow0 * this.fRec9[0]) + fTemp4);
			this.fRec8[0] = this.fVec2[((this.IOTA - this.iConst6) & 8191)];
			this.fRec15[0] = ((fSlow1 * this.fRec15[1]) + (fSlow2 * this.fRec14[1]));
			this.fVec3[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec15[0]));
			this.fRec14[0] = this.fVec3[((this.IOTA - this.iConst7) & 8191)];
			this.fRec17[0] = ((fSlow1 * this.fRec17[1]) + (fSlow2 * this.fRec16[1]));
			this.fVec4[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec17[0]));
			this.fRec16[0] = this.fVec4[((this.IOTA - this.iConst8) & 8191)];
			this.fRec19[0] = ((fSlow1 * this.fRec19[1]) + (fSlow2 * this.fRec18[1]));
			this.fVec5[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec19[0]));
			this.fRec18[0] = this.fVec5[((this.IOTA - this.iConst9) & 8191)];
			this.fRec21[0] = ((fSlow1 * this.fRec21[1]) + (fSlow2 * this.fRec20[1]));
			this.fVec6[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec21[0]));
			this.fRec20[0] = this.fVec6[((this.IOTA - this.iConst10) & 8191)];
			this.fRec23[0] = ((fSlow1 * this.fRec23[1]) + (fSlow2 * this.fRec22[1]));
			this.fVec7[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec23[0]));
			this.fRec22[0] = this.fVec7[((this.IOTA - this.iConst11) & 8191)];
			this.fRec25[0] = ((fSlow1 * this.fRec25[1]) + (fSlow2 * this.fRec24[1]));
			this.fVec8[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec25[0]));
			this.fRec24[0] = this.fVec8[((this.IOTA - this.iConst12) & 8191)];
			this.fRec27[0] = ((fSlow1 * this.fRec27[1]) + (fSlow2 * this.fRec26[1]));
			this.fVec9[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec27[0]));
			this.fRec26[0] = this.fVec9[((this.IOTA - this.iConst13) & 8191)];
			var fTemp5 = ((((((((this.fRec8[0] + this.fRec14[0]) + this.fRec16[0]) + this.fRec18[0]) + this.fRec20[0]) + this.fRec22[0]) + this.fRec24[0]) + this.fRec26[0]) + (0.5 * this.fRec6[1]));
			this.fVec10[(this.IOTA & 2047)] = fTemp5;
			this.fRec6[0] = this.fVec10[((this.IOTA - this.iConst15) & 2047)];
			var fRec7 = (0 - (0.5 * fTemp5));
			var fTemp6 = (this.fRec6[1] + (fRec7 + (0.5 * this.fRec4[1])));
			this.fVec11[(this.IOTA & 2047)] = fTemp6;
			this.fRec4[0] = this.fVec11[((this.IOTA - this.iConst17) & 2047)];
			var fRec5 = (0 - (0.5 * fTemp6));
			var fTemp7 = (this.fRec4[1] + (fRec5 + (0.5 * this.fRec2[1])));
			this.fVec12[(this.IOTA & 2047)] = fTemp7;
			this.fRec2[0] = this.fVec12[((this.IOTA - this.iConst19) & 2047)];
			var fRec3 = (0 - (0.5 * fTemp7));
			var fTemp8 = (this.fRec2[1] + (fRec3 + (0.5 * this.fRec0[1])));
			this.fVec13[(this.IOTA & 1023)] = fTemp8;
			this.fRec0[0] = this.fVec13[((this.IOTA - this.iConst21) & 1023)];
			var fRec1 = (0 - (0.5 * fTemp8));
			var fTemp9 = (fSlow11 * fTemp3);
			output0[i] = ((fRec1 + this.fRec0[1]) + fTemp9);
			this.fRec37[0] = ((fSlow1 * this.fRec37[1]) + (fSlow2 * this.fRec36[1]));
			this.fVec14[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec37[0]));
			this.fRec36[0] = this.fVec14[((this.IOTA - iSlow13) & 8191)];
			this.fRec39[0] = ((fSlow1 * this.fRec39[1]) + (fSlow2 * this.fRec38[1]));
			this.fVec15[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec39[0]));
			this.fRec38[0] = this.fVec15[((this.IOTA - iSlow14) & 8191)];
			this.fRec41[0] = ((fSlow1 * this.fRec41[1]) + (fSlow2 * this.fRec40[1]));
			this.fVec16[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec41[0]));
			this.fRec40[0] = this.fVec16[((this.IOTA - iSlow15) & 8191)];
			this.fRec43[0] = ((fSlow1 * this.fRec43[1]) + (fSlow2 * this.fRec42[1]));
			this.fVec17[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec43[0]));
			this.fRec42[0] = this.fVec17[((this.IOTA - iSlow16) & 8191)];
			this.fRec45[0] = ((fSlow1 * this.fRec45[1]) + (fSlow2 * this.fRec44[1]));
			this.fVec18[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec45[0]));
			this.fRec44[0] = this.fVec18[((this.IOTA - iSlow17) & 8191)];
			this.fRec47[0] = ((fSlow1 * this.fRec47[1]) + (fSlow2 * this.fRec46[1]));
			this.fVec19[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec47[0]));
			this.fRec46[0] = this.fVec19[((this.IOTA - iSlow18) & 8191)];
			this.fRec49[0] = ((fSlow1 * this.fRec49[1]) + (fSlow2 * this.fRec48[1]));
			this.fVec20[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec49[0]));
			this.fRec48[0] = this.fVec20[((this.IOTA - iSlow19) & 8191)];
			this.fRec51[0] = ((fSlow1 * this.fRec51[1]) + (fSlow2 * this.fRec50[1]));
			this.fVec21[(this.IOTA & 8191)] = (fTemp4 + (fSlow0 * this.fRec51[0]));
			this.fRec50[0] = this.fVec21[((this.IOTA - iSlow20) & 8191)];
			var fTemp10 = ((((((((this.fRec36[0] + this.fRec38[0]) + this.fRec40[0]) + this.fRec42[0]) + this.fRec44[0]) + this.fRec46[0]) + this.fRec48[0]) + this.fRec50[0]) + (0.5 * this.fRec34[1]));
			this.fVec22[(this.IOTA & 2047)] = fTemp10;
			this.fRec34[0] = this.fVec22[((this.IOTA - iSlow22) & 2047)];
			var fRec35 = (0 - (0.5 * fTemp10));
			var fTemp11 = (this.fRec34[1] + (fRec35 + (0.5 * this.fRec32[1])));
			this.fVec23[(this.IOTA & 2047)] = fTemp11;
			this.fRec32[0] = this.fVec23[((this.IOTA - iSlow23) & 2047)];
			var fRec33 = (0 - (0.5 * fTemp11));
			var fTemp12 = (this.fRec32[1] + (fRec33 + (0.5 * this.fRec30[1])));
			this.fVec24[(this.IOTA & 2047)] = fTemp12;
			this.fRec30[0] = this.fVec24[((this.IOTA - iSlow24) & 2047)];
			var fRec31 = (0 - (0.5 * fTemp12));
			var fTemp13 = (this.fRec30[1] + (fRec31 + (0.5 * this.fRec28[1])));
			this.fVec25[(this.IOTA & 2047)] = fTemp13;
			this.fRec28[0] = this.fVec25[((this.IOTA - iSlow25) & 2047)];
			var fRec29 = (0 - (0.5 * fTemp13));
			output1[i] = (this.fRec28[1] + (fRec29 + fTemp9));
