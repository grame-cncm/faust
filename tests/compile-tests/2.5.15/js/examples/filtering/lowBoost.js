...
function mydsp() {
	...
	this.buildUserInterface = function(ui_interface) {
		...
		ui_interface.addHorizontalSlider("freq", function handler(obj) { function setval(val) { obj.fHslider0 = val; } return setval; }(this), 1000, 20, 20000, 0.1);
		ui_interface.declare("fHslider1", "2", "");
		ui_interface.declare("fHslider1", "style", "knob");
		ui_interface.declare("fHslider1", "unit", "dB");
		ui_interface.addHorizontalSlider("gain", function handler(obj) { function setval(val) { obj.fHslider1 = val; } return setval; }(this), 0, -20, 20, 0.1);
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow2 = Math.pow(10, (0.05 * this.fHslider1));
