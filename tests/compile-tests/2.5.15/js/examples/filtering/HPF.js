...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow3 = Math.cos(fSlow0);
		var fSlow4 = (0.5 * (fSlow3 + 1));
		var fSlow5 = (0 - (2 * fSlow3));
		var fSlow6 = (1 - fSlow1);
		var fSlow7 = (-1 - fSlow3);
		for (var i = 0; (i < count); i = (i + 1)) {
			this.fRec0[0] = (input0[i] - (fSlow2 * ((fSlow5 * this.fRec0[1]) + (fSlow6 * this.fRec0[2]))));
			output0[i] = (fSlow2 * (((fSlow4 * this.fRec0[0]) + (fSlow7 * this.fRec0[1])) + (fSlow4 * this.fRec0[2])));
