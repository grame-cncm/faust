...
function mydsp() {
	...
	this.buildUserInterface = function(ui_interface) {
		...
		ui_interface.addHorizontalSlider("Gain", function handler(obj) { function setval(val) { obj.fHslider2 = val; } return setval; }(this), 1, 0, 8, 0.01);
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow2 = max_f(0.001, this.fHslider1);
		var fSlow3 = Math.sqrt(max_f(1e-05, this.fHslider2));
		var fSlow4 = (0.5 * (fSlow1 / (fSlow2 * fSlow3)));
		var fSlow5 = (1 / (fSlow4 + 1));
		var fSlow6 = (0 - (2 * Math.cos(fSlow0)));
		var fSlow7 = (1 - fSlow4);
		var fSlow8 = (0.5 * ((fSlow3 * fSlow1) / fSlow2));
		var fSlow9 = (fSlow8 + 1);
		var fSlow10 = (1 - fSlow8);
		for (var i = 0; (i < count); i = (i + 1)) {
			var fTemp0 = (fSlow6 * this.fRec0[1]);
			this.fRec0[0] = (input0[i] - (fSlow5 * (fTemp0 + (fSlow7 * this.fRec0[2]))));
			output0[i] = (fSlow5 * ((fTemp0 + (fSlow9 * this.fRec0[0])) + (fSlow10 * this.fRec0[2])));
