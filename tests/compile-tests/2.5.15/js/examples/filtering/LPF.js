...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow1 = Math.cos(fSlow0);
		var fSlow2 = (0.5 * (Math.sin(fSlow0) / max_f(0.001, this.fHslider1)));
		var fSlow3 = (fSlow2 + 1);
		var fSlow4 = ((1 - fSlow1) / fSlow3);
		var fSlow5 = (1 / fSlow3);
		var fSlow6 = (0 - (2 * fSlow1));
		var fSlow7 = (1 - fSlow2);
		for (var i = 0; (i < count); i = (i + 1)) {
			this.fRec0[0] = (input0[i] - (fSlow5 * ((fSlow6 * this.fRec0[1]) + (fSlow7 * this.fRec0[2]))));
			output0[i] = (fSlow4 * ((this.fRec0[1] + (0.5 * this.fRec0[0])) + (0.5 * this.fRec0[2])));
