...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow2 = Math.cos(fSlow1);
		var fSlow3 = ((fSlow0 + -1) * fSlow2);
		var fSlow4 = (fSlow0 + fSlow3);
		var fSlow5 = ((Math.sqrt(fSlow0) * Math.sin(fSlow1)) / max_f(0.001, this.fHslider2));
		var fSlow6 = ((fSlow4 + fSlow5) + 1);
		var fSlow7 = (fSlow0 / fSlow6);
		var fSlow8 = ((fSlow0 + fSlow5) + (1 - fSlow3));
		var fSlow9 = (1 / fSlow6);
		var fSlow10 = ((fSlow0 + 1) * fSlow2);
		var fSlow11 = (0 - (2 * ((fSlow0 + fSlow10) + -1)));
		var fSlow12 = (fSlow4 + (1 - fSlow5));
		var fSlow13 = (2 * (fSlow0 + (-1 - fSlow10)));
		var fSlow14 = (fSlow0 + (1 - (fSlow3 + fSlow5)));
		for (var i = 0; (i < count); i = (i + 1)) {
			this.fRec0[0] = (input0[i] - (fSlow9 * ((fSlow11 * this.fRec0[1]) + (fSlow12 * this.fRec0[2]))));
			output0[i] = (fSlow7 * (((fSlow8 * this.fRec0[0]) + (fSlow13 * this.fRec0[1])) + (fSlow14 * this.fRec0[2])));
