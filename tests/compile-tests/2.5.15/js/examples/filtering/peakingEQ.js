...
function mydsp() {
	...
	this.buildUserInterface = function(ui_interface) {
		...
		ui_interface.addHorizontalSlider("Gain", function handler(obj) { function setval(val) { obj.fHslider2 = val; } return setval; }(this), 0, -10, 10, 0.1);
