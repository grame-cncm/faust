...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		var fSlow5 = ((fSlow0 * (fSlow0 - fSlow2)) + 1);
		var fSlow6 = (1 / fSlow1);
		var fSlow7 = ((fSlow0 * (fSlow0 + fSlow6)) + 1);
		var fSlow8 = (1 - (fSlow0 * (fSlow6 - fSlow0)));
		for (var i = 0; (i < count); i = (i + 1)) {
			var fTemp0 = (fSlow4 * this.fRec0[1]);
			this.fRec0[0] = (input0[i] - (fSlow3 * ((fSlow5 * this.fRec0[2]) + fTemp0)));
			output0[i] = (fSlow3 * ((fTemp0 + (fSlow7 * this.fRec0[0])) + (fSlow8 * this.fRec0[2])));
