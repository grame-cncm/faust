...
function mydsp() {
	...
	this.compute = function(count, inputs, outputs) {
		...
		for (var i = 0; (i < count); i = (i + 1)) {
			...
			var fTemp7 = (this.fRec27[2] + ((2 * this.fRec27[1]) + this.fRec27[0]));
			...
			var fTemp11 = (this.fRec32[2] + ((2 * this.fRec32[1]) + this.fRec32[0]));
			...
			var fTemp14 = (this.fRec36[2] + ((2 * this.fRec36[1]) + this.fRec36[0]));
