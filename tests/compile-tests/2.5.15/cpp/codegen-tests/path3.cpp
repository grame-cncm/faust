...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("slid1", &fHslider1, 0.0f, 0.0f, 1.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("slid1", &fHslider3, 0.0f, 0.0f, 1.0f, 0.100000001f);
		ui_interface->closeBox();
