...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("lim1", &fHslider1, 0.0f, 0.0f, 10000.0f, 1.0f);
		ui_interface->addHorizontalSlider("lim2", &fHslider2, 0.0f, 0.0f, 10000.0f, 1.0f);
		ui_interface->addHorizontalSlider("vol", &fHslider0, 0.0f, 0.0f, 1.0f, 0.00999999978f);
