...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst15 = tanf((122.71846f / fConst0));
		...
		fConst21 = tanf((245.43692f / fConst0));
		...
		fConst27 = tanf((490.87384f / fConst0));
		...
		fConst33 = tanf((981.747681f / fConst0));
		...
		fConst39 = tanf((1963.49536f / fConst0));
		...
		fConst45 = tanf((3926.99072f / fConst0));
		...
		fConst51 = tanf((7853.98145f / fConst0));
		...
		fConst57 = tanf((15707.9629f / fConst0));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((iSlow0?fTemp0:((((((((((fRec0[2] + (fConst59 * (fTemp9 + (fConst60 * fRec0[0])))) * powf(10.0f, (0.0500000007f * fRec11[0]))) + ((fRec12[2] + (fConst53 * (fTemp17 + (fConst54 * fRec12[0])))) * powf(10.0f, (0.0500000007f * fRec25[0])))) + ((fRec26[2] + (fConst47 * (fTemp24 + (fConst48 * fRec26[0])))) * powf(10.0f, (0.0500000007f * fRec38[0])))) + ((fRec39[2] + (fConst41 * (fTemp30 + (fConst42 * fRec39[0])))) * powf(10.0f, (0.0500000007f * fRec50[0])))) + ((fRec51[2] + (fConst35 * (fTemp35 + (fConst36 * fRec51[0])))) * powf(10.0f, (0.0500000007f * fRec61[0])))) + ((fRec62[2] + (fConst29 * (fTemp39 + (fConst30 * fRec62[0])))) * powf(10.0f, (0.0500000007f * fRec71[0])))) + ((fRec72[2] + (fConst23 * (fTemp42 + (fConst24 * fRec72[0])))) * powf(10.0f, (0.0500000007f * fRec80[0])))) + ((fRec81[2] + (fConst17 * (fTemp44 + (fConst18 * fRec81[0])))) * powf(10.0f, (0.0500000007f * fRec88[0])))) + (fConst133 * (((((fConst134 * fRec89[1]) + (fConst19 * fRec89[0])) + (fConst19 * fRec89[2])) * powf(10.0f, (0.0500000007f * fRec95[0]))) + ((fRec96[2] + (fRec96[0] + (2.0f * fRec96[1]))) * powf(10.0f, (0.0500000007f * fRec99[0]))))))));
			fVec0[1] = fVec0[0];
			fRec10[1] = fRec10[0];
			fRec9[2] = fRec9[1];
			fRec9[1] = fRec9[0];
