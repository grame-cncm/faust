...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst32 = tanf((35543.0625f / fConst0));
		...
		fConst70 = tanf((25132.7422f / fConst0));
		...
		fConst108 = tanf((17771.5312f / fConst0));
		...
		fConst146 = tanf((12566.3711f / fConst0));
		...
		fConst184 = tanf((8885.76562f / fConst0));
		...
		fConst222 = tanf((6283.18555f / fConst0));
		...
		fConst260 = tanf((4442.88281f / fConst0));
		...
		fConst298 = tanf((3141.59277f / fConst0));
		...
		fConst336 = tanf((2221.44141f / fConst0));
		...
		fConst374 = tanf((1570.79639f / fConst0));
		...
		fConst412 = tanf((1110.7207f / fConst0));
		...
		fConst450 = tanf((785.398193f / fConst0));
		...
		fConst488 = tanf((555.360352f / fConst0));
		...
		fConst526 = tanf((392.699097f / fConst0));
		...
		fConst564 = tanf((277.680176f / fConst0));
		...
		fConst602 = tanf((196.349548f / fConst0));
		...
		fConst640 = tanf((138.840088f / fConst0));
		...
		fConst678 = tanf((98.1747742f / fConst0));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Low Boost|Cut", &fHslider4, 0.0f, -40.0f, 40.0f, 0.100000001f);
		ui_interface->declare(&fHslider3, "1", "");
		ui_interface->declare(&fHslider3, "scale", "log");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "tooltip", "Transition-frequency from boost (cut) to unity gain");
		ui_interface->declare(&fHslider3, "unit", "Hz");
		ui_interface->addHorizontalSlider("Transition Frequency", &fHslider3, 200.0f, 1.0f, 5000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->declare(0, "2", "");
		...
		ui_interface->addHorizontalSlider("Peak Boost|Cut", &fHslider6, 0.0f, -40.0f, 40.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Peak Frequency", &fHslider5, 49.0f, 1.0f, 100.0f, 1.0f);
		...
		ui_interface->addHorizontalSlider("High Boost|Cut", &fHslider8, 0.0f, -40.0f, 40.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Transition Frequency", &fHslider2, 8000.0f, 20.0f, 10000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = tanf((fConst14 * float(fHslider2)));
		...
		float fSlow9 = tanf((fConst14 * float(fHslider3)));
		...
		int iSlow18 = int(float(fCheckbox0));
		int iSlow19 = int(float(fCheckbox1));
		int iSlow20 = int((float(fEntry0) + -1.0f));
		int iSlow21 = (iSlow20 >= 2);
		int iSlow22 = (iSlow20 >= 1);
		float fSlow23 = expf((0.0f - (fConst15 / float(fVslider1))));
		float fSlow24 = (440.0f * (powf(2.0f, (0.0833333358f * (float(fVslider0) + -49.0f))) * (1.0f - fSlow23)));
		int iSlow25 = (iSlow20 >= 3);
		float fSlow26 = ((0.00999999978f * float(fVslider2)) + 1.0f);
		float fSlow27 = ((0.00999999978f * float(fVslider3)) + 1.0f);
		float fSlow28 = (0.00100000005f * powf(10.0f, (0.0500000007f * float(fVslider4))));
		int iSlow29 = int(float(fCheckbox2));
		float fSlow30 = (((fSlow10 + -1.0f) / fSlow9) + 1.0f);
		float fSlow31 = (2.0f * (1.0f - fSlow12));
		float fSlow32 = powf(10.0f, (0.0500000007f * float(fHslider4)));
		float fSlow33 = (0.00100000005f * float(fHslider5));
		float fSlow34 = float(fHslider6);
		int iSlow35 = (fSlow34 > 0.0f);
		float fSlow36 = float(fHslider7);
		float fSlow37 = (fConst20 * (powf(10.0f, (0.0500000007f * fabsf(fSlow34))) / fSlow36));
		...
		float fSlow42 = powf(10.0f, (0.0500000007f * float(fHslider8)));
		float fSlow43 = (2.0f * (0.0f - fSlow39));
		float fSlow44 = (0.0f - fSlow4);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec10[0] = (fSlow24 + (fSlow23 * fRec10[1]));
			float fTemp0 = max(20.0f, fabsf(fRec10[0]));
			fVec1[0] = fTemp0;
			float fTemp1 = (fRec9[1] + (fConst15 * fVec1[1]));
			...
			fVec7[0] = fTemp9;
			float fTemp10 = max(20.0f, fabsf((fSlow26 * fRec10[0])));
			fVec8[0] = fTemp10;
			float fTemp11 = (fRec11[1] + (fConst15 * fVec8[1]));
			...
			fVec14[0] = fTemp19;
			float fTemp20 = max(20.0f, fabsf((fSlow27 * fRec10[0])));
			fVec15[0] = fTemp20;
			float fTemp21 = (fRec12[1] + (fConst15 * fVec15[1]));
			...
			fRec15[0] = ((fTemp30 + ((2.49495602f * fRec15[1]) + (0.522189379f * fRec15[3]))) - (2.0172658f * fRec15[2]));
			float fTemp31 = ((iSlow18?float(input0[i]):(iSlow19?(iSlow29?(((0.0499220341f * fRec15[0]) + (0.0506126992f * fRec15[2])) - ((0.0959935337f * fRec15[1]) + (0.00440878607f * fRec15[3]))):fTemp30):(0.333333343f * ((((iSlow21?(iSlow25?(fConst18 * ((float(iVec0[3]) * (fTemp9 - fVec7[1])) / fTemp0)):(fConst17 * ((float(iVec0[2]) * (fTemp6 - fVec4[1])) / fTemp0))):(iSlow22?(fConst16 * ((float(iVec0[1]) * (fTemp4 - fVec2[1])) / fTemp0)):fTemp3)) + (iSlow21?(iSlow25?(fConst18 * ((float(iVec0[3]) * (fTemp19 - fVec14[1])) / fTemp10)):(fConst17 * ((float(iVec0[2]) * (fTemp16 - fVec11[1])) / fTemp10))):(iSlow22?(fConst16 * ((float(iVec0[1]) * (fTemp14 - fVec9[1])) / fTemp10)):fTemp13))) + (iSlow21?(iSlow25?(fConst18 * ((float(iVec0[3]) * (fTemp29 - fVec21[1])) / fTemp20)):(fConst17 * ((float(iVec0[2]) * (fTemp26 - fVec18[1])) / fTemp20))):(iSlow22?(fConst16 * ((float(iVec0[1]) * (fTemp24 - fVec16[1])) / fTemp20)):fTemp23))) * fRec13[0])))) * fRec13[0]);
			fVec22[0] = fTemp31;
			...
			float fTemp32 = powf(2.0f, (0.0833333358f * (fRec18[0] + -49.0f)));
			float fTemp33 = tanf((fConst19 * fTemp32));
			float fTemp34 = (1.0f / fTemp33);
			float fTemp35 = (fTemp32 / sinf((fConst21 * fTemp32)));
			...
			fRec6[0] = ((fSlow11 * ((((fSlow13 * fRec7[1]) + (fSlow12 * fRec7[0])) + (fSlow12 * fRec7[2])) + (fSlow32 * (fRec16[2] + ((2.0f * fRec16[1]) + fRec16[0]))))) - (((fRec6[2] * (((fTemp34 - fTemp38) / fTemp33) + 1.0f)) + fTemp39) / fTemp40));
			float fTemp41 = (iSlow35?fTemp36:fTemp37);
			float fTemp42 = (((fTemp39 + ((((fTemp34 + fTemp41) / fTemp33) + 1.0f) * fRec6[0])) + (fRec6[2] * (((fTemp34 - fTemp41) / fTemp33) + 1.0f))) / fTemp40);
			fVec23[0] = fTemp42;
			...
			float fTemp43 = (fSlow5 * ((fRec4[2] + ((2.0f * fRec4[1]) + fRec4[0])) + (fSlow42 * (((fSlow43 * fRec19[1]) + (fSlow39 * fRec19[0])) + (fSlow39 * fRec19[2])))));
			...
			fRec0[0] = ((fSlow2 * fabsf((fConst4 * (((fConst7 * fRec1[1]) + (fConst31 * fRec1[0])) + (fConst31 * fRec1[2]))))) + (fSlow1 * fRec0[1]));
			...
			fRec21[0] = ((fSlow1 * fRec21[1]) + (fSlow2 * fabsf((fConst34 * (((fConst37 * fRec22[1]) + (fConst69 * fRec22[0])) + (fConst69 * fRec22[2]))))));
			...
			fRec28[0] = ((fSlow1 * fRec28[1]) + (fSlow2 * fabsf((fConst72 * (((fConst75 * fRec29[1]) + (fConst107 * fRec29[0])) + (fConst107 * fRec29[2]))))));
			...
			fRec35[0] = ((fSlow1 * fRec35[1]) + (fSlow2 * fabsf((fConst110 * (((fConst113 * fRec36[1]) + (fConst145 * fRec36[0])) + (fConst145 * fRec36[2]))))));
			...
			fRec42[0] = ((fSlow1 * fRec42[1]) + (fSlow2 * fabsf((fConst148 * (((fConst151 * fRec43[1]) + (fConst183 * fRec43[0])) + (fConst183 * fRec43[2]))))));
			...
			fRec49[0] = ((fSlow1 * fRec49[1]) + (fSlow2 * fabsf((fConst186 * (((fConst189 * fRec50[1]) + (fConst221 * fRec50[0])) + (fConst221 * fRec50[2]))))));
			...
			fRec56[0] = ((fSlow1 * fRec56[1]) + (fSlow2 * fabsf((fConst224 * (((fConst227 * fRec57[1]) + (fConst259 * fRec57[0])) + (fConst259 * fRec57[2]))))));
			...
			fRec63[0] = ((fSlow1 * fRec63[1]) + (fSlow2 * fabsf((fConst262 * (((fConst265 * fRec64[1]) + (fConst297 * fRec64[0])) + (fConst297 * fRec64[2]))))));
			...
			fRec70[0] = ((fSlow1 * fRec70[1]) + (fSlow2 * fabsf((fConst300 * (((fConst303 * fRec71[1]) + (fConst335 * fRec71[0])) + (fConst335 * fRec71[2]))))));
			...
			fRec77[0] = ((fSlow1 * fRec77[1]) + (fSlow2 * fabsf((fConst338 * (((fConst341 * fRec78[1]) + (fConst373 * fRec78[0])) + (fConst373 * fRec78[2]))))));
			...
			fRec84[0] = ((fSlow1 * fRec84[1]) + (fSlow2 * fabsf((fConst376 * (((fConst379 * fRec85[1]) + (fConst411 * fRec85[0])) + (fConst411 * fRec85[2]))))));
			...
			fRec91[0] = ((fSlow1 * fRec91[1]) + (fSlow2 * fabsf((fConst414 * (((fConst417 * fRec92[1]) + (fConst449 * fRec92[0])) + (fConst449 * fRec92[2]))))));
			...
			fRec98[0] = ((fSlow1 * fRec98[1]) + (fSlow2 * fabsf((fConst452 * (((fConst455 * fRec99[1]) + (fConst487 * fRec99[0])) + (fConst487 * fRec99[2]))))));
			...
			fRec105[0] = ((fSlow1 * fRec105[1]) + (fSlow2 * fabsf((fConst490 * (((fConst493 * fRec106[1]) + (fConst525 * fRec106[0])) + (fConst525 * fRec106[2]))))));
			...
			fRec112[0] = ((fSlow1 * fRec112[1]) + (fSlow2 * fabsf((fConst528 * (((fConst531 * fRec113[1]) + (fConst563 * fRec113[0])) + (fConst563 * fRec113[2]))))));
			...
			fRec119[0] = ((fSlow1 * fRec119[1]) + (fSlow2 * fabsf((fConst566 * (((fConst569 * fRec120[1]) + (fConst601 * fRec120[0])) + (fConst601 * fRec120[2]))))));
			fVbargraph15 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec119[0])))));
			...
			fRec126[0] = ((fSlow1 * fRec126[1]) + (fSlow2 * fabsf((fConst604 * (((fConst607 * fRec127[1]) + (fConst639 * fRec127[0])) + (fConst639 * fRec127[2]))))));
			fVbargraph16 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec126[0])))));
			...
			fRec133[0] = ((fSlow1 * fRec133[1]) + (fSlow2 * fabsf((fConst642 * (((fConst645 * fRec134[1]) + (fConst677 * fRec134[0])) + (fConst677 * fRec134[2]))))));
			fVbargraph17 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec133[0])))));
			...
			fRec140[0] = ((fSlow1 * fRec140[1]) + (fSlow2 * fabsf((fConst680 * (((fConst683 * fRec141[1]) + (fConst715 * fRec141[0])) + (fConst715 * fRec141[2]))))));
			fVbargraph18 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec140[0])))));
			...
			fRec147[0] = ((fSlow1 * fRec147[1]) + (fSlow2 * fabsf((fConst716 * (((fConst717 * fRec148[1]) + (fConst731 * fRec148[0])) + (fConst731 * fRec148[2]))))));
			fVbargraph19 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec147[0])))));
