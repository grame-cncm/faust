...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Freq", &fHslider1, 330.0f, 50.0f, 2000.0f, 0.100000001f);
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->addVerticalSlider("Gain", &fVslider0, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Vocoder");
		ui_interface->declare(&fHslider2, "0", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "tooltip", "Attack time in seconds");
		ui_interface->addHorizontalSlider("Attack", &fHslider2, 5.0f, 0.100000001f, 100.0f, 0.100000001f);
		ui_interface->declare(&fHslider3, "1", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "tooltip", "Release time in seconds");
		ui_interface->addHorizontalSlider("Release", &fHslider3, 5.0f, 0.100000001f, 100.0f, 0.100000001f);
		ui_interface->declare(&fHslider0, "2", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "tooltip", "Coefficient to adjust the   bandwidth of each band");
		ui_interface->addHorizontalSlider("BW", &fHslider0, 0.5f, 0.100000001f, 2.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = (0.00100000005f * float(fVslider0));
		float fSlow4 = float(fHslider1);
		float fSlow5 = ((fConst2 * (fConst2 - fSlow1)) + 1.0f);
		float fSlow6 = expf((0.0f - (fConst6 / float(fHslider2))));
		float fSlow7 = expf((0.0f - (fConst6 / float(fHslider3))));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = (fRec1[0] * float(((fRec2[0] - fRec2[1]) < 0.0f)));
			...
			float fTemp3 = fabsf((fSlow2 * ((fConst2 * fRec5[0]) + (fConst5 * fRec5[2]))));
			...
			float fTemp5 = fabsf((fSlow9 * ((fConst8 * fRec9[0]) + (fConst10 * fRec9[2]))));
			...
			float fTemp7 = fabsf((fSlow11 * ((fConst12 * fRec13[0]) + (fConst14 * fRec13[2]))));
			...
			float fTemp9 = fabsf((fSlow14 * ((fConst16 * fRec17[0]) + (fConst18 * fRec17[2]))));
			...
			float fTemp11 = fabsf((fSlow17 * ((fConst20 * fRec21[0]) + (fConst22 * fRec21[2]))));
			...
			float fTemp13 = fabsf((fSlow20 * ((fConst24 * fRec25[0]) + (fConst26 * fRec25[2]))));
			...
			float fTemp15 = fabsf((fSlow23 * ((fConst28 * fRec29[0]) + (fConst30 * fRec29[2]))));
			...
			float fTemp17 = fabsf((fSlow25 * ((fConst32 * fRec33[0]) + (fConst34 * fRec33[2]))));
			...
			float fTemp19 = fabsf((fSlow27 * ((fConst36 * fRec37[0]) + (fConst38 * fRec37[2]))));
			...
			float fTemp21 = fabsf((fSlow29 * ((fConst40 * fRec41[0]) + (fConst42 * fRec41[2]))));
			...
			float fTemp23 = fabsf((fSlow32 * ((fConst44 * fRec45[0]) + (fConst46 * fRec45[2]))));
			...
			float fTemp25 = fabsf((fSlow35 * ((fConst48 * fRec49[0]) + (fConst50 * fRec49[2]))));
			...
			float fTemp27 = fabsf((fSlow37 * ((fConst52 * fRec53[0]) + (fConst54 * fRec53[2]))));
			...
			float fTemp29 = fabsf((fSlow40 * ((fConst56 * fRec57[0]) + (fConst58 * fRec57[2]))));
			...
			float fTemp31 = fabsf((fSlow42 * ((fConst60 * fRec61[0]) + (fConst62 * fRec61[2]))));
			...
			float fTemp33 = fabsf((fSlow44 * ((fConst64 * fRec65[0]) + (fConst66 * fRec65[2]))));
			...
			float fTemp35 = fabsf((fSlow46 * ((fConst68 * fRec69[0]) + (fConst70 * fRec69[2]))));
			...
			float fTemp37 = fabsf((fSlow49 * ((fConst72 * fRec73[0]) + (fConst74 * fRec73[2]))));
			...
			float fTemp39 = fabsf((fSlow51 * ((fConst76 * fRec77[0]) + (fConst78 * fRec77[2]))));
			...
			float fTemp41 = fabsf((fSlow53 * ((fConst80 * fRec81[0]) + (fConst82 * fRec81[2]))));
			...
			float fTemp43 = fabsf((fSlow55 * ((fConst84 * fRec85[0]) + (fConst86 * fRec85[2]))));
			...
			float fTemp45 = fabsf((fSlow57 * ((fConst88 * fRec89[0]) + (fConst90 * fRec89[2]))));
			...
			float fTemp47 = fabsf((fSlow59 * ((fConst92 * fRec93[0]) + (fConst94 * fRec93[2]))));
			...
			float fTemp49 = fabsf((fSlow62 * ((fConst96 * fRec97[0]) + (fConst98 * fRec97[2]))));
			...
			float fTemp51 = fabsf((fSlow64 * ((fConst100 * fRec101[0]) + (fConst102 * fRec101[2]))));
			...
			float fTemp53 = fabsf((fSlow66 * ((fConst104 * fRec105[0]) + (fConst106 * fRec105[2]))));
			...
			float fTemp55 = fabsf((fSlow68 * ((fConst108 * fRec109[0]) + (fConst110 * fRec109[2]))));
			...
			float fTemp57 = fabsf((fSlow71 * ((fConst112 * fRec113[0]) + (fConst114 * fRec113[2]))));
			...
			float fTemp59 = fabsf((fSlow73 * ((fConst116 * fRec117[0]) + (fConst118 * fRec117[2]))));
			...
			float fTemp61 = fabsf((fSlow75 * ((fConst120 * fRec121[0]) + (fConst122 * fRec121[2]))));
			...
			float fTemp63 = fabsf((fSlow78 * ((fConst124 * fRec125[0]) + (fConst126 * fRec125[2]))));
			...
			float fTemp65 = fabsf((fSlow80 * ((fConst128 * fRec129[0]) + (fConst130 * fRec129[2]))));
