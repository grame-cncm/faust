...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("gain", &fHslider0, 0.25f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider2, "acc", "1 0 -10 0 10");
		ui_interface->addHorizontalSlider("vibrato", &fHslider2, 0.0500000007f, 0.0f, 0.100000001f, 0.00999999978f);
		ui_interface->declare(&fHslider3, "acc", "0 0 -10 0 10");
		ui_interface->addHorizontalSlider("vowel", &fHslider3, 2.0f, 0.0f, 4.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("x", &fHslider1, 0.5f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = max(1.00000001e-07f, fabsf((((200.0f * fRec3[0]) + 50.0f) * ((fSlow2 * fRec4[0]) + 1.0f))));
			float fTemp2 = (fRec1[1] + (fConst1 * fTemp1));
			float fTemp3 = (fTemp2 + -1.0f);
			int iTemp4 = (fTemp3 < 0.0f);
			fRec1[0] = (iTemp4?fTemp2:fTemp3);
			float fRec2 = (iTemp4?fTemp2:(fTemp2 + (fTemp3 * (1.0f - (fConst0 / fTemp1)))));
			...
			float fTemp59 = tanf((fConst6 * fTemp58));
			...
			float fTemp74 = tanf((fConst6 * fTemp73));
			...
			float fTemp99 = tanf((fConst6 * fTemp98));
			...
			float fTemp106 = tanf((fConst6 * fTemp105));
