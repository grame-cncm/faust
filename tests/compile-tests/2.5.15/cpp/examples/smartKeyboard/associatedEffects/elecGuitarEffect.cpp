 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((0.5f * (fRec0[0] * (((fTemp0 * fTemp1) * fTemp2) + (fTemp3 * ((fTemp28 + (fRec2[2] + (fTemp26 + fTemp27))) + (fSlow3 * ((fTemp28 + (fTemp27 + fRec2[2])) - fTemp26))))))));
			...
			output1[i] = FAUSTFLOAT((0.5f * (fRec0[0] * (((fTemp0 * fTemp4) * fTemp5) + (fTemp3 * ((fTemp34 + (fRec44[2] + (fTemp32 + fTemp33))) + (fSlow3 * ((fTemp34 + (fTemp33 + fRec44[2])) - fTemp32))))))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec15[1] = fRec15[0];
			fRec14[1] = fRec14[0];
