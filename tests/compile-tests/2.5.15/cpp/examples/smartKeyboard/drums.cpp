...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("key", &fHslider3, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addHorizontalSlider("keyboard", &fHslider2, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = min(fabsf(((2.0f * float(fHslider0)) + -1.0f)), fabsf(((2.0f * float(fHslider1)) + -1.0f)));
		float fSlow1 = tanf((fConst1 * ((15000.0f * fSlow0) + 500.0f)));
		float fSlow2 = (1.0f / fSlow1);
		float fSlow3 = (((fSlow2 + 1.41421354f) / fSlow1) + 1.0f);
		float fSlow4 = (2.0f / fSlow3);
		float fSlow5 = tanf((fConst1 * ((500.0f * fSlow0) + 40.0f)));
		...
		int iSlow16 = ((2 * (1 - int(float(fHslider2)))) + (1 - int(float(fHslider3))));
		float fSlow17 = (fConst6 * cosf((fConst7 * float(iSlow16))));
		int iSlow18 = (60 * iSlow16);
		float fSlow19 = (fConst10 * cosf((fConst11 * float((iSlow18 + 200)))));
		float fSlow20 = (fConst14 * cosf((fConst11 * float((iSlow18 + 400)))));
		float fSlow21 = (fConst17 * cosf((fConst11 * float((iSlow18 + 600)))));
		float fSlow22 = (fConst20 * cosf((fConst11 * float((iSlow18 + 800)))));
		float fSlow23 = (fConst23 * cosf((fConst11 * float((iSlow18 + 1000)))));
		float fSlow24 = (fConst26 * cosf((fConst11 * float((iSlow18 + 1200)))));
		float fSlow25 = (fConst29 * cosf((fConst11 * float((iSlow18 + 1400)))));
		float fSlow26 = (fConst32 * cosf((fConst11 * float((iSlow18 + 1600)))));
		float fSlow27 = (fConst35 * cosf((fConst11 * float((iSlow18 + 1800)))));
		float fSlow28 = (fConst38 * cosf((fConst11 * float((iSlow18 + 2000)))));
		float fSlow29 = (fConst41 * cosf((fConst11 * float((iSlow18 + 2200)))));
		float fSlow30 = (fConst44 * cosf((fConst11 * float((iSlow18 + 2400)))));
		float fSlow31 = (fConst47 * cosf((fConst11 * float((iSlow18 + 2600)))));
		float fSlow32 = (fConst50 * cosf((fConst11 * float((iSlow18 + 2800)))));
		float fSlow33 = (fConst53 * cosf((fConst11 * float((iSlow18 + 3000)))));
		float fSlow34 = (fConst56 * cosf((fConst11 * float((iSlow18 + 3200)))));
		float fSlow35 = (fConst59 * cosf((fConst11 * float((iSlow18 + 3400)))));
		float fSlow36 = (fConst62 * cosf((fConst11 * float((iSlow18 + 3600)))));
		float fSlow37 = (fConst65 * cosf((fConst11 * float((iSlow18 + 3800)))));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec1[0] = fSlow15;
			fRec4[0] = ((((fSlow15 - fVec1[1]) > 0.0f) > 0)?0.0f:min(fConst2, ((fRec4[1] + (0.00200000009f * (fConst0 - fVec0[1]))) + 1.0f)));
			int iTemp0 = (fRec4[0] < fConst3);
			float fTemp1 = (fSlow4 * ((fRec1[2] + (fRec1[0] + (2.0f * fRec1[1]))) * (iTemp0?((fRec4[0] < 0.0f)?0.0f:(iTemp0?(fConst4 * fRec4[0]):1.0f)):((fRec4[0] < fConst2)?((fConst4 * (0.0f - (fRec4[0] - fConst3))) + 1.0f):0.0f))));
