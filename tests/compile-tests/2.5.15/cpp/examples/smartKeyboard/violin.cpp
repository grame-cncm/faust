...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst1 = tanf((1570.79639f / fConst0));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("kb0bend", &fHslider1, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb0fingers", &fHslider2, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb0freq", &fHslider0, 220.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb1bend", &fHslider6, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb1fingers", &fHslider7, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb1freq", &fHslider5, 330.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb2bend", &fHslider9, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb2fingers", &fHslider10, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb2freq", &fHslider8, 440.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb3bend", &fHslider12, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb3fingers", &fHslider13, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb3freq", &fHslider11, 550.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb4k0x", &fHslider3, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb4k0y", &fHslider4, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow1 = (int(float(fHslider2)) > 0);
		float fSlow2 = (0.00100000005f * float(fHslider3));
		float fSlow3 = (0.00100000005f * float(fHslider4));
		float fSlow4 = (0.340000004f / (float(fHslider5) * float(fHslider6)));
		int iSlow5 = (int(float(fHslider7)) > 0);
		float fSlow6 = (0.340000004f / (float(fHslider8) * float(fHslider9)));
		int iSlow7 = (int(float(fHslider10)) > 0);
		float fSlow8 = (0.340000004f / (float(fHslider11) * float(fHslider12)));
		int iSlow9 = (int(float(fHslider13)) > 0);
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			int iTemp4 = int(min(fConst4, float(max(0, iTemp3))));
			...
			int iTemp15 = int(min(fConst4, float(max(0, (iTemp3 + 2)))));
			float fTemp16 = (0.0f - fTemp10);
			float fTemp17 = (0.0f - (0.5f * fTemp12));
			int iTemp18 = int(min(fConst4, float(max(0, (iTemp3 + 1)))));
			...
			int iTemp23 = int(min(fConst4, float(max(0, (iTemp3 + 3)))));
			float fTemp24 = (0.0f - fTemp12);
			float fTemp25 = (fTemp22 * fTemp10);
			int iTemp26 = int(min(fConst4, float(max(0, (iTemp3 + 4)))));
			...
			fRec27[0] = ((0.999000013f * fRec27[1]) + (0.00100000005f * min(1.0f, (8000.0f * fabsf((fRec28[0] - fRec28[1]))))));
			fRec29[0] = fRec0[1];
			...
			int iTemp30 = int(min(fConst4, float(max(0, iTemp29))));
			...
			int iTemp41 = int(min(fConst4, float(max(0, (iTemp29 + 2)))));
			float fTemp42 = (0.0f - fTemp36);
			float fTemp43 = (0.0f - (0.5f * fTemp38));
			int iTemp44 = int(min(fConst4, float(max(0, (iTemp29 + 1)))));
			...
			int iTemp49 = int(min(fConst4, float(max(0, (iTemp29 + 3)))));
			float fTemp50 = (0.0f - fTemp38);
			float fTemp51 = (fTemp48 * fTemp36);
			int iTemp52 = int(min(fConst4, float(max(0, (iTemp29 + 4)))));
			...
			int iTemp62 = int(min(fConst4, float(max(0, iTemp61))));
			...
			int iTemp73 = int(min(fConst4, float(max(0, (iTemp61 + 2)))));
			float fTemp74 = (0.0f - fTemp68);
			float fTemp75 = (0.0f - (0.5f * fTemp70));
			int iTemp76 = int(min(fConst4, float(max(0, (iTemp61 + 1)))));
			...
			int iTemp81 = int(min(fConst4, float(max(0, (iTemp61 + 3)))));
			float fTemp82 = (0.0f - fTemp70);
			float fTemp83 = (fTemp80 * fTemp68);
			int iTemp84 = int(min(fConst4, float(max(0, (iTemp61 + 4)))));
			...
			int iTemp88 = int(min(fConst4, float(max(0, iTemp87))));
			...
			int iTemp99 = int(min(fConst4, float(max(0, (iTemp87 + 2)))));
			float fTemp100 = (0.0f - fTemp94);
			float fTemp101 = (0.0f - (0.5f * fTemp96));
			int iTemp102 = int(min(fConst4, float(max(0, (iTemp87 + 1)))));
			...
			int iTemp107 = int(min(fConst4, float(max(0, (iTemp87 + 3)))));
			float fTemp108 = (0.0f - fTemp96);
			float fTemp109 = (fTemp106 * fTemp94);
			int iTemp110 = int(min(fConst4, float(max(0, (iTemp87 + 4)))));
			...
			int iTemp119 = int(min(fConst4, float(max(0, iTemp118))));
			...
			int iTemp130 = int(min(fConst4, float(max(0, (iTemp118 + 2)))));
			float fTemp131 = (0.0f - fTemp125);
			float fTemp132 = (0.0f - (0.5f * fTemp127));
			int iTemp133 = int(min(fConst4, float(max(0, (iTemp118 + 1)))));
			...
			int iTemp138 = int(min(fConst4, float(max(0, (iTemp118 + 3)))));
			float fTemp139 = (0.0f - fTemp127);
			float fTemp140 = (fTemp137 * fTemp125);
			int iTemp141 = int(min(fConst4, float(max(0, (iTemp118 + 4)))));
			...
			int iTemp145 = int(min(fConst4, float(max(0, iTemp144))));
			...
			int iTemp156 = int(min(fConst4, float(max(0, (iTemp144 + 2)))));
			float fTemp157 = (0.0f - fTemp151);
			float fTemp158 = (0.0f - (0.5f * fTemp153));
			int iTemp159 = int(min(fConst4, float(max(0, (iTemp144 + 1)))));
			...
			int iTemp164 = int(min(fConst4, float(max(0, (iTemp144 + 3)))));
			float fTemp165 = (0.0f - fTemp153);
			float fTemp166 = (fTemp163 * fTemp151);
			int iTemp167 = int(min(fConst4, float(max(0, (iTemp144 + 4)))));
			...
			int iTemp176 = int(min(fConst4, float(max(0, iTemp175))));
			...
			int iTemp187 = int(min(fConst4, float(max(0, (iTemp175 + 2)))));
			float fTemp188 = (0.0f - fTemp182);
			float fTemp189 = (0.0f - (0.5f * fTemp184));
			int iTemp190 = int(min(fConst4, float(max(0, (iTemp175 + 1)))));
			...
			int iTemp195 = int(min(fConst4, float(max(0, (iTemp175 + 3)))));
			float fTemp196 = (0.0f - fTemp184);
			float fTemp197 = (fTemp194 * fTemp182);
			int iTemp198 = int(min(fConst4, float(max(0, (iTemp175 + 4)))));
			...
			int iTemp202 = int(min(fConst4, float(max(0, iTemp201))));
			...
			int iTemp213 = int(min(fConst4, float(max(0, (iTemp201 + 2)))));
			float fTemp214 = (0.0f - fTemp208);
			float fTemp215 = (0.0f - (0.5f * fTemp210));
			int iTemp216 = int(min(fConst4, float(max(0, (iTemp201 + 1)))));
			...
			int iTemp221 = int(min(fConst4, float(max(0, (iTemp201 + 3)))));
			float fTemp222 = (0.0f - fTemp210);
			float fTemp223 = (fTemp220 * fTemp208);
			int iTemp224 = int(min(fConst4, float(max(0, (iTemp201 + 4)))));
			fVec6[0] = (((((fRec121[((IOTA - (iTemp202 + 2)) & 2047)] * fTemp205) * fTemp207) * fTemp209) * fTemp211) + (fTemp212 * ((((0.5f * (((fTemp204 * fRec121[((IOTA - (iTemp213 + 2)) & 2047)]) * fTemp214) * fTemp215)) + (((fRec121[((IOTA - (iTemp216 + 2)) & 2047)] * fTemp217) * fTemp218) * fTemp219)) + (0.166666672f * ((fTemp220 * fRec121[((IOTA - (iTemp221 + 2)) & 2047)]) * fTemp222))) + (0.0416666679f * (fTemp223 * fRec121[((IOTA - (iTemp224 + 2)) & 2047)])))));
			float fTemp225 = ((float(iSlow9) * fRec27[0]) - (fRec115[1] + fVec6[1]));
			float fTemp226 = (fTemp225 * min(1.0f, (1.0f / mydsp_faustpower4_f((fabsf((fTemp54 * fTemp225)) + 0.75f)))));
			float fRec116 = (fRec115[1] + fTemp226);
			float fTemp227 = (fVec6[1] + fTemp226);
			fVec7[(IOTA & 2047)] = fTemp227;
