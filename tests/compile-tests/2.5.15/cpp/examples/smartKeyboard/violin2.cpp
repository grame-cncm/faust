...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("kb1bend", &fHslider5, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb1fingers", &fHslider6, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb1freq", &fHslider4, 330.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb2bend", &fHslider8, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb2fingers", &fHslider9, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb2freq", &fHslider7, 440.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb3bend", &fHslider11, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("kb3fingers", &fHslider12, 0.0f, 0.0f, 10.0f, 1.0f);
		ui_interface->addHorizontalSlider("kb3freq", &fHslider10, 550.0f, 20.0f, 10000.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("y", &fHslider3, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = (0.340000004f / (float(fHslider4) * float(fHslider5)));
		int iSlow4 = (int(float(fHslider6)) > 0);
		float fSlow5 = (0.340000004f / (float(fHslider7) * float(fHslider8)));
		int iSlow6 = (int(float(fHslider9)) > 0);
		float fSlow7 = (0.340000004f / (float(fHslider10) * float(fHslider11)));
		int iSlow8 = (int(float(fHslider12)) > 0);
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec27[0] = ((0.999000013f * fRec27[1]) + (0.00100000005f * min(1.0f, (3000.0f * fabsf((fRec28[0] - fRec28[1]))))));
			fRec29[0] = fRec0[1];
			...
			int iTemp61 = int(min(fConst4, float(max(0, iTemp60))));
			...
			int iTemp72 = int(min(fConst4, float(max(0, (iTemp60 + 2)))));
			float fTemp73 = (0.0f - fTemp67);
			float fTemp74 = (0.0f - (0.5f * fTemp69));
			int iTemp75 = int(min(fConst4, float(max(0, (iTemp60 + 1)))));
			...
			int iTemp80 = int(min(fConst4, float(max(0, (iTemp60 + 3)))));
			float fTemp81 = (0.0f - fTemp69);
			float fTemp82 = (fTemp79 * fTemp67);
			int iTemp83 = int(min(fConst4, float(max(0, (iTemp60 + 4)))));
			...
			int iTemp87 = int(min(fConst4, float(max(0, iTemp86))));
			...
			int iTemp98 = int(min(fConst4, float(max(0, (iTemp86 + 2)))));
			float fTemp99 = (0.0f - fTemp93);
			float fTemp100 = (0.0f - (0.5f * fTemp95));
			int iTemp101 = int(min(fConst4, float(max(0, (iTemp86 + 1)))));
			...
			int iTemp106 = int(min(fConst4, float(max(0, (iTemp86 + 3)))));
			float fTemp107 = (0.0f - fTemp95);
			float fTemp108 = (fTemp105 * fTemp93);
			int iTemp109 = int(min(fConst4, float(max(0, (iTemp86 + 4)))));
			...
			int iTemp118 = int(min(fConst4, float(max(0, iTemp117))));
			...
			int iTemp129 = int(min(fConst4, float(max(0, (iTemp117 + 2)))));
			float fTemp130 = (0.0f - fTemp124);
			float fTemp131 = (0.0f - (0.5f * fTemp126));
			int iTemp132 = int(min(fConst4, float(max(0, (iTemp117 + 1)))));
			...
			int iTemp137 = int(min(fConst4, float(max(0, (iTemp117 + 3)))));
			float fTemp138 = (0.0f - fTemp126);
			float fTemp139 = (fTemp136 * fTemp124);
			int iTemp140 = int(min(fConst4, float(max(0, (iTemp117 + 4)))));
			...
			int iTemp144 = int(min(fConst4, float(max(0, iTemp143))));
			...
			int iTemp155 = int(min(fConst4, float(max(0, (iTemp143 + 2)))));
			float fTemp156 = (0.0f - fTemp150);
			float fTemp157 = (0.0f - (0.5f * fTemp152));
			int iTemp158 = int(min(fConst4, float(max(0, (iTemp143 + 1)))));
			...
			int iTemp163 = int(min(fConst4, float(max(0, (iTemp143 + 3)))));
			float fTemp164 = (0.0f - fTemp152);
			float fTemp165 = (fTemp162 * fTemp150);
			int iTemp166 = int(min(fConst4, float(max(0, (iTemp143 + 4)))));
			...
			int iTemp175 = int(min(fConst4, float(max(0, iTemp174))));
			...
			int iTemp186 = int(min(fConst4, float(max(0, (iTemp174 + 2)))));
			float fTemp187 = (0.0f - fTemp181);
			float fTemp188 = (0.0f - (0.5f * fTemp183));
			int iTemp189 = int(min(fConst4, float(max(0, (iTemp174 + 1)))));
			...
			int iTemp194 = int(min(fConst4, float(max(0, (iTemp174 + 3)))));
			float fTemp195 = (0.0f - fTemp183);
			float fTemp196 = (fTemp193 * fTemp181);
			int iTemp197 = int(min(fConst4, float(max(0, (iTemp174 + 4)))));
			...
			int iTemp201 = int(min(fConst4, float(max(0, iTemp200))));
			...
			int iTemp212 = int(min(fConst4, float(max(0, (iTemp200 + 2)))));
			float fTemp213 = (0.0f - fTemp207);
			float fTemp214 = (0.0f - (0.5f * fTemp209));
			int iTemp215 = int(min(fConst4, float(max(0, (iTemp200 + 1)))));
			...
			int iTemp220 = int(min(fConst4, float(max(0, (iTemp200 + 3)))));
			float fTemp221 = (0.0f - fTemp209);
			float fTemp222 = (fTemp219 * fTemp207);
			int iTemp223 = int(min(fConst4, float(max(0, (iTemp200 + 4)))));
