...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider5 = FAUSTFLOAT(-30.0f);
		fHslider6 = FAUSTFLOAT(200.0f);
		fHslider7 = FAUSTFLOAT(50.0f);
		fHslider8 = FAUSTFLOAT(5.0f);
		fHslider9 = FAUSTFLOAT(500.0f);
		fHslider10 = FAUSTFLOAT(-30.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Threshold", &fHslider5, -30.0f, -120.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider3, 10.0f, 10.0f, 10000.0f, 1.0f);
		...
		ui_interface->addHorizontalSlider("Hold", &fHslider6, 200.0f, 1.0f, 1000.0f, 1.0f);
		...
		ui_interface->addHorizontalSlider("Release", &fHslider4, 100.0f, 1.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalBargraph("Compressor Gain", &fHbargraph1, -50.0f, 10.0f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openHorizontalBox("0x00");
		ui_interface->declare(0, "3", "");
		...
		ui_interface->addHorizontalSlider("Ratio", &fHslider8, 5.0f, 1.0f, 20.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Threshold", &fHslider10, -30.0f, -100.0f, 10.0f, 0.100000001f);
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Attack     tooltip: Time constant in ms (1/e smoothing time) for the compression gain  to approach (exponentially) a new lower target level (the compression  `kicking in')]", &fHslider7, 50.0f, 1.0f, 1000.0f, 0.100000001f);
		...
		ui_interface->addHorizontalSlider("Release", &fHslider9, 500.0f, 1.0f, 1000.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Makeup Gain", &fHslider2, 40.0f, -96.0f, 96.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(0, "4", "");
		ui_interface->openVerticalBox("0x00");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow6 = max(fConst15, (9.99999997e-07f * float(fHslider3)));
		float fSlow7 = max(fConst15, (0.00100000005f * float(fHslider4)));
		float fSlow8 = expf((0.0f - (fConst14 / min(fSlow6, fSlow7))));
		float fSlow9 = (1.0f - fSlow8);
		float fSlow10 = (0.00100000005f * powf(10.0f, (0.0500000007f * float(fVslider0))));
		...
		float fSlow16 = expf((0.0f - (fConst14 / float(fVslider2))));
		float fSlow17 = (440.0f * (powf(2.0f, (0.0833333358f * (float(fVslider1) + -49.0f))) * (1.0f - fSlow16)));
		int iSlow18 = (iSlow13 >= 3);
		float fSlow19 = ((0.00999999978f * float(fVslider3)) + 1.0f);
		float fSlow20 = ((0.00999999978f * float(fVslider4)) + 1.0f);
		int iSlow21 = int(float(fCheckbox4));
		float fSlow22 = powf(10.0f, (0.0500000007f * float(fHslider5)));
		int iSlow23 = int((fConst0 * max(fConst15, (0.00100000005f * float(fHslider6)))));
		float fSlow24 = expf((0.0f - (fConst14 / fSlow6)));
		float fSlow25 = expf((0.0f - (fConst14 / fSlow7)));
		float fSlow26 = max(fConst14, (0.00100000005f * float(fHslider7)));
		float fSlow27 = expf((0.0f - (fConst19 / fSlow26)));
		float fSlow28 = (((1.0f / float(fHslider8)) + -1.0f) * (1.0f - fSlow27));
		float fSlow29 = expf((0.0f - (fConst14 / fSlow26)));
		float fSlow30 = expf((0.0f - (fConst14 / max(fConst14, (0.00100000005f * float(fHslider9))))));
		float fSlow31 = float(fHslider10);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec8[0] = (fSlow10 + (0.999000013f * fRec8[1]));
			fRec10[0] = (fSlow17 + (fSlow16 * fRec10[1]));
			float fTemp0 = max(20.0f, fabsf(fRec10[0]));
			fVec1[0] = fTemp0;
			float fTemp1 = (fRec9[1] + (fConst14 * fVec1[1]));
			fRec9[0] = (fTemp1 - floorf(fTemp1));
			...
			fVec7[0] = fTemp9;
			float fTemp10 = max(20.0f, fabsf((fSlow19 * fRec10[0])));
			fVec8[0] = fTemp10;
			float fTemp11 = (fRec11[1] + (fConst14 * fVec8[1]));
			fRec11[0] = (fTemp11 - floorf(fTemp11));
			...
			fVec14[0] = fTemp19;
			float fTemp20 = max(20.0f, fabsf((fSlow20 * fRec10[0])));
			fVec15[0] = fTemp20;
			float fTemp21 = (fRec12[1] + (fConst14 * fVec15[1]));
			fRec12[0] = (fTemp21 - floorf(fTemp21));
			...
			float fTemp31 = (fRec8[0] * (iSlow11?float(input0[i]):(iSlow12?(iSlow21?(((0.0499220341f * fRec14[0]) + (0.0506126992f * fRec14[2])) - ((0.0959935337f * fRec14[1]) + (0.00440878607f * fRec14[3]))):fTemp30):(0.333333343f * (fRec8[0] * (((iSlow14?(iSlow18?(fConst18 * ((float(iVec0[3]) * (fTemp9 - fVec7[1])) / fTemp0)):(fConst17 * ((float(iVec0[2]) * (fTemp6 - fVec4[1])) / fTemp0))):(iSlow15?(fConst16 * ((float(iVec0[1]) * (fTemp4 - fVec2[1])) / fTemp0)):fTemp3)) + (iSlow14?(iSlow18?(fConst18 * ((float(iVec0[3]) * (fTemp19 - fVec14[1])) / fTemp10)):(fConst17 * ((float(iVec0[2]) * (fTemp16 - fVec11[1])) / fTemp10))):(iSlow15?(fConst16 * ((float(iVec0[1]) * (fTemp14 - fVec9[1])) / fTemp10)):fTemp13))) + (iSlow14?(iSlow18?(fConst18 * ((float(iVec0[3]) * (fTemp29 - fVec21[1])) / fTemp20)):(fConst17 * ((float(iVec0[2]) * (fTemp26 - fVec18[1])) / fTemp20))):(iSlow15?(fConst16 * ((float(iVec0[1]) * (fTemp24 - fVec16[1])) / fTemp20)):fTemp23))))))));
			float fTemp32 = (iSlow5?0.0f:fTemp31);
			float fTemp33 = fabsf(fTemp32);
			fRec18[0] = ((fSlow8 * fRec18[1]) + (fSlow9 * fabsf((2.0f * fTemp33))));
			float fRec17 = fRec18[0];
			int iTemp34 = (fRec17 > fSlow22);
			iVec22[0] = iTemp34;
			iRec19[0] = max(int((iSlow23 * (iTemp34 < iVec22[1]))), int((iRec19[1] + -1)));
			float fTemp35 = fabsf(max(float(iTemp34), float((iRec19[0] > 0))));
			float fTemp36 = ((fRec15[1] > fTemp35)?fSlow25:fSlow24);
			fRec16[0] = ((fRec16[1] * fTemp36) + (fTemp35 * (1.0f - fTemp36)));
			fRec15[0] = fRec16[0];
			fHbargraph0 = FAUSTFLOAT((20.0f * log10f(fRec15[0])));
			fRec7[0] = ((fSlow8 * fRec7[1]) + (fSlow9 * fabsf((fTemp33 + fabsf(fTemp32)))));
			float fRec6 = fRec7[0];
			int iTemp37 = (fRec6 > fSlow22);
			iVec23[0] = iTemp37;
			iRec20[0] = max(int((iSlow23 * (iTemp37 < iVec23[1]))), int((iRec20[1] + -1)));
			float fTemp38 = fabsf(max(float(iTemp37), float((iRec20[0] > 0))));
			float fTemp39 = ((fRec4[1] > fTemp38)?fSlow25:fSlow24);
			fRec5[0] = ((fRec5[1] * fTemp39) + (fTemp38 * (1.0f - fTemp39)));
			fRec4[0] = fRec5[0];
			float fTemp40 = (iSlow5?fTemp31:(fRec4[0] * fTemp32));
			float fTemp41 = (iSlow3?0.0f:fTemp40);
			float fTemp42 = (iSlow5?fTemp31:(fRec4[0] * fTemp32));
			...
			fRec22[0] = fRec23[0];
			fRec21[0] = ((fSlow27 * fRec21[1]) + (fSlow28 * max(((20.0f * log10f(fRec22[0])) - fSlow31), 0.0f)));
			float fTemp46 = powf(10.0f, (0.0500000007f * fRec21[0]));
			...
			fRec25[0] = fRec26[0];
			fRec24[0] = ((fSlow27 * fRec24[1]) + (fSlow28 * max(((20.0f * log10f(fRec25[0])) - fSlow31), 0.0f)));
			fHbargraph1 = FAUSTFLOAT((20.0f * log10f(powf(10.0f, (0.0500000007f * fRec24[0])))));
			...
			fVbargraph1 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec27[0])))));
			...
			fVbargraph2 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec34[0])))));
			...
			fVbargraph3 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec41[0])))));
			...
			fVbargraph4 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec48[0])))));
			...
			fVbargraph5 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec55[0])))));
			...
			fVbargraph6 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec62[0])))));
			...
			fVbargraph7 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec69[0])))));
			...
			fVbargraph8 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec76[0])))));
			...
			fVbargraph9 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec83[0])))));
			...
			fVbargraph10 = FAUSTFLOAT((fSlow0 + (20.0f * log10f(max(1.00000001e-07f, fRec90[0])))));
