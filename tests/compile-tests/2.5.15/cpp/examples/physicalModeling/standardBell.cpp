...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst12 = powf(0.00100000005f, (1.0f / (21.9828529f * fConst0)));
		fConst13 = ((0.0f - (2.0f * fConst12)) * cosf((3080.33154f / fConst0)));
		fConst14 = mydsp_faustpower2_f(fConst12);
		fConst15 = powf(0.00100000005f, (1.0f / (21.9324703f * fConst0)));
		fConst16 = ((0.0f - (2.0f * fConst15)) * cosf((3101.66919f / fConst0)));
		fConst17 = mydsp_faustpower2_f(fConst15);
		fConst18 = powf(0.00100000005f, (1.0f / (16.0875931f * fConst0)));
		fConst19 = ((0.0f - (2.0f * fConst18)) * cosf((5810.92871f / fConst0)));
		fConst20 = mydsp_faustpower2_f(fConst18);
		fConst21 = powf(0.00100000005f, (1.0f / (16.0514126f * fConst0)));
		fConst22 = ((0.0f - (2.0f * fConst21)) * cosf((5829.40723f / fConst0)));
		fConst23 = mydsp_faustpower2_f(fConst21);
		fConst24 = powf(0.00100000005f, (1.0f / (13.1148748f * fConst0)));
		fConst25 = ((0.0f - (2.0f * fConst24)) * cosf((7421.76123f / fConst0)));
		fConst26 = mydsp_faustpower2_f(fConst24);
		fConst27 = powf(0.00100000005f, (1.0f / (13.0525637f * fConst0)));
		fConst28 = ((0.0f - (2.0f * fConst27)) * cosf((7457.76416f / fConst0)));
		fConst29 = mydsp_faustpower2_f(fConst27);
		fConst30 = powf(0.00100000005f, (1.0f / (11.3648882f * fConst0)));
		fConst31 = ((0.0f - (2.0f * fConst30)) * cosf((8475.01172f / fConst0)));
		fConst32 = mydsp_faustpower2_f(fConst30);
		fConst33 = powf(0.00100000005f, (1.0f / (11.3582935f * fConst0)));
		fConst34 = ((0.0f - (2.0f * fConst33)) * cosf((8479.1582f / fConst0)));
		fConst35 = mydsp_faustpower2_f(fConst33);
		fConst36 = powf(0.00100000005f, (1.0f / (9.36782932f * fConst0)));
		fConst37 = ((0.0f - (2.0f * fConst36)) * cosf((9803.84277f / fConst0)));
		fConst38 = mydsp_faustpower2_f(fConst36);
		fConst39 = powf(0.00100000005f, (1.0f / (8.70912743f * fConst0)));
		fConst40 = ((0.0f - (2.0f * fConst39)) * cosf((10279.1025f / fConst0)));
		fConst41 = mydsp_faustpower2_f(fConst39);
		fConst42 = powf(0.00100000005f, (1.0f / (8.11882401f * fConst0)));
		fConst43 = ((0.0f - (2.0f * fConst42)) * cosf((10723.7012f / fConst0)));
		fConst44 = mydsp_faustpower2_f(fConst42);
		fConst45 = powf(0.00100000005f, (1.0f / (8.06860828f * fConst0)));
		fConst46 = ((0.0f - (2.0f * fConst45)) * cosf((10762.4053f / fConst0)));
		fConst47 = mydsp_faustpower2_f(fConst45);
		fConst48 = powf(0.00100000005f, (1.0f / (7.80947018f * fConst0)));
		fConst49 = ((0.0f - (2.0f * fConst48)) * cosf((10964.4727f / fConst0)));
		fConst50 = mydsp_faustpower2_f(fConst48);
		fConst51 = powf(0.00100000005f, (1.0f / (7.80787468f * fConst0)));
		fConst52 = ((0.0f - (2.0f * fConst51)) * cosf((10965.7295f / fConst0)));
		fConst53 = mydsp_faustpower2_f(fConst51);
		fConst54 = powf(0.00100000005f, (1.0f / (5.8942008f * fConst0)));
		fConst55 = ((0.0f - (2.0f * fConst54)) * cosf((12600.9912f / fConst0)));
		fConst56 = mydsp_faustpower2_f(fConst54);
		fConst57 = powf(0.00100000005f, (1.0f / (5.76060009f * fConst0)));
		fConst58 = ((0.0f - (2.0f * fConst57)) * cosf((12726.4033f / fConst0)));
		fConst59 = mydsp_faustpower2_f(fConst57);
		fConst60 = powf(0.00100000005f, (1.0f / (5.57360029f * fConst0)));
		fConst61 = ((0.0f - (2.0f * fConst60)) * cosf((12904.9082f / fConst0)));
		fConst62 = mydsp_faustpower2_f(fConst60);
		fConst63 = powf(0.00100000005f, (1.0f / (5.01467991f * fConst0)));
		fConst64 = ((0.0f - (2.0f * fConst63)) * cosf((13460.9072f / fConst0)));
		fConst65 = mydsp_faustpower2_f(fConst63);
		fConst66 = powf(0.00100000005f, (1.0f / (4.95962811f * fConst0)));
		fConst67 = ((0.0f - (2.0f * fConst66)) * cosf((13517.6445f / fConst0)));
		fConst68 = mydsp_faustpower2_f(fConst66);
		fConst69 = powf(0.00100000005f, (1.0f / (3.54356432f * fConst0)));
		fConst70 = ((0.0f - (2.0f * fConst69)) * cosf((15130.916f / fConst0)));
		fConst71 = mydsp_faustpower2_f(fConst69);
		fConst72 = powf(0.00100000005f, (1.0f / (2.95078492f * fConst0)));
		fConst73 = ((0.0f - (2.0f * fConst72)) * cosf((15922.2832f / fConst0)));
		fConst74 = mydsp_faustpower2_f(fConst72);
		fConst75 = powf(0.00100000005f, (1.0f / (2.94051671f * fConst0)));
		fConst76 = ((0.0f - (2.0f * fConst75)) * cosf((15936.7969f / fConst0)));
		fConst77 = mydsp_faustpower2_f(fConst75);
		fConst78 = powf(0.00100000005f, (1.0f / (2.5697813f * fConst0)));
		fConst79 = ((0.0f - (2.0f * fConst78)) * cosf((16482.6797f / fConst0)));
		fConst80 = mydsp_faustpower2_f(fConst78);
		fConst81 = powf(0.00100000005f, (1.0f / (2.54894495f * fConst0)));
		fConst82 = ((0.0f - (2.0f * fConst81)) * cosf((16514.7246f / fConst0)));
		fConst83 = mydsp_faustpower2_f(fConst81);
		fConst84 = powf(0.00100000005f, (1.0f / (2.22338176f * fConst0)));
		fConst85 = ((0.0f - (2.0f * fConst84)) * cosf((17037.2969f / fConst0)));
		fConst86 = mydsp_faustpower2_f(fConst84);
		fConst87 = powf(0.00100000005f, (1.0f / (2.22004151f * fConst0)));
		fConst88 = ((0.0f - (2.0f * fConst87)) * cosf((17042.8887f / fConst0)));
		fConst89 = mydsp_faustpower2_f(fConst87);
		fConst90 = powf(0.00100000005f, (1.0f / (1.82754278f * fConst0)));
		fConst91 = ((0.0f - (2.0f * fConst90)) * cosf((17738.877f / fConst0)));
		fConst92 = mydsp_faustpower2_f(fConst90);
		fConst93 = powf(0.00100000005f, (1.0f / (1.81425309f * fConst0)));
		fConst94 = ((0.0f - (2.0f * fConst93)) * cosf((17763.9473f / fConst0)));
		fConst95 = mydsp_faustpower2_f(fConst93);
		fConst96 = powf(0.00100000005f, (1.0f / (1.69632649f * fConst0)));
		fConst97 = ((0.0f - (2.0f * fConst96)) * cosf((17991.3984f / fConst0)));
		fConst98 = mydsp_faustpower2_f(fConst96);
		fConst99 = powf(0.00100000005f, (1.0f / (1.66215611f * fConst0)));
		fConst100 = ((0.0f - (2.0f * fConst99)) * cosf((18059.0684f / fConst0)));
		fConst101 = mydsp_faustpower2_f(fConst99);
		fConst102 = powf(0.00100000005f, (1.0f / (1.5124892f * fConst0)));
		fConst103 = ((0.0f - (2.0f * fConst102)) * cosf((18365.75f / fConst0)));
		fConst104 = mydsp_faustpower2_f(fConst102);
		fConst105 = powf(0.00100000005f, (1.0f / (1.50448632f * fConst0)));
		fConst106 = ((0.0f - (2.0f * fConst105)) * cosf((18382.6523f / fConst0)));
		fConst107 = mydsp_faustpower2_f(fConst105);
		fConst108 = powf(0.00100000005f, (1.0f / (1.20695853f * fConst0)));
		fConst109 = ((0.0f - (2.0f * fConst108)) * cosf((19053.8848f / fConst0)));
		fConst110 = mydsp_faustpower2_f(fConst108);
		fConst111 = powf(0.00100000005f, (1.0f / (1.18205249f * fConst0)));
		fConst112 = ((0.0f - (2.0f * fConst111)) * cosf((19114.3926f / fConst0)));
		fConst113 = mydsp_faustpower2_f(fConst111);
		fConst114 = powf(0.00100000005f, (1.0f / (0.799621463f * fConst0)));
		fConst115 = ((0.0f - (2.0f * fConst114)) * cosf((20160.0391f / fConst0)));
		fConst116 = mydsp_faustpower2_f(fConst114);
		fConst117 = powf(0.00100000005f, (1.0f / (0.476466238f * fConst0)));
		fConst118 = ((0.0f - (2.0f * fConst117)) * cosf((21315.832f / fConst0)));
		fConst119 = mydsp_faustpower2_f(fConst117);
		fConst120 = powf(0.00100000005f, (1.0f / (0.349252015f * fConst0)));
		fConst121 = ((0.0f - (2.0f * fConst120)) * cosf((21902.6816f / fConst0)));
		fConst122 = mydsp_faustpower2_f(fConst120);
		fConst123 = powf(0.00100000005f, (1.0f / (0.339770854f * fConst0)));
		fConst124 = ((0.0f - (2.0f * fConst123)) * cosf((21951.25f / fConst0)));
		fConst125 = mydsp_faustpower2_f(fConst123);
		fConst126 = powf(0.00100000005f, (1.0f / (0.286384672f * fConst0)));
		fConst127 = ((0.0f - (2.0f * fConst126)) * cosf((22241.2188f / fConst0)));
		fConst128 = mydsp_faustpower2_f(fConst126);
		fConst129 = powf(0.00100000005f, (1.0f / (0.274717599f * fConst0)));
		fConst130 = ((0.0f - (2.0f * fConst129)) * cosf((22308.8262f / fConst0)));
		fConst131 = mydsp_faustpower2_f(fConst129);
		fConst132 = powf(0.00100000005f, (1.0f / (0.157355621f * fConst0)));
		fConst133 = ((0.0f - (2.0f * fConst132)) * cosf((23114.0176f / fConst0)));
		fConst134 = mydsp_faustpower2_f(fConst132);
		fConst135 = powf(0.00100000005f, (1.0f / (0.128241107f * fConst0)));
		fConst136 = ((0.0f - (2.0f * fConst135)) * cosf((23367.418f / fConst0)));
		fConst137 = mydsp_faustpower2_f(fConst135);
		fConst138 = powf(0.00100000005f, (1.0f / (0.125847965f * fConst0)));
		fConst139 = ((0.0f - (2.0f * fConst138)) * cosf((23389.7227f / fConst0)));
		fConst140 = mydsp_faustpower2_f(fConst138);
		fConst141 = powf(0.00100000005f, (1.0f / (0.0874003693f * fConst0)));
		fConst142 = ((0.0f - (2.0f * fConst141)) * cosf((23789.8984f / fConst0)));
		fConst143 = mydsp_faustpower2_f(fConst141);
		fConst144 = powf(0.00100000005f, (1.0f / (0.0857402086f * fConst0)));
		fConst145 = ((0.0f - (2.0f * fConst144)) * cosf((23809.377f / fConst0)));
		fConst146 = mydsp_faustpower2_f(fConst144);
		fConst147 = powf(0.00100000005f, (1.0f / (0.0146122221f * fConst0)));
		fConst148 = ((0.0f - (2.0f * fConst147)) * cosf((25092.4668f / fConst0)));
		fConst149 = mydsp_faustpower2_f(fConst147);
		fConst150 = powf(0.00100000005f, (1.0f / (0.0137371188f * fConst0)));
		fConst151 = ((0.0f - (2.0f * fConst150)) * cosf((25122.877f / fConst0)));
		fConst152 = mydsp_faustpower2_f(fConst150);
		fConst153 = powf(0.00100000005f, (1.0f / (0.00102551328f * fConst0)));
		fConst154 = ((0.0f - (2.0f * fConst153)) * cosf((25908.1484f / fConst0)));
		fConst155 = mydsp_faustpower2_f(fConst153);
		fConst156 = powf(0.00100000005f, (1.0f / (0.000100996243f * fConst0)));
		fConst157 = ((0.0f - (2.0f * fConst156)) * cosf((26168.3984f / fConst0)));
		fConst158 = mydsp_faustpower2_f(fConst156);
		fConst159 = powf(0.00100000005f, (1.0f / (8.28051384e-07f * fConst0)));
		fConst160 = ((0.0f - (2.0f * fConst159)) * cosf((26313.8535f / fConst0)));
