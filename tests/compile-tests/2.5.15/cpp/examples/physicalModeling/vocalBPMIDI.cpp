...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider5, 440.0f, 50.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("bend", &fHslider6, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("vowel", &fHslider10, 0.0f, 0.0f, 4.0f, 0.00999999978f);
		ui_interface->declare(&fHslider4, "2", "");
		ui_interface->declare(&fHslider4, "style", "knob");
		ui_interface->addHorizontalSlider("fricative", &fHslider4, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider8, "3", "");
		ui_interface->declare(&fHslider8, "style", "knob");
		ui_interface->addHorizontalSlider("vibratoFreq", &fHslider8, 6.0f, 1.0f, 10.0f, 0.00999999978f);
		ui_interface->declare(&fHslider7, "4", "");
		ui_interface->declare(&fHslider7, "style", "knob");
		ui_interface->addHorizontalSlider("vibratoGain", &fHslider7, 0.5f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = ((fSlow1 * float(fHslider2)) * (1.0f - fSlow2));
		...
		float fSlow8 = (0.100000001f * float(fHslider7));
		float fSlow9 = (fConst3 * float(fHslider8));
		...
		float fSlow15 = (0.00100000005f * float(fHslider10));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			int iTemp0 = ((fSlow1 == fVec1[1]) | iSlow6);
			...
			float fTemp2 = max(1.00000001e-07f, fabsf((fSlow5 * (fRec5[0] * ((fSlow8 * fRec6[0]) + 1.0f)))));
			...
			float fTemp62 = tanf((fConst4 * fTemp61));
			...
			float fTemp79 = tanf((fConst4 * fTemp78));
			...
			float fTemp93 = tanf((fConst4 * fTemp92));
			...
			float fTemp106 = tanf((fConst4 * fTemp105));
			...
			float fTemp114 = tanf((fConst4 * fTemp113));
