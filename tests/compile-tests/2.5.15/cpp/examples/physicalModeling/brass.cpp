...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("tubeLength", &fHslider7, 0.5f, 0.00999999978f, 2.5f, 0.00999999978f);
		ui_interface->declare(&fHslider6, "2", "");
		ui_interface->addHorizontalSlider("lipsTension", &fHslider6, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->addHorizontalSlider("mute", &fHslider0, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec19[0] = ((0.0299999993f * ((0.300000012f * fTemp0) - (0.850000024f * fRec15[1]))) - ((fRec19[1] * (0.0f - (1.99399996f * cosf((fConst3 * (powf(4.0f, ((2.0f * fRec25[0]) + -1.0f)) / fRec26[0])))))) + (0.994009018f * fRec19[2])));
			float fTemp1 = max(-1.0f, min(1.0f, mydsp_faustpower2_f(fRec19[0])));
			...
			int iTemp7 = (int(min(fConst4, float(max(0, iTemp6)))) + 1);
			...
			int iTemp18 = (int(min(fConst4, float(max(0, (iTemp6 + 2))))) + 1);
			float fTemp19 = (0.0f - fTemp13);
			float fTemp20 = (0.0f - (0.5f * fTemp15));
			int iTemp21 = (int(min(fConst4, float(max(0, (iTemp6 + 1))))) + 1);
			...
			int iTemp26 = (int(min(fConst4, float(max(0, (iTemp6 + 3))))) + 1);
			float fTemp27 = (0.0f - fTemp15);
			float fTemp28 = (fTemp25 * fTemp13);
			int iTemp29 = (int(min(fConst4, float(max(0, (iTemp6 + 4))))) + 1);
