...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider7 = FAUSTFLOAT(0.59999999999999998f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("gain", &fHslider7, 0.600000024f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider8, "3", "");
		ui_interface->declare(&fHslider8, "style", "knob");
		ui_interface->addHorizontalSlider("envAttack", &fHslider8, 1.0f, 0.0f, 30.0f, 0.00999999978f);
		...
		ui_interface->addHorizontalSlider("pressure", &fHslider9, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider1, "1", "");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->addHorizontalSlider("position", &fHslider1, 0.699999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->declare(0, "2", "");
		ui_interface->openHorizontalBox("otherParams");
		ui_interface->declare(&fHslider6, "0", "");
		ui_interface->declare(&fHslider6, "style", "knob");
		ui_interface->addHorizontalSlider("vibratoFrequency", &fHslider6, 6.0f, 1.0f, 10.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (340.0f / float(fHslider2));
		float fSlow3 = float(fHslider3);
		float fSlow4 = min(1.0f, (float(fButton0) + float(fHslider4)));
		int iSlow5 = (fSlow4 == 0.0f);
		float fSlow6 = (0.00999999978f * float(fHslider5));
		float fSlow7 = (fConst6 * float(fHslider6));
		float fSlow8 = sinf(fSlow7);
		float fSlow9 = cosf(fSlow7);
		float fSlow10 = (0.0f - fSlow8);
		float fSlow11 = expf((0.0f - (fConst7 / float(fHslider8))));
		float fSlow12 = ((fSlow4 * float(fHslider7)) * (1.0f - fSlow11));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			int iTemp5 = int(min(fConst4, float(max(0, int(iTemp4)))));
			...
			int iTemp16 = int(min(fConst4, float(max(0, int((iTemp4 + 2))))));
			float fTemp17 = (0.0f - fTemp11);
			float fTemp18 = (0.0f - (0.5f * fTemp13));
			int iTemp19 = int(min(fConst4, float(max(0, int((iTemp4 + 1))))));
			...
			int iTemp24 = int(min(fConst4, float(max(0, int((iTemp4 + 3))))));
			float fTemp25 = (0.0f - fTemp13);
			float fTemp26 = (fTemp23 * fTemp11);
			int iTemp27 = int(min(fConst4, float(max(0, int((iTemp4 + 4))))));
			...
			int iTemp31 = int(min(fConst4, float(max(0, int(iTemp30)))));
			...
			int iTemp42 = int(min(fConst4, float(max(0, int((iTemp30 + 2))))));
			float fTemp43 = (0.0f - fTemp37);
			float fTemp44 = (0.0f - (0.5f * fTemp39));
			int iTemp45 = int(min(fConst4, float(max(0, int((iTemp30 + 1))))));
			...
			int iTemp50 = int(min(fConst4, float(max(0, int((iTemp30 + 3))))));
			float fTemp51 = (0.0f - fTemp39);
			float fTemp52 = (fTemp49 * fTemp37);
			int iTemp53 = int(min(fConst4, float(max(0, int((iTemp30 + 4))))));
			...
			float fTemp55 = (fTemp54 * min(1.0f, (1.0f / mydsp_faustpower4_f((fabsf(((5.0f - (4.0f * fRec34[0])) * fTemp54)) + 0.75f)))));
