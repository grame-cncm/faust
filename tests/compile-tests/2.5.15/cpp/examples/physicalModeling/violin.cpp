...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("length", &fHslider2, 0.75f, 0.0f, 2.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("bow");
		ui_interface->declare(&fHslider3, "0", "");
		ui_interface->addHorizontalSlider("velocity", &fHslider3, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider4, "1", "");
		ui_interface->addHorizontalSlider("pressure", &fHslider4, 0.5f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp54 = (fTemp53 * min(1.0f, (1.0f / mydsp_faustpower4_f((fabsf(((5.0f - (4.0f * fRec32[0])) * fTemp53)) + 0.75f)))));
