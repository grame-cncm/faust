...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "Simple acoustic guitar model with steel strings.");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = ((fSlow3 / fRec30[0]) + -0.100000001f);
			...
			fRec32[(IOTA & 2047)] = ((0.0500000007f * fRec32[((IOTA - 1) & 2047)]) + (0.949999988f * fVec3[1]));
