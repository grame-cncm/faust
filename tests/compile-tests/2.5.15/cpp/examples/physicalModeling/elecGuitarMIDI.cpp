...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow5 = min(1.0f, (float(fButton0) + float(fHslider4)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fSlow5;
			int iTemp0 = ((fSlow5 == fVec0[1]) | iSlow6);
			...
			int iTemp5 = int(min(fConst1, float(max(0, int(iTemp4)))));
			...
			int iTemp16 = int(min(fConst1, float(max(0, int((iTemp4 + 2))))));
			float fTemp17 = (0.0f - fTemp11);
			float fTemp18 = (0.0f - (0.5f * fTemp13));
			int iTemp19 = int(min(fConst1, float(max(0, int((iTemp4 + 1))))));
			...
			int iTemp24 = int(min(fConst1, float(max(0, int((iTemp4 + 3))))));
			float fTemp25 = (0.0f - fTemp13);
			float fTemp26 = (fTemp23 * fTemp11);
			int iTemp27 = int(min(fConst1, float(max(0, int((iTemp4 + 4))))));
			...
			int iTemp31 = int(min(fConst1, float(max(0, int(iTemp30)))));
			...
			int iTemp42 = int(min(fConst1, float(max(0, int((iTemp30 + 2))))));
			float fTemp43 = (0.0f - fTemp37);
			float fTemp44 = (0.0f - (0.5f * fTemp39));
			int iTemp45 = int(min(fConst1, float(max(0, int((iTemp30 + 1))))));
			...
			int iTemp50 = int(min(fConst1, float(max(0, int((iTemp30 + 3))))));
			float fTemp51 = (0.0f - fTemp39);
			float fTemp52 = (fTemp49 * fTemp37);
			int iTemp53 = int(min(fConst1, float(max(0, int((iTemp30 + 4))))));
			...
			float fTemp54 = tanf((fSlow8 * fRec30[0]));
			...
			fRec38[0] = ((((fSlow5 - fVec0[1]) > 0.0f) > 0)?0.0f:min(fTemp58, ((fRec38[1] + (fConst4 * (fTemp57 - fVec2[1]))) + 1.0f)));
			float fTemp59 = (fConst5 * fTemp57);
			int iTemp60 = (fRec38[0] < fTemp59);
			float fTemp61 = (fSlow7 * (((fRec36[2] + (fRec36[0] + (2.0f * fRec36[1]))) * (iTemp60?((fRec38[0] < 0.0f)?0.0f:(iTemp60?(fConst6 * (fRec38[0] / fTemp57)):1.0f)):((fRec38[0] < fTemp58)?((fConst6 * ((0.0f - (fRec38[0] - fTemp59)) / fTemp57)) + 1.0f):0.0f))) / fTemp56));
			float fTemp62 = (fVec1[1] + fTemp61);
			fVec3[0] = fTemp62;
			fRec32[(IOTA & 2047)] = ((0.0500000007f * fRec32[((IOTA - 1) & 2047)]) + (0.949999988f * fVec3[2]));
			...
			float fRec28 = (fRec21[1] + (float(iRec35) + fVec3[1]));
			fRec21[0] = fRec26;
			float fRec22 = fRec21[1];
			float fRec23 = fRec27;
			float fRec24 = fRec28;
			fRec17[0] = fRec22;
			float fRec18 = (fTemp61 + fRec17[1]);
			float fRec19 = fRec23;
			float fRec20 = fRec24;
			fRec13[(IOTA & 2047)] = fRec18;
			float fRec14 = (((((fTemp34 * fTemp36) * fTemp38) * fTemp40) * fRec13[((IOTA - (iTemp31 + 1)) & 2047)]) + (fTemp41 * (((0.166666672f * ((fTemp49 * fTemp51) * fRec13[((IOTA - (iTemp50 + 1)) & 2047)])) + ((((fTemp46 * fTemp47) * fTemp48) * fRec13[((IOTA - (iTemp45 + 1)) & 2047)]) + (0.5f * (((fTemp33 * fTemp43) * fTemp44) * fRec13[((IOTA - (iTemp42 + 1)) & 2047)])))) + (0.0416666679f * (fTemp52 * fRec13[((IOTA - (iTemp53 + 1)) & 2047)])))));
			fRec15[0] = fRec19;
			float fRec16 = fRec20;
			fRec11[0] = fRec15[1];
			float fRec12 = fRec16;
