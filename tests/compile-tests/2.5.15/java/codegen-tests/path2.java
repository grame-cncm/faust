...
public class mydsp extends dsp {
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("common", new FaustVarAccess() {
		...
		ui_interface.addHorizontalSlider("slid", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow0 = fHslider1;
		float fSlow1 = (fHslider0 * fSlow0);
		float fSlow2 = (fSlow0 * fHslider2);
		float fSlow3 = (fSlow0 * fHslider3);
		float fSlow4 = (fSlow0 * fHslider4);
