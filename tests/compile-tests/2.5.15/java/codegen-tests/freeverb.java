...
public class mydsp extends dsp {
	...
	public void instanceResetUserInterface() {
		fHslider0 = (float)0.33329999999999999f;
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("Damp", new FaustVarAccess() {
		...
		ui_interface.addHorizontalSlider("RoomSize", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = ((0.280000001f * fHslider1) + 0.699999988f);
		float fSlow2 = (0.400000006f * fHslider2);
