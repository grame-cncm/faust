...
public class mydsp extends dsp {
	...
	public void instanceConstants(int samplingFreq) {
		...
		fConst12 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.540000021f * fConst0)));
		fConst13 = (0.0f - (2.0f * fConst12));
		fConst14 = mydsp_faustpower2_f(fConst12);
		fConst15 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.50999999f * fConst0)));
		fConst16 = (0.0f - (2.0f * fConst15));
		fConst17 = mydsp_faustpower2_f(fConst15);
		fConst18 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.479999989f * fConst0)));
		fConst19 = (0.0f - (2.0f * fConst18));
		fConst20 = mydsp_faustpower2_f(fConst18);
		fConst21 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.449999988f * fConst0)));
		fConst22 = (0.0f - (2.0f * fConst21));
		fConst23 = mydsp_faustpower2_f(fConst21);
		fConst24 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.419999987f * fConst0)));
		fConst25 = (0.0f - (2.0f * fConst24));
		fConst26 = mydsp_faustpower2_f(fConst24);
		fConst27 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.389999986f * fConst0)));
		fConst28 = (0.0f - (2.0f * fConst27));
		fConst29 = mydsp_faustpower2_f(fConst27);
		fConst30 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.360000014f * fConst0)));
		fConst31 = (0.0f - (2.0f * fConst30));
		fConst32 = mydsp_faustpower2_f(fConst30);
		fConst33 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.330000013f * fConst0)));
		fConst34 = (0.0f - (2.0f * fConst33));
		fConst35 = mydsp_faustpower2_f(fConst33);
		fConst36 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.300000012f * fConst0)));
		fConst37 = (0.0f - (2.0f * fConst36));
		fConst38 = mydsp_faustpower2_f(fConst36);
		fConst39 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.270000011f * fConst0)));
		fConst40 = (0.0f - (2.0f * fConst39));
		fConst41 = mydsp_faustpower2_f(fConst39);
		fConst42 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.239999995f * fConst0)));
		fConst43 = (0.0f - (2.0f * fConst42));
		fConst44 = mydsp_faustpower2_f(fConst42);
		fConst45 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.209999993f * fConst0)));
		fConst46 = (0.0f - (2.0f * fConst45));
		fConst47 = mydsp_faustpower2_f(fConst45);
		fConst48 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.180000007f * fConst0)));
		fConst49 = (0.0f - (2.0f * fConst48));
		fConst50 = mydsp_faustpower2_f(fConst48);
		fConst51 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.150000006f * fConst0)));
		fConst52 = (0.0f - (2.0f * fConst51));
		fConst53 = mydsp_faustpower2_f(fConst51);
		fConst54 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.119999997f * fConst0)));
		fConst55 = (0.0f - (2.0f * fConst54));
		fConst56 = mydsp_faustpower2_f(fConst54);
		fConst57 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.0900000036f * fConst0)));
		fConst58 = (0.0f - (2.0f * fConst57));
		fConst59 = mydsp_faustpower2_f(fConst57);
		fConst60 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.0599999987f * fConst0)));
		fConst61 = (0.0f - (2.0f * fConst60));
		fConst62 = mydsp_faustpower2_f(fConst60);
		fConst63 = (float)java.lang.Math.pow(0.00100000005f, (1.0f / (0.0299999993f * fConst0)));
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("freq", new FaustVarAccess() {
			...
			, 60.0f, 50.0f, 100.0f, 0.00999999978f);
		...
		ui_interface.addHorizontalSlider("strikePosition", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow0 = (0.0500000007f * fHslider0);
		float fSlow1 = fHslider2;
		float fSlow2 = (float)java.lang.Math.tan((fConst1 * ((15000.0f * fSlow1) + 500.0f)));
		float fSlow3 = (1.0f / fSlow2);
		float fSlow4 = (((fSlow3 + 1.41421354f) / fSlow2) + 1.0f);
		float fSlow5 = (fHslider1 / fSlow4);
		float fSlow6 = (float)java.lang.Math.tan((fConst1 * ((500.0f * fSlow1) + 40.0f)));
		...
		float fSlow17 = fHslider3;
		float fSlow18 = (fConst2 * fSlow17);
		float fSlow19 = (fConst3 * fSlow17);
		float fSlow20 = (fConst4 / fSlow17);
		float fSlow21 = fHslider4;
		float fSlow22 = (fConst6 * (float)java.lang.Math.cos((fConst7 * fSlow21)));
		float fSlow23 = (fConst10 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 200.0f))));
		float fSlow24 = (fConst13 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 400.0f))));
		float fSlow25 = (fConst16 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 600.0f))));
		float fSlow26 = (fConst19 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 800.0f))));
		float fSlow27 = (fConst22 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 1000.0f))));
		float fSlow28 = (fConst25 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 1200.0f))));
		float fSlow29 = (fConst28 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 1400.0f))));
		float fSlow30 = (fConst31 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 1600.0f))));
		float fSlow31 = (fConst34 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 1800.0f))));
		float fSlow32 = (fConst37 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 2000.0f))));
		float fSlow33 = (fConst40 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 2200.0f))));
		float fSlow34 = (fConst43 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 2400.0f))));
		float fSlow35 = (fConst46 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 2600.0f))));
		float fSlow36 = (fConst49 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 2800.0f))));
		float fSlow37 = (fConst52 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 3000.0f))));
		float fSlow38 = (fConst55 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 3200.0f))));
		float fSlow39 = (fConst58 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 3400.0f))));
		float fSlow40 = (fConst61 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 3600.0f))));
		float fSlow41 = (fConst64 * (float)java.lang.Math.cos((fConst7 * (fSlow21 + 3800.0f))));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fSlow16;
			fVec1[0] = fSlow17;
			fRec4[0] = (((((fSlow16 - fVec0[1]) > 0.0f) > 0))?0.0f:(float)java.lang.Math.min(fSlow18, ((fRec4[1] + (fConst2 * (fSlow17 - fVec1[1]))) + 1.0f)));
			int iTemp0 = (fRec4[0] < fSlow19);
			float fTemp1 = (fSlow5 * ((fRec1[2] + (fRec1[0] + (2.0f * fRec1[1]))) * (((iTemp0==0)?true:false)?(((fRec4[0] < 0.0f))?0.0f:(((iTemp0==0)?true:false)?(fSlow20 * fRec4[0]):1.0f)):(((fRec4[0] < fSlow18))?((fSlow20 * (0.0f - (fRec4[0] - fSlow19))) + 1.0f):0.0f))));
