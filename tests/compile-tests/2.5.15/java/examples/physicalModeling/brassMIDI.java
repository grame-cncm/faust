...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow3 = (float)java.lang.Math.exp((0.0f - (fConst1 / fHslider4)));
		float fSlow4 = ((fSlow2 * fHslider3) * (1.0f - fSlow3));
		float fSlow5 = (0.0399999991f * fHslider5);
		float fSlow6 = (fConst2 * fHslider6);
		float fSlow7 = (float)java.lang.Math.sin(fSlow6);
		float fSlow8 = (float)java.lang.Math.cos(fSlow6);
		float fSlow9 = (0.0f - fSlow7);
		float fSlow10 = fHslider7;
		float fSlow11 = (fConst2 * fSlow10);
		int iSlow12 = (fSlow2 == 0.0f);
		float fSlow13 = fHslider8;
		float fSlow14 = (0.00100000005f * fHslider9);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			int iTemp1 = ((((fSlow2 == fVec1[1]))?1:0) | iSlow12);
			fRec23[0] = ((0.999000013f * (fRec23[1] * (float)iTemp1)) + (fSlow13 * (1.0f - (0.999000013f * (float)iTemp1))));
			fRec24[0] = (fSlow14 + (0.999000013f * fRec24[1]));
			fRec19[0] = ((0.0299999993f * ((0.300000012f * fTemp0) - (0.850000024f * fRec15[1]))) - ((fRec19[1] * (0.0f - (1.99399996f * (float)java.lang.Math.cos((fSlow11 * (fRec23[0] * (float)java.lang.Math.pow(4.0f, ((2.0f * fRec24[0]) + -1.0f)))))))) + (0.994009018f * fRec19[2])));
			float fTemp2 = (float)java.lang.Math.max(-1.0f, (float)java.lang.Math.min(1.0f, mydsp_faustpower2_f(fRec19[0])));
			...
			int iTemp8 = ((int)(float)java.lang.Math.min(fConst3, (float)java.lang.Math.max(0, iTemp7)) + 1);
			float fTemp9 = (float)java.lang.Math.floor(fTemp6);
			...
			int iTemp19 = ((int)(float)java.lang.Math.min(fConst3, (float)java.lang.Math.max(0, (iTemp7 + 2))) + 1);
			float fTemp20 = (0.0f - fTemp14);
			float fTemp21 = (0.0f - (0.5f * fTemp16));
			int iTemp22 = ((int)(float)java.lang.Math.min(fConst3, (float)java.lang.Math.max(0, (iTemp7 + 1))) + 1);
			...
			int iTemp27 = ((int)(float)java.lang.Math.min(fConst3, (float)java.lang.Math.max(0, (iTemp7 + 3))) + 1);
			float fTemp28 = (0.0f - fTemp16);
			float fTemp29 = (fTemp26 * fTemp14);
			int iTemp30 = ((int)(float)java.lang.Math.min(fConst3, (float)java.lang.Math.max(0, (iTemp7 + 4))) + 1);
