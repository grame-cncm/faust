...
public class mydsp extends dsp {
	...
	static float ftbl0mydspSIG0[] = new float[250];
	...
	public void instanceConstants(int samplingFreq) {
		...
		fConst5 = (float)java.lang.Math.tan((31.415926f / fConst0));
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow4 = (float)java.lang.Math.floor(fSlow3);
		...
		int iSlow11 = (int)(float)java.lang.Math.min(fConst2, (float)java.lang.Math.max(0, iSlow10));
		float fSlow12 = (fSlow2 - fSlow4);
		float fSlow13 = (((0.0f - fSlow6) * (0.0f - (0.5f * fSlow7))) * (0.0f - (0.333333343f * fSlow8)));
		int iSlow14 = (int)(float)java.lang.Math.min(fConst2, (float)java.lang.Math.max(0, (iSlow10 + 1)));
		float fSlow15 = (0.5f * ((fSlow5 * (0.0f - fSlow7)) * (0.0f - (0.5f * fSlow8))));
		int iSlow16 = (int)(float)java.lang.Math.min(fConst2, (float)java.lang.Math.max(0, (iSlow10 + 2)));
		float fSlow17 = (fSlow5 * fSlow6);
		float fSlow18 = (0.166666672f * (fSlow17 * (0.0f - fSlow8)));
		int iSlow19 = (int)(float)java.lang.Math.min(fConst2, (float)java.lang.Math.max(0, (iSlow10 + 3)));
		float fSlow20 = (0.0416666679f * (fSlow17 * fSlow7));
		int iSlow21 = (int)(float)java.lang.Math.min(fConst2, (float)java.lang.Math.max(0, (iSlow10 + 4)));
		int iSlow22 = (50 * (int)fEntry0);
		float fSlow23 = (((fSlow1 < fConst3))?ftbl0mydspSIG0[iSlow22]:0.0f);
		float fSlow24 = (float)java.lang.Math.tan((fConst4 * fHslider3));
		float fSlow25 = (1.0f / fSlow24);
		float fSlow26 = (((fSlow25 + 1.41421354f) / fSlow24) + 1.0f);
		float fSlow27 = (fHslider2 / fSlow26);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec1[0] = fSlow31;
			fVec2[0] = fSlow32;
			fRec15[0] = (((((fSlow31 - fVec1[1]) > 0.0f) > 0))?0.0f:(float)java.lang.Math.min(fSlow33, ((fRec15[1] + (fConst12 * (fSlow32 - fVec2[1]))) + 1.0f)));
			int iTemp1 = (fRec15[0] < fSlow34);
			float fTemp2 = (fSlow27 * ((fRec12[2] + (fRec12[0] + (2.0f * fRec12[1]))) * (((iTemp1==0)?true:false)?(((fRec15[0] < 0.0f))?0.0f:(((iTemp1==0)?true:false)?(fSlow35 * fRec15[0]):1.0f)):(((fRec15[0] < fSlow33))?((fSlow35 * (0.0f - (fRec15[0] - fSlow34))) + 1.0f):0.0f))));
