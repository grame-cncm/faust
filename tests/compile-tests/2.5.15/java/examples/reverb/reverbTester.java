...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (1.0f - fCheckbox0);
		float fSlow2 = fButton1;
		float fSlow3 = (0.100000001f * fCheckbox1);
		float fSlow4 = fButton2;
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = (((float)iTemp0 + ((fSlow1 * input3[i]) + ((((fSlow2 - fVec1[1]) > 0.0f))?1.f:0.f))) + fTemp1);
			fVec2[0] = fSlow4;
			output1[i] = (((((fSlow4 - fVec2[1]) > 0.0f))?1.f:0.f) + ((fSlow1 * input4[i]) + ((float)iTemp0 + fTemp1)));
			fVec0[1] = fVec0[0];
			fVec1[1] = fVec1[0];
			iRec1[1] = iRec1[0];
