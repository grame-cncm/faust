...
public class mydsp extends dsp {
	...
	float fVslider2;
	int IOTA;
	float fVec0[] = new float[8192];
	int iConst3;
	float fRec8[] = new float[2];
	float fRec11[] = new float[2];
	float fVec1[] = new float[8192];
	int iConst4;
	...
	float fVec20[] = new float[2048];
	float fRec30[] = new float[2];
	float fVec21[] = new float[2048];
	...
	public void instanceConstants(int samplingFreq) {
		...
		iConst12 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst11 + -1)));
		iConst13 = (int)(0.00999999978f * fConst0);
		iConst14 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst13 + -1)));
		iConst15 = (int)(0.00773242628f * fConst0);
		iConst16 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst15 + -1)));
		iConst17 = (int)(0.00510204071f * fConst0);
		iConst18 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst17 + -1)));
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		int iSlow6 = (int)(fConst19 * fVslider3);
		...
		int iSlow16 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst11 + iSlow15)));
		int iSlow17 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst13 + iSlow15)));
		int iSlow18 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst15 + iSlow15)));
		int iSlow19 = java.lang.Math.min(1024, java.lang.Math.max(0, (iConst17 + iSlow15)));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = ((fRec1 + fRec0[1]) + (fSlow5 * fTemp0));
			...
			output1[i] = ((fSlow5 * fTemp1) + (fRec25 + fRec24[1]));
			fRec9[1] = fRec9[0];
			IOTA = (IOTA + 1);
			fRec8[1] = fRec8[0];
			fRec11[1] = fRec11[0];
