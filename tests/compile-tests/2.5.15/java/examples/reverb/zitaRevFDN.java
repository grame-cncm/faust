...
public class mydsp extends dsp {
	...
	float fVec2[] = new float[32768];
	float fConst10;
	int iConst11;
	float fVec3[] = new float[4096];
	int iConst12;
	...
	float fVec4[] = new float[16384];
	float fConst15;
	int iConst16;
	float fVec5[] = new float[4096];
	int iConst17;
	...
	float fVec6[] = new float[32768];
	float fConst20;
	int iConst21;
	float fVec7[] = new float[4096];
	int iConst22;
	...
	float fVec8[] = new float[16384];
	float fConst25;
	int iConst26;
	float fVec9[] = new float[2048];
	int iConst27;
	...
	public void instanceConstants(int samplingFreq) {
		...
		fConst1 = (float)java.lang.Math.floor(((0.219990999f * fConst0) + 0.5f));
		fConst2 = ((0.0f - (6.90775537f * fConst1)) / fConst0);
		fConst3 = (6.28318548f / fConst0);
		fConst4 = (3.14159274f / fConst0);
		fConst5 = (float)java.lang.Math.floor(((0.0191229992f * fConst0) + 0.5f));
		iConst6 = (int)(float)java.lang.Math.min(16384.0f, (float)java.lang.Math.max(0.0f, (fConst1 - fConst5)));
		iConst7 = (int)(float)java.lang.Math.min(1024.0f, (float)java.lang.Math.max(0.0f, (fConst5 + -1.0f)));
		fConst8 = (float)java.lang.Math.floor(((0.256891012f * fConst0) + 0.5f));
		fConst9 = ((0.0f - (6.90775537f * fConst8)) / fConst0);
		fConst10 = (float)java.lang.Math.floor(((0.0273330007f * fConst0) + 0.5f));
		iConst11 = (int)(float)java.lang.Math.min(16384.0f, (float)java.lang.Math.max(0.0f, (fConst8 - fConst10)));
		iConst12 = (int)(float)java.lang.Math.min(2048.0f, (float)java.lang.Math.max(0.0f, (fConst10 + -1.0f)));
		fConst13 = (float)java.lang.Math.floor(((0.192303002f * fConst0) + 0.5f));
		fConst14 = ((0.0f - (6.90775537f * fConst13)) / fConst0);
		fConst15 = (float)java.lang.Math.floor(((0.0292910002f * fConst0) + 0.5f));
		iConst16 = (int)(float)java.lang.Math.min(8192.0f, (float)java.lang.Math.max(0.0f, (fConst13 - fConst15)));
		iConst17 = (int)(float)java.lang.Math.min(2048.0f, (float)java.lang.Math.max(0.0f, (fConst15 + -1.0f)));
		fConst18 = (float)java.lang.Math.floor(((0.210389003f * fConst0) + 0.5f));
		fConst19 = ((0.0f - (6.90775537f * fConst18)) / fConst0);
		fConst20 = (float)java.lang.Math.floor(((0.0244210009f * fConst0) + 0.5f));
		iConst21 = (int)(float)java.lang.Math.min(16384.0f, (float)java.lang.Math.max(0.0f, (fConst18 - fConst20)));
		iConst22 = (int)(float)java.lang.Math.min(2048.0f, (float)java.lang.Math.max(0.0f, (fConst20 + -1.0f)));
		fConst23 = (float)java.lang.Math.floor(((0.125f * fConst0) + 0.5f));
		fConst24 = ((0.0f - (6.90775537f * fConst23)) / fConst0);
		fConst25 = (float)java.lang.Math.floor(((0.0134579996f * fConst0) + 0.5f));
		iConst26 = (int)(float)java.lang.Math.min(8192.0f, (float)java.lang.Math.max(0.0f, (fConst23 - fConst25)));
		iConst27 = (int)(float)java.lang.Math.min(1024.0f, (float)java.lang.Math.max(0.0f, (fConst25 + -1.0f)));
		fConst28 = (float)java.lang.Math.floor(((0.127837002f * fConst0) + 0.5f));
		fConst29 = ((0.0f - (6.90775537f * fConst28)) / fConst0);
		fConst30 = (float)java.lang.Math.floor(((0.0316039994f * fConst0) + 0.5f));
		iConst31 = (int)(float)java.lang.Math.min(8192.0f, (float)java.lang.Math.max(0.0f, (fConst28 - fConst30)));
		iConst32 = (int)(float)java.lang.Math.min(2048.0f, (float)java.lang.Math.max(0.0f, (fConst30 + -1.0f)));
		fConst33 = (float)java.lang.Math.floor(((0.174713001f * fConst0) + 0.5f));
		fConst34 = ((0.0f - (6.90775537f * fConst33)) / fConst0);
		fConst35 = (float)java.lang.Math.floor(((0.0229039993f * fConst0) + 0.5f));
		iConst36 = (int)(float)java.lang.Math.min(8192.0f, (float)java.lang.Math.max(0.0f, (fConst33 - fConst35)));
		iConst37 = (int)(float)java.lang.Math.min(2048.0f, (float)java.lang.Math.max(0.0f, (fConst35 + -1.0f)));
		fConst38 = (float)java.lang.Math.floor(((0.153128996f * fConst0) + 0.5f));
		fConst39 = ((0.0f - (6.90775537f * fConst38)) / fConst0);
		fConst40 = (float)java.lang.Math.floor(((0.0203460008f * fConst0) + 0.5f));
		iConst41 = (int)(float)java.lang.Math.min(8192.0f, (float)java.lang.Math.max(0.0f, (fConst38 - fConst40)));
		iConst42 = (int)(float)java.lang.Math.min(1024.0f, (float)java.lang.Math.max(0.0f, (fConst40 + -1.0f)));
		
	}
	
	public void instanceResetUserInterface() {
		fVslider0 = (float)2.0f;
		fVslider1 = (float)6000.0f;
		fVslider2 = (float)3.0f;
		fVslider3 = (float)200.0f;
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (float)java.lang.Math.exp((fConst2 / fSlow0));
		float fSlow2 = mydsp_faustpower2_f(fSlow1);
		float fSlow3 = (float)java.lang.Math.cos((fConst3 * fVslider1));
		float fSlow4 = (1.0f - (fSlow2 * fSlow3));
		float fSlow5 = (1.0f - fSlow2);
		float fSlow6 = (fSlow4 / fSlow5);
		float fSlow7 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow4) / mydsp_faustpower2_f(fSlow5)) + -1.0f)));
		float fSlow8 = (fSlow6 - fSlow7);
		float fSlow9 = (fSlow1 * (fSlow7 + (1.0f - fSlow6)));
		float fSlow10 = fVslider2;
		float fSlow11 = (((float)java.lang.Math.exp((fConst2 / fSlow10)) / fSlow1) + -1.0f);
		float fSlow12 = (1.0f / (float)java.lang.Math.tan((fConst4 * fVslider3)));
		float fSlow13 = (fSlow12 + 1.0f);
		float fSlow14 = (0.0f - ((1.0f - fSlow12) / fSlow13));
		float fSlow15 = (1.0f / fSlow13);
		float fSlow16 = (float)java.lang.Math.exp((fConst9 / fSlow0));
		...
		float fSlow21 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow18) / mydsp_faustpower2_f(fSlow19)) + -1.0f)));
		float fSlow22 = (fSlow20 - fSlow21);
		float fSlow23 = (fSlow16 * (fSlow21 + (1.0f - fSlow20)));
		float fSlow24 = (((float)java.lang.Math.exp((fConst9 / fSlow10)) / fSlow16) + -1.0f);
		float fSlow25 = (float)java.lang.Math.exp((fConst14 / fSlow0));
		...
		float fSlow30 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow27) / mydsp_faustpower2_f(fSlow28)) + -1.0f)));
		float fSlow31 = (fSlow29 - fSlow30);
		float fSlow32 = (fSlow25 * (fSlow30 + (1.0f - fSlow29)));
		float fSlow33 = (((float)java.lang.Math.exp((fConst14 / fSlow10)) / fSlow25) + -1.0f);
		float fSlow34 = (float)java.lang.Math.exp((fConst19 / fSlow0));
		...
		float fSlow39 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow36) / mydsp_faustpower2_f(fSlow37)) + -1.0f)));
		float fSlow40 = (fSlow38 - fSlow39);
		float fSlow41 = (fSlow34 * (fSlow39 + (1.0f - fSlow38)));
		float fSlow42 = (((float)java.lang.Math.exp((fConst19 / fSlow10)) / fSlow34) + -1.0f);
		float fSlow43 = (float)java.lang.Math.exp((fConst24 / fSlow0));
		...
		float fSlow48 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow45) / mydsp_faustpower2_f(fSlow46)) + -1.0f)));
		float fSlow49 = (fSlow47 - fSlow48);
		float fSlow50 = (fSlow43 * (fSlow48 + (1.0f - fSlow47)));
		float fSlow51 = (((float)java.lang.Math.exp((fConst24 / fSlow10)) / fSlow43) + -1.0f);
		float fSlow52 = (float)java.lang.Math.exp((fConst29 / fSlow0));
		...
		float fSlow57 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow54) / mydsp_faustpower2_f(fSlow55)) + -1.0f)));
		float fSlow58 = (fSlow56 - fSlow57);
		float fSlow59 = (fSlow52 * (fSlow57 + (1.0f - fSlow56)));
		float fSlow60 = (((float)java.lang.Math.exp((fConst29 / fSlow10)) / fSlow52) + -1.0f);
		float fSlow61 = (float)java.lang.Math.exp((fConst34 / fSlow0));
		...
		float fSlow66 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow63) / mydsp_faustpower2_f(fSlow64)) + -1.0f)));
		float fSlow67 = (fSlow65 - fSlow66);
		float fSlow68 = (fSlow61 * (fSlow66 + (1.0f - fSlow65)));
		float fSlow69 = (((float)java.lang.Math.exp((fConst34 / fSlow10)) / fSlow61) + -1.0f);
		float fSlow70 = (float)java.lang.Math.exp((fConst39 / fSlow0));
		...
		float fSlow75 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, ((mydsp_faustpower2_f(fSlow72) / mydsp_faustpower2_f(fSlow73)) + -1.0f)));
		float fSlow76 = (fSlow74 - fSlow75);
		float fSlow77 = (fSlow70 * (fSlow75 + (1.0f - fSlow74)));
		float fSlow78 = (((float)java.lang.Math.exp((fConst39 / fSlow10)) / fSlow70) + -1.0f);
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (fVec0[((IOTA - iConst6) & 32767)] + (input7[i] + (0.600000024f * fRec8[1])));
			...
			float fTemp1 = (fVec2[((IOTA - iConst11) & 32767)] + (input3[i] + (0.600000024f * fRec12[1])));
			...
			float fTemp2 = (fVec4[((IOTA - iConst16) & 16383)] + (input5[i] + (0.600000024f * fRec16[1])));
			...
			float fTemp3 = (fVec6[((IOTA - iConst21) & 32767)] + (input1[i] + (0.600000024f * fRec20[1])));
			...
			float fTemp4 = ((input6[i] + fVec8[((IOTA - iConst26) & 16383)]) - (0.600000024f * fRec24[1]));
			...
			float fTemp5 = ((input2[i] + fVec10[((IOTA - iConst31) & 16383)]) - (0.600000024f * fRec28[1]));
			...
			float fTemp6 = ((input4[i] + fVec12[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec32[1]));
			...
			float fTemp7 = ((input0[i] + fVec14[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec36[1]));
