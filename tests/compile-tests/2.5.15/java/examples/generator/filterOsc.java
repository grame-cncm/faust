...
public class mydsp extends dsp {
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("Portamento", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (float)java.lang.Math.exp((0.0f - (fConst2 / fHslider2)));
		float fSlow2 = (440.0f * ((float)java.lang.Math.pow(2.0f, (0.0833333358f * (fHslider1 + -49.0f))) * (1.0f - fSlow1)));
