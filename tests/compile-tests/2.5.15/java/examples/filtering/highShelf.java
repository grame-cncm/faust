...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow2 = (((float)java.lang.Math.sqrt(fSlow0) * (float)java.lang.Math.sin(fSlow1)) / (float)java.lang.Math.max(0.00100000005f, fHslider2));
		float fSlow3 = (float)java.lang.Math.cos(fSlow1);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (input0[i] - (fSlow5 * ((fSlow8 * fRec0[2]) + (fSlow10 * fRec0[1]))));
			output0[i] = (fSlow5 * (((fSlow7 * fRec0[0]) + (fSlow11 * fRec0[1])) + (fSlow12 * fRec0[2])));
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
