...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow3 = fHslider1;
		float fSlow4 = (0.0f - (4.0f * (float)java.lang.Math.max(0.0f, (float)java.lang.Math.min(mydsp_faustpower4_f(fSlow3), 0.999998987f))));
		float fSlow5 = (0.439999998f * (float)java.lang.Math.pow(2.0f, (0.0833333358f * (fHslider2 + -49.0f))));
		int iSlow6 = (int)fCheckbox2;
		float fSlow7 = (float)java.lang.Math.min(1.41419947f, (1.41421354f * fSlow3));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec1[0] = (fRec2[0] * (float)java.lang.Math.pow(fTemp2, 4.0f));
			fRec9[0] = (fSlow5 + (0.999000013f * fRec9[1]));
			float fTemp4 = (float)java.lang.Math.tan((fConst2 * (float)java.lang.Math.max(20.0f, (float)java.lang.Math.min(10000.0f, fRec9[0]))));
			...
			float fTemp9 = (float)java.lang.Math.tan((fConst2 * (float)java.lang.Math.max(fRec9[0], 20.0f)));
			...
			float fTemp13 = (float)java.lang.Math.max(-0.999899983f, (float)java.lang.Math.min(0.999899983f, fTemp12));
			float fTemp14 = (1.0f - mydsp_faustpower2_f(fTemp13));
			float fTemp15 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, fTemp14));
			...
			float fTemp19 = (float)java.lang.Math.max(-0.999899983f, (float)java.lang.Math.min(0.999899983f, (2.0f * (fTemp18 / (fTemp11 * (fTemp12 + 1.0f))))));
			float fTemp20 = (1.0f - mydsp_faustpower2_f(fTemp19));
			float fTemp21 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, fTemp20));
			...
			float fTemp23 = (float)java.lang.Math.sqrt(fTemp14);
			float fTemp24 = ((((fTemp1 * fTemp13) + (fRec10[1] * fTemp15)) + (2.0f * ((fRec10[0] * fTemp22) / fTemp23))) + ((fRec11 * ((1.0f - fTemp12) - (2.0f * (fTemp19 * fTemp22)))) / (fTemp23 * (float)java.lang.Math.sqrt(fTemp20))));
			...
			float fTemp27 = (float)java.lang.Math.max(-0.999899983f, (float)java.lang.Math.min(0.999899983f, fTemp26));
			float fTemp28 = (1.0f - mydsp_faustpower2_f(fTemp27));
			float fTemp29 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, fTemp28));
			float fTemp30 = ((fRec13[1] * (0.0f - fTemp27)) + ((fTemp24 * fTemp29) / fTemp11));
			float fTemp31 = (fSlow14 + (fTemp17 - fSlow13));
			float fTemp32 = (float)java.lang.Math.max(-0.999899983f, (float)java.lang.Math.min(0.999899983f, (2.0f * (fTemp31 / (fTemp25 * (fTemp26 + 1.0f))))));
			float fTemp33 = (1.0f - mydsp_faustpower2_f(fTemp32));
			float fTemp34 = (float)java.lang.Math.sqrt((float)java.lang.Math.max(0.0f, fTemp33));
			...
			float fTemp36 = (float)java.lang.Math.sqrt(fTemp28);
			output0[i] = (((iSlow0==0)?true:false)?fTemp0:(fRec0[0] * (((iSlow2==0)?true:false)?(((iSlow6==0)?true:false)?((((((fTemp24 * fTemp27) / fTemp11) + (fRec13[1] * fTemp29)) + (2.0f * ((fRec13[0] * fTemp35) / fTemp36))) + ((fRec14 * ((1.0f - fTemp26) - (2.0f * (fTemp32 * fTemp35)))) / (fTemp36 * (float)java.lang.Math.sqrt(fTemp33)))) / fTemp25):((fRec7[2] + (fRec7[0] + (2.0f * fRec7[1]))) / fTemp8)):fRec1[0])));
			fRec0[1] = fRec0[0];
			fRec6[1] = fRec6[0];
			fRec5[1] = fRec5[0];
			fRec4[1] = fRec4[0];
