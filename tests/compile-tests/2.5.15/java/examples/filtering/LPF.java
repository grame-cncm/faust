...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (float)java.lang.Math.cos(fSlow0);
		float fSlow2 = (0.5f * ((float)java.lang.Math.sin(fSlow0) / (float)java.lang.Math.max(0.00100000005f, fHslider1)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (input0[i] - (fSlow5 * ((fSlow6 * fRec0[1]) + (fSlow7 * fRec0[2]))));
			output0[i] = (fSlow4 * ((fRec0[1] + (0.5f * fRec0[0])) + (0.5f * fRec0[2])));
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
