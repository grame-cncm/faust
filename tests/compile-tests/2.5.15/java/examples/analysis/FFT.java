...
public class mydsp extends dsp {
	...
	public void instanceConstants(int samplingFreq) {
		...
		fConst0 = (1000.0f / (float)java.lang.Math.min(192000.0f, (float)java.lang.Math.max(1.0f, (float)fSamplingFreq)));
	...
	public void instanceResetUserInterface() {
		...
		fHslider2 = (float)0.10000000000000001f;
		fHslider3 = (float)8.0f;
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addVerticalBargraph("0x7fcc427da4e0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc427eacd0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc427f6880", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc435061b0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc4350e150", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43519dd0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43520ec0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc4352bad0", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43531a50", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43538c70", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43540020", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43547c80", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc4354d210", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43554e60", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc4355be10", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc43563a50", new FaustVarAccess() {
		...
		ui_interface.addVerticalBargraph("0x7fcc435688f0", new FaustVarAccess() {
		...
		ui_interface.addHorizontalSlider("FFT Bin Number", new FaustVarAccess() {
				public String getId() { return "fHslider3"; }
				public void set(float val) { fHslider3 = val; }
				public float get() { return (float)fHslider3; }
			}
			, 8.0f, 0.0f, 16.0f, 0.00100000005f);
		ui_interface.declare("fHbargraph0", "3", "");
		ui_interface.addHorizontalBargraph("Measured FFT Bin Number", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (float)java.lang.Math.exp((0.0f - (fConst0 / fHslider1)));
		float fSlow2 = (10.0f * (1.0f - fSlow1));
		float fSlow3 = fHslider2;
		int iSlow4 = (int)fHslider3;
		fHbargraph0 = (float)iSlow4;
		int iSlow5 = (iSlow4 == 0);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (fSlow3 * (((iSlow5==0)?true:false)?1.0f:(((iSlow6==0)?true:false)?(float)iRec3[0]:(2.0f * fRec2[0]))));
			...
			fRec0[0] = ((fSlow1 * fRec0[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, mydsp_faustpower2_f((float)java.lang.Math.abs((fVec1[((IOTA - 31) & 31)] + (fVec1[((IOTA - 15) & 31)] + (fVec1[((IOTA - 23) & 31)] + (fVec1[((IOTA - 7) & 31)] + (fVec1[((IOTA - 27) & 31)] + (fVec1[((IOTA - 11) & 31)] + (fVec1[((IOTA - 19) & 31)] + (fVec1[((IOTA - 3) & 31)] + (fVec1[((IOTA - 29) & 31)] + (fVec1[((IOTA - 13) & 31)] + (fVec1[((IOTA - 21) & 31)] + (fVec1[((IOTA - 5) & 31)] + (fVec1[((IOTA - 25) & 31)] + (fVec1[((IOTA - 9) & 31)] + (fVec1[((IOTA - 17) & 31)] + (fVec1[((IOTA - 1) & 31)] + fTemp4))))))))))))))))))))));
			fVbargraph0 = (fSlow0 + fRec0[0]);
			...
			fRec4[0] = ((fSlow1 * fRec4[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.195090324f * fTemp20) + (((0.382683426f * fTemp25) + (fTemp31 + fTemp35)) + (0.980785251f * fTemp40))) - fVec1[((IOTA - 16) & 31)]))) + mydsp_faustpower2_f((float)java.lang.Math.abs((((0.980785251f * fTemp20) + (fTemp41 + fTemp42)) - ((fTemp44 + (0.382683426f * fTemp34)) + (0.195090324f * fTemp40))))))))));
			fVbargraph1 = (fSlow0 + fRec4[0]);
			...
			fRec5[0] = ((fSlow1 * fRec5[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.382683426f * fTemp53) + ((fTemp57 + (fTemp1 + fTemp60)) + (0.923879504f * fTemp65))) - fTemp66))) + mydsp_faustpower2_f((float)java.lang.Math.abs((((0.923879504f * fTemp53) + (fTemp67 + (0.707106769f * fTemp56))) - ((0.382683426f * fTemp65) + (fTemp68 + fTemp69))))))))));
			fVbargraph2 = (fSlow0 + fRec5[0]);
			...
			fRec6[0] = ((fSlow1 * fRec6[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.555570245f * fTemp75) + (((0.923879504f * fTemp77) + (fTemp78 + (0.382683426f * fTemp79))) + (0.831469595f * fTemp82))) - fTemp83))) + mydsp_faustpower2_f((float)java.lang.Math.abs((((0.831469595f * fTemp75) + (fVec1[((IOTA - 8) & 31)] + (0.382683426f * fTemp77))) - ((fTemp85 + (0.923879504f * fTemp79)) + (0.555570245f * fTemp82))))))))));
			fVbargraph3 = (fSlow0 + fRec6[0]);
			...
			fRec7[0] = ((fSlow1 * fRec7[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.707106769f * fTemp88) + (fTemp2 + fTemp91)) - fTemp92))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp93 + (0.707106769f * fTemp88)) - (fTemp94 + fTemp95)))))))));
			fVbargraph4 = (fSlow0 + fRec7[0]);
			...
			fRec8[0] = ((fSlow1 * fRec8[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.831469595f * fTemp101) + ((fTemp0 + (0.923879504f * fTemp102)) + (0.555570245f * fTemp105))) - (fTemp107 + (0.382683426f * fTemp109))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp110 + (0.555570245f * fTemp101)) - ((0.831469595f * fTemp105) + ((0.382683426f * fTemp102) + (fTemp111 + (0.923879504f * fTemp109))))))))))));
			fVbargraph5 = (fSlow0 + fRec8[0]);
			...
			fRec9[0] = ((fSlow1 * fRec9[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.923879504f * fTemp113) + ((fTemp1 + (0.707106769f * fTemp55)) + (0.382683426f * fTemp114))) - (fTemp66 + fTemp69)))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp68 + (0.382683426f * fTemp113)) - ((0.923879504f * fTemp114) + (fTemp115 + (fTemp67 + fTemp60)))))))))));
			fVbargraph6 = (fSlow0 + fRec9[0]);
			...
			fRec10[0] = ((fSlow1 * fRec10[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((0.980785251f * fTemp119) + ((fTemp120 + (0.382683426f * fTemp121)) + (0.195090324f * fTemp124))) - (fTemp125 + (0.923879504f * fTemp126))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp127 + (0.195090324f * fTemp119)) - ((0.980785251f * fTemp124) + ((0.923879504f * fTemp121) + (fVec1[((IOTA - 24) & 31)] + (0.382683426f * fTemp126))))))))))));
			fVbargraph7 = (fSlow0 + fRec10[0]);
			float fTemp128 = (fVec1[((IOTA - 29) & 31)] + (fVec1[((IOTA - 13) & 31)] + (fVec1[((IOTA - 21) & 31)] + (fVec1[((IOTA - 5) & 31)] + fTemp89))));
			fRec11[0] = ((fSlow1 * fRec11[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((fTemp3 - (fVec1[((IOTA - 30) & 31)] + (fVec1[((IOTA - 14) & 31)] + (fVec1[((IOTA - 22) & 31)] + (fVec1[((IOTA - 6) & 31)] + fTemp94))))))) + mydsp_faustpower2_f((float)java.lang.Math.abs((0.0f - (fTemp128 - (fVec1[((IOTA - 31) & 31)] + (fVec1[((IOTA - 15) & 31)] + (fVec1[((IOTA - 23) & 31)] + (fVec1[((IOTA - 7) & 31)] + fTemp86)))))))))))));
			fVbargraph8 = (fSlow0 + fRec11[0]);
			...
			fRec12[0] = ((fSlow1 * fRec12[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp31 + (0.980785251f * fTemp129)) - (((0.382683426f * fTemp25) + (fVec1[((IOTA - 16) & 31)] + fTemp35)) + (0.195090324f * fTemp130))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp42 + (0.382683426f * fTemp34)) - ((0.195090324f * fTemp129) + ((fTemp41 + fTemp44) + (0.980785251f * fTemp130)))))))))));
			fVbargraph9 = (fSlow0 + fRec12[0]);
			...
			fRec13[0] = ((fSlow1 * fRec13[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp1 + (0.923879504f * fTemp131)) - ((fTemp57 + (fTemp66 + fTemp132)) + (0.382683426f * fTemp134))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp67 + fTemp69) - ((0.382683426f * fTemp131) + ((fTemp68 + (0.707106769f * fTemp56)) + (0.923879504f * fTemp134)))))))))));
			fVbargraph10 = (fSlow0 + fRec13[0]);
			...
			fRec14[0] = ((fSlow1 * fRec14[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp78 + (0.831469595f * fTemp135)) - (((0.923879504f * fTemp77) + (fTemp83 + (0.382683426f * fTemp79))) + (0.555570245f * fTemp136))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fVec1[((IOTA - 8) & 31)] + (0.923879504f * fTemp79)) - ((0.555570245f * fTemp135) + ((fTemp85 + (0.382683426f * fTemp77)) + (0.831469595f * fTemp136)))))))))));
			fVbargraph11 = (fSlow0 + fRec14[0]);
			fRec15[0] = ((fSlow1 * fRec15[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp2 + (0.707106769f * fTemp87)) - (fTemp92 + fTemp95)))) + mydsp_faustpower2_f((float)java.lang.Math.abs((fTemp94 - ((0.707106769f * fTemp87) + (fTemp93 + fTemp91))))))))));
			fVbargraph12 = (fSlow0 + fRec15[0]);
			...
			fRec16[0] = ((fSlow1 * fRec16[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((fTemp0 + (0.382683426f * fTemp109)) + (0.555570245f * fTemp137)) - ((fTemp107 + (0.923879504f * fTemp102)) + (0.831469595f * fTemp138))))) + mydsp_faustpower2_f((float)java.lang.Math.abs((((0.382683426f * fTemp102) + (fTemp110 + (0.923879504f * fTemp109))) - ((0.831469595f * fTemp137) + (fTemp111 + (0.555570245f * fTemp138)))))))))));
			fVbargraph13 = (fSlow0 + fRec16[0]);
			float fTemp139 = ((fTemp112 + (fTemp49 + fTemp133)) - fTemp45);
			float fTemp140 = ((fTemp62 + fTemp52) - (fTemp64 + (0.707106769f * fTemp47)));
			fRec17[0] = ((fSlow1 * fRec17[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((fTemp1 + fTemp69) + (0.382683426f * fTemp139)) - ((fTemp66 + (0.707106769f * fTemp55)) + (0.923879504f * fTemp140))))) + mydsp_faustpower2_f((float)java.lang.Math.abs(((fTemp115 + (fTemp68 + fTemp132)) - ((0.923879504f * fTemp139) + (fTemp67 + (0.382683426f * fTemp140)))))))))));
			fVbargraph14 = (fSlow0 + fRec17[0]);
			...
			fRec18[0] = ((fSlow1 * fRec18[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, (mydsp_faustpower2_f((float)java.lang.Math.abs((((fTemp120 + (0.923879504f * fTemp126)) + (0.195090324f * fTemp141)) - ((fTemp125 + (0.382683426f * fTemp121)) + (0.980785251f * fTemp142))))) + mydsp_faustpower2_f((float)java.lang.Math.abs((((0.923879504f * fTemp121) + (fTemp127 + (0.382683426f * fTemp126))) - ((0.980785251f * fTemp141) + (fVec1[((IOTA - 24) & 31)] + (0.195090324f * fTemp142)))))))))));
			fVbargraph15 = (fSlow0 + fRec18[0]);
			fRec19[0] = ((fSlow1 * fRec19[1]) + (fSlow2 * (float)java.lang.Math.log10((float)java.lang.Math.max(1.00000001e-07f, mydsp_faustpower2_f((float)java.lang.Math.abs((fTemp4 - (fVec1[((IOTA - 31) & 31)] + (fVec1[((IOTA - 15) & 31)] + (fVec1[((IOTA - 23) & 31)] + (fVec1[((IOTA - 7) & 31)] + (fVec1[((IOTA - 27) & 31)] + (fVec1[((IOTA - 11) & 31)] + (fVec1[((IOTA - 19) & 31)] + (fVec1[((IOTA - 3) & 31)] + fTemp128)))))))))))))));
			fVbargraph16 = (fSlow0 + fRec19[0]);
			output0[i] = fTemp0;
			output1[i] = fTemp0;
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
