...
public class mydsp extends dsp {
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("Radius", new FaustVarAccess() {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp3 = (input0[i] * ((2.07944155f * (1.0f - fTemp2)) + 1.0f));
			float fTemp4 = (3.0f * fTemp2);
			float fTemp5 = ((3.0f * ((fTemp2 * (((fTemp4 > 0.0f))?1.f:0.f)) * (((fTemp4 <= 1.0f))?1.f:0.f))) + (((fTemp4 > 1.0f))?1.f:0.f));
			fRec1[0] = (fSlow1 + (fConst0 * fRec1[1]));
			float fTemp6 = (fTemp5 * (float)java.lang.Math.cos(fRec1[0]));
			float fTemp7 = (2.0f * fRec1[0]);
			float fTemp8 = (2.07944155f * fTemp2);
			float fTemp9 = (fTemp8 + -0.693147182f);
			float fTemp10 = (2.46630335f * fTemp9);
			float fTemp11 = ((2.46630335f * ((fTemp9 * (((fTemp10 > 0.0f))?1.f:0.f)) * (((fTemp10 <= 1.0f))?1.f:0.f))) + (((fTemp10 > 1.0f))?1.f:0.f));
			float fTemp12 = ((float)java.lang.Math.cos(fTemp7) * fTemp11);
			...
			float fTemp17 = ((3.47605944f * ((fTemp15 * (((fTemp16 > 0.0f))?1.f:0.f)) * (((fTemp16 <= 1.0f))?1.f:0.f))) + (((fTemp16 > 1.0f))?1.f:0.f));
			float fTemp18 = ((float)java.lang.Math.cos(fTemp14) * fTemp17);
			float fTemp19 = (4.0f * fRec1[0]);
			float fTemp20 = (fTemp8 + -1.38629436f);
			float fTemp21 = (4.48142004f * fTemp20);
			float fTemp22 = ((4.48142004f * ((fTemp20 * (((fTemp21 > 0.0f))?1.f:0.f)) * (((fTemp21 <= 1.0f))?1.f:0.f))) + (((fTemp21 > 1.0f))?1.f:0.f));
			float fTemp23 = (0.0141414143f * ((float)java.lang.Math.cos(fTemp19) * fTemp22));
			float fTemp24 = (5.0f * fRec1[0]);
			float fTemp25 = (fTemp8 + -1.60943794f);
			float fTemp26 = (5.48481512f * fTemp25);
			float fTemp27 = ((5.48481512f * ((fTemp25 * (((fTemp26 > 0.0f))?1.f:0.f)) * (((fTemp26 <= 1.0f))?1.f:0.f))) + (((fTemp26 > 1.0f))?1.f:0.f));
			float fTemp28 = ((float)java.lang.Math.cos(fTemp24) * fTemp27);
			float fTemp29 = (6.0f * fRec1[0]);
			float fTemp30 = (fTemp8 + -1.79175949f);
			float fTemp31 = (6.48715925f * fTemp30);
			float fTemp32 = ((6.48715925f * ((fTemp30 * (((fTemp31 > 0.0f))?1.f:0.f)) * (((fTemp31 <= 1.0f))?1.f:0.f))) + (((fTemp31 > 1.0f))?1.f:0.f));
			float fTemp33 = ((float)java.lang.Math.cos(fTemp29) * fTemp32);
			...
			float fTemp38 = ((7.48887587f * ((fTemp36 * (((fTemp37 > 0.0f))?1.f:0.f)) * (((fTemp37 <= 1.0f))?1.f:0.f))) + (((fTemp37 > 1.0f))?1.f:0.f));
			float fTemp39 = ((float)java.lang.Math.cos(fTemp35) * fTemp38);
			...
			float fTemp41 = (0.0141414143f * ((float)java.lang.Math.sin(fTemp19) * fTemp22));
			float fTemp42 = ((float)java.lang.Math.sin(fRec1[0]) * fTemp5);
			float fTemp43 = (0.107785948f * fTemp6);
			float fTemp44 = ((float)java.lang.Math.sin(fTemp7) * fTemp11);
			float fTemp45 = (0.0549971946f * fTemp44);
			float fTemp46 = (0.0549971946f * fTemp12);
			float fTemp47 = ((float)java.lang.Math.sin(fTemp14) * fTemp17);
			float fTemp48 = ((float)java.lang.Math.sin(fTemp24) * fTemp27);
			float fTemp49 = ((float)java.lang.Math.sin(fTemp29) * fTemp32);
			float fTemp50 = (0.00123955461f * fTemp49);
			float fTemp51 = (0.00123955461f * fTemp33);
			float fTemp52 = ((float)java.lang.Math.sin(fTemp35) * fTemp38);
