...
public class mydsp extends dsp {
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow1 = (0.00100000005f * (fSlow0 * fHslider1));
		float fSlow2 = (0.00100000005f * fHslider2);
		int iSlow3 = (int)fHslider3;
		int iSlow4 = (iSlow3 == 2);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (float)java.lang.Math.tan((fConst1 * ((4000.0f * fRec3[0]) + 50.0f)));
			float fTemp1 = (1.0f / fTemp0);
			float fTemp2 = (fTemp1 + 1.0f);
			int iTemp3 = ((((fSlow0 == fVec1[1]))?1:0) | iSlow7);
			fRec5[0] = ((fSlow6 * (1.0f - (0.999000013f * (float)iTemp3))) + (0.999000013f * ((float)iTemp3 * fRec5[1])));
			float fTemp4 = (fSlow5 * fRec5[0]);
			float fTemp5 = (float)java.lang.Math.max(fTemp4, 23.4489498f);
			float fTemp6 = (float)java.lang.Math.max(20.0f, (float)java.lang.Math.abs(fTemp5));
			fVec2[0] = fTemp6;
			float fTemp7 = (fRec4[1] + (fConst3 * fVec2[1]));
			fRec4[0] = (fTemp7 - (float)java.lang.Math.floor(fTemp7));
			float fTemp8 = mydsp_faustpower2_f(((2.0f * fRec4[0]) + -1.0f));
			fVec3[0] = fTemp8;
			float fTemp9 = (((float)iVec0[1] * (fTemp8 - fVec3[1])) / fTemp6);
			fVec4[(IOTA & 4095)] = fTemp9;
			float fTemp10 = (float)java.lang.Math.max(0.0f, (float)java.lang.Math.min(2047.0f, (fConst4 / fTemp5)));
			int iTemp11 = (int)fTemp10;
			float fTemp12 = (float)java.lang.Math.floor(fTemp10);
			...
			float fTemp15 = (float)java.lang.Math.sin(fTemp14);
			float fTemp16 = (float)java.lang.Math.cos(fTemp14);
			fRec7[0] = ((fRec8[1] * fTemp15) + (fRec7[1] * fTemp16));
			fRec8[0] = (((fRec8[1] * fTemp16) + (fRec7[1] * (0.0f - fTemp15))) + (float)(1 - iVec0[1]));
			float fTemp17 = (float)java.lang.Math.max(1.00000001e-07f, (float)java.lang.Math.abs(fTemp4));
			float fTemp18 = (fRec9[1] + (fConst7 * fTemp17));
			float fTemp19 = (fTemp18 + -1.0f);
			int iTemp20 = (fTemp19 < 0.0f);
			fRec9[0] = (((iTemp20==0)?true:false)?fTemp18:fTemp19);
			float fRec10 = (((iTemp20==0)?true:false)?fTemp18:(fTemp18 + ((1.0f - (fConst0 / fTemp17)) * fTemp19)));
			float fTemp21 = ((((iSlow4==0)?true:false)?fTemp13:0.0f) + ((((iSlow8==0)?true:false)?(fSlow9 * (fRec5[0] * fRec6[0])):0.0f) + ((((iSlow10==0)?true:false)?fRec7[0]:0.0f) + (((iSlow12==0)?true:false)?((2.0f * fRec10) + -1.0f):0.0f))));
			fVec5[0] = fTemp21;
