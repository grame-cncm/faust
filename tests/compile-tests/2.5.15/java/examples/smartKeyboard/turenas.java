...
public class mydsp extends dsp {
	...
	public void buildUserInterface(UI ui_interface) {
		...
		ui_interface.addHorizontalSlider("res", new FaustVarAccess() {
			...
			, 2.5f, 0.00999999978f, 5.0f, 0.00999999978f);
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		float fSlow7 = (0.00100000005f * fHslider2);
		...
		float fSlow17 = (float)java.lang.Math.sin(fSlow16);
		float fSlow18 = (float)java.lang.Math.cos(fSlow16);
		float fSlow19 = (0.0f - fSlow17);
		float fSlow20 = (fConst1 * (fSlow0 * ((4.16666651f * fSlow1) + 1.0f)));
		float fSlow21 = (float)java.lang.Math.sin(fSlow20);
		float fSlow22 = (float)java.lang.Math.cos(fSlow20);
		float fSlow23 = (0.0f - fSlow21);
		float fSlow24 = (fConst1 * (fSlow0 * ((5.0f * fSlow1) + 1.0f)));
		float fSlow25 = (float)java.lang.Math.sin(fSlow24);
		float fSlow26 = (float)java.lang.Math.cos(fSlow24);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec2[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp3, (fRec2[1] + (1.0f - (fConst0 * (fVec2[1] - fTemp2))))));
			...
			fRec6[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp6, (fRec6[1] + (1.0f - (fConst0 * (fVec3[1] - fTemp5))))));
			...
			fRec9[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp9, (fRec9[1] + (1.0f - (fConst0 * (fVec4[1] - fTemp8))))));
			...
			fRec12[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp12, (fRec12[1] + (1.0f - (fConst0 * (fVec5[1] - fTemp11))))));
			...
			fRec15[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp15, (fRec15[1] + (1.0f - (fConst0 * (fVec6[1] - fTemp14))))));
			...
			fRec18[0] = (((iTemp1==0)?true:false)?0.0f:(float)java.lang.Math.min(fTemp18, (fRec18[1] + (1.0f - (fConst0 * (fVec7[1] - fTemp17))))));
			int iTemp19 = (fRec18[0] < fConst2);
			output0[i] = (0.0500000007f * ((((((0.444444448f * (fRec0[0] * (((iTemp4==0)?true:false)?(((fRec2[0] < 0.0f))?0.0f:(((iTemp4==0)?true:false)?(fConst4 * fRec2[0]):1.0f)):(((fRec2[0] < fTemp3))?((fConst3 * ((0.0f - (fRec2[0] - fConst2)) / (fTemp2 + -0.00100000005f))) + 1.0f):0.0f)))) + (fRec4[0] * (0.0f - (0.111111112f * (((iTemp7==0)?true:false)?(((fRec6[0] < 0.0f))?0.0f:(((iTemp7==0)?true:false)?(fConst4 * fRec6[0]):1.0f)):(((fRec6[0] < fTemp6))?((fConst3 * ((0.0f - (fRec6[0] - fConst2)) / (fTemp5 + -0.00100000005f))) + 1.0f):0.0f)))))) + (fRec7[0] * (0.0f - (0.666666687f * (((iTemp10==0)?true:false)?(((fRec9[0] < 0.0f))?0.0f:(((iTemp10==0)?true:false)?(fConst4 * fRec9[0]):1.0f)):(((fRec9[0] < fTemp9))?((fConst3 * ((0.0f - (fRec9[0] - fConst2)) / (fTemp8 + -0.00100000005f))) + 1.0f):0.0f)))))) + (fRec10[0] * (0.0f - (1.22222221f * (((iTemp13==0)?true:false)?(((fRec12[0] < 0.0f))?0.0f:(((iTemp13==0)?true:false)?(fConst4 * fRec12[0]):1.0f)):(((fRec12[0] < fTemp12))?((fConst3 * ((0.0f - (fRec12[0] - fConst2)) / (fTemp11 + -0.00100000005f))) + 1.0f):0.0f)))))) + (fRec13[0] * (0.0f - (1.77777779f * (((iTemp16==0)?true:false)?(((fRec15[0] < 0.0f))?0.0f:(((iTemp16==0)?true:false)?(fConst4 * fRec15[0]):1.0f)):(((fRec15[0] < fTemp15))?((fConst3 * ((0.0f - (fRec15[0] - fConst2)) / (fTemp14 + -0.00100000005f))) + 1.0f):0.0f)))))) + (fRec16[0] * (0.0f - (2.33333325f * (((iTemp19==0)?true:false)?(((fRec18[0] < 0.0f))?0.0f:(((iTemp19==0)?true:false)?(fConst4 * fRec18[0]):1.0f)):(((fRec18[0] < fTemp18))?((fConst3 * ((0.0f - (fRec18[0] - fConst2)) / (fTemp17 + -0.00100000005f))) + 1.0f):0.0f)))))));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fVec1[1] = fVec1[0];
