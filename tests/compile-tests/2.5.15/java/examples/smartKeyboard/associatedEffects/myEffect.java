...
public class mydsp extends dsp {
	...
	float fVec1[] = new float[32768];
	float fConst6;
	int iConst7;
	float fVec2[] = new float[16384];
	float fConst8;
	float fVslider10;
	...
	float fVec8[] = new float[32768];
	float fConst22;
	int iConst23;
	float fVec9[] = new float[4096];
	int iConst24;
	...
	public void compute(int count, float[][] inputs, float[][] outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = (0.5f * (fRec0[0] * ((fTemp0 * fTemp1) + (fTemp2 * ((fTemp26 + (fRec2[2] + (fTemp24 + fTemp25))) + (fSlow3 * ((fTemp26 + (fTemp25 + fRec2[2])) - fTemp24)))))));
			...
			output1[i] = (0.5f * (fRec0[0] * ((fTemp3 * fTemp1) + (fTemp2 * ((fTemp32 + (fRec44[2] + (fTemp30 + fTemp31))) + (fSlow3 * ((fTemp32 + (fTemp31 + fRec44[2])) - fTemp30)))))));
			fRec0[1] = fRec0[0];
			IOTA = (IOTA + 1);
			fRec1[1] = fRec1[0];
			fRec15[1] = fRec15[0];
