...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fslider0, 1000.0f, 20.0f, 20000.0f, 0.10000000000000001f);
		ui_interface->declare(&fslider1, "2", "");
		ui_interface->declare(&fslider1, "style", "knob");
		ui_interface->declare(&fslider1, "unit", "dB");
		ui_interface->addHorizontalSlider("gain", &fslider1, 0.0f, -20.0f, 20.0f, 0.10000000000000001f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow2 = powf(10,(0.050000000000000003f * float(fslider1)));
