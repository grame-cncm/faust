...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fslider2, "unit", "lin");
		ui_interface->addHorizontalSlider("Gain", &fslider2, 1.0f, 0.0f, 8.0f, 0.01f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow3 = sqrtf(max(1.0000000000000001e-05f, float(fslider2)));
