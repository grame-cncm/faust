...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow6 = ((fSlow4 + fSlow5) + 1);
		float 	fSlow7 = (fSlow0 / fSlow6);
		float 	fSlow8 = ((fSlow0 + fSlow5) + (1 - fSlow3));
		float 	fSlow9 = (1.0f / fSlow6);
		float 	fSlow10 = ((fSlow0 + 1) * fSlow2);
		float 	fSlow11 = (0 - (2 * ((fSlow0 + fSlow10) + -1)));
		float 	fSlow12 = (fSlow4 + (1 - fSlow5));
		float 	fSlow13 = (2 * (fSlow0 + (-1 - fSlow10)));
		float 	fSlow14 = (fSlow0 + (1 - (fSlow3 + fSlow5)));
		//zone2b
		//zone3
		...
		for (int i=0; i<count; i++) {
			fRec0[0] = ((float)input0[i] - (fSlow9 * ((fSlow11 * fRec0[1]) + (fSlow12 * fRec0[2]))));
			output0[i] = (FAUSTFLOAT)(fSlow7 * (((fSlow8 * fRec0[0]) + (fSlow13 * fRec0[1])) + (fSlow14 * fRec0[2])));
			// post processing
