...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow9 = (0.00033333333333333332f * fSlow2);
		//zone2b
		//zone3
		...
		for (int i=0; i<count; i++) {
			...
			fTempPerm1 = ((fSlow3 / fRec30[0]) + -0.10000000000000001f);
			...
			fVec3[0] = (fVec1[1] + fTempPerm61);
			fRec32[IOTA&2047] = ((0.050000000000000003f * fRec32[(IOTA-1)&2047]) + (0.94999999999999996f * fVec3[1]));
			...
			int 	iRec28 = iRec35;
			fRec21[0] = fRec26;
			float 	fRec22 = (fTempPerm61 + fRec21[1]);
			float 	fRec23 = fRec27;
			int 	iRec24 = iRec28;
