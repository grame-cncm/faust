...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fTempPerm30 = 0;
		fTempPerm31 = 0;
		fConst19 = (3.1415926535897931f / fConst0);
		fConst20 = (1.0f / tanf((0.5f / fConst0)));
		fTempPerm32 = 0;
		fTempPerm33 = 0;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Slope of Spectral Tilt across Band", &fslider9, -0.5f, -1.0f, 1.0f, 0.001f);
		ui_interface->declare(0, "1", "");
		ui_interface->declare(0, "tooltip", "See Faust's filters.lib for spectral_tilt_demo");
		ui_interface->openVerticalBox("Spectral Tilt Filter");
		...
		ui_interface->addHorizontalSlider("Band Start Frequency", &fslider7, 100.0f, 20.0f, 10000.0f, 1.0f);
		ui_interface->declare(&fslider8, "3", "");
		ui_interface->declare(&fslider8, "unit", "Hz");
		ui_interface->addHorizontalSlider("Band Width", &fslider8, 5000.0f, 100.0f, 10000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addVerticalBargraph("0x7fc1a07babd0", &fbargraph14, -50.0f, 10.0f);
		...
		ui_interface->addVerticalBargraph("0x7fc1a07b0690", &fbargraph13, -50.0f, 10.0f);
		...
		ui_interface->addVerticalBargraph("0x7fc1a079ce80", &fbargraph12, -50.0f, 10.0f);
		...
		ui_interface->addVerticalBargraph("0x7fc1a0789710", &fbargraph11, -50.0f, 10.0f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow16 = float(fslider7);
		float 	fSlow17 = powf(((fSlow16 + float(fslider8)) / fSlow16),0.1111111111111111f);
		float 	fSlow18 = tanf((fConst19 * (fSlow16 * faustpower<9>(fSlow17))));
		float 	fSlow19 = float(fslider9);
		float 	fSlow20 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(9 - fSlow19)))));
		float 	fSlow21 = (fSlow18 / fSlow20);
		float 	fSlow22 = tanf((fConst19 * fSlow16));
		float 	fSlow23 = (6.2831853071795862f * ((fSlow16 * fSlow18) / fSlow22));
		float 	fSlow24 = (fConst20 + fSlow23);
		float 	fSlow25 = (0 - ((fSlow23 - fConst20) / fSlow24));
		float 	fSlow26 = (1.0f / fSlow24);
		float 	fSlow27 = (6.2831853071795862f * ((fSlow16 * fSlow20) / fSlow22));
		float 	fSlow28 = (fSlow27 - fConst20);
		float 	fSlow29 = tanf((fConst19 * (fSlow16 * faustpower<8>(fSlow17))));
		float 	fSlow30 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(8 - fSlow19)))));
		float 	fSlow31 = (fSlow29 / fSlow30);
		float 	fSlow32 = (6.2831853071795862f * ((fSlow16 * fSlow29) / fSlow22));
		float 	fSlow33 = (fConst20 + fSlow32);
		float 	fSlow34 = (0 - ((fSlow32 - fConst20) / fSlow33));
		float 	fSlow35 = (1.0f / fSlow33);
		float 	fSlow36 = (6.2831853071795862f * ((fSlow16 * fSlow30) / fSlow22));
		float 	fSlow37 = (fSlow36 - fConst20);
		float 	fSlow38 = tanf((fConst19 * (fSlow16 * faustpower<7>(fSlow17))));
		float 	fSlow39 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(7 - fSlow19)))));
		float 	fSlow40 = (fSlow38 / fSlow39);
		float 	fSlow41 = (6.2831853071795862f * ((fSlow16 * fSlow38) / fSlow22));
		float 	fSlow42 = (fConst20 + fSlow41);
		float 	fSlow43 = (0 - ((fSlow41 - fConst20) / fSlow42));
		float 	fSlow44 = (1.0f / fSlow42);
		float 	fSlow45 = (6.2831853071795862f * ((fSlow16 * fSlow39) / fSlow22));
		float 	fSlow46 = (fSlow45 - fConst20);
		float 	fSlow47 = tanf((fConst19 * (fSlow16 * faustpower<6>(fSlow17))));
		float 	fSlow48 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(6 - fSlow19)))));
		float 	fSlow49 = (fSlow47 / fSlow48);
		float 	fSlow50 = (6.2831853071795862f * ((fSlow16 * fSlow47) / fSlow22));
		float 	fSlow51 = (fConst20 + fSlow50);
		float 	fSlow52 = (0 - ((fSlow50 - fConst20) / fSlow51));
		float 	fSlow53 = (1.0f / fSlow51);
		float 	fSlow54 = (6.2831853071795862f * ((fSlow16 * fSlow48) / fSlow22));
		float 	fSlow55 = (fSlow54 - fConst20);
		float 	fSlow56 = tanf((fConst19 * (fSlow16 * faustpower<5>(fSlow17))));
		float 	fSlow57 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(5 - fSlow19)))));
		float 	fSlow58 = (fSlow56 / fSlow57);
		float 	fSlow59 = (6.2831853071795862f * ((fSlow16 * fSlow56) / fSlow22));
		float 	fSlow60 = (fConst20 + fSlow59);
		float 	fSlow61 = (0 - ((fSlow59 - fConst20) / fSlow60));
		float 	fSlow62 = (1.0f / fSlow60);
		float 	fSlow63 = (6.2831853071795862f * ((fSlow16 * fSlow57) / fSlow22));
		float 	fSlow64 = (fSlow63 - fConst20);
		float 	fSlow65 = tanf((fConst19 * (fSlow16 * faustpower<4>(fSlow17))));
		float 	fSlow66 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(4 - fSlow19)))));
		float 	fSlow67 = (fSlow65 / fSlow66);
		float 	fSlow68 = (6.2831853071795862f * ((fSlow16 * fSlow65) / fSlow22));
		float 	fSlow69 = (fConst20 + fSlow68);
		float 	fSlow70 = (0 - ((fSlow68 - fConst20) / fSlow69));
		float 	fSlow71 = (1.0f / fSlow69);
		float 	fSlow72 = (6.2831853071795862f * ((fSlow16 * fSlow66) / fSlow22));
		float 	fSlow73 = (fSlow72 - fConst20);
		float 	fSlow74 = tanf((fConst19 * (fSlow16 * faustpower<3>(fSlow17))));
		float 	fSlow75 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(3 - fSlow19)))));
		float 	fSlow76 = (fSlow74 / fSlow75);
		float 	fSlow77 = (6.2831853071795862f * ((fSlow16 * fSlow74) / fSlow22));
		float 	fSlow78 = (fConst20 + fSlow77);
		float 	fSlow79 = (0 - ((fSlow77 - fConst20) / fSlow78));
		float 	fSlow80 = (1.0f / fSlow78);
		float 	fSlow81 = (6.2831853071795862f * ((fSlow16 * fSlow75) / fSlow22));
		float 	fSlow82 = (fSlow81 - fConst20);
		float 	fSlow83 = tanf((fConst19 * (fSlow16 * faustpower<2>(fSlow17))));
		float 	fSlow84 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(2 - fSlow19)))));
		float 	fSlow85 = (fSlow83 / fSlow84);
		float 	fSlow86 = (6.2831853071795862f * ((fSlow16 * fSlow83) / fSlow22));
		float 	fSlow87 = (fConst20 + fSlow86);
		float 	fSlow88 = (0 - ((fSlow86 - fConst20) / fSlow87));
		float 	fSlow89 = (1.0f / fSlow87);
		float 	fSlow90 = (6.2831853071795862f * ((fSlow16 * fSlow84) / fSlow22));
		float 	fSlow91 = (fSlow90 - fConst20);
		float 	fSlow92 = tanf((fConst19 * (fSlow16 * fSlow17)));
		float 	fSlow93 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(1 - fSlow19)))));
		float 	fSlow94 = (fSlow92 / fSlow93);
		float 	fSlow95 = (6.2831853071795862f * ((fSlow16 * fSlow92) / fSlow22));
		float 	fSlow96 = (fConst20 + fSlow95);
		float 	fSlow97 = (0 - ((fSlow95 - fConst20) / fSlow96));
		float 	fSlow98 = (1.0f / fSlow96);
		float 	fSlow99 = (6.2831853071795862f * ((fSlow16 * fSlow93) / fSlow22));
		float 	fSlow100 = (fSlow99 - fConst20);
		float 	fSlow101 = tanf((fConst19 * (fSlow16 * powf(fSlow17,(0 - fSlow19)))));
		float 	fSlow102 = (fSlow22 / fSlow101);
		float 	fSlow103 = (6.2831853071795862f * fSlow16);
		float 	fSlow104 = (fConst20 + fSlow103);
		float 	fSlow105 = (0 - ((fSlow103 - fConst20) / fSlow104));
		float 	fSlow106 = (1.0f / fSlow104);
		float 	fSlow107 = (6.2831853071795862f * ((fSlow16 * fSlow101) / fSlow22));
		float 	fSlow108 = (fConst20 + fSlow107);
		float 	fSlow109 = (fSlow107 - fConst20);
		float 	fSlow110 = ((fSlow22 * (fConst20 + fSlow99)) / fSlow101);
		float 	fSlow111 = ((fSlow92 * (fConst20 + fSlow90)) / fSlow93);
		float 	fSlow112 = ((fSlow83 * (fConst20 + fSlow81)) / fSlow84);
		float 	fSlow113 = ((fSlow74 * (fConst20 + fSlow72)) / fSlow75);
		float 	fSlow114 = ((fSlow65 * (fConst20 + fSlow63)) / fSlow66);
		float 	fSlow115 = ((fSlow56 * (fConst20 + fSlow54)) / fSlow57);
		float 	fSlow116 = ((fSlow47 * (fConst20 + fSlow45)) / fSlow48);
		float 	fSlow117 = ((fSlow38 * (fConst20 + fSlow36)) / fSlow39);
		float 	fSlow118 = ((fSlow29 * (fConst20 + fSlow27)) / fSlow30);
		//zone2b
		//zone3
		...
		for (int i=0; i<count; i++) {
			...
			fRec20[0] = ((fSlow105 * fRec20[1]) + (fSlow106 * ((fSlow108 * fVec22[0]) + (fSlow109 * fVec22[1]))));
			fVec23[0] = (fSlow102 * fRec20[0]);
			fRec19[0] = ((fSlow97 * fRec19[1]) + (fSlow98 * ((fSlow100 * fVec23[1]) + (fSlow110 * fRec20[0]))));
			fVec24[0] = (fSlow94 * fRec19[0]);
			fRec18[0] = ((fSlow88 * fRec18[1]) + (fSlow89 * ((fSlow91 * fVec24[1]) + (fSlow111 * fRec19[0]))));
			fVec25[0] = (fSlow85 * fRec18[0]);
			fRec17[0] = ((fSlow79 * fRec17[1]) + (fSlow80 * ((fSlow82 * fVec25[1]) + (fSlow112 * fRec18[0]))));
			fVec26[0] = (fSlow76 * fRec17[0]);
			fRec16[0] = ((fSlow70 * fRec16[1]) + (fSlow71 * ((fSlow73 * fVec26[1]) + (fSlow113 * fRec17[0]))));
			fVec27[0] = (fSlow67 * fRec16[0]);
			fRec15[0] = ((fSlow61 * fRec15[1]) + (fSlow62 * ((fSlow64 * fVec27[1]) + (fSlow114 * fRec16[0]))));
			fVec28[0] = (fSlow58 * fRec15[0]);
			fRec14[0] = ((fSlow52 * fRec14[1]) + (fSlow53 * ((fSlow55 * fVec28[1]) + (fSlow115 * fRec15[0]))));
			fVec29[0] = (fSlow49 * fRec14[0]);
			fRec13[0] = ((fSlow43 * fRec13[1]) + (fSlow44 * ((fSlow46 * fVec29[1]) + (fSlow116 * fRec14[0]))));
			fVec30[0] = (fSlow40 * fRec13[0]);
			fRec12[0] = ((fSlow34 * fRec12[1]) + (fSlow35 * ((fSlow37 * fVec30[1]) + (fSlow117 * fRec13[0]))));
			fVec31[0] = (fSlow31 * fRec12[0]);
			fRec11[0] = ((fSlow25 * fRec11[1]) + (fSlow26 * ((fSlow28 * fVec31[1]) + (fSlow118 * fRec12[0]))));
			fTempPerm33 = ((iSlow3)?fTempPerm31:(fSlow21 * fRec11[0]));
			fRec3[0] = (fTempPerm33 - (fConst11 * ((fConst21 * fRec3[2]) + (fConst23 * fRec3[1]))));
			...
			fRec27[0] = (fTempPerm33 - (fConst47 * ((fConst50 * fRec27[2]) + (fConst51 * fRec27[1]))));
			fRec26[0] = ((fConst47 * (((fConst49 * fRec27[1]) + (fConst52 * fRec27[0])) + (fConst52 * fRec27[2]))) - (fConst45 * ((fConst53 * fRec26[2]) + (fConst54 * fRec26[1]))));
			fRec25[0] = ((fConst45 * (((fConst46 * fRec26[1]) + (fConst55 * fRec26[0])) + (fConst55 * fRec26[2]))) - (fConst43 * ((fConst56 * fRec25[2]) + (fConst57 * fRec25[1]))));
			fTempPerm34 = (fConst43 * (((fConst44 * fRec25[1]) + (fConst58 * fRec25[0])) + (fConst58 * fRec25[2])));
			fRec24[0] = (fTempPerm34 - (fConst40 * ((fConst59 * fRec24[2]) + (fConst61 * fRec24[1]))));
			fRec23[0] = ((fConst40 * (((fConst42 * fRec24[1]) + (fConst62 * fRec24[0])) + (fConst62 * fRec24[2]))) - (fConst37 * ((fConst63 * fRec23[2]) + (fConst64 * fRec23[1]))));
			fRec22[0] = ((fConst37 * (((fConst39 * fRec23[1]) + (fConst65 * fRec23[0])) + (fConst65 * fRec23[2]))) - (fConst33 * ((fConst66 * fRec22[2]) + (fConst67 * fRec22[1]))));
			fRec21[0] = ((fSlow1 * fRec21[1]) + (fSlow2 * fabsf((fConst33 * (((fConst36 * fRec22[1]) + (fConst68 * fRec22[0])) + (fConst68 * fRec22[2]))))));
			fbargraph1 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec21[0]))));
			fRec34[0] = (fTempPerm34 - (fConst85 * ((fConst88 * fRec34[2]) + (fConst89 * fRec34[1]))));
			fRec33[0] = ((fConst85 * (((fConst87 * fRec34[1]) + (fConst90 * fRec34[0])) + (fConst90 * fRec34[2]))) - (fConst83 * ((fConst91 * fRec33[2]) + (fConst92 * fRec33[1]))));
			fRec32[0] = ((fConst83 * (((fConst84 * fRec33[1]) + (fConst93 * fRec33[0])) + (fConst93 * fRec33[2]))) - (fConst81 * ((fConst94 * fRec32[2]) + (fConst95 * fRec32[1]))));
			fTempPerm35 = (fConst81 * (((fConst82 * fRec32[1]) + (fConst96 * fRec32[0])) + (fConst96 * fRec32[2])));
			fRec31[0] = (fTempPerm35 - (fConst78 * ((fConst97 * fRec31[2]) + (fConst99 * fRec31[1]))));
			fRec30[0] = ((fConst78 * (((fConst80 * fRec31[1]) + (fConst100 * fRec31[0])) + (fConst100 * fRec31[2]))) - (fConst75 * ((fConst101 * fRec30[2]) + (fConst102 * fRec30[1]))));
			fRec29[0] = ((fConst75 * (((fConst77 * fRec30[1]) + (fConst103 * fRec30[0])) + (fConst103 * fRec30[2]))) - (fConst71 * ((fConst104 * fRec29[2]) + (fConst105 * fRec29[1]))));
			fRec28[0] = ((fSlow1 * fRec28[1]) + (fSlow2 * fabsf((fConst71 * (((fConst74 * fRec29[1]) + (fConst106 * fRec29[0])) + (fConst106 * fRec29[2]))))));
			fbargraph2 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec28[0]))));
			fRec41[0] = (fTempPerm35 - (fConst123 * ((fConst126 * fRec41[2]) + (fConst127 * fRec41[1]))));
			fRec40[0] = ((fConst123 * (((fConst125 * fRec41[1]) + (fConst128 * fRec41[0])) + (fConst128 * fRec41[2]))) - (fConst121 * ((fConst129 * fRec40[2]) + (fConst130 * fRec40[1]))));
			fRec39[0] = ((fConst121 * (((fConst122 * fRec40[1]) + (fConst131 * fRec40[0])) + (fConst131 * fRec40[2]))) - (fConst119 * ((fConst132 * fRec39[2]) + (fConst133 * fRec39[1]))));
			fTempPerm36 = (fConst119 * (((fConst120 * fRec39[1]) + (fConst134 * fRec39[0])) + (fConst134 * fRec39[2])));
			fRec38[0] = (fTempPerm36 - (fConst116 * ((fConst135 * fRec38[2]) + (fConst137 * fRec38[1]))));
			fRec37[0] = ((fConst116 * (((fConst118 * fRec38[1]) + (fConst138 * fRec38[0])) + (fConst138 * fRec38[2]))) - (fConst113 * ((fConst139 * fRec37[2]) + (fConst140 * fRec37[1]))));
			fRec36[0] = ((fConst113 * (((fConst115 * fRec37[1]) + (fConst141 * fRec37[0])) + (fConst141 * fRec37[2]))) - (fConst109 * ((fConst142 * fRec36[2]) + (fConst143 * fRec36[1]))));
			fRec35[0] = ((fSlow1 * fRec35[1]) + (fSlow2 * fabsf((fConst109 * (((fConst112 * fRec36[1]) + (fConst144 * fRec36[0])) + (fConst144 * fRec36[2]))))));
			fbargraph3 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec35[0]))));
			fRec48[0] = (fTempPerm36 - (fConst161 * ((fConst164 * fRec48[2]) + (fConst165 * fRec48[1]))));
			fRec47[0] = ((fConst161 * (((fConst163 * fRec48[1]) + (fConst166 * fRec48[0])) + (fConst166 * fRec48[2]))) - (fConst159 * ((fConst167 * fRec47[2]) + (fConst168 * fRec47[1]))));
			fRec46[0] = ((fConst159 * (((fConst160 * fRec47[1]) + (fConst169 * fRec47[0])) + (fConst169 * fRec47[2]))) - (fConst157 * ((fConst170 * fRec46[2]) + (fConst171 * fRec46[1]))));
			fTempPerm37 = (fConst157 * (((fConst158 * fRec46[1]) + (fConst172 * fRec46[0])) + (fConst172 * fRec46[2])));
			fRec45[0] = (fTempPerm37 - (fConst154 * ((fConst173 * fRec45[2]) + (fConst175 * fRec45[1]))));
			fRec44[0] = ((fConst154 * (((fConst156 * fRec45[1]) + (fConst176 * fRec45[0])) + (fConst176 * fRec45[2]))) - (fConst151 * ((fConst177 * fRec44[2]) + (fConst178 * fRec44[1]))));
			fRec43[0] = ((fConst151 * (((fConst153 * fRec44[1]) + (fConst179 * fRec44[0])) + (fConst179 * fRec44[2]))) - (fConst147 * ((fConst180 * fRec43[2]) + (fConst181 * fRec43[1]))));
			fRec42[0] = ((fSlow1 * fRec42[1]) + (fSlow2 * fabsf((fConst147 * (((fConst150 * fRec43[1]) + (fConst182 * fRec43[0])) + (fConst182 * fRec43[2]))))));
			fbargraph4 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec42[0]))));
			fRec55[0] = (fTempPerm37 - (fConst199 * ((fConst202 * fRec55[2]) + (fConst203 * fRec55[1]))));
			fRec54[0] = ((fConst199 * (((fConst201 * fRec55[1]) + (fConst204 * fRec55[0])) + (fConst204 * fRec55[2]))) - (fConst197 * ((fConst205 * fRec54[2]) + (fConst206 * fRec54[1]))));
			fRec53[0] = ((fConst197 * (((fConst198 * fRec54[1]) + (fConst207 * fRec54[0])) + (fConst207 * fRec54[2]))) - (fConst195 * ((fConst208 * fRec53[2]) + (fConst209 * fRec53[1]))));
			fTempPerm38 = (fConst195 * (((fConst196 * fRec53[1]) + (fConst210 * fRec53[0])) + (fConst210 * fRec53[2])));
			fRec52[0] = (fTempPerm38 - (fConst192 * ((fConst211 * fRec52[2]) + (fConst213 * fRec52[1]))));
			fRec51[0] = ((fConst192 * (((fConst194 * fRec52[1]) + (fConst214 * fRec52[0])) + (fConst214 * fRec52[2]))) - (fConst189 * ((fConst215 * fRec51[2]) + (fConst216 * fRec51[1]))));
			fRec50[0] = ((fConst189 * (((fConst191 * fRec51[1]) + (fConst217 * fRec51[0])) + (fConst217 * fRec51[2]))) - (fConst185 * ((fConst218 * fRec50[2]) + (fConst219 * fRec50[1]))));
			fRec49[0] = ((fSlow1 * fRec49[1]) + (fSlow2 * fabsf((fConst185 * (((fConst188 * fRec50[1]) + (fConst220 * fRec50[0])) + (fConst220 * fRec50[2]))))));
			fbargraph5 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec49[0]))));
			fRec62[0] = (fTempPerm38 - (fConst237 * ((fConst240 * fRec62[2]) + (fConst241 * fRec62[1]))));
			fRec61[0] = ((fConst237 * (((fConst239 * fRec62[1]) + (fConst242 * fRec62[0])) + (fConst242 * fRec62[2]))) - (fConst235 * ((fConst243 * fRec61[2]) + (fConst244 * fRec61[1]))));
			fRec60[0] = ((fConst235 * (((fConst236 * fRec61[1]) + (fConst245 * fRec61[0])) + (fConst245 * fRec61[2]))) - (fConst233 * ((fConst246 * fRec60[2]) + (fConst247 * fRec60[1]))));
			fTempPerm39 = (fConst233 * (((fConst234 * fRec60[1]) + (fConst248 * fRec60[0])) + (fConst248 * fRec60[2])));
			fRec59[0] = (fTempPerm39 - (fConst230 * ((fConst249 * fRec59[2]) + (fConst251 * fRec59[1]))));
			fRec58[0] = ((fConst230 * (((fConst232 * fRec59[1]) + (fConst252 * fRec59[0])) + (fConst252 * fRec59[2]))) - (fConst227 * ((fConst253 * fRec58[2]) + (fConst254 * fRec58[1]))));
			fRec57[0] = ((fConst227 * (((fConst229 * fRec58[1]) + (fConst255 * fRec58[0])) + (fConst255 * fRec58[2]))) - (fConst223 * ((fConst256 * fRec57[2]) + (fConst257 * fRec57[1]))));
			fRec56[0] = ((fSlow1 * fRec56[1]) + (fSlow2 * fabsf((fConst223 * (((fConst226 * fRec57[1]) + (fConst258 * fRec57[0])) + (fConst258 * fRec57[2]))))));
			fbargraph6 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec56[0]))));
			fRec69[0] = (fTempPerm39 - (fConst275 * ((fConst278 * fRec69[2]) + (fConst279 * fRec69[1]))));
			fRec68[0] = ((fConst275 * (((fConst277 * fRec69[1]) + (fConst280 * fRec69[0])) + (fConst280 * fRec69[2]))) - (fConst273 * ((fConst281 * fRec68[2]) + (fConst282 * fRec68[1]))));
			fRec67[0] = ((fConst273 * (((fConst274 * fRec68[1]) + (fConst283 * fRec68[0])) + (fConst283 * fRec68[2]))) - (fConst271 * ((fConst284 * fRec67[2]) + (fConst285 * fRec67[1]))));
			fTempPerm40 = (fConst271 * (((fConst272 * fRec67[1]) + (fConst286 * fRec67[0])) + (fConst286 * fRec67[2])));
			fRec66[0] = (fTempPerm40 - (fConst268 * ((fConst287 * fRec66[2]) + (fConst289 * fRec66[1]))));
			fRec65[0] = ((fConst268 * (((fConst270 * fRec66[1]) + (fConst290 * fRec66[0])) + (fConst290 * fRec66[2]))) - (fConst265 * ((fConst291 * fRec65[2]) + (fConst292 * fRec65[1]))));
			fRec64[0] = ((fConst265 * (((fConst267 * fRec65[1]) + (fConst293 * fRec65[0])) + (fConst293 * fRec65[2]))) - (fConst261 * ((fConst294 * fRec64[2]) + (fConst295 * fRec64[1]))));
			fRec63[0] = ((fSlow1 * fRec63[1]) + (fSlow2 * fabsf((fConst261 * (((fConst264 * fRec64[1]) + (fConst296 * fRec64[0])) + (fConst296 * fRec64[2]))))));
			fbargraph7 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec63[0]))));
			fRec76[0] = (fTempPerm40 - (fConst313 * ((fConst316 * fRec76[2]) + (fConst317 * fRec76[1]))));
			fRec75[0] = ((fConst313 * (((fConst315 * fRec76[1]) + (fConst318 * fRec76[0])) + (fConst318 * fRec76[2]))) - (fConst311 * ((fConst319 * fRec75[2]) + (fConst320 * fRec75[1]))));
			fRec74[0] = ((fConst311 * (((fConst312 * fRec75[1]) + (fConst321 * fRec75[0])) + (fConst321 * fRec75[2]))) - (fConst309 * ((fConst322 * fRec74[2]) + (fConst323 * fRec74[1]))));
			fTempPerm41 = (fConst309 * (((fConst310 * fRec74[1]) + (fConst324 * fRec74[0])) + (fConst324 * fRec74[2])));
			fRec73[0] = (fTempPerm41 - (fConst306 * ((fConst325 * fRec73[2]) + (fConst327 * fRec73[1]))));
			fRec72[0] = ((fConst306 * (((fConst308 * fRec73[1]) + (fConst328 * fRec73[0])) + (fConst328 * fRec73[2]))) - (fConst303 * ((fConst329 * fRec72[2]) + (fConst330 * fRec72[1]))));
			fRec71[0] = ((fConst303 * (((fConst305 * fRec72[1]) + (fConst331 * fRec72[0])) + (fConst331 * fRec72[2]))) - (fConst299 * ((fConst332 * fRec71[2]) + (fConst333 * fRec71[1]))));
			fRec70[0] = ((fSlow1 * fRec70[1]) + (fSlow2 * fabsf((fConst299 * (((fConst302 * fRec71[1]) + (fConst334 * fRec71[0])) + (fConst334 * fRec71[2]))))));
			fbargraph8 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec70[0]))));
			fRec83[0] = (fTempPerm41 - (fConst351 * ((fConst354 * fRec83[2]) + (fConst355 * fRec83[1]))));
			fRec82[0] = ((fConst351 * (((fConst353 * fRec83[1]) + (fConst356 * fRec83[0])) + (fConst356 * fRec83[2]))) - (fConst349 * ((fConst357 * fRec82[2]) + (fConst358 * fRec82[1]))));
			fRec81[0] = ((fConst349 * (((fConst350 * fRec82[1]) + (fConst359 * fRec82[0])) + (fConst359 * fRec82[2]))) - (fConst347 * ((fConst360 * fRec81[2]) + (fConst361 * fRec81[1]))));
			fTempPerm42 = (fConst347 * (((fConst348 * fRec81[1]) + (fConst362 * fRec81[0])) + (fConst362 * fRec81[2])));
			fRec80[0] = (fTempPerm42 - (fConst344 * ((fConst363 * fRec80[2]) + (fConst365 * fRec80[1]))));
			fRec79[0] = ((fConst344 * (((fConst346 * fRec80[1]) + (fConst366 * fRec80[0])) + (fConst366 * fRec80[2]))) - (fConst341 * ((fConst367 * fRec79[2]) + (fConst368 * fRec79[1]))));
			fRec78[0] = ((fConst341 * (((fConst343 * fRec79[1]) + (fConst369 * fRec79[0])) + (fConst369 * fRec79[2]))) - (fConst337 * ((fConst370 * fRec78[2]) + (fConst371 * fRec78[1]))));
			fRec77[0] = ((fSlow1 * fRec77[1]) + (fSlow2 * fabsf((fConst337 * (((fConst340 * fRec78[1]) + (fConst372 * fRec78[0])) + (fConst372 * fRec78[2]))))));
			fbargraph9 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec77[0]))));
			fRec90[0] = (fTempPerm42 - (fConst389 * ((fConst392 * fRec90[2]) + (fConst393 * fRec90[1]))));
			fRec89[0] = ((fConst389 * (((fConst391 * fRec90[1]) + (fConst394 * fRec90[0])) + (fConst394 * fRec90[2]))) - (fConst387 * ((fConst395 * fRec89[2]) + (fConst396 * fRec89[1]))));
			fRec88[0] = ((fConst387 * (((fConst388 * fRec89[1]) + (fConst397 * fRec89[0])) + (fConst397 * fRec89[2]))) - (fConst385 * ((fConst398 * fRec88[2]) + (fConst399 * fRec88[1]))));
			fTempPerm43 = (fConst385 * (((fConst386 * fRec88[1]) + (fConst400 * fRec88[0])) + (fConst400 * fRec88[2])));
			fRec87[0] = (fTempPerm43 - (fConst382 * ((fConst401 * fRec87[2]) + (fConst403 * fRec87[1]))));
			fRec86[0] = ((fConst382 * (((fConst384 * fRec87[1]) + (fConst404 * fRec87[0])) + (fConst404 * fRec87[2]))) - (fConst379 * ((fConst405 * fRec86[2]) + (fConst406 * fRec86[1]))));
			fRec85[0] = ((fConst379 * (((fConst381 * fRec86[1]) + (fConst407 * fRec86[0])) + (fConst407 * fRec86[2]))) - (fConst375 * ((fConst408 * fRec85[2]) + (fConst409 * fRec85[1]))));
			fRec84[0] = ((fSlow1 * fRec84[1]) + (fSlow2 * fabsf((fConst375 * (((fConst378 * fRec85[1]) + (fConst410 * fRec85[0])) + (fConst410 * fRec85[2]))))));
			fbargraph10 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec84[0]))));
			fRec97[0] = (fTempPerm43 - (fConst427 * ((fConst430 * fRec97[2]) + (fConst431 * fRec97[1]))));
			fRec96[0] = ((fConst427 * (((fConst429 * fRec97[1]) + (fConst432 * fRec97[0])) + (fConst432 * fRec97[2]))) - (fConst425 * ((fConst433 * fRec96[2]) + (fConst434 * fRec96[1]))));
			fRec95[0] = ((fConst425 * (((fConst426 * fRec96[1]) + (fConst435 * fRec96[0])) + (fConst435 * fRec96[2]))) - (fConst423 * ((fConst436 * fRec95[2]) + (fConst437 * fRec95[1]))));
			fTempPerm44 = (fConst423 * (((fConst424 * fRec95[1]) + (fConst438 * fRec95[0])) + (fConst438 * fRec95[2])));
			fRec94[0] = (fTempPerm44 - (fConst420 * ((fConst439 * fRec94[2]) + (fConst441 * fRec94[1]))));
			fRec93[0] = ((fConst420 * (((fConst422 * fRec94[1]) + (fConst442 * fRec94[0])) + (fConst442 * fRec94[2]))) - (fConst417 * ((fConst443 * fRec93[2]) + (fConst444 * fRec93[1]))));
			fRec92[0] = ((fConst417 * (((fConst419 * fRec93[1]) + (fConst445 * fRec93[0])) + (fConst445 * fRec93[2]))) - (fConst413 * ((fConst446 * fRec92[2]) + (fConst447 * fRec92[1]))));
			fRec91[0] = ((fSlow1 * fRec91[1]) + (fSlow2 * fabsf((fConst413 * (((fConst416 * fRec92[1]) + (fConst448 * fRec92[0])) + (fConst448 * fRec92[2]))))));
			fbargraph11 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec91[0]))));
			fRec104[0] = (fTempPerm44 - (fConst465 * ((fConst468 * fRec104[2]) + (fConst469 * fRec104[1]))));
			fRec103[0] = ((fConst465 * (((fConst467 * fRec104[1]) + (fConst470 * fRec104[0])) + (fConst470 * fRec104[2]))) - (fConst463 * ((fConst471 * fRec103[2]) + (fConst472 * fRec103[1]))));
			fRec102[0] = ((fConst463 * (((fConst464 * fRec103[1]) + (fConst473 * fRec103[0])) + (fConst473 * fRec103[2]))) - (fConst461 * ((fConst474 * fRec102[2]) + (fConst475 * fRec102[1]))));
			fTempPerm45 = (fConst461 * (((fConst462 * fRec102[1]) + (fConst476 * fRec102[0])) + (fConst476 * fRec102[2])));
			fRec101[0] = (fTempPerm45 - (fConst458 * ((fConst477 * fRec101[2]) + (fConst479 * fRec101[1]))));
			fRec100[0] = ((fConst458 * (((fConst460 * fRec101[1]) + (fConst480 * fRec101[0])) + (fConst480 * fRec101[2]))) - (fConst455 * ((fConst481 * fRec100[2]) + (fConst482 * fRec100[1]))));
			fRec99[0] = ((fConst455 * (((fConst457 * fRec100[1]) + (fConst483 * fRec100[0])) + (fConst483 * fRec100[2]))) - (fConst451 * ((fConst484 * fRec99[2]) + (fConst485 * fRec99[1]))));
			fRec98[0] = ((fSlow1 * fRec98[1]) + (fSlow2 * fabsf((fConst451 * (((fConst454 * fRec99[1]) + (fConst486 * fRec99[0])) + (fConst486 * fRec99[2]))))));
			fbargraph12 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec98[0]))));
			fRec111[0] = (fTempPerm45 - (fConst503 * ((fConst506 * fRec111[2]) + (fConst507 * fRec111[1]))));
			fRec110[0] = ((fConst503 * (((fConst505 * fRec111[1]) + (fConst508 * fRec111[0])) + (fConst508 * fRec111[2]))) - (fConst501 * ((fConst509 * fRec110[2]) + (fConst510 * fRec110[1]))));
			fRec109[0] = ((fConst501 * (((fConst502 * fRec110[1]) + (fConst511 * fRec110[0])) + (fConst511 * fRec110[2]))) - (fConst499 * ((fConst512 * fRec109[2]) + (fConst513 * fRec109[1]))));
			fTempPerm46 = (fConst499 * (((fConst500 * fRec109[1]) + (fConst514 * fRec109[0])) + (fConst514 * fRec109[2])));
			fRec108[0] = (fTempPerm46 - (fConst496 * ((fConst515 * fRec108[2]) + (fConst517 * fRec108[1]))));
			fRec107[0] = ((fConst496 * (((fConst498 * fRec108[1]) + (fConst518 * fRec108[0])) + (fConst518 * fRec108[2]))) - (fConst493 * ((fConst519 * fRec107[2]) + (fConst520 * fRec107[1]))));
			fRec106[0] = ((fConst493 * (((fConst495 * fRec107[1]) + (fConst521 * fRec107[0])) + (fConst521 * fRec107[2]))) - (fConst489 * ((fConst522 * fRec106[2]) + (fConst523 * fRec106[1]))));
			fRec105[0] = ((fSlow1 * fRec105[1]) + (fSlow2 * fabsf((fConst489 * (((fConst492 * fRec106[1]) + (fConst524 * fRec106[0])) + (fConst524 * fRec106[2]))))));
			fbargraph13 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec105[0]))));
			fRec115[0] = (fTempPerm46 - (fConst529 * ((fConst532 * fRec115[2]) + (fConst533 * fRec115[1]))));
			fRec114[0] = ((fConst529 * (((fConst531 * fRec115[1]) + (fConst534 * fRec115[0])) + (fConst534 * fRec115[2]))) - (fConst527 * ((fConst535 * fRec114[2]) + (fConst536 * fRec114[1]))));
			fRec113[0] = ((fConst527 * (((fConst528 * fRec114[1]) + (fConst537 * fRec114[0])) + (fConst537 * fRec114[2]))) - (fConst525 * ((fConst538 * fRec113[2]) + (fConst539 * fRec113[1]))));
			fRec112[0] = ((fSlow1 * fRec112[1]) + (fSlow2 * fabsf((fConst525 * (((fConst526 * fRec113[1]) + (fConst540 * fRec113[0])) + (fConst540 * fRec113[2]))))));
			fbargraph14 = (fSlow0 + (20 * log10f(max(9.9999999999999995e-08f, fRec112[0]))));
			output0[i] = (FAUSTFLOAT)fTempPerm33;
			// post processing
			fRec112[1] = fRec112[0];
