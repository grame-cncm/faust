  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fTempPerm0 = (fRec1[0] + 1.0f);
			fTempPerm1 = max((float)-1, min((float)1, (39.810717055349734f * (float)input0[i])));
			fTempPerm2 = (1 - (0.33333333333333331f * faustpower<2>(fTempPerm1)));
			fTempPerm3 = (1.0f - (0.5f * fTempPerm0));
			fRec15[0] = ((fSlow24 * fRec15[1]) + (fSlow25 * (fRec11[1] + fRec11[2])));
			fRec14[0] = ((fSlow18 * fRec14[1]) + (fSlow19 * (fRec11[1] + (fSlow21 * fRec15[0]))));
			fVec0[IOTA&32767] = ((0.35355339059327373f * fRec14[0]) + 9.9999999999999995e-21f);
			fTempPerm4 = max((float)-1, min((float)1, (39.810717055349734f * (float)input1[i])));
			fTempPerm5 = (1 - (0.33333333333333331f * faustpower<2>(fTempPerm4)));
			fVec1[IOTA&16383] = (fTempPerm4 * fTempPerm5);
			fTempPerm6 = (0.29999999999999999f * fVec1[(IOTA-iSlow26)&16383]);
			fTempPerm7 = (((0.59999999999999998f * fRec12[1]) + fVec0[(IOTA-iConst7)&32767]) - fTempPerm6);
			fVec2[IOTA&2047] = fTempPerm7;
			fRec12[0] = fVec2[(IOTA-iConst9)&2047];
			float 	fRec13 = (0 - (0.59999999999999998f * fVec2[IOTA&2047]));
			fRec19[0] = ((fSlow24 * fRec19[1]) + (fSlow25 * (fRec7[1] + fRec7[2])));
			fRec18[0] = ((fSlow33 * fRec18[1]) + (fSlow34 * (fRec7[1] + (fSlow35 * fRec19[0]))));
			fVec3[IOTA&32767] = ((0.35355339059327373f * fRec18[0]) + 9.9999999999999995e-21f);
			fTempPerm8 = (((0.59999999999999998f * fRec16[1]) + fVec3[(IOTA-iConst13)&32767]) - fTempPerm6);
			fVec4[IOTA&4095] = fTempPerm8;
			fRec16[0] = fVec4[(IOTA-iConst14)&4095];
			float 	fRec17 = (0 - (0.59999999999999998f * fVec4[IOTA&4095]));
			fRec23[0] = ((fSlow24 * fRec23[1]) + (fSlow25 * (fRec9[1] + fRec9[2])));
			fRec22[0] = ((fSlow42 * fRec22[1]) + (fSlow43 * (fRec9[1] + (fSlow44 * fRec23[0]))));
			fVec5[IOTA&16383] = ((0.35355339059327373f * fRec22[0]) + 9.9999999999999995e-21f);
			fTempPerm9 = (fVec5[(IOTA-iConst18)&16383] + (fTempPerm6 + (0.59999999999999998f * fRec20[1])));
			fVec6[IOTA&4095] = fTempPerm9;
			fRec20[0] = fVec6[(IOTA-iConst19)&4095];
			float 	fRec21 = (0 - (0.59999999999999998f * fVec6[IOTA&4095]));
			fRec27[0] = ((fSlow24 * fRec27[1]) + (fSlow25 * (fRec5[1] + fRec5[2])));
			fRec26[0] = ((fSlow51 * fRec26[1]) + (fSlow52 * (fRec5[1] + (fSlow53 * fRec27[0]))));
			fVec7[IOTA&32767] = ((0.35355339059327373f * fRec26[0]) + 9.9999999999999995e-21f);
			fTempPerm10 = (fTempPerm6 + ((0.59999999999999998f * fRec24[1]) + fVec7[(IOTA-iConst23)&32767]));
			fVec8[IOTA&4095] = fTempPerm10;
			fRec24[0] = fVec8[(IOTA-iConst24)&4095];
			float 	fRec25 = (0 - (0.59999999999999998f * fVec8[IOTA&4095]));
			fRec31[0] = ((fSlow24 * fRec31[1]) + (fSlow25 * (fRec10[1] + fRec10[2])));
			fRec30[0] = ((fSlow60 * fRec30[1]) + (fSlow61 * (fRec10[1] + (fSlow62 * fRec31[0]))));
			fVec9[IOTA&16383] = ((0.35355339059327373f * fRec30[0]) + 9.9999999999999995e-21f);
			fVec10[IOTA&16383] = (fTempPerm1 * fTempPerm2);
			fTempPerm11 = (0.29999999999999999f * fVec10[(IOTA-iSlow26)&16383]);
			fTempPerm12 = (fVec9[(IOTA-iConst28)&16383] - (fTempPerm11 + (0.59999999999999998f * fRec28[1])));
			fVec11[IOTA&2047] = fTempPerm12;
			...
			fTempPerm13 = (fVec12[(IOTA-iConst33)&16383] - (fTempPerm11 + (0.59999999999999998f * fRec32[1])));
			fVec13[IOTA&4095] = fTempPerm13;
			...
			fTempPerm14 = ((fTempPerm11 + fVec14[(IOTA-iConst38)&16383]) - (0.59999999999999998f * fRec36[1]));
			fVec15[IOTA&4095] = fTempPerm14;
			...
			fTempPerm15 = ((fVec16[(IOTA-iConst43)&16383] + fTempPerm11) - (0.59999999999999998f * fRec40[1]));
			fVec17[IOTA&2047] = fTempPerm15;
			fRec40[0] = fVec17[(IOTA-iConst44)&2047];
			float 	fRec41 = (0.59999999999999998f * fVec17[IOTA&2047]);
			fTempPerm16 = (fRec41 + fRec37);
			fTempPerm17 = (fRec29 + (fRec33 + fTempPerm16));
			fRec4[0] = (fRec12[1] + (fRec16[1] + (fRec20[1] + (fRec24[1] + (fRec28[1] + (fRec32[1] + (fRec36[1] + (fRec40[1] + (fRec13 + (fRec17 + (fRec21 + (fRec25 + fTempPerm17))))))))))));
			fRec5[0] = ((fRec28[1] + (fRec32[1] + (fRec36[1] + (fRec40[1] + fTempPerm17)))) - (fRec12[1] + (fRec16[1] + (fRec20[1] + (fRec24[1] + (fRec13 + (fRec17 + (fRec25 + fRec21))))))));
			fTempPerm18 = (fRec33 + fRec29);
			fRec6[0] = ((fRec20[1] + (fRec24[1] + (fRec36[1] + (fRec40[1] + (fRec21 + (fRec25 + fTempPerm16)))))) - (fRec12[1] + (fRec16[1] + (fRec28[1] + (fRec32[1] + (fRec13 + (fRec17 + fTempPerm18)))))));
			fRec7[0] = ((fRec12[1] + (fRec16[1] + (fRec36[1] + (fRec40[1] + (fRec13 + (fRec17 + fTempPerm16)))))) - (fRec20[1] + (fRec24[1] + (fRec28[1] + (fRec32[1] + (fRec21 + (fRec25 + fTempPerm18)))))));
			fTempPerm19 = (fRec41 + fRec33);
			fTempPerm20 = (fRec37 + fRec29);
			fRec8[0] = ((fRec16[1] + (fRec24[1] + (fRec32[1] + (fRec40[1] + (fRec17 + (fRec25 + fTempPerm19)))))) - (fRec12[1] + (fRec20[1] + (fRec28[1] + (fRec36[1] + (fRec13 + (fRec21 + fTempPerm20)))))));
			fRec9[0] = ((fRec12[1] + (fRec20[1] + (fRec32[1] + (fRec40[1] + (fRec13 + (fRec21 + fTempPerm19)))))) - (fRec16[1] + (fRec24[1] + (fRec28[1] + (fRec36[1] + (fRec17 + (fRec25 + fTempPerm20)))))));
			fTempPerm21 = (fRec41 + fRec29);
			fTempPerm22 = (fRec37 + fRec33);
			fRec10[0] = ((fRec12[1] + (fRec24[1] + (fRec28[1] + (fRec40[1] + (fRec13 + (fRec25 + fTempPerm21)))))) - (fRec16[1] + (fRec20[1] + (fRec32[1] + (fRec36[1] + (fRec17 + (fRec21 + fTempPerm22)))))));
			fRec11[0] = ((fRec16[1] + (fRec20[1] + (fRec28[1] + (fRec40[1] + (fRec17 + (fRec21 + fTempPerm21)))))) - (fRec12[1] + (fRec24[1] + (fRec32[1] + (fRec36[1] + (fRec13 + (fRec25 + fTempPerm22)))))));
			fTempPerm23 = (0.37f * (fRec5[0] + fRec6[0]));
			fTempPerm24 = (fSlow90 * fRec3[1]);
			fRec3[0] = (fTempPerm23 - (fTempPerm24 + (fSlow9 * fRec3[2])));
			fTempPerm25 = (fSlow9 * fRec3[0]);
			fTempPerm26 = (0.5f * ((fTempPerm25 + (fRec3[2] + (fTempPerm23 + fTempPerm24))) + (fSlow7 * ((fTempPerm25 + (fTempPerm24 + fRec3[2])) - fTempPerm23))));
			fTempPerm27 = (fSlow91 * fRec2[1]);
			fRec2[0] = (fTempPerm26 - (fTempPerm27 + (fSlow5 * fRec2[2])));
			fTempPerm28 = (fSlow5 * fRec2[0]);
			output0[i] = (FAUSTFLOAT)(0.5f * (fRec0[0] * (((fTempPerm0 * fTempPerm1) * fTempPerm2) + (fTempPerm3 * ((fTempPerm28 + (fRec2[2] + (fTempPerm26 + fTempPerm27))) + (fSlow3 * ((fTempPerm28 + (fTempPerm27 + fRec2[2])) - fTempPerm26)))))));
			fTempPerm29 = (0.37f * (fRec5[0] - fRec6[0]));
			fTempPerm30 = (fSlow90 * fRec45[1]);
			fRec45[0] = (fTempPerm29 - (fTempPerm30 + (fSlow9 * fRec45[2])));
			fTempPerm31 = (fSlow9 * fRec45[0]);
			fTempPerm32 = (0.5f * ((fTempPerm31 + (fRec45[2] + (fTempPerm29 + fTempPerm30))) + (fSlow7 * ((fTempPerm31 + (fTempPerm30 + fRec45[2])) - fTempPerm29))));
			fTempPerm33 = (fSlow91 * fRec44[1]);
			fRec44[0] = (fTempPerm32 - (fTempPerm33 + (fSlow5 * fRec44[2])));
			fTempPerm34 = (fSlow5 * fRec44[0]);
			output1[i] = (FAUSTFLOAT)(0.5f * (fRec0[0] * (((fTempPerm0 * fTempPerm4) * fTempPerm5) + (fTempPerm3 * ((fTempPerm34 + (fRec44[2] + (fTempPerm32 + fTempPerm33))) + (fSlow3 * ((fTempPerm34 + (fTempPerm33 + fRec44[2])) - fTempPerm32)))))));
			// post processing
