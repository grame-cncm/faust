...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("slid1", &fslider1, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
		...
		ui_interface->addHorizontalSlider("slid1", &fslider3, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
		ui_interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow1 = (fSlow0 * float(fslider1));
