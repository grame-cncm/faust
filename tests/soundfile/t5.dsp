...
process = so_loop_rate(soundfile("tango.flac",1), speed),so_loop_rate(soundfile("levot.flac",1), speed) : dm.freeverb_demo;
//process = so_loop_rate(soundfile("tango.flac",1), speed),so_loop_rate(soundfile("levot.flac",1), speed);
