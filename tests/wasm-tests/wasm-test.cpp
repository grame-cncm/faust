...
int main(int argc, const char** argv)
{
    ...
    cout << "=============================\n";
    cout << "Test createWasmDSPFactoryFromFile\n";
    {
        wasm_dsp_factory* factory = createWasmDSPFactoryFromFile(dspFile, 0, NULL, error_msg, true);
    ...
    string tempPath = "/private/var/tmp/FaustDSP.wasm";
    
    cout << "=============================\n";
    cout << "Test createWasmDSPFactoryFromString\n";
    {
        wasm_dsp_factory* factory = createWasmDSPFactoryFromString("FaustDSP", "process = 0.5,0.6;", 0, NULL, error_msg, true);
        if (!factory) {
            cerr << "Cannot create factory : " << error_msg;
            exit(EXIT_FAILURE);
        }
    ...
    cout << "=============================\n";
    cout << "Test createWasmDSPFactoryFromString with getWarningMessages\n";
    {
        const char* argv[8];
        int argc = 0;
        argv[argc++] = "-wall";
        ...
        wasm_dsp_factory* factory = createWasmDSPFactoryFromString("FaustDSP", code, argc, argv, error_msg, true);
        if (!factory) {
            cerr << "Cannot create factory : " << error_msg;
            exit(EXIT_FAILURE);
        }
