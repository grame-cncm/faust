...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("freq", &fEntry0, FAUSTFLOAT(1e+02), FAUSTFLOAT(2e+01), FAUSTFLOAT(1.5e+02), FAUSTFLOAT(1.0));
		ui_interface->declare(&fVslider0, "unit", "dB");
		ui_interface->addVerticalSlider("gain", &fVslider0, FAUSTFLOAT(0.0), FAUSTFLOAT(-2e+01), FAUSTFLOAT(2e+01), FAUSTFLOAT(0.1));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow5 = std::pow(1e+01, 0.05 * static_cast<double>(fVslider0));
