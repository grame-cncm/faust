	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (vindex = 0; vindex <= (faust_wrap_sub(count, 4)); vindex = faust_wrap_add(vindex, 4)) {
			...
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec4[i] = fSlow0 + 0.999 * fRec4[faust_wrap_sub(i, 1)];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec6[i] = fRec6[faust_wrap_sub(i, 1)] * fSlow2 + fSlow3;
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec1[i] = fRec5[faust_wrap_sub(i, 1)] + fConst1 * fZec0[i];
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec3[i] = fRec7[faust_wrap_sub(i, 1)] + fConst1 * fZec2[i];
				fRec7[i] = fZec3[i] - std::floor(fZec3[i]);
			}
			/* Post code */
			for (int j7 = 0; j7 < 4; j7 = faust_wrap_add(j7, 1)) {
				fRec7_perm[j7] = fRec7_tmp[faust_wrap_add(vsize, j7)];
			}
			/* Vectorizable loop 6 */
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec5[i] = fRec8[faust_wrap_sub(i, 1)] + fConst1 * fZec4[i];
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				iRec9[i] = faust_wrap_add(faust_wrap_mul(1103515245, iRec9[faust_wrap_sub(i, 1)]), 12345);
			}
			/* Post code */
			for (int j11 = 0; j11 < 4; j11 = faust_wrap_add(j11, 1)) {
				iRec9_perm[j11] = iRec9_tmp[faust_wrap_add(vsize, j11)];
			}
			/* Vectorizable loop 9 */
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec10[i] = 0.5221894 * fRec10[faust_wrap_sub(i, 3)] + fZec6[i] + 2.494956002 * fRec10[faust_wrap_sub(i, 1)] - 2.017265875 * fRec10[faust_wrap_sub(i, 2)];
			}
			/* Post code */
			for (int j13 = 0; j13 < 4; j13 = faust_wrap_add(j13, 1)) {
				fRec10_perm[j13] = fRec10_tmp[faust_wrap_add(vsize, j13)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec19[i] = fRec4[i] * ((iSlow11) ? static_cast<double>(input0[i]) : ((iSlow12) ? ((iSlow17) ? 0.049922035 * fRec10[i] + 0.050612699 * fRec10[faust_wrap_sub(i, 2)] - (0.095993537 * fRec10[faust_wrap_sub(i, 1)] + 0.004408786 * fRec10[faust_wrap_sub(i, 3)]) : fZec6[i]) : 0.3333333333333333 * fRec4[i] * (((iSlow14) ? ((iSlow16) ? fConst4 * (fZec12[i] * (fYec5[i] - fYec5[faust_wrap_sub(i, 1)]) / fZec0[i]) : fConst3 * (fZec10[i] * (fYec2[i] - fYec2[faust_wrap_sub(i, 1)]) / fZec0[i])) : ((iSlow15) ? fConst2 * (fZec9[i] * (fYec0[i] - fYec0[faust_wrap_sub(i, 1)]) / fZec0[i]) : fZec8[i])) + ((iSlow14) ? ((iSlow16) ? fConst4 * (fZec12[i] * (fYec11[i] - fYec11[faust_wrap_sub(i, 1)]) / fZec2[i]) : fConst3 * (fZec10[i] * (fYec8[i] - fYec8[faust_wrap_sub(i, 1)]) / fZec2[i])) : ((iSlow15) ? fConst2 * (fZec9[i] * (fYec6[i] - fYec6[faust_wrap_sub(i, 1)]) / fZec2[i]) : fZec14[i])) + ((iSlow14) ? ((iSlow16) ? fConst4 * (fZec12[i] * (fYec17[i] - fYec17[faust_wrap_sub(i, 1)]) / fZec4[i]) : fConst3 * (fZec10[i] * (fYec14[i] - fYec14[faust_wrap_sub(i, 1)]) / fZec4[i])) : ((iSlow15) ? fConst2 * (fZec9[i] * (fYec12[i] - fYec12[faust_wrap_sub(i, 1)]) / fZec4[i]) : fZec17[i])))));
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec14[i] = fRec14[faust_wrap_sub(i, 1)] * fSlow9 + std::fabs(2.0 * fZec21[i]) * fSlow18;
			}
			/* Post code */
			for (int j53 = 0; j53 < 4; j53 = faust_wrap_add(j53, 1)) {
				fRec14_perm[j53] = fRec14_tmp[faust_wrap_add(vsize, j53)];
			}
			/* Recursive loop 46 */
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
			...
			for (int j55 = 0; j55 < 4; j55 = faust_wrap_add(j55, 1)) {
				iYec18_perm[j55] = iYec18_tmp[faust_wrap_add(vsize, j55)];
			}
			/* Recursive loop 48 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				iRec15[i] = std::max<int>(faust_wrap_mul(iSlow19, iYec18[i] < iYec18[faust_wrap_sub(i, 1)]), faust_wrap_add(iRec15[faust_wrap_sub(i, 1)], -1));
			}
			/* Post code */
			for (int j57 = 0; j57 < 4; j57 = faust_wrap_add(j57, 1)) {
				iRec15_perm[j57] = iRec15_tmp[faust_wrap_add(vsize, j57)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec23[i] = ((fRec11[faust_wrap_sub(i, 1)] > fZec22[i]) ? fSlow22 : fSlow21);
				fRec12[i] = fRec12[faust_wrap_sub(i, 1)] * fZec23[i] + fZec22[i] * (1.0 - fZec23[i]);
				fRec11[i] = fRec12[i];
			}
			/* Post code */
			for (int j59 = 0; j59 < 4; j59 = faust_wrap_add(j59, 1)) {
				fRec12_perm[j59] = fRec12_tmp[faust_wrap_add(vsize, j59)];
			}
			for (int j61 = 0; j61 < 4; j61 = faust_wrap_add(j61, 1)) {
				fRec11_perm[j61] = fRec11_tmp[faust_wrap_add(vsize, j61)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec3[i] = fRec3[faust_wrap_sub(i, 1)] * fSlow9 + fSlow18 * std::fabs(fZec21[i] + std::fabs(fZec24[i]));
			}
			/* Post code */
			for (int j63 = 0; j63 < 4; j63 = faust_wrap_add(j63, 1)) {
				fRec3_perm[j63] = fRec3_tmp[faust_wrap_add(vsize, j63)];
			}
			/* Recursive loop 53 */
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
			...
			for (int j65 = 0; j65 < 4; j65 = faust_wrap_add(j65, 1)) {
				iYec19_perm[j65] = iYec19_tmp[faust_wrap_add(vsize, j65)];
			}
			/* Recursive loop 55 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				iRec16[i] = std::max<int>(faust_wrap_mul(iSlow19, iYec19[i] < iYec19[faust_wrap_sub(i, 1)]), faust_wrap_add(iRec16[faust_wrap_sub(i, 1)], -1));
			}
			/* Post code */
			for (int j67 = 0; j67 < 4; j67 = faust_wrap_add(j67, 1)) {
				iRec16_perm[j67] = iRec16_tmp[faust_wrap_add(vsize, j67)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec26[i] = ((fRec0[faust_wrap_sub(i, 1)] > fZec25[i]) ? fSlow22 : fSlow21);
				fRec1[i] = fRec1[faust_wrap_sub(i, 1)] * fZec26[i] + fZec25[i] * (1.0 - fZec26[i]);
				fRec0[i] = fRec1[i];
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec32[i] = ((fRec18[faust_wrap_sub(i, 1)] > fZec31[i]) ? fSlow27 : fSlow25);
				fRec19[i] = fRec19[faust_wrap_sub(i, 1)] * fZec32[i] + fZec31[i] * (1.0 - fZec32[i]);
				fRec18[i] = fRec19[i];
			}
			/* Post code */
			for (int j73 = 0; j73 < 4; j73 = faust_wrap_add(j73, 1)) {
				fRec19_perm[j73] = fRec19_tmp[faust_wrap_add(vsize, j73)];
			}
			for (int j75 = 0; j75 < 4; j75 = faust_wrap_add(j75, 1)) {
				fRec18_perm[j75] = fRec18_tmp[faust_wrap_add(vsize, j75)];
			}
			/* Recursive loop 64 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec17[i] = fRec17[faust_wrap_sub(i, 1)] * fSlow28 + fSlow29 * std::max<double>(2e+01 * std::log10(fRec18[i]) - fSlow30, 0.0) * fSlow31;
			}
			/* Post code */
			for (int j77 = 0; j77 < 4; j77 = faust_wrap_add(j77, 1)) {
				fRec17_perm[j77] = fRec17_tmp[faust_wrap_add(vsize, j77)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec37[i] = ((fRec21[faust_wrap_sub(i, 1)] > fZec36[i]) ? fSlow27 : fSlow25);
				fRec22[i] = fRec22[faust_wrap_sub(i, 1)] * fZec37[i] + fZec36[i] * (1.0 - fZec37[i]);
				fRec21[i] = fRec22[i];
			}
			/* Post code */
			for (int j79 = 0; j79 < 4; j79 = faust_wrap_add(j79, 1)) {
				fRec22_perm[j79] = fRec22_tmp[faust_wrap_add(vsize, j79)];
			}
			for (int j81 = 0; j81 < 4; j81 = faust_wrap_add(j81, 1)) {
				fRec21_perm[j81] = fRec21_tmp[faust_wrap_add(vsize, j81)];
			}
			/* Recursive loop 70 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec20[i] = fSlow28 * fRec20[faust_wrap_sub(i, 1)] + fSlow29 * std::max<double>(2e+01 * std::log10(fRec21[i]) - fSlow30, 0.0) * fSlow31;
			}
			/* Post code */
			for (int j83 = 0; j83 < 4; j83 = faust_wrap_add(j83, 1)) {
				fRec20_perm[j83] = fRec20_tmp[faust_wrap_add(vsize, j83)];
			}
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec26[i] = fZec38[i] - fConst8 * (fConst9 * fRec26[faust_wrap_sub(i, 2)] + fConst12 * fRec26[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec25[i] = fConst8 * (fConst14 * fRec26[i] + fConst15 * fRec26[faust_wrap_sub(i, 1)] + fConst14 * fRec26[faust_wrap_sub(i, 2)]) - fConst16 * (fConst17 * fRec25[faust_wrap_sub(i, 2)] + fConst18 * fRec25[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec24[i] = fConst16 * (fConst20 * fRec25[i] + fConst21 * fRec25[faust_wrap_sub(i, 1)] + fConst20 * fRec25[faust_wrap_sub(i, 2)]) - fConst22 * (fConst23 * fRec24[faust_wrap_sub(i, 2)] + fConst24 * fRec24[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec23[i] = fRec23[faust_wrap_sub(i, 1)] * fSlow34 + std::fabs(fConst22 * (fConst27 * fRec24[i] + fConst28 * fRec24[faust_wrap_sub(i, 1)] + fConst27 * fRec24[faust_wrap_sub(i, 2)])) * fSlow35;
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec33[i] = fZec38[i] - fConst29 * (fConst30 * fRec33[faust_wrap_sub(i, 2)] + fConst31 * fRec33[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec32[i] = fConst29 * (fConst33 * fRec33[i] + fConst34 * fRec33[faust_wrap_sub(i, 1)] + fConst33 * fRec33[faust_wrap_sub(i, 2)]) - fConst35 * (fConst36 * fRec32[faust_wrap_sub(i, 2)] + fConst37 * fRec32[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec31[i] = fConst35 * (fConst38 * fRec32[i] + fConst39 * fRec32[faust_wrap_sub(i, 1)] + fConst38 * fRec32[faust_wrap_sub(i, 2)]) - fConst40 * (fConst41 * fRec31[faust_wrap_sub(i, 2)] + fConst42 * fRec31[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec39[i] = fConst40 * (fConst43 * fRec31[i] + fConst44 * fRec31[faust_wrap_sub(i, 1)] + fConst43 * fRec31[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 80 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec30[i] = fZec39[i] - fConst47 * (fConst48 * fRec30[faust_wrap_sub(i, 2)] + fConst51 * fRec30[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec29[i] = fConst47 * (fConst53 * fRec30[i] + fConst54 * fRec30[faust_wrap_sub(i, 1)] + fConst53 * fRec30[faust_wrap_sub(i, 2)]) - fConst55 * (fConst56 * fRec29[faust_wrap_sub(i, 2)] + fConst57 * fRec29[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec28[i] = fConst55 * (fConst59 * fRec29[i] + fConst60 * fRec29[faust_wrap_sub(i, 1)] + fConst59 * fRec29[faust_wrap_sub(i, 2)]) - fConst61 * (fConst62 * fRec28[faust_wrap_sub(i, 2)] + fConst63 * fRec28[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec27[i] = fSlow34 * fRec27[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst61 * (fConst65 * fRec28[i] + fConst66 * fRec28[faust_wrap_sub(i, 1)] + fConst65 * fRec28[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec40[i] = fZec39[i] - fConst67 * (fConst68 * fRec40[faust_wrap_sub(i, 2)] + fConst69 * fRec40[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec39[i] = fConst67 * (fConst71 * fRec40[i] + fConst72 * fRec40[faust_wrap_sub(i, 1)] + fConst71 * fRec40[faust_wrap_sub(i, 2)]) - fConst73 * (fConst74 * fRec39[faust_wrap_sub(i, 2)] + fConst75 * fRec39[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec38[i] = fConst73 * (fConst76 * fRec39[i] + fConst77 * fRec39[faust_wrap_sub(i, 1)] + fConst76 * fRec39[faust_wrap_sub(i, 2)]) - fConst78 * (fConst79 * fRec38[faust_wrap_sub(i, 2)] + fConst80 * fRec38[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec40[i] = fConst78 * (fConst81 * fRec38[i] + fConst82 * fRec38[faust_wrap_sub(i, 1)] + fConst81 * fRec38[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 88 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec37[i] = fZec40[i] - fConst85 * (fConst86 * fRec37[faust_wrap_sub(i, 2)] + fConst89 * fRec37[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec36[i] = fConst85 * (fConst91 * fRec37[i] + fConst92 * fRec37[faust_wrap_sub(i, 1)] + fConst91 * fRec37[faust_wrap_sub(i, 2)]) - fConst93 * (fConst94 * fRec36[faust_wrap_sub(i, 2)] + fConst95 * fRec36[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec35[i] = fConst93 * (fConst97 * fRec36[i] + fConst98 * fRec36[faust_wrap_sub(i, 1)] + fConst97 * fRec36[faust_wrap_sub(i, 2)]) - fConst99 * (fConst100 * fRec35[faust_wrap_sub(i, 2)] + fConst101 * fRec35[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec34[i] = fSlow34 * fRec34[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst99 * (fConst103 * fRec35[i] + fConst104 * fRec35[faust_wrap_sub(i, 1)] + fConst103 * fRec35[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec47[i] = fZec40[i] - fConst105 * (fConst106 * fRec47[faust_wrap_sub(i, 2)] + fConst107 * fRec47[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec46[i] = fConst105 * (fConst109 * fRec47[i] + fConst110 * fRec47[faust_wrap_sub(i, 1)] + fConst109 * fRec47[faust_wrap_sub(i, 2)]) - fConst111 * (fConst112 * fRec46[faust_wrap_sub(i, 2)] + fConst113 * fRec46[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec45[i] = fConst111 * (fConst114 * fRec46[i] + fConst115 * fRec46[faust_wrap_sub(i, 1)] + fConst114 * fRec46[faust_wrap_sub(i, 2)]) - fConst116 * (fConst117 * fRec45[faust_wrap_sub(i, 2)] + fConst118 * fRec45[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec41[i] = fConst116 * (fConst119 * fRec45[i] + fConst120 * fRec45[faust_wrap_sub(i, 1)] + fConst119 * fRec45[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 96 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec44[i] = fZec41[i] - fConst123 * (fConst124 * fRec44[faust_wrap_sub(i, 2)] + fConst127 * fRec44[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec43[i] = fConst123 * (fConst129 * fRec44[i] + fConst130 * fRec44[faust_wrap_sub(i, 1)] + fConst129 * fRec44[faust_wrap_sub(i, 2)]) - fConst131 * (fConst132 * fRec43[faust_wrap_sub(i, 2)] + fConst133 * fRec43[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec42[i] = fConst131 * (fConst135 * fRec43[i] + fConst136 * fRec43[faust_wrap_sub(i, 1)] + fConst135 * fRec43[faust_wrap_sub(i, 2)]) - fConst137 * (fConst138 * fRec42[faust_wrap_sub(i, 2)] + fConst139 * fRec42[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec41[i] = fSlow34 * fRec41[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst137 * (fConst141 * fRec42[i] + fConst142 * fRec42[faust_wrap_sub(i, 1)] + fConst141 * fRec42[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec54[i] = fZec41[i] - fConst143 * (fConst144 * fRec54[faust_wrap_sub(i, 2)] + fConst145 * fRec54[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec53[i] = fConst143 * (fConst147 * fRec54[i] + fConst148 * fRec54[faust_wrap_sub(i, 1)] + fConst147 * fRec54[faust_wrap_sub(i, 2)]) - fConst149 * (fConst150 * fRec53[faust_wrap_sub(i, 2)] + fConst151 * fRec53[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec52[i] = fConst149 * (fConst152 * fRec53[i] + fConst153 * fRec53[faust_wrap_sub(i, 1)] + fConst152 * fRec53[faust_wrap_sub(i, 2)]) - fConst154 * (fConst155 * fRec52[faust_wrap_sub(i, 2)] + fConst156 * fRec52[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec42[i] = fConst154 * (fConst157 * fRec52[i] + fConst158 * fRec52[faust_wrap_sub(i, 1)] + fConst157 * fRec52[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 104 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec51[i] = fZec42[i] - fConst161 * (fConst162 * fRec51[faust_wrap_sub(i, 2)] + fConst165 * fRec51[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec50[i] = fConst161 * (fConst167 * fRec51[i] + fConst168 * fRec51[faust_wrap_sub(i, 1)] + fConst167 * fRec51[faust_wrap_sub(i, 2)]) - fConst169 * (fConst170 * fRec50[faust_wrap_sub(i, 2)] + fConst171 * fRec50[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec49[i] = fConst169 * (fConst173 * fRec50[i] + fConst174 * fRec50[faust_wrap_sub(i, 1)] + fConst173 * fRec50[faust_wrap_sub(i, 2)]) - fConst175 * (fConst176 * fRec49[faust_wrap_sub(i, 2)] + fConst177 * fRec49[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec48[i] = fSlow34 * fRec48[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst175 * (fConst179 * fRec49[i] + fConst180 * fRec49[faust_wrap_sub(i, 1)] + fConst179 * fRec49[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec61[i] = fZec42[i] - fConst181 * (fConst182 * fRec61[faust_wrap_sub(i, 2)] + fConst183 * fRec61[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec60[i] = fConst181 * (fConst185 * fRec61[i] + fConst186 * fRec61[faust_wrap_sub(i, 1)] + fConst185 * fRec61[faust_wrap_sub(i, 2)]) - fConst187 * (fConst188 * fRec60[faust_wrap_sub(i, 2)] + fConst189 * fRec60[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec59[i] = fConst187 * (fConst190 * fRec60[i] + fConst191 * fRec60[faust_wrap_sub(i, 1)] + fConst190 * fRec60[faust_wrap_sub(i, 2)]) - fConst192 * (fConst193 * fRec59[faust_wrap_sub(i, 2)] + fConst194 * fRec59[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec43[i] = fConst192 * (fConst195 * fRec59[i] + fConst196 * fRec59[faust_wrap_sub(i, 1)] + fConst195 * fRec59[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 112 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec58[i] = fZec43[i] - fConst199 * (fConst200 * fRec58[faust_wrap_sub(i, 2)] + fConst203 * fRec58[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec57[i] = fConst199 * (fConst205 * fRec58[i] + fConst206 * fRec58[faust_wrap_sub(i, 1)] + fConst205 * fRec58[faust_wrap_sub(i, 2)]) - fConst207 * (fConst208 * fRec57[faust_wrap_sub(i, 2)] + fConst209 * fRec57[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec56[i] = fConst207 * (fConst211 * fRec57[i] + fConst212 * fRec57[faust_wrap_sub(i, 1)] + fConst211 * fRec57[faust_wrap_sub(i, 2)]) - fConst213 * (fConst214 * fRec56[faust_wrap_sub(i, 2)] + fConst215 * fRec56[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec55[i] = fSlow34 * fRec55[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst213 * (fConst217 * fRec56[i] + fConst218 * fRec56[faust_wrap_sub(i, 1)] + fConst217 * fRec56[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec68[i] = fZec43[i] - fConst219 * (fConst220 * fRec68[faust_wrap_sub(i, 2)] + fConst221 * fRec68[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec67[i] = fConst219 * (fConst223 * fRec68[i] + fConst224 * fRec68[faust_wrap_sub(i, 1)] + fConst223 * fRec68[faust_wrap_sub(i, 2)]) - fConst225 * (fConst226 * fRec67[faust_wrap_sub(i, 2)] + fConst227 * fRec67[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec66[i] = fConst225 * (fConst228 * fRec67[i] + fConst229 * fRec67[faust_wrap_sub(i, 1)] + fConst228 * fRec67[faust_wrap_sub(i, 2)]) - fConst230 * (fConst231 * fRec66[faust_wrap_sub(i, 2)] + fConst232 * fRec66[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec44[i] = fConst230 * (fConst233 * fRec66[i] + fConst234 * fRec66[faust_wrap_sub(i, 1)] + fConst233 * fRec66[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 120 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec65[i] = fZec44[i] - fConst237 * (fConst238 * fRec65[faust_wrap_sub(i, 2)] + fConst241 * fRec65[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec64[i] = fConst237 * (fConst243 * fRec65[i] + fConst244 * fRec65[faust_wrap_sub(i, 1)] + fConst243 * fRec65[faust_wrap_sub(i, 2)]) - fConst245 * (fConst246 * fRec64[faust_wrap_sub(i, 2)] + fConst247 * fRec64[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec63[i] = fConst245 * (fConst249 * fRec64[i] + fConst250 * fRec64[faust_wrap_sub(i, 1)] + fConst249 * fRec64[faust_wrap_sub(i, 2)]) - fConst251 * (fConst252 * fRec63[faust_wrap_sub(i, 2)] + fConst253 * fRec63[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec62[i] = fSlow34 * fRec62[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst251 * (fConst255 * fRec63[i] + fConst256 * fRec63[faust_wrap_sub(i, 1)] + fConst255 * fRec63[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec75[i] = fZec44[i] - fConst257 * (fConst258 * fRec75[faust_wrap_sub(i, 2)] + fConst259 * fRec75[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec74[i] = fConst257 * (fConst261 * fRec75[i] + fConst262 * fRec75[faust_wrap_sub(i, 1)] + fConst261 * fRec75[faust_wrap_sub(i, 2)]) - fConst263 * (fConst264 * fRec74[faust_wrap_sub(i, 2)] + fConst265 * fRec74[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec73[i] = fConst263 * (fConst266 * fRec74[i] + fConst267 * fRec74[faust_wrap_sub(i, 1)] + fConst266 * fRec74[faust_wrap_sub(i, 2)]) - fConst268 * (fConst269 * fRec73[faust_wrap_sub(i, 2)] + fConst270 * fRec73[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec45[i] = fConst268 * (fConst271 * fRec73[i] + fConst272 * fRec73[faust_wrap_sub(i, 1)] + fConst271 * fRec73[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 128 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec72[i] = fZec45[i] - fConst275 * (fConst276 * fRec72[faust_wrap_sub(i, 2)] + fConst279 * fRec72[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec71[i] = fConst275 * (fConst281 * fRec72[i] + fConst282 * fRec72[faust_wrap_sub(i, 1)] + fConst281 * fRec72[faust_wrap_sub(i, 2)]) - fConst283 * (fConst284 * fRec71[faust_wrap_sub(i, 2)] + fConst285 * fRec71[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec70[i] = fConst283 * (fConst287 * fRec71[i] + fConst288 * fRec71[faust_wrap_sub(i, 1)] + fConst287 * fRec71[faust_wrap_sub(i, 2)]) - fConst289 * (fConst290 * fRec70[faust_wrap_sub(i, 2)] + fConst291 * fRec70[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec69[i] = fSlow34 * fRec69[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst289 * (fConst293 * fRec70[i] + fConst294 * fRec70[faust_wrap_sub(i, 1)] + fConst293 * fRec70[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec82[i] = fZec45[i] - fConst295 * (fConst296 * fRec82[faust_wrap_sub(i, 2)] + fConst297 * fRec82[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec81[i] = fConst295 * (fConst299 * fRec82[i] + fConst300 * fRec82[faust_wrap_sub(i, 1)] + fConst299 * fRec82[faust_wrap_sub(i, 2)]) - fConst301 * (fConst302 * fRec81[faust_wrap_sub(i, 2)] + fConst303 * fRec81[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec80[i] = fConst301 * (fConst304 * fRec81[i] + fConst305 * fRec81[faust_wrap_sub(i, 1)] + fConst304 * fRec81[faust_wrap_sub(i, 2)]) - fConst306 * (fConst307 * fRec80[faust_wrap_sub(i, 2)] + fConst308 * fRec80[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec46[i] = fConst306 * (fConst309 * fRec80[i] + fConst310 * fRec80[faust_wrap_sub(i, 1)] + fConst309 * fRec80[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 136 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec79[i] = fZec46[i] - fConst313 * (fConst314 * fRec79[faust_wrap_sub(i, 2)] + fConst317 * fRec79[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec78[i] = fConst313 * (fConst319 * fRec79[i] + fConst320 * fRec79[faust_wrap_sub(i, 1)] + fConst319 * fRec79[faust_wrap_sub(i, 2)]) - fConst321 * (fConst322 * fRec78[faust_wrap_sub(i, 2)] + fConst323 * fRec78[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec77[i] = fConst321 * (fConst325 * fRec78[i] + fConst326 * fRec78[faust_wrap_sub(i, 1)] + fConst325 * fRec78[faust_wrap_sub(i, 2)]) - fConst327 * (fConst328 * fRec77[faust_wrap_sub(i, 2)] + fConst329 * fRec77[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec76[i] = fSlow34 * fRec76[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst327 * (fConst331 * fRec77[i] + fConst332 * fRec77[faust_wrap_sub(i, 1)] + fConst331 * fRec77[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec89[i] = fZec46[i] - fConst333 * (fConst334 * fRec89[faust_wrap_sub(i, 2)] + fConst335 * fRec89[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec88[i] = fConst333 * (fConst337 * fRec89[i] + fConst338 * fRec89[faust_wrap_sub(i, 1)] + fConst337 * fRec89[faust_wrap_sub(i, 2)]) - fConst339 * (fConst340 * fRec88[faust_wrap_sub(i, 2)] + fConst341 * fRec88[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec87[i] = fConst339 * (fConst342 * fRec88[i] + fConst343 * fRec88[faust_wrap_sub(i, 1)] + fConst342 * fRec88[faust_wrap_sub(i, 2)]) - fConst344 * (fConst345 * fRec87[faust_wrap_sub(i, 2)] + fConst346 * fRec87[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec47[i] = fConst344 * (fConst347 * fRec87[i] + fConst348 * fRec87[faust_wrap_sub(i, 1)] + fConst347 * fRec87[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 144 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec86[i] = fZec47[i] - fConst351 * (fConst352 * fRec86[faust_wrap_sub(i, 2)] + fConst355 * fRec86[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec85[i] = fConst351 * (fConst357 * fRec86[i] + fConst358 * fRec86[faust_wrap_sub(i, 1)] + fConst357 * fRec86[faust_wrap_sub(i, 2)]) - fConst359 * (fConst360 * fRec85[faust_wrap_sub(i, 2)] + fConst361 * fRec85[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec84[i] = fConst359 * (fConst363 * fRec85[i] + fConst364 * fRec85[faust_wrap_sub(i, 1)] + fConst363 * fRec85[faust_wrap_sub(i, 2)]) - fConst365 * (fConst366 * fRec84[faust_wrap_sub(i, 2)] + fConst367 * fRec84[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec83[i] = fSlow34 * fRec83[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst365 * (fConst369 * fRec84[i] + fConst370 * fRec84[faust_wrap_sub(i, 1)] + fConst369 * fRec84[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec96[i] = fZec47[i] - fConst371 * (fConst372 * fRec96[faust_wrap_sub(i, 2)] + fConst373 * fRec96[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec95[i] = fConst371 * (fConst375 * fRec96[i] + fConst376 * fRec96[faust_wrap_sub(i, 1)] + fConst375 * fRec96[faust_wrap_sub(i, 2)]) - fConst377 * (fConst378 * fRec95[faust_wrap_sub(i, 2)] + fConst379 * fRec95[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec94[i] = fConst377 * (fConst380 * fRec95[i] + fConst381 * fRec95[faust_wrap_sub(i, 1)] + fConst380 * fRec95[faust_wrap_sub(i, 2)]) - fConst382 * (fConst383 * fRec94[faust_wrap_sub(i, 2)] + fConst384 * fRec94[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec48[i] = fConst382 * (fConst385 * fRec94[i] + fConst386 * fRec94[faust_wrap_sub(i, 1)] + fConst385 * fRec94[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 152 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec93[i] = fZec48[i] - fConst389 * (fConst390 * fRec93[faust_wrap_sub(i, 2)] + fConst393 * fRec93[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec92[i] = fConst389 * (fConst395 * fRec93[i] + fConst396 * fRec93[faust_wrap_sub(i, 1)] + fConst395 * fRec93[faust_wrap_sub(i, 2)]) - fConst397 * (fConst398 * fRec92[faust_wrap_sub(i, 2)] + fConst399 * fRec92[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec91[i] = fConst397 * (fConst401 * fRec92[i] + fConst402 * fRec92[faust_wrap_sub(i, 1)] + fConst401 * fRec92[faust_wrap_sub(i, 2)]) - fConst403 * (fConst404 * fRec91[faust_wrap_sub(i, 2)] + fConst405 * fRec91[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec90[i] = fSlow34 * fRec90[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst403 * (fConst407 * fRec91[i] + fConst408 * fRec91[faust_wrap_sub(i, 1)] + fConst407 * fRec91[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec103[i] = fZec48[i] - fConst409 * (fConst410 * fRec103[faust_wrap_sub(i, 2)] + fConst411 * fRec103[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec102[i] = fConst409 * (fConst413 * fRec103[i] + fConst414 * fRec103[faust_wrap_sub(i, 1)] + fConst413 * fRec103[faust_wrap_sub(i, 2)]) - fConst415 * (fConst416 * fRec102[faust_wrap_sub(i, 2)] + fConst417 * fRec102[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec101[i] = fConst415 * (fConst418 * fRec102[i] + fConst419 * fRec102[faust_wrap_sub(i, 1)] + fConst418 * fRec102[faust_wrap_sub(i, 2)]) - fConst420 * (fConst421 * fRec101[faust_wrap_sub(i, 2)] + fConst422 * fRec101[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec49[i] = fConst420 * (fConst423 * fRec101[i] + fConst424 * fRec101[faust_wrap_sub(i, 1)] + fConst423 * fRec101[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 160 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec100[i] = fZec49[i] - fConst427 * (fConst428 * fRec100[faust_wrap_sub(i, 2)] + fConst431 * fRec100[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec99[i] = fConst427 * (fConst433 * fRec100[i] + fConst434 * fRec100[faust_wrap_sub(i, 1)] + fConst433 * fRec100[faust_wrap_sub(i, 2)]) - fConst435 * (fConst436 * fRec99[faust_wrap_sub(i, 2)] + fConst437 * fRec99[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec98[i] = fConst435 * (fConst439 * fRec99[i] + fConst440 * fRec99[faust_wrap_sub(i, 1)] + fConst439 * fRec99[faust_wrap_sub(i, 2)]) - fConst441 * (fConst442 * fRec98[faust_wrap_sub(i, 2)] + fConst443 * fRec98[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec97[i] = fSlow34 * fRec97[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst441 * (fConst445 * fRec98[i] + fConst446 * fRec98[faust_wrap_sub(i, 1)] + fConst445 * fRec98[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec110[i] = fZec49[i] - fConst447 * (fConst448 * fRec110[faust_wrap_sub(i, 2)] + fConst449 * fRec110[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec109[i] = fConst447 * (fConst451 * fRec110[i] + fConst452 * fRec110[faust_wrap_sub(i, 1)] + fConst451 * fRec110[faust_wrap_sub(i, 2)]) - fConst453 * (fConst454 * fRec109[faust_wrap_sub(i, 2)] + fConst455 * fRec109[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec108[i] = fConst453 * (fConst456 * fRec109[i] + fConst457 * fRec109[faust_wrap_sub(i, 1)] + fConst456 * fRec109[faust_wrap_sub(i, 2)]) - fConst458 * (fConst459 * fRec108[faust_wrap_sub(i, 2)] + fConst460 * fRec108[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec50[i] = fConst458 * (fConst461 * fRec108[i] + fConst462 * fRec108[faust_wrap_sub(i, 1)] + fConst461 * fRec108[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 168 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec107[i] = fZec50[i] - fConst465 * (fConst466 * fRec107[faust_wrap_sub(i, 2)] + fConst469 * fRec107[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec106[i] = fConst465 * (fConst471 * fRec107[i] + fConst472 * fRec107[faust_wrap_sub(i, 1)] + fConst471 * fRec107[faust_wrap_sub(i, 2)]) - fConst473 * (fConst474 * fRec106[faust_wrap_sub(i, 2)] + fConst475 * fRec106[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec105[i] = fConst473 * (fConst477 * fRec106[i] + fConst478 * fRec106[faust_wrap_sub(i, 1)] + fConst477 * fRec106[faust_wrap_sub(i, 2)]) - fConst479 * (fConst480 * fRec105[faust_wrap_sub(i, 2)] + fConst481 * fRec105[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec104[i] = fSlow34 * fRec104[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst479 * (fConst483 * fRec105[i] + fConst484 * fRec105[faust_wrap_sub(i, 1)] + fConst483 * fRec105[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec117[i] = fZec50[i] - fConst485 * (fConst486 * fRec117[faust_wrap_sub(i, 2)] + fConst487 * fRec117[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec116[i] = fConst485 * (fConst489 * fRec117[i] + fConst490 * fRec117[faust_wrap_sub(i, 1)] + fConst489 * fRec117[faust_wrap_sub(i, 2)]) - fConst491 * (fConst492 * fRec116[faust_wrap_sub(i, 2)] + fConst493 * fRec116[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec115[i] = fConst491 * (fConst494 * fRec116[i] + fConst495 * fRec116[faust_wrap_sub(i, 1)] + fConst494 * fRec116[faust_wrap_sub(i, 2)]) - fConst496 * (fConst497 * fRec115[faust_wrap_sub(i, 2)] + fConst498 * fRec115[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec51[i] = fConst496 * (fConst499 * fRec115[i] + fConst500 * fRec115[faust_wrap_sub(i, 1)] + fConst499 * fRec115[faust_wrap_sub(i, 2)]);
			}
			/* Recursive loop 176 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec114[i] = fZec51[i] - fConst503 * (fConst504 * fRec114[faust_wrap_sub(i, 2)] + fConst507 * fRec114[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec113[i] = fConst503 * (fConst509 * fRec114[i] + fConst510 * fRec114[faust_wrap_sub(i, 1)] + fConst509 * fRec114[faust_wrap_sub(i, 2)]) - fConst511 * (fConst512 * fRec113[faust_wrap_sub(i, 2)] + fConst513 * fRec113[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec112[i] = fConst511 * (fConst515 * fRec113[i] + fConst516 * fRec113[faust_wrap_sub(i, 1)] + fConst515 * fRec113[faust_wrap_sub(i, 2)]) - fConst517 * (fConst518 * fRec112[faust_wrap_sub(i, 2)] + fConst519 * fRec112[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec111[i] = fSlow34 * fRec111[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst517 * (fConst521 * fRec112[i] + fConst522 * fRec112[faust_wrap_sub(i, 1)] + fConst521 * fRec112[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec121[i] = fZec51[i] - fConst523 * (fConst524 * fRec121[faust_wrap_sub(i, 2)] + fConst525 * fRec121[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec120[i] = fConst523 * (fConst527 * fRec121[i] + fConst528 * fRec121[faust_wrap_sub(i, 1)] + fConst527 * fRec121[faust_wrap_sub(i, 2)]) - fConst529 * (fConst530 * fRec120[faust_wrap_sub(i, 2)] + fConst531 * fRec120[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec119[i] = fConst529 * (fConst532 * fRec120[i] + fConst533 * fRec120[faust_wrap_sub(i, 1)] + fConst532 * fRec120[faust_wrap_sub(i, 2)]) - fConst534 * (fConst535 * fRec119[faust_wrap_sub(i, 2)] + fConst536 * fRec119[faust_wrap_sub(i, 1)]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fRec118[i] = fSlow34 * fRec118[faust_wrap_sub(i, 1)] + fSlow35 * std::fabs(fConst534 * (fConst537 * fRec119[i] + fConst538 * fRec119[faust_wrap_sub(i, 1)] + fConst537 * fRec119[faust_wrap_sub(i, 2)]));
			}
			/* Post code */
