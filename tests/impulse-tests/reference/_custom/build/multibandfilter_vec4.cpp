	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (vindex = 0; vindex <= (faust_wrap_sub(count, 4)); vindex = faust_wrap_add(vindex, 4)) {
			...
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec0[i] = fSlow5 * fRec9[faust_wrap_sub(i, 1)];
				fRec9[i] = static_cast<double>(input0[i]) - fSlow3 * (fSlow4 * fRec9[faust_wrap_sub(i, 2)] + fZec0[i]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec1[i] = fSlow14 * fRec8[faust_wrap_sub(i, 1)];
				fRec8[i] = fSlow3 * (fZec0[i] + fSlow7 * fRec9[i] + fSlow8 * fRec9[faust_wrap_sub(i, 2)]) - fSlow12 * (fSlow13 * fRec8[faust_wrap_sub(i, 2)] + fZec1[i]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec2[i] = fSlow23 * fRec7[faust_wrap_sub(i, 1)];
				fRec7[i] = fSlow12 * (fZec1[i] + fSlow16 * fRec8[i] + fSlow17 * fRec8[faust_wrap_sub(i, 2)]) - fSlow21 * (fSlow22 * fRec7[faust_wrap_sub(i, 2)] + fZec2[i]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec3[i] = fSlow32 * fRec6[faust_wrap_sub(i, 1)];
				fRec6[i] = fSlow21 * (fZec2[i] + fSlow25 * fRec7[i] + fSlow26 * fRec7[faust_wrap_sub(i, 2)]) - fSlow30 * (fSlow31 * fRec6[faust_wrap_sub(i, 2)] + fZec3[i]);
			}
			/* Post code */
			for (int j7 = 0; j7 < 4; j7 = faust_wrap_add(j7, 1)) {
				fRec6_perm[j7] = fRec6_tmp[faust_wrap_add(vsize, j7)];
			}
			/* Recursive loop 4 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec4[i] = fSlow41 * fRec5[faust_wrap_sub(i, 1)];
				fRec5[i] = fSlow30 * (fZec3[i] + fSlow34 * fRec6[i] + fSlow35 * fRec6[faust_wrap_sub(i, 2)]) - fSlow39 * (fSlow40 * fRec5[faust_wrap_sub(i, 2)] + fZec4[i]);
			}
			/* Post code */
			for (int j9 = 0; j9 < 4; j9 = faust_wrap_add(j9, 1)) {
				fRec5_perm[j9] = fRec5_tmp[faust_wrap_add(vsize, j9)];
			}
			/* Recursive loop 5 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec5[i] = fSlow50 * fRec4[faust_wrap_sub(i, 1)];
				fRec4[i] = fSlow39 * (fZec4[i] + fSlow43 * fRec5[i] + fSlow44 * fRec5[faust_wrap_sub(i, 2)]) - fSlow48 * (fSlow49 * fRec4[faust_wrap_sub(i, 2)] + fZec5[i]);
			}
			/* Post code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec6[i] = fSlow59 * fRec3[faust_wrap_sub(i, 1)];
				fRec3[i] = fSlow48 * (fZec5[i] + fSlow52 * fRec4[i] + fSlow53 * fRec4[faust_wrap_sub(i, 2)]) - fSlow57 * (fSlow58 * fRec3[faust_wrap_sub(i, 2)] + fZec6[i]);
			}
			/* Post code */
			for (int j13 = 0; j13 < 4; j13 = faust_wrap_add(j13, 1)) {
				fRec3_perm[j13] = fRec3_tmp[faust_wrap_add(vsize, j13)];
			}
			/* Recursive loop 7 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec7[i] = fSlow68 * fRec2[faust_wrap_sub(i, 1)];
				fRec2[i] = fSlow57 * (fZec6[i] + fSlow61 * fRec3[i] + fSlow62 * fRec3[faust_wrap_sub(i, 2)]) - fSlow66 * (fSlow67 * fRec2[faust_wrap_sub(i, 2)] + fZec7[i]);
			}
			/* Post code */
			for (int j15 = 0; j15 < 4; j15 = faust_wrap_add(j15, 1)) {
				fRec2_perm[j15] = fRec2_tmp[faust_wrap_add(vsize, j15)];
			}
			/* Recursive loop 8 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec8[i] = fSlow77 * fRec1[faust_wrap_sub(i, 1)];
				fRec1[i] = fSlow66 * (fZec7[i] + fSlow70 * fRec2[i] + fSlow71 * fRec2[faust_wrap_sub(i, 2)]) - fSlow75 * (fSlow76 * fRec1[faust_wrap_sub(i, 2)] + fZec8[i]);
			}
			/* Post code */
			for (int j17 = 0; j17 < 4; j17 = faust_wrap_add(j17, 1)) {
				fRec1_perm[j17] = fRec1_tmp[faust_wrap_add(vsize, j17)];
			}
			/* Recursive loop 9 */
			/* Pre code */
			...
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				fZec9[i] = fSlow86 * fRec0[faust_wrap_sub(i, 1)];
				fRec0[i] = fSlow75 * (fZec8[i] + fSlow79 * fRec1[i] + fSlow80 * fRec1[faust_wrap_sub(i, 2)]) - fSlow84 * (fSlow85 * fRec0[faust_wrap_sub(i, 2)] + fZec9[i]);
			}
			/* Post code */
			for (int j19 = 0; j19 < 4; j19 = faust_wrap_add(j19, 1)) {
				fRec0_perm[j19] = fRec0_tmp[faust_wrap_add(vsize, j19)];
			}
			/* Vectorizable loop 10 */
			/* Compute code */
			for (int i = 0; i < vsize; i = faust_wrap_add(i, 1)) {
				output0[i] = static_cast<FAUSTFLOAT>(fSlow84 * (fZec9[i] + fSlow88 * fRec0[i] + fSlow89 * fRec0[faust_wrap_sub(i, 2)]));
			}
		}
		/* Remaining frames */
		if (vindex < count) {
