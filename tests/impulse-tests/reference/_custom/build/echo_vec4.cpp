...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		fHslider0 = static_cast<FAUSTFLOAT>(98.4);
		fHslider1 = static_cast<FAUSTFLOAT>(8.1);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("feedback", &fHslider0, FAUSTFLOAT(98.4), FAUSTFLOAT(0.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.1));
		ui_interface->addHorizontalSlider("millisecond", &fHslider1, FAUSTFLOAT(8.1), FAUSTFLOAT(0.0), FAUSTFLOAT(1e+03), FAUSTFLOAT(0.1));
