...
impl ButtonUI {
    fn set_button_parameters_to(&self, dsp: &mut dyn FaustDsp<T = f32>, value: f32) {
...
type Dsp32 = dyn FaustDsp<T = f32>;

fn print_header(mut dsp: Box<Dsp32>, num_total_samples: usize, output_file: &mut File) {
