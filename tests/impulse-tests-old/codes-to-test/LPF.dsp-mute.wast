...
(module
	...
	(data (i32.const 0) "{\"name\":\"LPF.dsp-mute\",\"version\":\"2.5.15\",\"options\":\"wast-i, -double -ftz 0\",\"size\":\"64\",\"inputs\":\"1\",\"outputs\":\"1\",\"meta\":[{\"math.lib/author\":\"GRAME\"},{\"math.lib/copyright\":\"GRAME\"},{\"math.lib/deprecated\":\"This library is deprecated and is not maintained anymore. It will be removed in August 2017.\"},{\"math.lib/license\":\"LGPL with exception\"},{\"math.lib/name\":\"Math Library\"},{\"math.lib/version\":\"1.0\"},{\"maxmsp.lib/author\":\"GRAME\"},{\"maxmsp.lib/copyright\":\"GRAME\"},{\"maxmsp.lib/license\":\"LGPL\"},{\"maxmsp.lib/name\":\"MaxMSP compatibility Library\"},{\"maxmsp.lib/version\":\"1.1\"},{\"music.lib/author\":\"GRAME\"},{\"music.lib/copyright\":\"GRAME\"},{\"music.lib/license\":\"LGPL with exception\"},{\"music.lib/name\":\"Music Library\"},{\"music.lib/version\":\"1.0\"},{\"name\":\"LPF.dsp-mute\"}],\"ui\":[{\"type\":\"vgroup\",\"label\":\"LPF.dsp-mute\",\"items\":[{\"type\":\"hslider\",\"label\":\"Freq\",\"address\":\"/LPF.dsp-mute/Freq\",\"index\":\"16\",\"init\":\"1000\",\"min\":\"100\",\"max\":\"10000\",\"step\":\"1\"},{\"type\":\"hslider\",\"label\":\"Q\",\"address\":\"/LPF.dsp-mute/Q\",\"index\":\"32\",\"init\":\"1\",\"min\":\"0.01\",\"max\":\"100\",\"step\":\"0.01\"},{\"type\":\"checkbox\",\"label\":\"fakedisable  0\",\"address\":\"/LPF.dsp-mute/fakedisable__0\",\"index\":\"24\"}]}]}")
	...
	(func $compute (param $dsp i32) (param $count i32) (param $inputs i32) (param $outputs i32)
		...
		(set_local $fSlow2 (f64.mul (f64.const 0.5) (f64.div (call $sin (get_local $fSlow0)) (f64.max (f64.const 0.001) (f64.load offset=32 (i32.const 0))))))
		(set_local $fSlow3 (f64.add (get_local $fSlow2) (f64.const 1.)))
		(set_local $fSlow4 (f64.div (f64.mul (f64.sub (f64.const 1.) (get_local $fSlow1)) (f64.sub (f64.const 1.) (f64.load offset=24 (i32.const 0)))) (get_local $fSlow3)))
		...
		(loop $for-in-i 
			(block $for-out-i 
				...
				(f64.store (i32.add (get_local $output0) (get_local $i)) (f64.mul (get_local $fSlow4) (f64.add (f64.add (f64.load offset=48 (i32.const 0)) (f64.mul (f64.const 0.5) (f64.load offset=40 (i32.const 0)))) (f64.mul (f64.const 0.5) (f64.load offset=56 (i32.const 0))))))
