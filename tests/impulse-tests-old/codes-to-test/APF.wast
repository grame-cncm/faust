...
(module
	...
	(data (i32.const 0) "{\"name\":\"APF\",\"version\":\"2.5.15\",\"options\":\"wast-i, -double -ftz 0\",\"size\":\"56\",\"inputs\":\"1\",\"outputs\":\"1\",\"meta\":[{\"math.lib/author\":\"GRAME\"},{\"math.lib/copyright\":\"GRAME\"},{\"math.lib/deprecated\":\"This library is deprecated and is not maintained anymore. It will be removed in August 2017.\"},{\"math.lib/license\":\"LGPL with exception\"},{\"math.lib/name\":\"Math Library\"},{\"math.lib/version\":\"1.0\"},{\"maxmsp.lib/author\":\"GRAME\"},{\"maxmsp.lib/copyright\":\"GRAME\"},{\"maxmsp.lib/license\":\"LGPL\"},{\"maxmsp.lib/name\":\"MaxMSP compatibility Library\"},{\"maxmsp.lib/version\":\"1.1\"},{\"music.lib/author\":\"GRAME\"},{\"music.lib/copyright\":\"GRAME\"},{\"music.lib/license\":\"LGPL with exception\"},{\"music.lib/name\":\"Music Library\"},{\"music.lib/version\":\"1.0\"},{\"name\":\"APF\"}],\"ui\":[{\"type\":\"vgroup\",\"label\":\"APF\",\"items\":[{\"type\":\"hslider\",\"label\":\"Freq\",\"address\":\"/APF/Freq\",\"index\":\"16\",\"init\":\"1000\",\"min\":\"100\",\"max\":\"10000\",\"step\":\"1\"},{\"type\":\"hslider\",\"label\":\"Q\",\"address\":\"/APF/Q\",\"index\":\"24\",\"init\":\"1\",\"min\":\"0.01\",\"max\":\"100\",\"step\":\"0.01\"}]}]}")
	...
	(func $compute (param $dsp i32) (param $count i32) (param $inputs i32) (param $outputs i32)
		...
		(set_local $fSlow3 (f64.sub (f64.const 0.) (f64.mul (f64.const 2.) (call $cos (get_local $fSlow0)))))
		(set_local $fSlow4 (f64.sub (f64.const 1.) (get_local $fSlow1)))
		(set_local $i (i32.const 0))
		(loop $for-in-i 
			(block $for-out-i 
				(set_local $fTemp0 (f64.mul (get_local $fSlow3) (f64.load offset=40 (i32.const 0))))
				(f64.store offset=32 (i32.const 0) (f64.sub (f64.load (i32.add (get_local $input0) (get_local $i))) (f64.mul (get_local $fSlow2) (f64.add (get_local $fTemp0) (f64.mul (get_local $fSlow4) (f64.load offset=48 (i32.const 0)))))))
				(f64.store (i32.add (get_local $output0) (get_local $i)) (f64.add (f64.load offset=48 (i32.const 0)) (f64.mul (get_local $fSlow2) (f64.add (get_local $fTemp0) (f64.mul (get_local $fSlow4) (f64.load offset=32 (i32.const 0)))))))
