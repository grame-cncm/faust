...
(module
	...
	(data (i32.const 0) "{\"name\":\"echo\",\"version\":\"2.5.15\",\"options\":\"wast-i, -double -ftz 0\",\"size\":\"1048616\",\"inputs\":\"1\",\"outputs\":\"1\",\"meta\":[{\"author\":\"Grame\"},{\"copyright\":\"(c)GRAME 2006\"},{\"license\":\"BSD\"},{\"math.lib/author\":\"GRAME\"},{\"math.lib/copyright\":\"GRAME\"},{\"math.lib/deprecated\":\"This library is deprecated and is not maintained anymore. It will be removed in August 2017.\"},{\"math.lib/license\":\"LGPL with exception\"},{\"math.lib/name\":\"Math Library\"},{\"math.lib/version\":\"1.0\"},{\"music.lib/author\":\"GRAME\"},{\"music.lib/copyright\":\"GRAME\"},{\"music.lib/license\":\"LGPL with exception\"},{\"music.lib/name\":\"Music Library\"},{\"music.lib/version\":\"1.0\"},{\"name\":\"echo\"},{\"version\":\"1.0\"}],\"ui\":[{\"type\":\"vgroup\",\"label\":\"echo-simple\",\"items\":[{\"type\":\"vgroup\",\"label\":\"echo  1000\",\"items\":[{\"type\":\"hslider\",\"label\":\"feedback\",\"address\":\"/echo-simple/echo__1000/feedback\",\"index\":\"0\",\"init\":\"98.4\",\"min\":\"0\",\"max\":\"100\",\"step\":\"0.1\"},{\"type\":\"hslider\",\"label\":\"millisecond\",\"address\":\"/echo-simple/echo__1000/millisecond\",\"index\":\"24\",\"init\":\"8.1\",\"min\":\"0\",\"max\":\"1000\",\"step\":\"0.1\"}]}]}]}")
	...
	(func $instanceConstants (param $dsp i32) (param $samplingFreq i32)
		...
		(f64.store offset=16 (i32.const 0) (f64.mul (f64.const 0.001) (f64.min (f64.const 192000.) (f64.max (f64.const 1.) (f64.convert_s/i32 (i32.load offset=8 (i32.const 0)))))))
		
	)
	(func $instanceResetUserInterface (param $dsp i32)
		(f64.store (i32.const 0) (f64.const 98.400000000000006))
		(f64.store offset=24 (i32.const 0) (f64.const 8.0999999999999996))
	...
	(func $compute (param $dsp i32) (param $count i32) (param $inputs i32) (param $outputs i32)
		...
		(set_local $fSlow0 (f64.mul (f64.const 0.01) (f64.load (i32.const 0))))
		(set_local $iSlow1 (i32.add (i32.and (i32.add (i32.trunc_s/f64 (f64.mul (f64.load offset=16 (i32.const 0)) (f64.load offset=24 (i32.const 0)))) (i32.const -1)) (i32.const 65535)) (i32.const 1)))
		(set_local $i (i32.const 0))
		(loop $for-in-i 
			(block $for-out-i 
				(f64.store (i32.add (i32.const 40) (i32.shl (i32.and (i32.load offset=32 (i32.const 0)) (i32.const 131071)) (i32.const 3))) (f64.add (f64.load (i32.add (get_local $input0) (get_local $i))) (f64.mul (get_local $fSlow0) (f64.load (i32.add (i32.const 40) (i32.shl (i32.and (i32.sub (i32.load offset=32 (i32.const 0)) (get_local $iSlow1)) (i32.const 131071)) (i32.const 3)))))))
				(f64.store (i32.add (get_local $output0) (get_local $i)) (f64.load (i32.add (i32.const 40) (i32.shl (i32.and (i32.sub (i32.load offset=32 (i32.const 0)) (i32.const 0)) (i32.const 131071)) (i32.const 3)))))
