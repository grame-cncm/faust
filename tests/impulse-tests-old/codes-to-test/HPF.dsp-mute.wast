...
(module
	...
	(func $compute (param $dsp i32) (param $count i32) (param $inputs i32) (param $outputs i32)
		...
		(set_local $fSlow4 (call $cos (get_local $fSlow0)))
		(set_local $fSlow5 (f64.mul (f64.const 0.5) (f64.add (get_local $fSlow4) (f64.const 1.))))
		(set_local $fSlow6 (f64.div (f64.const 1.) (get_local $fSlow2)))
		(set_local $fSlow7 (f64.sub (f64.const 0.) (f64.mul (f64.const 2.) (get_local $fSlow4))))
		(set_local $fSlow8 (f64.sub (f64.const 1.) (get_local $fSlow1)))
		(set_local $fSlow9 (f64.sub (f64.const -1.) (get_local $fSlow4)))
		(set_local $i (i32.const 0))
		(loop $for-in-i 
			(block $for-out-i 
				(f64.store offset=40 (i32.const 0) (f64.sub (f64.load (i32.add (get_local $input0) (get_local $i))) (f64.mul (get_local $fSlow6) (f64.add (f64.mul (get_local $fSlow7) (f64.load offset=48 (i32.const 0))) (f64.mul (get_local $fSlow8) (f64.load offset=56 (i32.const 0)))))))
				(f64.store (i32.add (get_local $output0) (get_local $i)) (f64.mul (get_local $fSlow3) (f64.add (f64.add (f64.mul (get_local $fSlow5) (f64.load offset=40 (i32.const 0))) (f64.mul (get_local $fSlow9) (f64.load offset=48 (i32.const 0)))) (f64.mul (get_local $fSlow5) (f64.load offset=56 (i32.const 0))))))
