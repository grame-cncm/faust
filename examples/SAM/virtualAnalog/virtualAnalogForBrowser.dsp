...
eei = mr2(vslider("[1] extInputOn [midi:ctrl 13] [style:knob] [color:blue]", 0, 0, 1, 1));
...
// was Staccato
legatoButton = wg(vslider("GlideEnable [midi:ctrl 65] [tooltip: Glide from note to note][style:knob]", 1, 0, 1, 1));
// was Legato
