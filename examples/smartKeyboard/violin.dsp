...
kb0freq = hslider("kb0freq",220,20,10000,0.01);
kb0bend = hslider("kb0bend",1,0,10,0.01);
kb1freq = hslider("kb1freq",330,20,10000,0.01);
kb1bend = hslider("kb1bend",1,0,10,0.01);
kb2freq = hslider("kb2freq",440,20,10000,0.01);
kb2bend = hslider("kb2bend",1,0,10,0.01);
kb3freq = hslider("kb3freq",550,20,10000,0.01);
kb3bend = hslider("kb3bend",1,0,10,0.01);
kb4k0x = hslider("kb4k0x",0,0,1,1) : si.smoo;
kb4k0y = hslider("kb4k0y",0,0,1,1) : si.smoo;
kb0fingers = hslider("kb0fingers",0,0,10,1) : int;
kb1fingers = hslider("kb1fingers",0,0,10,1) : int;
kb2fingers = hslider("kb2fingers",0,0,10,1) : int;
kb3fingers = hslider("kb3fingers",0,0,10,1) : int;

// MODEL PARAMETERS
// strings lengths
sl(0) = kb0freq*kb0bend : pm.f2l : si.smoo;
sl(1) = kb1freq*kb1bend : pm.f2l : si.smoo;
sl(2) = kb2freq*kb2bend : pm.f2l : si.smoo;
sl(3) = kb3freq*kb3bend : pm.f2l : si.smoo;
