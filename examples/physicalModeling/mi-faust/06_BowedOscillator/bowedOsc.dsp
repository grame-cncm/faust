...
in1 = hslider("Bow Position", 0, 0, 100, 0.001):si.smoo:si.smoo:si.smoo;
...
model = (mi.oscil(1., 0.1, 0.0003, 0, 0., 0.), mi.posInput(1.):RoutingMassToLink:mi.nlBow(1.2, 0.001, type, 0., 1.), par(i, nbOut, _):RoutingLinkToMass)~par(i, nbMass, _):par(i, nbMass, !), par(i, nbOut, _)
    with {
