...
model = (mi.oscil(1., 0.1, 0.0003, 0, 0., 0.), mi.posInput(1.):RoutingMassToLink:mi.nlPluck(0.5, 0.1, 0.001, 0., 1.), par(i, nbOut, _):RoutingLinkToMass)~par(i, nbMass, _):par(i, nbMass, !), par(i, nbOut, _)
    with {
        RoutingMassToLink(m0, m1) = /* routed positions */
        m0, m1, /* outputs */
        m0, m1;
        RoutingLinkToMass(l0_f1, l0_f2, p_out1, p_out2) = /* routed forces  */
