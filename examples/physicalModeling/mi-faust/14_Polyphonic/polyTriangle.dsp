...
model = (mi.ground(0.), mi.mass(1., 0, 0., 0.), mi.mass(1., 0, 0., 0.), mi.mass(1., 0, 0., 0.), par(i, nbFrcIn, _):RoutingMassToLink, par(i, nbFrcIn, _):mi.springDamper(0.05, 0.01, 0., 0.), mi.springDamper(m_K, m_Z, 0., 0.), mi.springDamper(m_K, m_Z, 0., 0.), mi.springDamper(m_K, m_Z, 0., 0.), par(i, nbOut+nbFrcIn, _):RoutingLinkToMass)~par(i, nbMass, _):par(i, nbMass, !), par(i, nbOut, _)
    with {
        RoutingMassToLink(m0, m1, m2, m3) = /* routed positions */
        m0, m1, m1, m2, m2, m3, m3, m1, /* outputs */
        m3;
        RoutingLinkToMass(l0_f1, l0_f2, l1_f1, l1_f2, l2_f1, l2_f2, l3_f1, l3_f2, p_out1, f_in1) = /* routed forces  */
        l0_f1, l0_f2+l1_f1+l3_f2, f_in1+l1_f2+l2_f1, l2_f2+l3_f1, /* pass-through */
        p_out1;
        nbMass = 4;
        nbFrcIn = 1;
        nbOut = 1;
