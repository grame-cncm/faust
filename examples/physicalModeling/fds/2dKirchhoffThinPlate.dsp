...
midCoeff = 0, 0, E, 0, 0, 0, D, C, D, 0, E, C, A, C, E, 0, D, C, D, 0, 0, 0, E, 0, 0;

midCoeffDelay1 = 0, 0, 0, 0, 0, 0, 0, F, 0, 0, 0, F, B, F, 0, 0, 0, F, 0, 0, 0, 0, 0, 0, 0;
...
scheme(pointsX, pointsY) = par(i, pointsX, par(j, pointsY, coefficients));
...
//----------------------------------Process---------------------------------//
process = forceModel<:fd.linInterp2D(nPointsX, nPointsY, inPointX, inPointY):fd.model2D(nPointsX, nPointsY, r, t, scheme(nPointsX, nPointsY)):fd.linInterp2DOut(nPointsX, nPointsY, outPointX, outPointY);
