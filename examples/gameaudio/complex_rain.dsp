...
path(d, g, f1, f2, f1o, f2o, q, s) = (+(s):de.delay(300, ds):*(g)<:(flt(f2, f2o), flt(f1, f1o), _))~(_):(si.block(1), _, _)
    with {
...
ambient_rain(f) = drops2(f, 0.013, 0.05, 0.1)
    with {
        drops2(f, q, t, a) = no.noise:fi.resonbp(f, q, 200):aa.clip(0, 1):max(t):-(t):sq:sq:*(a):fi.highpass(1, 2000);
        sq(x) = x*x;
    };
