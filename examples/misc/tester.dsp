...
// TODO: this should be rewritten with the pink noise function of generator.lib
pink	= f : (+ ~ g) with {
...
testsignal		= ge.osci(freq)*checkbox("sine wave")
				+ ge.noise * checkbox("white noise")
				+ pink(ge.noise) * ba.db2linear(20)  * checkbox("pink noise");
