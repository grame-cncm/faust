 ...
 */
preamp = hgroup("Guitarix", hgroup("[0]TubeScreamer", ts9sim):hgroup("[1]preamp: 12AX7", stage1:stage2):hgroup("[2]tonestack: jcm2000", tstack):hgroup("[3]Cabinet", cab))
    with {
...
ts9(low, step, size, table, x) = interpolation(table,
