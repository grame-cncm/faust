...
const FaustAudioWorkletProcessorGenerator = () => {
    ...
    class FaustMonoAudioWorkletProcessorImp extends FaustAudioWorkletProcessorImp {
        ...
        constructor(options: AudioWorkletNodeOptions) {
            ...
            this.fDSPCode = createMonoDSP(new FaustGeneratorImp().createSyncMonoDSPInstance(options.processorOptions.factory),
                sampleRate,
    ...
    class FaustPolyAudioWorkletProcessorImp extends FaustAudioWorkletProcessorImp {
        ...
        constructor(options: AudioWorkletNodeOptions) {
            ...
            this.fDSPCode = createPolyDSP(new FaustGeneratorImp().createSyncPolyDSPInstance(
